...
<script type="text/javascript"  src="<%=contextPath%>/test2/demo/js/staffCareLogic.js"></script>
...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/test/demo/act/T9DemoAct/addStaffCareInfo.act"  method="post" name="form1" id="form1" onsubmit="">
  <table class="TableBlock" width="80%" align="center">
    ...
    <tr>
      ...
      <td class="TableData">
        ...
        <a href="javascript:;" class="orgAdd" onClick="selectSingleUser(['byCareStaffs', 'byCareStaffsDesc']);">添加</a>
      </td>
    ...
    <tr>
      ...
      <td class="TableData" colspan=3>
        ...
        <a href="javascript:;" class="orgAdd" onClick="selectUser(['participants', 'participantsDesc']);">添加</a>
