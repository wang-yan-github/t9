...
<%
  ...
  List<T9OAKnowUser> users = (List<T9OAKnowUser>)request.getAttribute("users");
  ...
  List<T9CategoriesType>  types = (List<T9CategoriesType>)request.getAttribute("types");//问题分类
  List<T9OAAsk> askList  = (List<T9OAAsk>)request.getAttribute("askList");              //精彩问题推荐  
  List<T9OAAsk> noResolveAskList  = (List<T9OAAsk>)request.getAttribute("noResolvedList");     //为解决的问题
  List<T9OAAsk> resolvedList = (List<T9OAAsk>)request.getAttribute("resolvedList");
  List<T9OAAsk> myAsk  = (List<T9OAAsk>)request.getAttribute("myAsk");
%>
     		...
     		<div class="bc">
     			<div class="bai">     
			      ...
			      %>
			          		...
			          		<li class="showli1">&#8226;&nbsp;<a href="<%=contextPath%>/t9/core/oaknow/act/T9OAAskReferenceAct/findAskRef.act?askId=<%=askList.get(i).getSeqId()%>"><%=askList.get(i).getAsk()%></a>&nbsp;&nbsp;
     	...
     	<div class="bg">
     		...
     		<div class="bc">
     			<div class="bai">
			      ...
			      %>
			          		<li class="showli1">&#8226;&nbsp;<a href="<%=contextPath%>/t9/core/oaknow/act/T9OAAskReferenceAct/findAskRef.act?askId=<%=myAsk.get(i).getSeqId()%>" ><%=myAsk.get(i).getAsk()%></a>
     		...
     		<div class="bc">
     			<div class="bai">
			      ...
			      %>
			          		...
			          		<li class="showli1">&#8226;&nbsp;<a href="<%=contextPath%>/t9/core/oaknow/act/T9OAAskReferenceAct/findAskRef.act?askId=<%=noResolveAskList.get(i).getSeqId()%>" >
     		...
     		<div class="bc">
     			<div class="bai">
			      ...
			      %>
			          		...
			          		<li class="showli1">&#8226;&nbsp;<a href="<%=contextPath%>/t9/core/oaknow/act/T9OAAskReferenceAct/findAskRef.act?askId=<%=resolvedList.get(i).getSeqId()%>"><%=resolvedList.get(i).getAsk()%></a>&nbsp;&nbsp;
