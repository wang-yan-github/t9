...
<script type="text/javascript">
   function gotoIndex(){
		window.location.href = "<%=contextPath3%>/t9/core/oaknow/act/T9OAKnowAct/OAKnowIndex.act";
  }
...
<!--search begin  -->
	 <form name="form1" id="form1" action='<%=contextPath3%>/t9/core/oaknow/act/T9OASeachAct/findResolveStatus.act' method='post'>
	 <div class="searchcss">
	      ...
	      <td><a onclick="javascript:gotoIndex();" class="logo">${oaName}</a>
	      	<input id="textValue" type="text" onmouseover="this.focus()" onfocus="this.select()" name="question" class="" size="35" value="${askName}"/>
	 	      ...
	 	      <input type="button" value="提 问" onclick=location.href="<%=contextPath3%>/core/oaknow/ask.jsp" class="BigButton" />
                                     &nbsp;&nbsp;<a href="<%=contextPath3%>/t9/core/oaknow/act/T9OAKnowPanelAct/mainPanel.act">管理面板</a>
