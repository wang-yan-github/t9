...
String tits = T9Utility.encodeSpecial(tit);
%>
...
function dosubmit(){
  var url = "<%=contextPath%>/t9/core/oaknow/act/T9OAKnowAct/saveAsk.act";
...
function findReference(param, currNo){
  ...
  var url = contextPath + "/t9/core/oaknow/act/T9OAKnowAct/askQuestionByPage.act";
  ...
  if(len && len != 0){
		for(var i=0; i<len; i++){
			temp += "<a href='<%=contextPath%>/t9/core/oaknow/act/T9OAAskReferenceAct/findAskRef.act?askId=" + rtjson.rtData.page[i].seqId +"'>";
...
<div class="navbar">
	<a href="<%=contextPath%>/t9/core/oaknow/act/T9OAKnowAct/OAKnowIndex.act" style="font-size:11px;">${oaName}</a>&nbsp;&raquo;&nbsp;<span style="font-size:11px;">提问</span>
</div>
