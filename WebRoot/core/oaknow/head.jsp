...
function gotoIndex(){
  window.location.href = "<%=contextPath4%>/t9/core/oaknow/act/T9OAKnowAct/OAKnowIndex.act";
 }
function checkVal(){
	 ...
	 <form name="form1" id="form1" action='<%=contextPath4%>/t9/core/oaknow/act/T9OASeachAct/findResolveStatus.act' method='post'>
	 <div class="searchcss">
    ...
    <tr>
	      <td><a onclick="gotoIndex();" class="logo">OA知道</a>
	      	<input type="text" id="textValue" onmouseover="this.focus()" onfocus="this.select()" name="question" size="35" class="askincss2" />	 	      
	 	      ...
	 	      &nbsp;&nbsp;<a href="<%=contextPath4%>/t9/core/oaknow/act/T9OAKnowPanelAct/mainPanel.act">管理面板</a>
