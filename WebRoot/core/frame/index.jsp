...
function reloadScMenu(){
  var scUrl = '<%=contextPath %>/t9/core/funcs/setdescktop/shortcut/act/T9ShortcutAct/listShortCut.act';
  try {
...
function reloadFavMenu(){
  var fUrl = '<%=contextPath %>/t9/core/funcs/setdescktop/fav/act/T9FavAct/list.act';
  try {
...
function getIeTitle() {
  var url = '<%=contextPath %>/t9/core/funcs/system/act/T9SystemAct/getIeTitle.act';
  try {
...
Ext.onReady(function(){
  ...
  ssoLogin("http://192.168.0.126/t9/test/core/sso/1.jsp?sessionToken=" + sessionToken);
  **/
