(function() {
  ...
  window.sms = {
    ...
    checkShortMsrg: function() {
      ...
      var url = contextPath + "/t9/core/funcs/sms/act/T9SmsAct/remindCheck2.act";
      $.ajax({
        type: "GET",
        dataType: "text",
        url: url,
    ...
    showShortMsrg: function () {
      ...
      if (!sms.smsWindow) {
        ...
        sms.smsWindow = new T9.Window(cfg);
      }
      else {
    ...
    showSmsButton: function () {
      if (sms.smsOn == '0') {
        if (!sms.smsAlert) {
          ...
          T9.getCmp('smsBtn') && T9.getCmp('smsBtn').setStatus('active');
          $('#smsFlash').css({
            'display': 'block'
          });
    ...
    hideSmsButton: function (){
      T9.getCmp('smsBtn') && T9.getCmp('smsBtn').setStatus('default');
      $('#smsFlash').css({
        'display': 'none'
      });
    },
