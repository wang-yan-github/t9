...
if (T9Utility.isNullorEmpty(useUsbKeyStr) || T9Utility.isNullorEmpty(secKeyUserStr)) {
  request.getRequestDispatcher("/t9/core/funcs/system/act/T9SystemAct/prepareLoginInIM.act").forward(request, response);
  return;
}
...
function loginUsbKey() {
  ...
  var url = contextPath + "/t9/core/funcs/system/act/T9SystemAct/doLoginIn.act?CLIENT=2";
  $('layout').hide();
  //$('displayDiv').show();
