...
function getUserInfo(el,pageIndex,pageSize){
  ...
  var url = contextPath + "/t9/core/funcs/search/act/T9FrameSerach/searchUser.act";
...
function openIMWindow(seqId,userName){
	var url="/t9/core/funcs/message/smsback.jsp?fromId="+seqId;
...
function getEmialInfo(el,pageIndex,pageSize){
  ...
  var importantInfoArray = new Array();
  var generalInfoArray = new Array();
  var url = contextPath + "/t9/core/funcs/search/act/T9FrameSerach/searchEmail.act";
  var param = "keyWord=" + keyWord + "&pageStart=" + pageIndex + "&pageNum=" + pageSize;
  var rtJson = getJsonRs(url,param);
  var totalRecords = 0;
  totalRecords = rtJson.rtData.recordTotal;
...
function getNotifyInfo(el,pageIndex,pageSize){
  ...
  var importantInfoArray = new Array();
  var generalInfoArray = new Array();
  var url = contextPath + "/t9/core/funcs/search/act/T9FrameSerach/searchNotify.act";
  var param = "keyWord=" + keyWord + "&pageStart=" + pageIndex + "&pageNum=" + pageSize;
  var rtJson = getJsonRs(url,param);
  var totalRecords = 0;
  totalRecords = rtJson.rtData.recordTotal;
...
function getAddressInfo(el,pageIndex,pageSize){
  ...
  var importantInfoArray = new Array();
  var generalInfoArray = new Array();
  var url = contextPath + "/t9/core/funcs/search/act/T9FrameSerach/searchAddress.act";
  var param = "keyWord=" + keyWord + "&pageStart=" + pageIndex + "&pageNum=" + pageSize;
  var rtJson = getJsonRs(url,param);
  var totalRecords = 0;
  totalRecords = rtJson.rtData.recordTotal;
...
function getFileFolderInfo(el,pageIndex,pageSize){
  ...
  var importantInfoArray = new Array();
  var generalInfoArray = new Array();
  var url = contextPath + "/t9/core/funcs/search/act/T9FrameSerach/searchFileFolder.act";
  var param = "keyWord=" + keyWord + "&pageStart=" + pageIndex + "&pageNum=" + pageSize;
  var rtJson = getJsonRs(url,param);
  var totalRecords = 0;
  totalRecords = rtJson.rtData.recordTotal;
...
function getFlowWorkInfo(el,pageIndex,pageSize){
  ...
  var importantInfoArray = new Array();
  var generalInfoArray = new Array();
  var url = contextPath + "/t9/core/funcs/search/act/T9FrameSerach/searchWorkFlow.act";
  var param = "keyWord=" + keyWord + "&pageStart=" + pageIndex + "&pageNum=" + pageSize;
  var rtJson = getJsonRs(url,param);
  var totalRecords = 0;
