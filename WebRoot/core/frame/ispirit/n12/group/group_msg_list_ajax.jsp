...
<script type="text/javascript" src="<%=contextPath%>/core/js/jquery/t9/core/js/jquery/jquery.min1.6.2.js"></script>
...
function getUserName(){
	var url=contextPath + "/t9/core/funcs/system/ispirit/n12/org/act/T9IsPiritOrgAct/getUserName.act";
...
<form id='form1' name='form1' action='<%=contextPath%>/t9/core/funcs/system/ispirit/n12/group/act/T9ImGroupAct/groupMsgSend.act' target="empty" method='post' enctype='multipart/form-data'>
