function getLeftMenus() {
  var actionPath = contextPath + "/t9/core/funcs/system/act/T9SystemAct/listMenu.act";
  ...
  if (cls == 'mainframe-menu-lv1'){
    ...
    if (selected){
      ...
      if (!menuState[id].children){
        try {
          var actionPath = contextPath + "/t9/core/funcs/system/act/T9SystemAct/lazyLoadMenu.act?parent=" + id.replace('m','');
          var json = getJsonRs(actionPath);
          if (json.rtState){
