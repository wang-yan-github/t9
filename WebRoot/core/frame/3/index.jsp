    ...
    <nav class="navbar-default navbar-static-side" role="navigation" style="z-index: 1991;">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                <li class="nav-header" style="width: 100%!important;">
            ...
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li class="dropdown hidden-xs">
                        <a href="javascript:addOneTab('我的工作', contextPath+'/core/funcs/workflow/flowrun/list/index.jsp', 'default');">
                            <i class="fa fa-bell" style="color:#EE6B6B"></i> 待办<!--(<span id="taskCount">5</span>)-->
                        </a>
                    </li>
                    <li class="dropdown">
                        <a href="javascript:doLogoutMsg()" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
                    </li>
                </ul>
            </nav>
        </div>
