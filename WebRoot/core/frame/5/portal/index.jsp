...
$(function() {
  $.ajax({
    type: "POST",
    dataType: "text",
    url: contextPath + "/t9/core/frame/act/T9TdoaAct/showParam.act",
...
function openAppBox() {
  var appbox = T9.getCmp("appbox");
  if (!appbox) {
	  appbox = new T9.Window({
	    title: "应用盒子",
	    modal: true,
	    id: "appbox",
	    layout: 'cardlayout',
...
function serializeSlide() {
  ...
  $.ajax({
     ...
     data: {"oaItem": s},
     type: "POST",
     url: contextPath + '/t9/core/frame/act/T9TdoaAct/updateUserParam.act',
     success: function(r) {
       var json = T9.parseJson(r);
        if (json.rtState == "0") {
           flag = true;
        }
     }
