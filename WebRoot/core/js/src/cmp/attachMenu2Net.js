var T9JsAttachMenu2Net = Class.create();
T9JsAttachMenu2Net.prototype = {
...
function downLoadFile(fileName,filePath){
  ...
  var param = "fileName=" + encodeURIComponent(fileName) + "&path=" + encodeURIComponent(filePath);
  var url = contextPath + "/t9/core/funcs/office/ntko/act/T9NtkoAct/downFileByLocal2.act?" + param;
  location = url;
}
/**
 * NTKOword操作
...
function attachMenuUtil(container,deleteAction,fileNames,filePaths,readOnly,prec , code,isCanPrint,canDown,opFlag,seqId){
  ...
  var attachmenu = new T9JsAttachMenu2Net(cfgs);
  attachmenu.show();
}
