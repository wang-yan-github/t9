...
function insertImg(dom,cntrlId,extData){
  var src = contextPath + "/t9/core/funcs/office/ntko/act/T9NtkoAct/upload.act?attachmentName=" + encodeURIComponent(extData.name) + "&amp;attachmentId=" +extData.id +"&amp;module="+extData.moduel+"&amp;directView=1" ; 
  try{
    InsertImage(src);
  }catch(e){
    alert("");
