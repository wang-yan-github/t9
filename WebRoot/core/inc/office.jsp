...
<%
  ...
  String fileNameServer = request.getParameter(T9ActionKeys.UPLOAD_FILE_NAME_SERVER);
...
<table width="100%" height="100%" align="center">
  <tr>
    <td valign="top">
      ...
      <object border="1" id="TANGER_OCX" classid="clsid:C9BC4DFF-4248-4a3c-8A49-63A7D317F404"
        codebase="<%=contextPath %>/core/cntrls/OfficeControl.cab#version=5,0,1,1" align="center" width="100%" height="100%">
...
<span id="TANGER_OCX_attachURL" style="display:none"><%=contextPath %>/getFile?uploadFileNameOrgn=<%=T9Utility.encodeURL(fileNameOrgn) %>&uploadFileNameServer=<%=T9Utility.encodeURL(fileNameServer) %></span>
