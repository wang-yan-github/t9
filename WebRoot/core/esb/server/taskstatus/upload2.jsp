...
function statistics() {
  ...
  var url = contextPath + "/t9/core/esb/server/taskstatus/act/T9TaskStatusAct/statisticsUpload.act";
...
function addData(data , i) {
  ...
  if (status) {
	if (status == 2) {
	  ...
	  statusValue = data.STATUS3;
	  statusValue2 = date.STATUS23;
	  statusTitle = "接收完毕";
	} else if (status == 4) {
	  statusValue = data.STATUS4;
	  statusValue2 = date.STATUS24;
	  statusTitle = "发送失败";
	}   
  } 
  td = new Element("td");
  ...
  if (!status)  {
    ...
    getTr("发送完毕" , status2 , status22, color , fontColor);
    getTr("接收完毕" , status3 ,status23, color , fontColor);
    getTr("发送失败" , status4,status23, color , fontColor);
  }
}
...
<table border="0" width="" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/system.gif" align="absmiddle"><span class="big3"> 发送任务统计</span><br>
    </td>
  </tr>
</table>
<br>
...
<tr class="TableTr"><td class="TableHeader" width="20%">用户账号</td><td  class="TableHeader"  width="20%">用户名</td><td  class="TableHeader"  width="10%">状态</td><td  class="TableHeader"  width="10%">数量</td><td  class="TableHeader"  width="10%">合计</td><td  class="TableHeader"  width="10%">发文大小</td><td  class="TableHeader"  width="10%">大小合计</td></tr>
<tbody id="listData">
<!-- 
