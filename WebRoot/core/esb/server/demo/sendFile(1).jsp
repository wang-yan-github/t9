...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/meeting.gif" width="17" height="17"><span class="big3">数据交换平台--T9下发送文件</span><br>
    </td>
  </tr>
</table>
<br>
<form id="form1" name="form1" action="<%=contextPath%>/t9/core/esb/server/demo/act/ESBDemoAct/uploadFile.act" method="post" enctype="multipart/form-data">
