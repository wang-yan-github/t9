...
function doInit() {
  ...
  if (rtJson.rtState == "0") {
    ...
    $('sysname').innerHTML = (data['sysname.t9'] || shortOrgName + '数据交换平台') + '&nbsp;20' + ver + '版';
  }else {
    var verArray = (version || "").split('.');
    var ver;
    if (verArray.length > 2) {
    ...
    $('sysname').innerHTML = shortOrgName + '数据交换平台' + '&nbsp;1.0' + ver + '版';
  }
}
...
<table class="TableBlock" width="80%" align="center" cellpadding="5">
  ...
  <tr class="TableLine2">
    ...
    <td nowrap id="sysname"><%=shortOrgName %>数据交换平台</td>
  </tr>
  <tr class="TableLine2">
