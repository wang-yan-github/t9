...
function doInit(){
  var url = "<%=contextPath%>/t9/core/esb/server/sysConfig/act/SysConfigAct/getSysConfig.act";
...
<br>
<form action="<%=contextPath%>/t9/core/esb/server/sysConfig/act/SysConfigAct/updateSysConfig.act" id="" method="post">
