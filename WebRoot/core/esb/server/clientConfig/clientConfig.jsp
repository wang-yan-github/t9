...
function doInit(){
  var url = "<%=contextPath%>/t9/core/esb/server/sysConfig/act/SysConfigAct/getClientConfig.act";
...
<br>
<form action="<%=contextPath%>/t9/core/esb/server/sysConfig/act/SysConfigAct/updateClientConfig.act" id="" method="post">
