...
function delete_Proces(contentId){
	...
	if(window.confirm(msg)){
		var personRequestURL="<%=contextPath%>/t9/core/funcs/personfolder/act/T9PersonFileContentAct";
...
function getFolderName(){
	var getFolderNameUrl =contextPath + "/t9/core/funcs/filefolder/act/T9FileSortAct/getFolderName.act?seqId=<%=seqId%>";
