...
function upload_attach()
{
  if(checkForm()){
    ...
    var actionURL = "<%=contextPath%>/t9/core/funcs/personfolder/act/T9PersonFileContentAct/newFileSingleUpload.act?failseFlag=returnNew&seqId=<%=seqId%>&contentId=<%=contentId %>";
...
function treeSize() {
  var flag=1;
  var requestUrl = contextPath + "/t9/core/funcs/personfolder/act/T9FolderSizeAct";
...
<div>
<form id="newAttachForm" name="newAttachForm" action="<%=contextPath%>/t9/core/funcs/personfolder/act/T9PersonFileContentAct/createFile.act?seqId=<%=seqId%>&contentId=<%=contentId%>" method="post">
