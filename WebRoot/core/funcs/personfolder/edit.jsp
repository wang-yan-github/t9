  ...
  if(checkForm()){
    var oEditor = FCKeditorAPI.GetInstance('fileFolder') ;
	  ...
	  if($("ATTACH_DIR").value){
		...
		var actionURL = "<%=contextPath%>/t9/core/funcs/personfolder/act/T9PersonFileContentAct/newFileSingleUpload.act?failseFlag=returnEdit&seqId=<%=seqId%>&contentId=<%=contentId %>";
