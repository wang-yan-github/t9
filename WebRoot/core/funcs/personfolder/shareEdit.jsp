...
var requestURL="<%=contextPath%>/t9/core/funcs/personfolder/act/T9PersonFileContentAct";
function sendForm(){
  ...
  if(checkForm()){
    var oEditor = FCKeditorAPI.GetInstance('fileFolder') ;
	  ...
	  if($("ATTACH_DIR").value){
	   ...
	   var actionURL = "<%=contextPath%>/t9/core/funcs/personfolder/act/T9PersonFileContentAct/newFileSingleUpload.act?failseFlag=shareEdit&seqId=<%=seqId%>&contentId=<%=contentId %>&managerPriSeqId=<%=managerPriSeqId%>";
...
<input type="hidden" value="t9.core.funcs.personfolder.data.T9FileContent" name="dtoClass">
...
<div>
<form id="newAttachForm" name="newAttachForm" action="<%=contextPath%>/t9/core/funcs/personfolder/act/T9PersonFileContentAct/newFile.act?seqId=<%=seqId%>&contentId=<%=contentId%>" method="post">
