...
function userRepair(){
  var url = contextPath + "/t9/core/funcs/mysqldb/act/T9MySqldbAct/userRepair.act";
...
function userRepairById(){
  ...
  var url = contextPath + "/t9/core/funcs/mysqldb/act/T9MySqldbAct/userRepairById.act?userIds=" + userId;
  var rtJson = getJsonRs(url);
  if(rtJson.rtState == '0'){
