...
function doInit(){
  ...
  var url1 = contextPath + "/t9/core/funcs/mysqldb/act/T9MySqldbAct/getBackUpTask.act";
  ...
  var url = contextPath + "/t9/core/funcs/mysqldb/act/T9MySqldbAct/getDbNames.act";
...
function saveSet(){
  ...
  var url = contextPath + "/t9/core/funcs/mysqldb/act/T9MySqldbAct/updateOfficeTask.act";
