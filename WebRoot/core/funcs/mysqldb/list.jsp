<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.*,t9.core.funcs.mysqldb.data.*"%>
<%@ include file="/core/inc/header.jsp" %>
<%
  List<T9MySqlTabInfo> tabInfo = (List<T9MySqlTabInfo>)request.getAttribute("tabInfo");
%>
...
function actionUrl(type,form1){
  if(type == 1){
     url = contextPath + "/t9/core/funcs/mysqldb/act/T9MySqldbAct/export.act";
   }else{
...
4、“数据库热备份”是拷贝备份整个数据库目录(T9)，可作为日常数据备份方法。<br/>
  <div style="height:4px"></div>
...
<table class="TableList" align="center">
 ...
 <tr class="TableHeader">
  ...
  <%for(int i = 0 ; i < tabInfo.size() ; i ++){ 
    T9MySqlTabInfo mytab = tabInfo.get(i);
  %>
    <tr class="TableData">
