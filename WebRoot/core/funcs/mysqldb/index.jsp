...
var jso = [
   {title:"数据库管理", contentUrl:"<%=contextPath%>/t9/core/funcs/mysqldb/act/T9MySqldbAct/listTableInfo.act",  useIframe:true}
...
function checkIsMysql(){
  var url = contextPath + "/t9/core/funcs/mysqldb/act/T9MySqldbAct/checkDb.act";
