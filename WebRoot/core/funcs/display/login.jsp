...
<div id="layout">
	<div id="login_area_pic"><img src="<%=imgPath %>/frame/login_area.jpg" alt="<%=productName %>" title="<%=productName %>"/></div>
	<form method=post action="/t9/core/funcs/display/index.jsp" id='loginForm'>
	<div id="login_area">
