...
function doInit(){	
  ...
  ,requestUrl:contextPath + '/t9/core/funcs/system/dimension/act/T9DimensionAct/getTree.act?seqId=<%=seqId%>&id='
  ,isOnceLoad:false
...
//alert("curNode:"+node+"  parentId>>>:"+parentId);
  ...
  if(id){
    //判断此节点有没有所有者权限
    var requestURL="<%=contextPath%>/t9/core/funcs/system/dimension/act/T9DimensionAct/getPrivteById.act?seqId="+id;
