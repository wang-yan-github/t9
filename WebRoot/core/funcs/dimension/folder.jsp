...
var requestURL1="<%=contextPath%>/t9/core/funcs/system/dimension/act/T9DimensionAct";
function doInit(){
     var seqId='<%=seqId%>';
...
function delete_sort(seqId){
	...
	if(window.confirm(msg)){
		var url="<%=contextPath%>/t9/core/funcs/system/dimension/act/T9DimensionAct/delDimensionInfoById.act";
		//alert(url);
