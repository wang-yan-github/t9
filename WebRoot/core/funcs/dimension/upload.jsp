...
<body>
  ...
  <form name="form1" id="form1" action="<%=contextPath %>/test/core/act/T9TestFileUploadAct/uploadFile.act" method="post" enctype="multipart/form-data" >
    <table>     
      <tr id="fsUploadRow">
        <td colspan="3">
...
<%--
<br>
<form name="form1" id="form1" action="<%=contextPath %>/t9/test/core/act/T9TestFileUploadAct/uploadFile.act" method="post" enctype="multipart/form-data" >
<table>
  <tr id="">
    <td colspan="3">
