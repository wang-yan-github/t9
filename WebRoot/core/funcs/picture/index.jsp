...
function doInit(){
	...
	if(picIdStr =='0'){
	      ...
	      for(var j=1;j<=6;j++){
	        if(lang>=(i*6+j)){
	        	...
	        	//alert(prcs);
	    			...
	    			var div = new Element('div',{"align":"center", "width":"17%" }).update("<a href='<%=contextPath%>/t9/core/funcs/picture/act/T9PictureAct/getPicInfoById.act?seqId="+ +picId +"' ><img src='<%=contextPath%>/core/funcs/picture/images/disk_share.gif' border='0'></img><br>" + picName +"</a>" );
		...
		location.href="<%=contextPath%>/t9/core/funcs/picture/act/T9PictureAct/getPicInfoById.act?seqId=<%=picId%>";		
