...
function sendForm(){
	...
	if(checkForm()){
	  ...
	  if(flag=="true"){
			parent.opener.location.href="<%=contextPath%>/t9/core/funcs/picture/act/T9PictureAct/getPicInfoById.act?ascDescFlag=<%=pageAscDesc %>&field=<%=pageField %>&subDir=" + returnSubDir +"&seqId=<%=seqId%>";
			$("formDiv").hide();
			$("returnDiv").show();		
