...
function doInit(){
	...
	location.href=contextPath + "/t9/core/funcs/picture/act/T9PictureAct/getPicInfoById.act?seqId=<%=seqId%>&ascDescFlag=<%=ascDescFlag%>&field=<%=field%>&subDir=" + subDirStrEncode ;
}
