...
function doInit(){
  if(seqId){
    var url = "<%=contextPath%>/t9/core/funcs/system/extuser/act/T9ExtUserAct/getEditExtUser.act?seqId="+seqId;
...
function commit(){
  ...
  if (seqId) {
    var url = "<%=contextPath%>/t9/core/funcs/system/extuser/act/T9ExtUserAct/updateExtUser.act?seqId="+seqId+"&userId="+encodeURIComponent(userId)+"&password="+password+"&useFlagstr="+useFlagstr+"&remark="+encodeURIComponent(remark)+"&moduleSmsStr="+moduleSmsStr+"&moduleWorkflowStr="+moduleWorkflowStr+"&postfix="+encodeURIComponent(postfix);
    ...
    var url = "<%=contextPath%>/t9/core/funcs/system/extuser/act/T9ExtUserAct/addExtUser.act?userId="+encodeURIComponent(userId)+"&password="+password+"&useFlagstr="+useFlagstr+"&remark="+encodeURIComponent(remark)+"&moduleSmsStr="+moduleSmsStr+"&moduleWorkflowStr="+moduleWorkflowStr+"&postfix="+encodeURIComponent(postfix);
    var rtJson = getJsonRs(url, mergeQueryString($("form1")));
    if (rtJson.rtState == "0") {
...
<input type="hidden" name="seqId" id="seqId" value="">
  <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.system.extuser.data.T9ExtUser.java"/>
