...
<%@ page import="java.util.*,t9.core.funcs.system.extuser.data.T9ExtUser" %>
<%@ page import="t9.core.data.T9RequestDbConn, t9.core.global.T9BeanKeys" %>
<%
  ArrayList<T9ExtUser> extList = (ArrayList<T9ExtUser>)request.getAttribute("extList");
...
var sum = 0;
function doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/system/extuser/act/T9ExtUserAct/getCount.act";
...
function deleteAllUser() {
  ...
  var url = "<%=contextPath %>/t9/core/funcs/system/extuser/act/T9ExtUserAct/deleteExtUser.act";
...
function commit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/accesscontrol/act/T9IpRuleAct/updateIpRule.act?seqId="+seqId+"&beginIp="+beginIp+"&endIp="+endIp+"&remark="+remark+"&type="+type;
