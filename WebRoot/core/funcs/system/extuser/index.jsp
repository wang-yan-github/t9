...
function doInit() {
  var tabArray = [{title:"接口用户管理", content:"", contentUrl:"<%=contextPath%>/t9/core/funcs/system/extuser/act/T9ExtUserAct/getExtUser.act", imgUrl: imgPath + "/cmp/tab/sys_config.gif", useIframe:true},
