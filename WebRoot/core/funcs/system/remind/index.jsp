...
function doInit(){
  remindPriv();
  var url = "<%=contextPath%>/t9/core/funcs/system/remind/act/T9RemindAct/getRemind.act";
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/remind/act/T9RemindAct/getRemindCode.act";
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
    bindJson2Cntrl(rtJson.rtData);
...
function remindPriv(){
  var url = "<%=contextPath%>/t9/core/funcs/system/remind/act/T9RemindAct/getRemindPriv.act";
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
...
function commitRemind(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/remind/act/T9RemindAct/updateRemind.act?remindSum="+remindSum+"&seqIdRemind="+seqIdRemind;
  var rtJson = getJsonRs(url);
  if(rtJson.rtState == "0"){
...
<input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.system.remind.data.T9Remind.java"/>
