...
<form name="form1" id="form1" method="post" action="<%=contextPath %>/t9/core/funcs/system/info/act/T9InfoAct/triaReg.act" enctype="multipart/form-data">
<table class="TableTop" style="width: 600px" align="center">
  <tr>
    <td class="left">
    </td>
    <td class="center" align="center">
    <%=shortProductName %>增加试用人数延长试用期限
    </td>
    <td class="right">
    </td>
  </tr>
  ...
  <tbody>
    <tr>
      ...
      <td nowrap="" class="TableData">
        ...
        试用用户，请选择通过<%=shortOrgName %>网站获取的授权文件，进行操作      </td>
    </tr>
    <tr>
