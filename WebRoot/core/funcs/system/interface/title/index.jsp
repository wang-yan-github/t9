...
function theme(){
  var url = "<%=contextPath%>/t9/core/funcs/system/interfaces/act/T9InterFacesAct/getTheme.act";
...
function webosLogo(){
  var url = "<%=contextPath%>/t9/core/funcs/system/interfaces/act/T9InterFacesAct/getWebosLogo.act";
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
    if (rtJson.rtData == "1") {
      $('editPic2').show();
...
function getDefaultStyle(){
  var url = "<%=contextPath%>/t9/core/funcs/system/interfaces/act/T9InterFacesAct/getDefaultStyle.act";
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
    if (rtJson.rtData == "1") {
...
function deleteWebosLogo(){
  var url = "<%=contextPath%>/t9/core/funcs/system/interfaces/act/T9InterFacesAct/deleteWebosLogo.act";
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
...
function ui(){
  var url = "<%=contextPath%>/t9/core/funcs/system/interfaces/act/T9InterFacesAct/getUi.act";
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
...
function template(){
  var url = "<%=contextPath%>/t9/core/funcs/system/interfaces/act/T9InterFacesAct/getTemplate.act";
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
 ...
 */
 ...
 function statusText(){
   var url = "<%=contextPath%>/t9/core/funcs/system/interfaces/act/T9InterFacesAct/getStatusText.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/interfaces/act/T9InterFacesAct/getInterFaces.act";
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
    ...
    if(rtJson.rtData.ieTitle == ""){
       $("ieTitle").value = productName;
    }
    if(rtJson.rtData.bannerText == ""){
      //$("bannerText").value = productName;
   }
  } else {
    alert(rtJson.rtMsrg); 
  }

  var url = "<%=contextPath%>/t9/core/funcs/system/interfaces/act/T9InterFacesAct/getTableGround.act";
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
    //bindJson2Cntrl(rtJson.rtData);
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/interfaces/act/T9InterFacesAct/getMiibeian.act";
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
    //bindJson2Cntrl(rtJson.rtData);
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/interfaces/act/T9InterFacesAct/getOnlineView.act";
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
    //bindJson2Cntrl(rtJson.rtData);
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/interfaces/act/T9InterFacesAct/getLogOutText.act";
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
   // bindJson2Cntrl(rtJson.rtData);
...
//主界面-顶部图标  上传文件
  ...
  $("form1").action = contextPath + "/t9/core/funcs/system/interfaces/act/T9InterFacesAct/updateAll.act?onlineView="+onlineView+"&ATTACHMENT="+ATTACHMENT+"&ATTACHMENT1="+ATTACHMENT1;
  $("form1").submit();
}
...
function deleteAttachPic(flag){
  if(flag == "0"){
    var url = contextPath + "/t9/core/funcs/system/interfaces/act/T9InterFacesAct/updateAttachMent.act";
  ...
  if(flag == "1"){
    var url = contextPath + "/t9/core/funcs/system/interfaces/act/T9InterFacesAct/updateAttachMent1.act";
...
<form enctype="multipart/form-data" method="post" name="form1" id="form1">
  <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.system.interfaces.data.T9Interface"/>
