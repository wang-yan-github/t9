...
var requestUrl = contextPath + "/t9/core/funcs/system/resManage/act/T9ResManageAct";
function CheckForm2()
{   
...
<tr>
    <td class="Big"><img src="<%=imgPath %>/sys_config.gif" WIDTH="22" HEIGHT="20" align="absmiddle"><span class="big3"> 提醒资源回收</span><br>
    </td>
  </tr>
</table>
...
<div align="center">
  <input type="button"  value="删除已读且发件人已删提醒" class="BigButtonD" onClick="delete_sms();" title="删除所有已读且发件人已删除的提醒，有利于改进系统速度">&nbsp;&nbsp;
  <input type="button"  value="清空收信人已删提醒" class="BigButtonD" onClick="delete_deleted_sms();" title="清空收信人已删提醒，有利于改进系统速度">
</div>
...
<br>
  ...
  <table class="TableBlock" width="500" align="center">
    ...
    <tr>
      ...
      <td class="TableData">
          <input type="checkbox" name="SMS" id="SMS"><label for="SMS">提醒</label>
