...
function doInit() {
var jso = [{ title:"资源监控", useTextContent:true, contentUrl:"monitor/index.jsp", useIframe:true}
           ...
           ,{title:"数据归档", useTextContent:true,  contentUrl:contextPath + "/core/funcs/system/res_manage/archive/index.jsp" , useIframe:true}
