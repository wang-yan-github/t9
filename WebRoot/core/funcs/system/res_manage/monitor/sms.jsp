...
function delete_one(SMS_ID)
{
 ...
 {
  URL= contextPath + "/t9/core/funcs/system/resManage/act/T9SmsResManageAct/deleteSms.act?SMS_ID=" + SMS_ID;
...
function doInit() {
  ...
  var url = contextPath + "/t9/core/funcs/system/resManage/act/T9SmsResManageAct/searchSms.act";
