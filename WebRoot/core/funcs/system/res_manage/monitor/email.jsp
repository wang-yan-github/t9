...
function delete_mail(EMAIL_ID)
{
 ...
 if(window.confirm(msg)){
   var url = contextPath + "/t9/core/funcs/system/resManage/act/T9EmailResManageAct/deleteEmail.act";;
...
function doInit() {
  ...
  var url = contextPath + "/t9/core/funcs/system/resManage/act/T9EmailResManageAct/searchEmail.act";
