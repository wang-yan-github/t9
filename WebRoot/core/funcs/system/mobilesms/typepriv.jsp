...
function  doInit(){
  var typePrivStr = "";
  var seqId = "";
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/getTypePriv.act";
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/getTypePrivConfig.act?typePriv="+typePrivStr;
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
...
function submitForm(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/setTypePrivConfig.act";
