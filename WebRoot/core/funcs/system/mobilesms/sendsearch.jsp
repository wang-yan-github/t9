...
<%
  ...
  phone = T9Utility.encodeSpecial(phone);
  if (phone == null) {
    phone = "";
  }
...
function doInit() {
  ...
  var url =  contextPath + "/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/getSendSearchList.act?" + param;
  var cfgs = {
    dataAction: url,
...
function mobilNo(cellData, recordIndex, columIndex){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/getPersonPhone.act";
...
function sms3Phone(seqId){
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/getSms2MobilNo.act";
...
function fromName(cellData, recordIndex, columIndex){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/getUserName.act";
...
function addressMobilNo(phone){
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/getAddressPhone.act";
  var rtJson = getJsonRs(url, "mobilNo="+phone);
  if (rtJson.rtState == "0") {
...
function doDelete(seqId) {
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/deleteSelectSms2.act";
