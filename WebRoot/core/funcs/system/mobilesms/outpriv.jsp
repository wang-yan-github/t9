...
function doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/getOutPriv.act";
...
function doSubmit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/updateOutPriv.act";
