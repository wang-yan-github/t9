...
function doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/getSms2RemindPriv.act";
...
function doSubmit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/updateSms2RemindPriv.act";
