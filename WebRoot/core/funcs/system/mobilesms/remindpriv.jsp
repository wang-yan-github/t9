...
function doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/getRemindPriv.act";
...
function doSubmit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/updateRemindPriv.act";
