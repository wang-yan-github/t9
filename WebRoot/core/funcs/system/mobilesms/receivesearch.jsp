...
function doInit() {
  ...
  var url =  contextPath + "/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/getReceiveSearchList.act?" + param;
  var cfgs = {
    dataAction: url,
...
function doDelete(seqId) {
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/deleteSelect.act";
