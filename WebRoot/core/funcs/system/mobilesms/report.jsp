...
function doInit() {
  var url =  contextPath + "/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/getReportSearchList.act";
  var cfgs = {
    dataAction: url,
...
function sendSuccess(cellData, recordIndex, columIndex){
  var seqId = this.getCellData(recordIndex,"seqId");
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/getSendSuccess.act";
...
function sendNo(cellData, recordIndex, columIndex){
  var seqId = this.getCellData(recordIndex,"seqId");
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/getSendNo.act";
  var rtJson = getJsonRs(url, "seqId="+seqId+"&beginDate="+beginDate+"&endDate="+endDate);
  if (rtJson.rtState == "0") {
    return "<center>" + rtJson.rtData + "</center>";
  }
...
function sendTimeOut(cellData, recordIndex, columIndex){
  var seqId = this.getCellData(recordIndex,"seqId");
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/getsendTimeOut.act";
  var rtJson = getJsonRs(url, "seqId="+seqId+"&beginDate="+beginDate+"&endDate="+endDate);
  if (rtJson.rtState == "0") {
    return "<center>" + rtJson.rtData + "</center>";
  }
...
function doDelete(seqId) {
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/deleteSendSign.act";
