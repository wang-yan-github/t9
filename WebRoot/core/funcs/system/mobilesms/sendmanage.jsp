...
function deleteSms(){
  ...
  var beginDate = $("beginDate").value;
  var endDate = $("endDate").value;
  var url = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/deleteSendManage.act";
...
function reportSubmit(){
  ...
  if(radio2.checked == true){
    ...
    if(radio0.checked == true){
      location = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/exportToExcelSmsPerson.act?beginDate="+beginDate+"&endDate="+endDate;
    }else if(radio1.checked == true){
      location = "<%=contextPath%>/t9/core/funcs/system/mobilesms/act/T9MobileSmsAct/exportToExcelSmsDept.act?beginDate="+beginDate+"&endDate="+endDate;
    }
  }
}
</script>
