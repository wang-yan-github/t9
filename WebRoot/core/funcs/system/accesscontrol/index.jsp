...
function doInit() {
  var tabArray = [{title:"IP规则管理", content:"", contentUrl:"<%=contextPath%>/t9/core/funcs/system/accesscontrol/act/T9IpRuleAct/getIpRule.act", imgUrl: imgPath + "/cmp/tab/asset.gif", useIframe:true},
