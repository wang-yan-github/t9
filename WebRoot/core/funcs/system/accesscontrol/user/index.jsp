...
function doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/system/accesscontrol/act/T9AccesscontrolAct/getAccessControl.act";
...
function commit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/accesscontrol/act/T9AccesscontrolAct/updateAccessControl.act?accessControlId="+accessControlId;
...
<form enctype="multipart/form-data" method="post" name="form1" id="form1">
  ...
  <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.system.accesscontrol.data.T9Accesscontrol.java"/>
    <tr>
      <td class="TableData">
