...
function showModel(seqId){
  var url = contextPath + "/t9/core/funcs/system/wordmoudel/act/T9WordModelAct/showModel.act";
...
function deleteLogic(seqId){
  var url = contextPath + "/t9/core/funcs/system/wordmoudel/act/T9WordModelAct/deleteModel.act" ;
  var rtJson = getJsonRs(url,"seqId=" + seqId);
  if(rtJson.rtState == "0"){
    alert("删除成功");
  }else{
...
function getAllDept(){
  var url = contextPath + "/t9/core/funcs/system/wordmoudel/act/T9WordModelAct/getAllDept.act" ;
