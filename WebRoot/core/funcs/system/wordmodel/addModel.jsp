...
function doSubmit(){
  ...
  if(id){
    $("form1").action = contextPath + "/t9/core/funcs/system/wordmoudel/act/T9WordModelAct/updateWordModel.act";
...
<br>
<form enctype="multipart/form-data" action="<%=contextPath %>/t9/core/funcs/system/wordmoudel/act/T9WordModelAct/saveWordModel.act" method="post" name="form1" id="form1">
