...
function doInit(){
  ...
  var url =  contextPath + "/t9/core/funcs/system/wordmoudel/act/T9WordModelAct/listAllModel.act";
  var cfgs = {
    dataAction: url,
...
function doSearch(){
 ...
 // var url =  contextPath + "/t9/core/funcs/system/wordmoudel/act/T9WordModelAct/listModelSearch.act?" + param;
