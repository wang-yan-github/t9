...
function doInit() {
  var tabArray = [{title:"词语过滤管理", content:"", contentUrl:"<%=contextPath%>/t9/core/funcs/system/censorwords/act/T9CensorWordsAct/getCensorWords.act", imgUrl: imgPath + "/cmp/tab/notify_open.gif", useIframe:true},
                  ...
                  {title:"过滤模块设置", content:"", contentUrl:"<%=contextPath%>/t9/core/funcs/system/censorwords/act/T9CensorModuleAct/getCensorModule.act", imgUrl: imgPath + "/cmp/tab/notify_open.gif", useIframe:true}];
