...
function deleteAllUser() {
  ...
  var url = "<%=contextPath %>/t9/core/funcs/system/censorwords/act/T9CensorWordsAct/deleteCensorWords.act";
...
function getUserName(userId){
  var userName = "";
  var url = "<%=contextPath %>/t9/core/funcs/system/censorwords/act/T9CensorWordsAct/getUserName.act";
...
<%
  for(int i = 0; i < wordList.size(); i++) {
    T9CensorWords cen = wordList.get(i);
