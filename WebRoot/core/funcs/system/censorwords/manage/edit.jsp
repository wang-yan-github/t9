...
var seqId = "<%=seqId%>";
function doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/system/censorwords/act/T9CensorWordsAct/getCensorWordsId.act?seqId="+seqId;
...
function commit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/censorwords/act/T9CensorWordsAct/updateCensorWords.act?seqId="+seqId+"&find="+encodeURIComponent(find)+"&replacement="+encodeURIComponent(replacement);
