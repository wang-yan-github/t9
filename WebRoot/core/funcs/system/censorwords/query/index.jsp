...
function commit(){
  ...
  if(document.getElementById("OPERATION1").checked == true){
    var url = "<%=contextPath%>/t9/core/funcs/system/censorwords/act/T9CensorWordsAct/getCensorWordsSearch.act?find="+find+"&replacement="+replacement;
    location = url;
  }else if(document.getElementById("OPERATION2").checked == true){
    var url = "<%=contextPath%>/t9/core/funcs/system/censorwords/act/T9CensorWordsAct/exportToTxt.act?find="+find+"&replacement="+replacement;
    location = url;
  }else if(document.getElementById("OPERATION3").checked == true){
    var url = "<%=contextPath%>/t9/core/funcs/system/censorwords/act/T9CensorWordsAct/deleteSearchWords.act?find="+find+"&replacement="+replacement;
    location = url;
  }
}
</script>
