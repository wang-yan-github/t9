...
function doInit(){
  if(seqId){
    var url = "<%=contextPath%>/t9/core/funcs/system/censorwords/act/T9CensorModuleAct/getCensorModuleId.act?seqId="+seqId;
...
function commit(){
  ...
  if(seqId){
    var url = "<%=contextPath%>/t9/core/funcs/system/censorwords/act/T9CensorModuleAct/updateCensorModule.act";
    ...
    if(rtJson.rtState == "0"){
      location = "<%=contextPath %>/t9/core/funcs/system/censorwords/act/T9CensorModuleAct/getCensorModule.act";
    }else{
	  alert(rtJson.rtMsrg);
    }
  }else{
    var url = "<%=contextPath%>/t9/core/funcs/system/censorwords/act/T9CensorModuleAct/insertCensorModule.act";
...
<input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.system.censorwords.data.T9CensorModule.java"/>
