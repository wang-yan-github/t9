...
function doInit(){
  ...
  var url =  contextPath + "/t9/core/funcs/system/sealmanage/act/T9SealLogAct/getSealLogList.act?" + param;
  var cfgs = {
    dataAction: url,
...
function deleteAllUser() {
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/sealmanage/act/T9SealLogAct/deleteSealLog.act";
