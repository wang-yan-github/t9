...
function doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/system/sealmanage/act/T9SealAct/getSealPriv.act";
...
function commit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/sealmanage/act/T9SealAct/updateSealPriv.act";
