...
<%
	String usePortalFunc = T9SysProps.getString("usePortalFunc");
	if(T9Utility.isNullorEmpty(usePortalFunc)){
		usePortalFunc = "";
	}
%>
...
<div id="ModalDialog" class="ModalDialog" style="width:300px;">
  ...
  <div id="body" class="body">
    <form name="form1" id="form1" action="">
    	<input type="hidden" value="t9.core.funcs.system.filefolder.data.T9FileSort" name="dtoClass">
