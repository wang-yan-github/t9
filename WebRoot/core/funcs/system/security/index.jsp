...
function initVerificationCode() {
  var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getVerificationCode.act";
...
function doInit(){
  initVerificationCode();
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityInitPass.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
   ...
   //密码定时过期
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityPassFlag.act";
   var rtJson = getJsonRs(url);
   ...
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityPassTime.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     bindJson2Cntrl(rtJson.rtData);
   ...
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityPassMin.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     //bindJson2Cntrl(rtJson.rtData);
   ...
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityPassMax.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     //bindJson2Cntrl(rtJson.rtData);
   ...
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityPassSafe.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     var d = rtJson.rtData;
   ...
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityRetryBan.act";
   var rtJson = getJsonRs(url);
   ...
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityRetryTimes.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     //bindJson2Cntrl(rtJson.rtData);
   ...
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityBenTime.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     bindJson2Cntrl(rtJson.rtData);
   ...
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityLoginKey.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     bindJson2Cntrl(rtJson.rtData);
   ...
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityUserMen.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     bindJson2Cntrl(rtJson.rtData);
   ...
   //使用用户KEY登录时是否需要输入用户名
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityKeyuser.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     bindJson2Cntrl(rtJson.rtData);
   ...
   //是否启用RTX客户端
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityUseRtx.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     bindJson2Cntrl(rtJson.rtData);
   ...
   */
   ...
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityImModule.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
   ...
   //显示用户登录IP
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityShowIp.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     bindJson2Cntrl(rtJson.rtData);
   ...
   //记忆在线状态
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityOnStatus.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     bindJson2Cntrl(rtJson.rtData);
   ...
   //保留痕迹选项1
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityOcMark.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     bindJson2Cntrl(rtJson.rtData);
   ...
   //保留痕迹选项2
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityMarkDefault.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     bindJson2Cntrl(rtJson.rtData);
 ...
 //显示痕迹
   var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/getSecrityOcRevision.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     bindJson2Cntrl(rtJson.rtData);
...
function commit(){
 ...
 var d = "";
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updateInitPass.act?secInitPass="+secInitPass;
  ...
  //alert(secPassFlag);
  var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updatePassFlag.act?secPassFlag="+secPassFlag;
  var rtJson = getJsonRs(url, mergeQueryString($("form1")));
  ...
  if(secPassFlag == "1"){
    ...
    var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updatePassTime.act?secPassTime="+secPassTime;
    var rtJson = getJsonRs(url, mergeQueryString($("form1")));
  }

  var secPassMin = document.getElementById("SEC_PASS_MIN").value;
  var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updatePassMin.act?secPassMin="+secPassMin;
  var rtJson = getJsonRs(url, mergeQueryString($("form1")));

  var secPassMax = document.getElementById("SEC_PASS_MAX").value;
  var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updatePassMax.act?secPassMax="+secPassMax;
  var rtJson = getJsonRs(url, mergeQueryString($("form1")));
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updatePassSafe.act";
  ...
  if(secRetryBan == "1"){
    ...
    var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updateRetryTimes.act?secRetryTimes="+secRetryTimes;
    var rtJson = getJsonRs(url, mergeQueryString($("form1")));

    var secBanTime = document.getElementById("SEC_BAN_TIME").value;
    var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updateBanTime.act?secBanTime="+secBanTime;
    var rtJson = getJsonRs(url, mergeQueryString($("form1")));
    
  }
  var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updateRetryBan.act?secRetryBan="+secRetryBan;
  var rtJson = getJsonRs(url, mergeQueryString($("form1")));
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updateUserMen.act?secUserMen="+secUserMen;
  var rtJson = getJsonRs(url, mergeQueryString($("form1")));
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updateLoginKey.act?secLoginKey="+secLoginKey;
  var rtJson = getJsonRs(url, mergeQueryString($("form1")));
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updateKeyUser.act?secKeyUser="+secKeyUser;
  var rtJson = getJsonRs(url, mergeQueryString($("form1")));
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updateSecureKey.act?loginSecureKey="+loginSecureKey;
  var rtJson = getJsonRs(url, mergeQueryString($("form1")));
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updateUseRtx.act?secUseRtx="+secUseRtx;
  var rtJson = getJsonRs(url, mergeQueryString($("form1")));
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updateShowIp.act?secShowIp="+secShowIp;
  var rtJson = getJsonRs(url, mergeQueryString($("form1")));
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updateImModule.act?secOnStatus="+secOnStatus;
  ...
  if(secOcMark == "allow_save"){
    ...
    var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updateOcMarkDefault.act?secOcMarkDefault="+secOcMarkDefault;
    var rtJson = getJsonRs(url, mergeQueryString($("form1")));
    ...
    var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updateSecOcMarkDefault.act?secOcMarkDefault="+secOcMarkDefault1;
    var rtJson = getJsonRs(url);
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updateOcMark.act?secOcMark="+secOcMark;
  var rtJson = getJsonRs(url, mergeQueryString($("form1")));
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/security/act/T9SecurityAct/updateOcRevision.act?secOcRevision="+secOcRevision;
  var rtJson = getJsonRs(url, mergeQueryString($("form1")));
