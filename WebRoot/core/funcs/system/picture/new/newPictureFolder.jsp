...
<%
	String isDemo = T9SysProps.getString("IS_ONLINE_EVAL");
	if (isDemo == null) {
		isDemo = "";
	}
...
function sendForm(){
	var requestURL="<%=contextPath%>/t9/core/funcs/system/picture/act/T9PictureAct";
	if(checkForm()){
...
<input type="hidden" value="t9.core.funcs.system.picture.data.T9Picture" name="dtoClass">
 <table class="TableBlock"  width="85%" align="center">
   ...
   <tr>
    ...
    <tr>
      ...
      <td class="TableData">
        <input type="text" name="picPath" id="picPath" size="36" class="BigInput">  说明：T9服务器的本地路径(如:D:\T9)
      </td>
