...
function doOnload(){
  ...
  requestURL = "<%=contextPath%>/t9/core/funcs/system/attendance/act/T9AttendHolidayAct/selectHolidayById.act?seqId=" + seqId; 
...
<form action="<%=contextPath%>/t9/core/funcs/system/attendance/act/T9AttendHolidayAct/updateHolidayById.act"  method="post" id = "form1" name="form1" onsubmit="return CheckForm();">
