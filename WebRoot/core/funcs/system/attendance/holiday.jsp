...
<%
   String curDateStr = T9Utility.getCurDateTimeStr("yyyy-MM-dd");
%>
...
function delete_holiday(seqId){
  ...
  if(window.confirm(msg)){
    var URL = "<%=contextPath%>/t9/core/funcs/system/attendance/act/T9AttendHolidayAct/deleteHolidayById.act?seqId=" + seqId;
    window.location = URL;
  }
}
function delete_all(){
  msg='确认要删除所有节假日吗？';
  if(window.confirm(msg)){
    var URL = "<%=contextPath%>/t9/core/funcs/system/attendance/act/T9AttendHolidayAct/deleteAllHoliday.act";
    window.location = URL;
  }
}
function doOnload(){
  var requestURL; 
  var prcsJson; 
  requestURL = "<%=contextPath%>/t9/core/funcs/system/attendance/act/T9AttendHolidayAct/selectHoliday.act"; 
...
<form action="<%=contextPath%>/t9/core/funcs/system/attendance/act/T9AttendHolidayAct/addHoliday.act"  method="post" id = "form1" name="form1" onsubmit="return CheckForm();">
<input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.system.attendance.data.T9AttendHoliday"/>
