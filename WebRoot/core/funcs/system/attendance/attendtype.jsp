...
function config_delete(seqId){
  var requestURL = "<%=contextPath%>/t9/core/funcs/system/attendance/act/T9AttendConfigAct/deleteConfigById.act?seqId=" + seqId; 
...
function doOnLoad(){
  var requestURL; 
  var prcsJson; 
  requestURL = "<%=contextPath%>/t9/core/funcs/system/attendance/act/T9AttendConfigAct/selectConfig.act"; 
