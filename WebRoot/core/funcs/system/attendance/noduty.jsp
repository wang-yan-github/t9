...
function doOnload(){
  var requestURL; 
  var prcsJson; 
  requestURL = "<%=contextPath%>/t9/core/funcs/system/attendance/act/T9SysParaAct/selectParaNoDutyUser.act"; 
...
<br><br>
<form action="<%=contextPath%>/t9/core/funcs/system/attendance/act/T9SysParaAct/update_addNoDutyUser.act" method="post" name="form1">
