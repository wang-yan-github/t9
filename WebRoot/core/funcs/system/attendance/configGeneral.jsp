...
function Init(){
  ...
  requestURL = "<%=contextPath%>/t9/core/funcs/system/attendance/act/T9AttendConfigAct/updateConfigGenaralById.act?seqId=" + seqId; 
...
function doOnload(){
  ...
  var seqId = '<%=request.getParameter("seqId")%>'; 
  if(seqId != "undefined"){
    var requestURL = "<%=contextPath%>/t9/core/funcs/system/attendance/act/T9AttendConfigAct/selectConfigById.act?seqId=" + seqId; 
