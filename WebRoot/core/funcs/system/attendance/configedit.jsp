...
function Init(){
  if(CheckForm()){
    var requestURL; 
    var prcsJson; 
    requestURL = "<%=contextPath%>/t9/core/funcs/system/attendance/act/T9AttendConfigAct/updateConfigById.act"; 
...
function doOnLoad(){
  ...
  if(seqId != "undefined"){
    var requestURL; 
    var prcs; 
    requestURL = "<%=contextPath%>/t9/core/funcs/system/attendance/act/T9AttendConfigAct/selectConfigById.act?seqId=" + seqId; 
...
<form action="config_insert.php"  method="post" id = "form1" name="form1" >
  <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.system.attendance.data.T9AttendConfig"/>
