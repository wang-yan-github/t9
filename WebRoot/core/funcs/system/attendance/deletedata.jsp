<%@ page language="java" import="java.util.*,t9.core.util.*" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
...
function Init(){
  if(CheckForm()){
    var requestUrl = "<%=contextPath%>/t9/core/funcs/system/attendance/act/T9ManageDataAct/deleteData.act";
