...
function doOnload(){
  var requestURL; 
  var prcsJson; 
  requestURL = "<%=contextPath%>/t9/core/funcs/system/attendance/act/T9AttendManagerAct/selectManager.act"; 
...
<br><br>
<form action="<%=contextPath%>/t9/core/funcs/system/attendance/act/T9AttendManagerAct/add_updateManager.act" method="post" id = "form1" name="form1">
