...
function doOnload(){
  var requestURL; 
  var prcsJson; 
  requestURL = "<%=contextPath%>/t9/core/funcs/system/attendance/act/T9SysParaAct/selectParaInteval.act"; 
...
<br>
<form action="<%=contextPath%>/t9/core/funcs/system/attendance/act/T9SysParaAct/update_addInteval.act" name="form1" id = "form1" onsubmit="return CheckForm();">
