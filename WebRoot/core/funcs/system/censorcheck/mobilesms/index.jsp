...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getCensorContentMobilSmsJson.act";
  ...
  if(rtJson.rtState == "0"){
   ...
   // var url = "<%=contextPath%>/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getCensorChangeName.act?formId="+userSum;
	...
	//}
      ...
      var phone1 = rtJson.rtData[i].cont.PHONE1 || "";
  	  ...
  	  var url = "<%=contextPath%>/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getCensorChangeName.act?formId="+formId;
      ...
      if(toId == ""){
        toIdName = "";
  	    ...
  	    var url = "<%=contextPath%>/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getCensorChangeName.act?formId="+toId;
