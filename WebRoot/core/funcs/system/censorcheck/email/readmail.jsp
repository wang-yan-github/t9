...
function doInit(){
  emailContent(seqId);
  var urls = "<%=contextPath%>/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getCensorEmailBody.act";
...
//      }
 ...
 //     }
      ...
      //showAllUser('toIdDesc','showAllUser',80);
      var url = "<%=contextPath%>/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getUserNameStrs.act";
...
function emailContent(seqId){
  var urls = "<%=contextPath%>/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getCensorEmailContent.act";
  ...
  if(rtJson.rtState == "0"){
    for(var i = 0; i < rtJson.rtData.length; i++){
      ...
      var urlss = "<%=contextPath%>/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getCensorChangeName.act?formId="+toId;
...
function checkPass(){
  ...
  var count = 0;
  var url = "<%=contextPath%>/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getcheckDenyCensor.act";
