...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getCensorContentJson2.act?censorFlag="+censorFlaga+"&content="+encodeURIComponent(content)+"&subject="+encodeURIComponent(sub);
