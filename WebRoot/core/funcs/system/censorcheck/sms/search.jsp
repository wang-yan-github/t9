...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getSmsSearchJson.act?censorFlag="+censorFlaga+"&content="+encodeURIComponent(content);
