...
function getJsonData(moduleCode, jsonStr){
  var url = contextPath + "/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/addJsonContent.act";
...
function bannedFunc(moduleCode){
  location = contextPath + "/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getCensorBanned.act?moduleCode="+moduleCode;
}
...
function modFunc(moduleCode){
  location = contextPath + "/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getCensorMod.act?moduleCode="+moduleCode;
}
...
function emailPass(idStrsVal, textFlag){
  var moduleCode = "0";
  var url = contextPath + "/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/sendMailByCoren.act";
  ...
  //var urls = contextPath + "/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getSmsRemind.act";
...
function emailPassFunc(idStrsVal){
  var urls = contextPath + "/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getPassEmailJson.act";
  ...
  if(rtJson.rtState == "0"){
    ...
    for(var i = 0; i < rtJson.rtData.length; i++){
      ...
      var urls =  contextPath + "/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/doEmailBack.act";
...
function smsPass(idStrsVal){
  var url = contextPath + "/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getPassSmsJson.act";
  ...
  if(rtJson.rtState == "0"){
    for(var i = 0; i < rtJson.rtData.length; i++){
      ...
      var urls =  contextPath + "/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/doSmsBack.act";
...
function mobileSmsPass(idStrsVal){
  var url = contextPath + "/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getPassMobileSmsJson.act";
  var rtJson = getJsonRs(url,"seqId="+idStrsVal);
  if(rtJson.rtState == "0"){
    for(var i = 0; i < rtJson.rtData.length; i++){
      ...
      var urls =  contextPath + "/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/doMobileSmsBack.act";
...
function isPrivFunc(moduleCode){
  var url = contextPath + "/t9/core/funcs/system/censorcheck/act/T9CensorCheckAct/getCheckUser.act";
