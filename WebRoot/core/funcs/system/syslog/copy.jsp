	...
	function doInit(){
		 // alert(!isAdmin);
		 var url = contextPath+'/t9/core/funcs/system/syslog/act/T9SysLogSaveAct/SaveLog.act'; 
	...
	<body class="bodycolor" topmargin="5" onload="doInit()">
			<form  name="queryForm" id="queryForm" action="/t9/t9/core/funcs/system/syslog/act/T9SysLogSaveAct/getsysradio.act">
			  <%
