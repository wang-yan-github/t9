  function doInit3(){
    ...
    var url = contextPath+'/t9/core/funcs/system/syslog/act/T9SysLogSearchAct/getMySysLog.act';
  ...
  var k = 0;
  function Newten(){
    var url = contextPath+'/t9/core/funcs/system/syslog/act/T9SysLogTenAct/getMySysLog.act';
    var rtJson = getJsonRs(url);
    if(rtJson.rtState == "0"){
        var rtData = rtJson.rtData;
        var listData = rtData.listData;
