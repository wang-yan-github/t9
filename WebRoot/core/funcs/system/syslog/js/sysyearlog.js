  ...
  // 统计下拉列表中  有多少年（在系统日志第2个标签页）  function doInit9(){
    var url = contextPath+'/t9/core/funcs/system/syslog/act/T9SysYearLogSearchAct/getMySysLog.act';
  ...
  function getdoInit(){
    //alert("::"+$F('YEAR'));
    // var url = contextPath+'/t9/core/funcs/system/syslog/act/T9SysYearLogSearchAct/getMySysLog.act?year=' + $('YEAR').value;
    var url = contextPath+'/t9/core/funcs/system/syslog/act/T9SysYearLogSearchAct/getMySysLog.act';
    var rtJson = getJsonRs(url);
    if(rtJson.rtState == "0"){
        initSelectOption($('YEAR'),rtJson);
  ...
  function doInit5(){
    var url = contextPath+'/t9/core/funcs/system/syslog/act/T9SysYearLogSearchAct/getMySysHourLog.act';
    var rtJson = getJsonRs(url);
    var sum = 0;
    if(rtJson.rtState == "0"){
  ...
  function change_date4(){
    ...
    var url = contextPath+'/t9/core/funcs/system/syslog/act/T9SysYearLogSearchAct/getMySysyueLog.act';
  ...
  function change_date(){
    ...
    var month = $F('MONTH');
    var par = "year="+ year +"&month="+month;
    var url = contextPath+'/t9/core/funcs/system/syslog/act/T9SysYearLogSearchAct/getMySysYearLog.act';
    var rtJson = getJsonRs(url,par);
    if(rtJson.rtState == "0"){
       var rtData = rtJson.rtData;
       var sum = rtData.sum;
