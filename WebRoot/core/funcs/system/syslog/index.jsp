	...
	var jso = [
	  ...
	  ,{title:"日志管理", contentUrl:"<%=contextPath %>/t9/core/funcs/system/syslog/act/T9SysLogSaveAct/getsysradio.act", useIframe:true}
	  ,{title:"系统日志下载", contentUrl:"<%=contextPath %>/core/funcs/system/res_manage/log/index.jsp", useIframe:true}
	];
	function doInit(){
	  buildTab(jso, 'syslog');
	}
