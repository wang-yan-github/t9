...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	...
	function delete_mail(){
		...
		if(window.confirm(msg)){
			  ...
			  var url = contextPath+'/t9/core/funcs/system/syslog/act/T9GlSyslogAct/deleteChecklog.act';
			  var json = getJsonRs(url, par); 
			  if (json.rtState == "0"){
	...
	function addRow(tmp,i){
      ...
      if(remark.length > 15){ 
       ...
       //  alert(tmk);
        td += "<td nowrap align=center><a href=javascript:; title='" +las + "'>" + tmk.replace('null','') +"</a></td>";
      }else{
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
	 ...
	 <table id="flow_table" width="100%" class="TableList" style="table-layout:fixed;">
	  ...
	  <table class="TableList" id="Table" border=0 width="100%" style="margin:0;">
