...
function doInit(){
   var url = "<%=contextPath%>/t9/core/funcs/system/notify/act/T9NotifyAct/getNotify.act";
   ...
   var url = "<%=contextPath%>/t9/core/funcs/system/notify/act/T9NotifyAct/getNotifySingle.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     bindJson2Cntrl(rtJson.rtData);
   ...
   var url = "<%=contextPath%>/t9/core/funcs/system/notify/act/T9NotifyAct/getNotifyRangeAll.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     bindJson2Cntrl(rtJson.rtData);
   ...
   var url = "<%=contextPath%>/t9/core/funcs/system/notify/act/T9NotifyAct/getNotifyExceptionId.act";
   var rtJson = getJsonRs(url);
   if (rtJson.rtState == "0") {
     bindJson2Cntrl(rtJson.rtData);
...
function commit(){
  ...
  url = "<%=contextPath%>/t9/core/funcs/system/notify/act/T9NotifyAct/";
  ...
  var urls = "<%=contextPath%>/t9/core/funcs/system/notify/act/T9NotifyAct/";
  ...
  var urlsd = "<%=contextPath%>/t9/core/funcs/system/notify/act/T9NotifyAct/";
...
<input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.system.notify.data.T9Notify.java"/>
