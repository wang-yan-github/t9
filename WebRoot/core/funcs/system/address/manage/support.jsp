...
function doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/system/address/act/T9AddressAct/getEditPrivGroup.act?seqId="+seqId;
...
function commit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/address/act/T9AddressAct/updatePrivGroup.act?seqId="+seqId+"&groupNameOld="+encodeURIComponent(groupNameOld);
