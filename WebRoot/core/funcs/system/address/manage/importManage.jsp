...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  ...
  <b>请指定用于导入的CSV文件：</b>
  <form name="form1" id="form1" action="<%=contextPath%>/t9/core/funcs/system/address/act/T9AddressAct/importAddressPublic.act" method="post" enctype="multipart/form-data">
