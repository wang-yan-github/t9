...
function doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/system/address/act/T9AddressAct/getManageGroup.act";
...
function expFoxMail(seqId, groupName){
  location = contextPath + "/t9/core/funcs/address/act/T9AddressAct/exportCsvPublicAddress.act?seqId="+seqId+"&groupName="+encodeURIComponent(groupName);
}
...
function support(groupNames, seqId){
  var URL = "/t9/core/funcs/system/address/manage/supportIframe.jsp?seqId="+seqId+"&groupName="+encodeURIComponent(groupNames);
...
function deleteGroup(seqId){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/deleteManageGroup.act";
...
function clearGroup(seqId, groupName){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/clearPublicManageGroup.act";
  var rtJson = getJsonRs(url,"seqId="+seqId);
  if(rtJson.rtState == "0"){
    window.location.reload();
  }else{
