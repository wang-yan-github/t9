...
function doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/system/address/act/T9AddressAct/getEditGroup.act?seqId="+seqId;
...
function commit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/address/act/T9AddressAct/updateGroup.act?seqId="+seqId+"&groupNameOld="+encodeURIComponent(groupNameOld);
