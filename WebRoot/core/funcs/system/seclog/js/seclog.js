...
function getSecretFlag(parentNo,optDiv,extValue){
	var requestURLStr = contextPath + "/t9/core/funcs/seclog/act/T9SeclogAct/selectChildCode.act?parentNo=" + parentNo;
...
function secLogFunc(cellData, recordIndex, columIndex){
  ...
  var urls = contextPath + "/t9/core/funcs/seclog/act/T9SeclogAct/getSecLogType.act";
