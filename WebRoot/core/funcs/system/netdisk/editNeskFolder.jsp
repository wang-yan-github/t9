...
var isDemo="<%=isDemo%>";
var requestURL="<%=contextPath%>/t9/core/funcs/system/netdisk/act/T9NetdiskAct";	
function doInit(){
...
<input type="hidden" value="t9.core.funcs.system.netdisk.data.T9Netdisk" name="dtoClass">
