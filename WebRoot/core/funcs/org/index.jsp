...
function doInit() {
  var url = "<%=contextPath%>/t9/core/funcs/org/act/T9OrgAct/getOrganization.act";
...
function commitItem() {
  ...
  url = "<%=contextPath%>/t9/core/funcs/org/act/T9OrgAct/";
  if (seq && seq != 0) {
...
<body onload="doInit()">
  ...
  <form name="form1" id="form1" method="post">
   <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.org.data.T9Organization"/>
