...
var formId = '<%=formId%>';
function doInit(){
  var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowFormAct/listByVersion.act";
...
function replay(seqId , formId){
  var url = "<%=contextPath%>/t9/core/funcs/workflow/act/T9FormVersionAct/replay.act";
