...
var flowFormUrl = contextPath + "/t9/core/funcs/workflow/act/T9FlowFormAct";
var formViewUrl = contextPath + "/t9/core/funcs/workflow/act/T9FlowFormViewAct";
...
function exportForm(formId) {
  window.open(contextPath + '/t9/core/funcs/workflow/act/T9FlowExportAct/exportForm.act?formId=' + formId); 
}
...
<br>
  ...
  <div align=center>
   ...
   <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.workflow.data.T9FlowFormType"/>
    <tr>
