...
var sortId = '<%=sortId%>';
function doInit(){
  var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowFormAct/listBySort.act";
...
function deleteForm(seqId){
  ...
  var url = "<%=contextPath %>/t9/core/funcs/workflow/act/T9FlowFormAct/deleteForm.act";
