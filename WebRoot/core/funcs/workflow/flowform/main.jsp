<!-- 
保存操作
Wed May 17 16:32:54 CST 2017====/t9/t9/core/funcs/workflow/act/T9FlowFormAct/updateForm.act
params=={printModel=&nbsp;<input title="1" id="DATA_1" name="DATA_1" align="left" style="text-align: left;">, dtoClass=t9.rad.flowform.data.T9FlowFormType, _=, CLOSE_FLAG=, seqId=639, itemMax=1}
-->
...
<HEAD>
<TITLE>表单智能设计器</TITLE>
<link rel="stylesheet" href="<%=contextPath%>/core/js/cmp/ueditor/ueditor/formdesign/bootstrap/css/bootstrap.css" type="text/css"/>
<BODY>
<div class="container" style="padding-top: 5px; padding-left: 5px">
    <form method="post" id="saveform" name="saveform" action="">
        ...
        <div class="row">
            ...
            <div class="span10">
                <script id="formEditor" type="text/plain" style="width:100%;"></script><%-- ${form.originalHtml} --%>
            </div>
        </div><!--end row-->
    </form>
</div><!--end container-->
...
<script type="text/javascript" src="<%=contextPath%>/core/js/cmp/ueditor/ueditor/lang/zh-cn/zh-cn.js"></script>
<script type="text/javascript" src="<%=contextPath%>/core/js/cmp/ueditor/ueditor/formdesign/formdesign.v4.js"></script>
<!-- script start-->
