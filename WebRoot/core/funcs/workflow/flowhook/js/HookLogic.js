...
function delHook(seqId){
    ...
    var url = contextPath+"/t9/core/funcs/workflow/act/T9FlowHookAct/deleteHookAct.act";
...
function getFlowName(cellData, recordIndex, columIndex){
    ...
    var url = contextPath+"/t9/core/funcs/workflow/act/T9FlowHookAct/getFlowNameAct.act";
    var rtJson = getJsonRs(url,param);
    if (rtJson.rtState == "0") {
