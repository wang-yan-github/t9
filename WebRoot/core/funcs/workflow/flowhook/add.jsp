...
function selPlugin(){
	  var url = contextPath + "/t9/core/funcs/workflow/act/T9PluginAct/getPluginListTwo.act" ;
	  loc_y=loc_x=200;
...
function doSubmit(){
  if(checkForm()){
    ...
    var url=contextPath+"/t9/core/funcs/workflow/act/T9FlowHookAct/addHookAct.act";
...
<table width="95%" class="TableBlock" align="center">
    ...
    <tr>
      ...
      <td class="TableData">
        ...
        一般无需设置
        &nbsp;<a href="javascript:;" title="如没有软件开发商特殊定制开发的的插件程序，请勿填写。<br>插件程序为PHP文件，例如：my_process.java，放置于src/t9/plugins/workflow/system下。插件程序将在本步骤执行完毕后被自动调用执行。">说明</a>
      </td>
    </tr>
    <tr>
