...
if (!T9Utility.isNullorEmpty(flowMobileRemind) && "1".equals(flowMobileRemind)) {
  flowMobileRemind = "checked";
} else {
  flowMobileRemind = "";
}
String flowAction = (String)request.getAttribute("flowAction");
if (T9Utility.isNullorEmpty(flowAction)) {
  flowAction = "";
}
%>
...
function save() {
  var url = contextPath + "/t9/core/funcs/workflow/act/T9ConfigAct/saveConfig.act";
...
<table class="TableList" width="90%">
  ...
  <tr class="TableData" align="center" height="30" style="">
    ...
    <td align="left">
       <input type="checkbox" id="FLOW_ACTION1" name="FLOW_ACTION" <% if(T9WorkFlowUtility.findId(flowAction , "1")) out.print("checked"); %> value="1" /><label for="FLOW_ACTION1">公告通知</label>
       <input type="checkbox" id="FLOW_ACTION2" name="FLOW_ACTION" <% if(T9WorkFlowUtility.findId(flowAction , "2")) out.print("checked"); %>  value="2" /><label for="FLOW_ACTION2">内部邮件</label>
       <input type="checkbox" id="FLOW_ACTION3" name="FLOW_ACTION" <% if(T9WorkFlowUtility.findId(flowAction , "3")) out.print("checked"); %>  value="3" /><label for="FLOW_ACTION3">转存</label>
       <input type="checkbox" id="FLOW_ACTION4" name="FLOW_ACTION" <% if(T9WorkFlowUtility.findId(flowAction , "4")) out.print("checked"); %>  value="4" /><label for="FLOW_ACTION4">归档</label>
    </td>
