...
function delFlowSort(seqId, haveChild, sortParent) {
  ...
  var url = "<%=contextPath %>/t9/core/funcs/workflow/act/T9FlowSortAct/deleteFlowSort.act";
...
function doInit() {
  var url = "<%=contextPath %>/t9/core/funcs/workflow/act/T9FlowSortAct/listFlowSort.act";
