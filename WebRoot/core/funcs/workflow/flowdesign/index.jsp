...
function doInit() {
  ...
  if (window.navigator.appVersion.match(/9./i)!='9.') {
    ...
    jso.push( {title:"图形视图",useTextContent:true,imgUrl:imgPath + "/asset.gif", contentUrl:"<%=contextPath %>/t9/core/funcs/workflow/act/T9FlowProcessAct/getProcessList1.act?flowId=<%=flowId%>", useIframe:true});
  }
