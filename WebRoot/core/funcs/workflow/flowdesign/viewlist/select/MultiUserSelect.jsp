...
function doInit(){
  ...
  if(User.value){
    ...
    var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowProcessAct/getUsers.act";
...
function treeNodeClick(id){
  var url = contextPath  + "/t9/core/funcs/workflow/act/T9FlowProcessAct/getPersonsByDept.act"
