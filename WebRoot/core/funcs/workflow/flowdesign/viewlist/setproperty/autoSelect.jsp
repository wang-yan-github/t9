  ...
  <tr class="TableLine2">
    ...
    <td>
      <select id="autoType" name="autoType" onchange="autoTypeSet(this)">
        ...
        <option value="22">自动选择部门主管</option>
      </select>
     ...
     <div id="roleItemDiv" style="display:none">
       ...
       <div id="deptItemDiv" style="display:none">
        <span>选择部门：</span>
        <input type="hidden" id="autoDeptOp" name="autoDeptOp" value="">
        <textarea cols=35 id="autoDeptOpDesc" name="autoDeptOpDesc" rows="4" class="BigStatic" wrap="yes" readonly></textarea>
        <a href="javascript:;" class="orgAdd" onClick="selectDept(['autoDeptOp','autoDeptOpDesc'])" title="指定部门">指定部门</a>
        <a href="javascript:;" class="orgClear"  onClick="clearUser('autoUserHoName','autoUserHo');" title="清空经办人和主办人">清空</a>      
      </div>
