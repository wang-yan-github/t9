<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ page import="java.util.List,t9.core.funcs.workflow.data.T9Plugin,t9.core.funcs.workflow.util.T9WorkFlowUtility" %>
    <%
    List<T9Plugin> list = (List<T9Plugin>)request.getAttribute("files");
    %>
<html>
	<head>
	<title>选择流程插件</title>	
...
<% } else {
  ...
  String message = T9WorkFlowUtility.Message("没有定义插件！", 0);
  out.print(message);
}%>
</body>
</html>