 ...
 * @return
 */
function formViewByRunId(runId) {
  var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowRunAct/getFlowId.act";
  var  par = 'runId=' + runId;
...
function playAction(){
  ...
  var param = "attachmentName=" + encodeURIComponent(attachName) + "&attachmentId=" + attachId + "&moudle=workflow&mediaType=" + mediaType + "&video=" + video;
...
function getSortIdByName(sortName){
  var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowSortAct/getSortId.act";
...
function getSortIdsByName(sortName){
  if (sortName) {
    var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowSortAct/getSortIds.act";
    var json = getJsonRs(url , "sortName=" + sortName);
    if(json.rtState == "0"){
      return json.rtData;
    }
...
function SaveFile()
{
  ...
  {
    var URL= contextPath + "/t9/core/funcs/workflow/act/T9FlowSaveFileAct/toSaveFile.act?runId=" + runId;
    var json = getJsonRs(URL);
    if(json.rtState == '0'){
      var data = json.rtData;
       
      URL = contextPath + "/core/funcs/savefile/index.jsp?attachId="+ data.attachId +"&attachName="+ encodeURIComponent(data.attachName) +"&module=workflow";
