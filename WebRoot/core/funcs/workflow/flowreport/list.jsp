...
<script type="text/javascript">
 function doInit(){
   var fId='<%=fId%>';
	 if(fId!=""){
		  var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowReportAct/getReportAct.act?fId="+fId;
 ...
 function del(rid){
	  if(window.confirm("确认要删除该报表 ？")){
		  var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowReportAct/delReportByIdAct.act";
