...
<form action="<%=contextPath %>/t9/core/funcs/workflow/act/T9FlowReportAct/addReportPrivAct.act?rid=<%=rId %>&fId=<%=fId %>" enctype="multipart/form-data"  method="post" name="form1" onSubmit="return CheckForm();">
