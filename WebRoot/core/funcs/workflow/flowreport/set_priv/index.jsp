...
<script type="text/javascript">
 function doInit(){
     var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowReportAct/getReportPrivByRidAct.act?rId=<%=rId%>";
 ...
 function del(pid){
	 ...
	 var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowReportAct/delReportPrivByIdAct.act";
