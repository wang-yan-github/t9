...
function InitList(){
	  var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowReportAct/editReportAct.act";
...
<form action="<%=contextPath %>/t9/core/funcs/workflow/act/T9FlowReportAct/updateReportAct.act?rId=<%=rId %>&fId=<%=fId %>" enctype="multipart/form-data" method="post" id="form1" name="form1">
