...
<form action="<%=contextPath %>/t9/core/funcs/workflow/act/T9FlowReportAct/addReportAct.act?fId=<%=fId %>" enctype="multipart/form-data" method="post" id="form2" name="form2">
