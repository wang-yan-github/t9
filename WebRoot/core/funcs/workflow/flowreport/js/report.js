function loadData () {
	var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowSortAct/getSortList.act";
   ...
   // });
    ...
    jQuery("#form1").bind("submit",function(){
     ...
     jQuery(".sortable").disableSelection();
		...
		function addOption(){
			  var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowReportAct/getListItemAct.act?fId="+fId;
		    var json = getJsonRs(url);
		    if(json.rtState == '0'){
