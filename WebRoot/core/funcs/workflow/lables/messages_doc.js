...
function newDOC() {
  ...
  docName += ".doc";
  var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocAct/createDoc.act";
...
function getDoc(){
  ...
  var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocAct/getDoc.act";
