...
function getDocList(flag) {
  $('docList').update("");
  var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9Doc2Act/getDocHistory.act";
...
function delDocHistory(seqId) {
  var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9Doc2Act/delDocHistory.act";
...
function saveDoc(){
  var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9Doc2Act/saveDoc.act";
...
function getDoc1(){
 ...
 var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9Doc2Act/getDoc.act";
...
function newDOC() {
 ...
 docName += ".doc";
 var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9Doc2Act/createDoc.act";
