...
<div align="center" class="Big1">
  <b>请指定用于导入的xml文件：</b>
  <form name="form1" id="form1" method="post" action="<%=contextPath %>/t9/core/funcs/workflow/act/T9FlowImportAct/importFlow.act" target="iframe" enctype="multipart/form-data" onsubmit="return CheckForm();">
