...
function doInit(){
  ...
  if (seqId) {
    var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowTimerAct/getTimer.act";      
...
function saveTimer() {
  if (check_form()) {
    var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowTimerAct/saveTimer.act";      
...
<br>
 <table class="TableBlock" width="480" align="center">
	...
	<tr>
	   <td colspan="2" align="center"><input type="button" class="SmallButton" value="<% if (T9Utility.isNullorEmpty(seqId)) {  %>增加<% }else{  %>保存<% } %>" onclick="saveTimer()"/>&nbsp;
