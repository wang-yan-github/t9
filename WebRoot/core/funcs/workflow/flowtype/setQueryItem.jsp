...
var sortId = "";
function doInit(){
  var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowManageAct/getQueryItem.act";
...
function commit() {
  ...
  var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowManageAct/setQueryItem.act";
