...
function doInit(){ 
  ...
  var url =  contextPath + "/t9/core/funcs/workflow/act/T9MyWorkControlAct/getMyManagerWork1.act";
  cfgs = {
    dataAction: url, 
...
function loadFlowType(){
  var url = contextPath+'/t9/core/funcs/workflow/act/T9FlowManageAct/getFlowTypeJson.act?sortId='+ sortId;
