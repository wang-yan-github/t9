<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="t9.core.funcs.workflow.data.T9FlowType,java.util.List"%>
...
<script type="text/javascript">
   ...
   function doInit(){
     ...
     requestURL = contextPath + "/t9/core/funcs/workflow/act/T9FlowProcessAct";
     var url =  contextPath + "/t9/core/funcs/workflow/act/T9FlowRunAct/getRunList.act?sortId=<%=sortId%>";
   ...
   var requestUrl  = contextPath + "/t9/core/funcs/workflow/act/T9FlowRunAct";
