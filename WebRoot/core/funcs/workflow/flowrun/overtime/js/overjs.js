...
function doInit(flag){
  ...
  loadFlowType() ;
  var url = contextPath+'/t9/core/funcs/workflow/act/T9WorkOverTimeAct/getWorkOverTimeList.act';
  cfgs = {
      dataAction: url,
...
function loadFlowType(){
  var url = contextPath+'/t9/core/funcs/workflow/act/T9FlowTypeAct/getFlowTypeJson.act?sortId=' + sortId;
...
function exportCsv() {
  var url = contextPath+'/t9/core/funcs/workflow/act/T9WorkOverTimeAct/exportCsv.act?' + getParam();
  window.open(url);
}