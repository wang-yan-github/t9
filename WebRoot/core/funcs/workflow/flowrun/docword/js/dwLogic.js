...
function deleteSingle(seqId){
	...
	var requestURLStr = contextPath + "/t9/core/funcs/workflow/act/T9DocWordAct";
...
function deptNameFunc(cellData, recordIndex, columIndex){
  var url = contextPath + "/t9/core/funcs/workflow/act/T9DocWordAct/getDeptName.act";
...
function roleNameFunc(cellData, recordIndex, columIndex){
	  var url = contextPath + "/t9/core/funcs/workflow/act/T9DocWordAct/getRoleName.act";
...
function userNameFunc(cellData, recordIndex, columIndex){
	  var url = contextPath + "/t9/core/funcs/workflow/act/T9DocWordAct/getUserName.act";
