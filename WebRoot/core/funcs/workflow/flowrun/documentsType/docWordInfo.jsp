...
function selectCodeById(seqId) {
	var str = "";
	var requestURLStr = contextPath + "/t9/core/funcs/workflow/act/T9DocumentsTypeAct/getDocumentsTypeById.act?seqId=" + seqId;
...
function getTrainingAjaxFunc(condition){
  var requestURI = contextPath + "/t9/core/funcs/workflow/act/T9DocumentsTypeAct";
