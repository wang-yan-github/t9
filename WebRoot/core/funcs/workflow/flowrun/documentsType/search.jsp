...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/workflow/act/T9DocumentsTypeAct/queryDocumentsTypeList.act?"+param;
  var cfgs = {
    dataAction: url,
...
function renderDwName(cellData, recordIndex, columIndex){
	  var urls = contextPath + "/t9/core/funcs/workflow/act/T9DocumentsTypeAct/getDocWordById.act?seqId="+cellData;
