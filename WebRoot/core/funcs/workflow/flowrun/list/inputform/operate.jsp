...
<span id="span5">
<span id="cancleSpan" style="display:none"><input value="取消" style="display:<%=T9Utility.isNullorEmpty(noCancle) ? "" : "none" %>"  class="SmallButtonW" type="button" onclick="from.cancelRun();"/></span>
</span>
<span id="span6">
