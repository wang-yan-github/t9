...
var content = "";
var feedbackUrl = contextPath + "/t9/core/funcs/workflow/act/T9FeedbackAct";
function doInit(){
...
function restoreFile(i) {
  ...
  if (attachmentName) {
    var url = contextPath + "/t9/core/funcs/workflow/act/T9AttachmentAct/restoreFile.act?isFeedAttach=true";;
    var json = getJsonRs(url , param);
    if (json.rtState == '0') {
      obj = json.rtData;
      var id = obj.id;
...
<form name="ATTACHMENT1_formFile" id="ATTACHMENT1_formFile"action="<%=contextPath %>/t9/core/funcs/workflow/act/T9AttachmentAct/uploadFile.act" target="returnPage"  method="post" enctype="multipart/form-data">
