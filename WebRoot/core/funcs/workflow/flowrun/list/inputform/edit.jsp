...
<form style="padding-bottom:80px" action="<%=contextPath %>/t9/core/funcs/workflow/act/T9AttachmentAct/uploadImg.act" name="workFlowForm" target="returnPage" id="workFlowForm"  method="post" enctype="multipart/form-data">
...
<form style="padding-bottom:10px" action="<%=contextPath %>/t9/core/funcs/workflow/act/T9AttachmentAct/uploadFile.act" name="formFile" target="returnPage" id="formFile"  method="post" enctype="multipart/form-data">
