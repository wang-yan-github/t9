...
var toId = "<%=toId%>";
function doInit() {
  var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowManageAct/getRemindInfo.act";
...
function remind() {
  if(CheckForm()) {
    var url = contextPath + "/t9/core/funcs/workflow/act/T9FlowManageAct/remindUser.act?sortId=<%=sortId%>&skin=<%=skin%>";
