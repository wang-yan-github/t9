...
var actionUrl = contextPath + "/t9/core/funcs/workflow/act/T9ProcessUserSelectAct";
function getAccord(){
  var data = {
  panel:'left',
...
function getDept(){
  var config = {bindToContainerId:deptIndex
      , requestUrl:contextPath + "/t9/core/funcs/orgselect/act/T9DeptSelectAct/getDeptTree.act?id="
      , isOnceLoad:false
...
function getDeptUser (id) {
  $('right').update("");
  var url = contextPath  + "/t9/core/funcs/workflow/act/T9FlowProcessAct/getPrivUser.act"
