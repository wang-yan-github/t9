...
function doInit() {
  var url = contextPath+'/t9/core/funcs/workflow/act/T9FlowManageAct/getCommentMsg.act';
...
function saveComment() {
  ...
  var url = contextPath+'/t9/core/funcs/workflow/act/T9FlowManageAct/saveComment.act';
