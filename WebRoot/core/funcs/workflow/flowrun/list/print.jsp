...
<%@ page import="t9.core.funcs.workflow.act.T9WorkHandleAct" %>
<%
...
<div id="view" style="display:none;padding-bottom:5px">
<table width='100%' class="TableList">
<tr class=TableHeader><td colspan=3>查阅信息</td></tr>
<tbody id="viewTbody">
