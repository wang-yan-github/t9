...
<script type="text/javascript"><!--
 ...
 function getHeader() {
   ...
   if (flowId != '0') {
     var url = contextPath + "/t9/core/funcs/workflow/act/T9MyWorkAct/getHeader.act?flowId=" + flowId;
 ...
 function doInit(){
   ...
   $('runId').focus();
   var param = getParam();
   var url =  contextPath + "/t9/core/funcs/workflow/act/T9WorkQueryAct/getWorkList1.act";
