...
function doInit(){ 
  ...
  var url = contextPath + "/t9/core/funcs/workflow/act/T9WorkQueryAct/getFlowList.act";
  ...
  if (json.rtState == "0") {
    ...
    for (var i = 0 ;i < sorts.length ;i ++) {
      ...
      if (sort) {
        ...
        var url2 = contextPath + "/t9/core/funcs/workflow/act/T9WorkQueryAct/getFlowType.act";
