<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ page import="java.sql.Timestamp,java.util.Set,java.util.HashMap,java.util.List,t9.core.funcs.workflow.util.T9WorkFlowUtility,java.util.Map" %>
...
if (list.size()== 0 ) {
  String msg =  T9WorkFlowUtility.Message("无符合条件的记录", 0);
  ...
  if (rowSpan == 2) {
    ...
    for (String tmp : s) {
      if (!"".equals(tmp) && !"runId".equals(tmp) && !"runName".equals(tmp)) {
        ...
        String value = (String)map.get(tmp);
        if (has) {
          if (T9Utility.isNumber(value) && value != null && !"".equals(value)) {
