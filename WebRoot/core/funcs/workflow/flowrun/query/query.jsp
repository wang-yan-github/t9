...
if (T9Utility.isNullorEmpty(versionNo)) {
  versionNo = "1";
}
%>
...
function htmlSubmit() {
  document.form1.action= contextPath + "/t9/core/funcs/workflow/act/T9WorkQueryAct/doQuery.act";
...
function flowReport(op) {
  $('OP').value = op;
  var url = contextPath + "/t9/core/funcs/workflow/act/T9WorkQueryAct/flowReport.act";
