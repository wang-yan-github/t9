...
function doInit(){
  ...
  var requestURL = "<%=contextPath%>/t9/core/funcs/utilapps/info/bus/act/T9BusAct/searchBus.act?address=${param.address}";
  if(start.trim() != ""){
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/t9/core/styles/imgs/menuIcon/new_email.gif" align="absmiddle"><span class="big3"> 公交线路查询结果 </span><br><br>
    </td>
  </tr>
</table>
