...
function submitForm(){
	  ...
	  if($('seqId').value == "")
		  var url = "<%=contextPath %>/t9/core/funcs/utilapps/info/bus/act/T9BusAct/addBus.act";
	  else
		  var url = "<%=contextPath %>/t9/core/funcs/utilapps/info/bus/act/T9BusAct/updateBus.act";
...
<c:choose>
  <c:when test="${empty param.seqId}">
    <td class="Big"><img src="/t9/core/styles/imgs/menuIcon/info.gif" height="22" width="20" align="absmiddle"><span class="big3">  新建线路</span>
  </c:when>
  <c:otherwise>
    <td class="Big"><img src="/t9/core/styles/imgs/menuIcon/info.gif" height="22" width="20" align="absmiddle"><span class="big3">  编辑线路</span>
  </c:otherwise>
</c:choose>
    </td>
  </tr>
...
<table class="TableBlock" width="450" align="center">
  ...
  <tr class="TableControl">
    <td nowrap colspan="4" align="center">
      <input type="hidden" value="t9.core.funcs.utilapps.info.bus.data.T9Bus" name="dtoClass" id="dtoClass">
