...
function Init(){
  ...
  var cfgs;
  if(province.trim() != ""){
    requestURL = "<%=contextPath%>/t9/core/funcs/utilapps/info/telNo/act/T9TelNoAct/searchProvince.act?province="+province;
    cfgs = {
    ...
    requestURL = "<%=contextPath%>/t9/core/funcs/utilapps/info/telNo/act/T9TelNoAct/searchArea.act?area="+area;
    cfgs = {
      dataAction: requestURL,
      container: "listDiv",
      colums: [
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big">
      <img src="/t9/core/styles/imgs/menuIcon/infofind.gif" align="absmiddle"><span class="big3" id="pro"> 电话区号 - </span>
    </td>
  </tr>
</table>
