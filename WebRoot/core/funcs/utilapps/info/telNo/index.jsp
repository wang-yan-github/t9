...
function Init(){
  ...
  var url = "<%=contextPath %>/t9/core/funcs/utilapps/info/telNo/act/T9TelNoAct/showMain.act"
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/t9/core/styles/imgs/menuIcon/infofind.gif" align="absmiddle"><span class="big3"> 电话区号查询</span>
    </td>
  </tr>
</table>
