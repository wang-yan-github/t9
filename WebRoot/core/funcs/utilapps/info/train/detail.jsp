...
function Init(){
	 ...
	 var requestURL = "<%=contextPath%>/t9/core/funcs/utilapps/info/train/act/T9TrainAct/searchTrainInfo.act?seqId="+seqId;
	 var cfgs;
   cfgs = {
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/t9/core/styles/imgs/menuIcon/infofind.gif" align="absmiddle"><span class="big3"> 乘车基本信息 - ${param.train}次（${param.start}--${param.end}）${param.kind}列车</span><br>
    </td>
  </tr>
</table>
<br>
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/t9/core/styles/imgs/menuIcon/infofind.gif" align="absmiddle"><span class="big3"> 列车经停站次 - ${param.train}次（
