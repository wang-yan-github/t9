...
function doInit(){
  ...
  var requestURL = "<%=contextPath%>/t9/core/funcs/utilapps/info/train/act/T9TrainAct/searchTrain.act";
  var cfgs;
  if(start != "" || end != ""){
...
function searchInfo(recordIndex){
	...
	var url = "<%=contextPath %>/t9/core/funcs/utilapps/info/train/act/T9TrainAct/searchTrainInfoShow.act"
