...
function Init(){
	...
	var url = "<%=contextPath %>/t9/core/funcs/utilapps/info/postNo/act/T9PostNoAct/showMain.act"
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/t9/core/styles/imgs/menuIcon/infofind.gif" align="absmiddle"><span class="big3"> 邮政编码查询</span>
    </td>
  </tr>
</table>
