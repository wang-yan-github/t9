...
function Init(){
  ...
  var cfgs;
  if(postNo.trim() != ""){
    requestURL = "<%=contextPath%>/t9/core/funcs/utilapps/info/postNo/act/T9PostNoAct/searchPostNo.act?postNo="+postNo;
    cfgs = {
    ...
    requestURL = "<%=contextPath%>/t9/core/funcs/utilapps/info/postNo/act/T9PostNoAct/searchAreaInfo.act?area="+area;
    cfgs = {
      dataAction: requestURL,
      container: "listDiv",
      colums: [
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/t9/core/styles/imgs/menuIcon/infofind.gif" align="absmiddle"><span class="big3"> 邮政编码查询结果</span>
    </td>
  </tr>
</table>
