...
function delete_content(sortId,contentId,fileSortCur){
	...
	if(window.confirm(msg)){
		if(fileSortCur == 1){
			var folderURL = "<%=contextPath%>/t9/core/funcs/filefolder/act/T9FileContentAct/delCheckedFile.act?seqIdStr=" + contentId;
			...
			var personFolderURL = "<%=contextPath%>/t9/core/funcs/personfolder/act/T9PersonFileContentAct/delCheckedFile.act?seqIdStr=" + contentId; 
