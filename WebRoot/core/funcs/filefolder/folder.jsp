...
function delete_sort(seqId){
	...
	if(window.confirm(msg)){
		var url="<%=contextPath%>/t9/core/funcs/filefolder/act/T9FileSortAct/delFileSortInfoById.act";
...
<br>
<form name="form1" id="form1" action="<%=contextPath%>/t9/core/funcs/filefolder/act/T9FileContentAct/uploadFile.act?seqId=<%=seqId %>" method="post" enctype="multipart/form-data" >
