...
function newAttach(){
  var oEditor = FCKeditorAPI.GetInstance('fileFolder') ;
	...
	if(checkForm()){
		...
		location.href = "<%=contextPath%>/t9/core/funcs/filefolder/act/T9FileContentAct/createFile.act?" + pars + "&seqId=<%=seqId%>&contentId=<%=contentId%>";
...
<div>
<form id="formFile"	action="<%=contextPath%>/t9/core/funcs/filefolder/act/T9FileContentAct/newFileSingleUpload.act?seqId=<%=seqId%>&contentId=<%=contentId%>&folderPath=<%=folderPath%>"
