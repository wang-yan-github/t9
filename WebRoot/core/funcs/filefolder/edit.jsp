...
function getFilePath(){
	var returnFilePath="";
	var requestURL1="<%=contextPath%>/t9/core/funcs/system/filefolder/act/T9FileSortAct";
...
function newAttach(){
	...
	if(checkForm()){
		...
		location.href = "<%=contextPath%>/t9/core/funcs/filefolder/act/T9FileContentAct/newFile.act?" + pars +"&seqId=<%=seqId%>&contentId=<%=contentId%>";
...
<div>
 <form id="formFile" action="<%=contextPath%>/t9/core/funcs/filefolder/act/T9FileContentAct/newFileSingleUpload.act?seqId=<%=seqId%>&contentId=<%=contentId %>&actionFlag=edit" method="post" enctype="multipart/form-data">
