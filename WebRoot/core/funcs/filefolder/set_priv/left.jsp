...
function doInit(){	
  ...
  ,requestUrl:contextPath + '/t9/core/funcs/system/filefolder/act/T9FileSortAct/getTree.act?seqId=<%=seqId%>&id='
  ,isOnceLoad:false
...
if(id){
	var ownerPriv = "0";
	if(id){
		//判断此节点有没有所有者权限		var requestURL="<%=contextPath%>/t9/core/funcs/system/filefolder/act/T9FileSortAct/getPrivteById.act?seqId="+id;
