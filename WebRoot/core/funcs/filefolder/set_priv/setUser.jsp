...
function sendForm(){
	if(flag=="USER_ID"){
	  ...
	  var url = "<%=contextPath%>/t9/core/funcs/system/filefolder/act/T9FileSortAct/setVisitById.act?userId=" + userId + "&seqId=" + seqId + "&override=" + override;
		//alert(url);
	  ...
	  var url = "<%=contextPath%>/t9/core/funcs/system/filefolder/act/T9FileSortAct/setManageUserById.act?manageUser=" + manageUser + "&seqId=" + seqId + "&override=" + override;
	  var rtJson = getJsonRs(url);
	  if(rtJson.rtState == "0"){
	    alert('设置权限成功！');
	    //formDiv.style.display = "none";
    ...
    var url = "<%=contextPath%>/t9/core/funcs/system/filefolder/act/T9FileSortAct/setDelUserById.act?manageUser=" + manageUser + "&seqId=" + seqId + "&override=" + override;
    var rtJson = getJsonRs(url);
    if(rtJson.rtState == "0"){
      alert('设置权限成功！');
      //formDiv.style.display = "none";
	  ...
	  var override=checkOverride();
	  var url = "<%=contextPath%>/t9/core/funcs/system/filefolder/act/T9FileSortAct/setNewUserById.act?createId=" + createId + "&seqId=" + seqId + "&override=" + override;
	  var rtJson = getJsonRs(url);
	  if(rtJson.rtState == "0"){
	    alert('设置权限成功！');
	    //formDiv.style.display = "none";
	  ...
	  var override=checkOverride();
	  var url = "<%=contextPath%>/t9/core/funcs/system/filefolder/act/T9FileSortAct/setDownLoadById.act?downLoadId=" + downLoadId + "&seqId=" + seqId + "&override=" + override;
	  var rtJson = getJsonRs(url);
	  if(rtJson.rtState == "0"){
	    alert('设置权限成功！');
	    //formDiv.style.display = "none";
