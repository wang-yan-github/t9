...
function doInit(){
  ...
  var url = contextPath + "/t9/core/funcs/doc/send/act/T9WordTreeAct/getTree.act?id=";
...
function test(id){
  ...
  if(parentId != '0'){
    window.parent.wordInput.location = "<%=contextPath%>/core/funcs/doc/docword/wordEdit.jsp?treeId=" + id;
  	...
  	var rtJson = getJsonRs(contextPath + "/t9/core/funcs/doc/send/act/T9SubjectTermAct/getSeqId.act");
  	if(rtJson.rtState=="0"){
