...
function getTree(){
  $(defaultIndex).update("");
  var url = contextPath + "/t9/core/funcs/doc/send/act/T9WordSelectAct/getTree.act?id=";
...
function treeNodeClick(id){
	var url=contextPath+"/t9/core/funcs/doc/send/act/T9WordSelectAct/getWordBySort.act";
...
function doSearch(value) {
  $('right').update("");
  var url = contextPath+"/t9/core/funcs/doc/send/act/T9WordSelectAct/getWordBySearch.act";
