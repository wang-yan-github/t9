...
function doSubmit(event) {
  if(checkForm()&& checkWord()){
    ...
    var rtJson = getJsonRs(contextPath + "/t9/core/funcs/doc/send/act/T9SubjectTermAct/insertWord.act?treeId="+treeId, mergeQueryString($("form1")));
    if (rtJson.rtState == 0) {
...
function deptFunc(){
  var url = "<%=contextPath%>/t9/core/funcs/doc/send/act/T9WordTreeAct/selectWordToAttendance.act";
