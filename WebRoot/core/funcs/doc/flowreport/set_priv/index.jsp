...
<script type="text/javascript">
 function doInit(){
     var url = contextPath + "<%=moduleSrcPath %>/act/T9FlowReportAct/getReportPrivByRidAct.act?rId=<%=rId%>";
 ...
 function del(pid){
	 ...
	 var url = contextPath + "<%=moduleSrcPath %>/act/T9FlowReportAct/delReportPrivByIdAct.act";
