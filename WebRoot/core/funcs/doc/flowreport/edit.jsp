...
function InitList(){
	  var url = contextPath + "<%=moduleSrcPath %>/act/T9FlowReportAct/editReportAct.act";
...
<form action="<%=contextPath %><%=moduleSrcPath %>/act/T9FlowReportAct/updateReportAct.act?rId=<%=rId %>&fId=<%=fId %>" enctype="multipart/form-data" method="post" id="form1" name="form1">
