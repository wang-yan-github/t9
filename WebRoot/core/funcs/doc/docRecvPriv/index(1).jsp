...
var pageMgr = null;
function doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/doc/act/T9DocRecvPrivAct/getAllPriv.act";
  ...
  if(rtJson.rtState == "0"){
	  ...
	  if(data.userId != 0){
		  ...
		  var url = contextPath + "/t9/core/funcs/doc/act/T9DocRecvPrivAct/getPrivName.act";
  ...
  var url = "<%=contextPath%>/t9/core/funcs/doc/act/T9DocRecvPrivAct/getDeptPrivListJson.act";
  var cfgs = {
      dataAction: url,
...
function deleteAllPriv(seqId){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/doc/act/T9DocRecvPrivAct/deleteAllPriv.act?seqId="+seqId;
  var rtJson = getJsonRs(url);
  if(rtJson.rtState == "0"){
	  alert("删除成功！")
