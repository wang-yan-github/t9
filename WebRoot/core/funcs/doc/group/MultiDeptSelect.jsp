...
function getDefaultGroup() {
  $(defaultIndex).update("");
  url = contextPath + "/t9/core/funcs/doc/group/act/T9DeptGroupAct/getDeptGroups.act";
...
function getUserByGroup(id , name) {
  var url = contextPath + "/t9/core/funcs/doc/group/act/T9DeptGroupAct/getDeptByGroup.act?groupId=" + id;
  var json = getJsonRs(url);
  if (json.rtState == '0') {
...
function getTree(){
  $(deptIndex).update("");
  var url = contextPath + "/t9/core/funcs/orgselect/act/T9DeptSelectAct/getDeptTree.act?privNoFlag=" + privNoFlag;
  if (moduleId) {
...
function getDefaultDept() {
  url = contextPath + "/t9/core/funcs/orgselect/act/T9DeptSelectAct/getDefaultDept.act?privNoFlag=" + privNoFlag;
  if (moduleId) {
...
function treeNodeClick(id){
  url = contextPath + "/t9/core/funcs/orgselect/act/T9DeptSelectAct/getDeptIndent.act?privNoFlag=" + privNoFlag;
  if (moduleId) {
    url += "&moduleId=" + moduleId  ;
  }
...
function comeBack(){
  url = contextPath + "/t9/core/funcs/orgselect/act/T9DeptSelectAct/getDeptIndent.act";
  var json = getJsonRs(url);
   if(json.rtState == "0"){
    $('title').update('全体部门');
    $('title').onclick = function() {
