...
function doInit(){
  if (seqId) {
    var url = "<%=contextPath%>/t9/core/funcs/doc/group/act/T9DeptGroupAct/getDeptGroup.act";
...
function commit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/doc/group/act/T9DeptGroupAct/addDeptGroup.act";
  if (seqId) {
     url = "<%=contextPath%>/t9/core/funcs/doc/group/act/T9DeptGroupAct/updateDeptGroup.act?seqId="+seqId;
  }
