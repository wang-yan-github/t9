...
function doInit(){
  var count = 0;
  var url = "<%=contextPath%>/t9/core/funcs/doc/group/act/T9DeptGroupAct/getDeptGroups.act";
...
function deleteSingle(seqId){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/doc/group/act/T9DeptGroupAct/deleteDeptGroup.act";
