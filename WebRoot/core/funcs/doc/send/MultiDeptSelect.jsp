...
function doInit(){
  var url = contextPath + "/t9/core/esb/client/act/T9DeptTreeAct/getTree.act?id=";
...
function getDefaultDept() {
  url = contextPath + "/t9/core/esb/client/act/T9DeptTreeAct/getDeptsByDeptParent.act?deptId=0";
...
function treeNodeClick(id){
  url = contextPath + "/t9/core/esb/client/act/T9DeptTreeAct/getDeptsByDeptParent.act";
