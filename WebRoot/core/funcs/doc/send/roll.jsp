...
var requestUrl = contextPath + "/t9/core/funcs/doc/send/act/T9DocAct";
function doInit(){
...
<table class="TableBlock" width="90%"  align="center">
  <TR>
      ...
      <TD class="TableData">
       <INPUT  type="text"  name="fileCode" id="fileCode" size=20 maxlength="100" class="BigInput" value="">
      </TD>
  ...
  <TR>
      ...
      <TD class="TableData">
       <INPUT  type="text"  name="fileTitle" id=fileTitle size=30 maxlength="100" class="BigInput">
      </TD>
      <TD class="TableData">文件辅标题：</TD>
      <TD class="TableData">
       <INPUT  type="text"  name="fileTitleo" id="fileTitleo" size=30 maxlength="100" class="BigInput">
      </TD>
  </TR>
  ...
  <TR>
      ...
      <TD class="TableData">
       <INPUT  type="text"  name="sendUnit" id="sendUnit" size=30 value="" class="BigInput">
      </TD>
  ...
  <tr><TD class="TableData" >文件主题词：</TD>
      <TD class="TableData" colspan="3">
       <INPUT  type="text"  name="fileSubject" id="fileSubject" size=30 maxlength="100" class="BigInput">
      </TD></tr>
  <TR>
