...
function loadFileName() {
  var url = contextPath + "/t9/core/funcs/doc/send/act/T9DocAct/getDocType.act" ;
...
function loadWord(type) {
  ...
  var url = contextPath + "/t9/core/funcs/doc/send/act/T9DocAct/getDocWordByType.act";
...
function createNewDoc(){
  ...
  var url = contextPath + "/t9/core/funcs/doc/send/act/T9DocAct/createWorkFlow.act";
