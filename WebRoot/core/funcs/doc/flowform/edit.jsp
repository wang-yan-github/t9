...
var flowFormUrl = contextPath + "<%=moduleSrcPath %>/act/T9FlowFormAct";
var formViewUrl = contextPath + "<%=moduleSrcPath %>/act/T9FlowFormViewAct";
...
function exportForm(formId) {
  window.open(contextPath + '<%=moduleSrcPath %>/act/T9FlowExportAct/exportForm.act?formId=' + formId); 
}
...
<br>
  ...
  <div align=center>
   ...
   <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.doc.data.T9DocFlowFormType"/>
    <tr>
...
不明白如何设计表单和设计流程？请参考官方网站下载中心的<a href="<%=workflowZipDown%>">《工作流使用详解》</a>。
</div>
</body>
</html>