...
function send()
{
  if(CheckForm())
  {
   ...
   /// var url = "";
    ...
    if(seqId != null && seqId != ""){
      url = "<%=contextPath%><%=moduleSrcPath %>/act/T9FlowFormAct/updateForm.act";
    }else{
      url = "<%=contextPath%><%=moduleSrcPath %>/act/T9FlowFormAct/insertForm.act";
    }
...
function loadData(){
  var url = "<%=contextPath%><%=moduleSrcPath %>/act/T9FlowFormAct/getFormView.act?";
