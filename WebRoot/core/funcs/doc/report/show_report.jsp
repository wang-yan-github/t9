...
function getJson(){
	 var url = contextPath + "<%=moduleSrcPath %>/act/T9FlowReportAct/getReportByRidAct.act?rId=<%=rId%>";
...
function export_excel()
{
 ...
 function export_excel(){
     $("form1").action=contextPath+"<%=moduleSrcPath %>/act/T9FlowReportAct/toExcel.act";
     $("form1").target="";
     $("form1").submit();
