<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="t9.core.funcs.doc.data.T9DocFlowType,java.util.List"%>
...
<script type="text/javascript" src="<%=contextPath %><%=moduleContextPath %>/workflowUtility/skin.js"></script>
   ...
   function doInit(){
     ...
     requestURL = contextPath + "<%=moduleSrcPath %>/act/T9FlowProcessAct";
     var url =  contextPath + "<%=moduleSrcPath %>/act/T9FlowRunAct/getRunList.act?sortId=<%=sortId%>";
   ...
   var requestUrl  = contextPath + "<%=moduleSrcPath %>/act/T9FlowRunAct";
