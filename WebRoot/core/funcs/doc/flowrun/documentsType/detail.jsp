...
function getFlowTypeName(id) {
  var urls = contextPath + "<%=moduleSrcPath %>/act/T9DocumentsTypeAct/getFlowTypeName.act?seqId="+id;
  var rtJsons = getJsonRs(urls);
  if(rtJsons.rtState == '0'){
    var  prc = rtJsons.rtData;
    $('flowType').update(prc);
...
<table class="TableBlock" width="90%" align="center">
  ...
  <tr>
    ...
    <td align="left" class="TableData Content" colspan="5"><div id="documentsFont"></div></td>
  </tr>
  <tr>
    <td align="left" width="120" class="TableContent">套红模板：</td>
    <td align="left" class="TableData Content" colspan="5"><div id="documentsWordModel"></div></td>
  </tr>
