...
function selectCodeById(seqId) {
	var str = "";
	var requestURLStr = contextPath + "<%=moduleSrcPath %>/act/T9DocumentsTypeAct/getDocumentsTypeById.act?seqId=" + seqId;
...
function doInit2(){
  ...
  var requestURI = contextPath + "<%=moduleSrcPath %>/act/T9DocumentsTypeAct";
