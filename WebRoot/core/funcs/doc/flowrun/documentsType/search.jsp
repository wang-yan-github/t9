...
<%
  String documentsName = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("documentsName")));
  String flowType = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("flowType")));
  String documentsFont = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("documentsFont")));
  String documentsWordModel = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("documentsWordModel")));
%>
<html>
<head>
...
function doInit(){
  ...
  var url = "<%=contextPath%><%=moduleSrcPath %>/act/T9DocumentsTypeAct/queryDocumentsTypeList.act?"+param;
  var cfgs = {
    dataAction: url,
    ...
    colums: [
       ...
       {type:"data", name:"typeNo", text:"排序号",  width: '5%'},
...
function renderDwName(cellData, recordIndex, columIndex){
	  var urls = contextPath + "<%=moduleSrcPath %>/act/T9DocumentsTypeAct/getDocWordById.act?seqId="+cellData;
