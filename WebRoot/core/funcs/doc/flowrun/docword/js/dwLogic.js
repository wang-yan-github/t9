...
function deptNameFunc(cellData, recordIndex, columIndex){
  var url = contextPath +moduleSrcPath+"/act/T9DocWordAct/getDeptName.act";
...
function roleNameFunc(cellData, recordIndex, columIndex){
	  var url = contextPath +moduleSrcPath+"/act/T9DocWordAct/getRoleName.act";
...
function userNameFunc(cellData, recordIndex, columIndex){
	  var url = contextPath +moduleSrcPath+"/act/T9DocWordAct/getUserName.act";
