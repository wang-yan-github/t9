...
function doInit(){
  var url = "<%=contextPath%><%=moduleSrcPath %>/act/T9DocWordAct/queryDocWordListJson.act?dwName="+encodeURIComponent(dwName)+"&indexStyle="+encodeURIComponent(indexS);
  var cfgs = {
		    dataAction: url,
		    ...
		    colums: [
		       ...
		       {type:"data", name:"wordNo", text:"排序号", width: '5%'},
