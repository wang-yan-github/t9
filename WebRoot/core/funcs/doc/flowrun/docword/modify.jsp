...
{ 
  ...
  if($('dwName').value && oldDocWord != $('dwName').value){ 
    var requestURLStr = contextPath + "<%=moduleSrcPath %>/act/T9DocWordAct";
...
<br>
<form enctype="" action="<%=contextPath%><%=moduleSrcPath %>/act/T9DocWordAct/updateDocWordAct.act"  method="post" name="form1" id="form1" >
<table class="TableBlock" width="50%" align="center">
  ...
  <tr>
    <td nowrap class="TableContent">排序号：</td>
      <td class="TableData">
        <input type="text" name="wordNo" id="wordNo" class="BigInput" size="30" >
    </td>
