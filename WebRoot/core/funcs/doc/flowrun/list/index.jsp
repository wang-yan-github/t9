...
String sortName = T9DocConst.getProp(webroot  , T9DocConst.DOC_SEND_FLOW_SORT) ;
if (sortId == null) {
  sortId = "";
}
if (flowId == null) {
...
function doInit(){
  ...
  var url = contextPath + "<%=moduleSrcPath %>/act/T9MyWorkAct/hasWork.act?sortId=" + sortId + "&flowId=" + flowId;
