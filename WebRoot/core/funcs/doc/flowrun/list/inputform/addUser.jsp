...
var sortId = "<%=sortId%>";
var skin = "<%=skin%>";
var requestUrl = contextPath + "<%=moduleSrcPath %>/act/T9WorkHandleAct";
function doInit() {
//取步骤列表}
function myClose() {
  close();
...
function addUser(){
  ...
  var url = contextPath + "<%=moduleSrcPath %>/act/T9FlowRunAct/addUser.act";
...
function selectUser(){
  var Url = contextPath + "/core/funcs/doc/flowrun/list/inputform/userSelect/index.jsp?isSingle=true&flowId=<%=flowId%>&runId=<%=runId%>&prcsId=<%=prcsId%>&flowPrcs=<%=flowPrcs%>";
