...
function doInit(){ 
  ...
  var url =  contextPath + "<%=moduleSrcPath %>/act/T9MyWorkControlAct/getMyManagerWork1.act";
  cfgs = {
    dataAction: url, 
...
function loadFlowType(){
  var url = contextPath+'<%=moduleSrcPath %>/act/T9FlowManageAct/getFlowTypeJson.act?sortId='+ sortId;
