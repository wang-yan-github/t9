...
<script type="text/javascript"><!--
 ...
 function loadFileName() {
   var url = contextPath + "/t9/core/funcs/doc/send/act/T9DocAct/getDocType.act?flag=1";
 ...
 function loadWord(type) {
   ...
   var url = contextPath + "/t9/core/funcs/doc/send/act/T9DocAct/getDocWordByType.act?flag=1";
 ...
 function doInit(){
   ...
   loadFileName();
   var url =  contextPath + "<%=moduleSrcPath %>/act/T9WorkQueryAct/getWorkList1.act";
