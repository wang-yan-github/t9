...
<%@ page  import="t9.core.funcs.doc.receive.data.T9DocConst,t9.core.funcs.doc.receive.data.T9DocReceive,t9.core.util.T9Utility"%>
...
<form action="<%=contextPath%>/t9/core/funcs/doc/receive/act/T9DocReceiveAct/update.act" id="form1" method="post" name="form1" >
...
<form id="formFile" action="<%=contextPath %>/t9/core/funcs/doc/receive/act/T9DocReceiveAct/uploadFile.act" method="post" enctype="multipart/form-data" target="commintFrame">
