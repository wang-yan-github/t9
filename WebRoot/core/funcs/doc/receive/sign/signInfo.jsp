...
function doInit(){
  ...
  var url = contextPath + "/t9/core/funcs/doc/receive/act/T9DocRegisterAct/getRecReg.act?rec_seqId="+seqId;
...
function signUp(){
  if (confirm("确认签收！")) {
    var url = contextPath + "/t9/core/funcs/doc/receive/act/T9DocSignAct/sign.act?seqId=" + seqId;
    var json = getJsonRs(url);
    if (json.rtState = '0') {
