...
<%@ page  import="java.util.List,java.util.Set,java.util.Map, t9.core.funcs.doc.receive.data.T9DocReceive, t9.core.funcs.doc.receive.data.T9DocConst"%>
<%
...
function read(seqId){
  window.location.href = contextPath + "/t9/core/funcs/doc/receive/act/T9DocReceiveAct/updateReadDocReceive.act?seqId=" + seqId;
  return true;
}
function cost_balance(seqId){
  var url = contextPath + "/t9/core/funcs/doc/receive/act/T9DocReceiveAct/findDocFileAjax.act?seqId="+seqId;
...
function createNewWork2(flowId , par , isNotOpenWindow , seqId){
  var url = contextPath +   moduleSrcPath + "/receive/act/T9DocReceiveHandlerAct/createWork.act?seqId=" + seqId;
  if (par) {
