...
function doInit(){
  ...
  initDept();
  getMaxOrderNo(1);
  var url = contextPath + "/t9/core/funcs/doc/receive/act/T9DocReceiveRegAct/getRecReg.act?seqId="+seqId;
...
<form action="<%=contextPath%>/t9/core/funcs/doc/receive/act/T9DocReceiveRegAct/updateReceive.act" id="form1" method="post" name="form1" >
