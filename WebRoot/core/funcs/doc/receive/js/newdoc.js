...
//浮动菜单文件的删除 
  ...
  var url= contextPath + "/t9/core/funcs/doc/receve/act/T9DocReceiveAct/delFloatFile.act?attachId=" + attachId +"&attachName=" + attachName ; 
  if (seqId) {
    url += "&seqId=" + seqId;
  }
  ...
  function getMaxOrderNo(typeId){
    ...
    var url = contextPath +"/t9/core/funcs/doc/receive/act/T9DocReceiveAct/getMaxOrderNo.act?typeId=" + typeId;
...
function initDept(){
  var requestUrl = contextPath + "/t9/core/funcs/doc/receive/act/T9DocReceiveRegAct/selectDept.act?deptId=0";
...
function getNRegList() {
  var url = contextPath + "/t9/core/funcs/doc/receive/act/T9DocReceiveRegAct/getNReg.act";
  var cfgs = {
    dataAction: url,
    container: "container",
    showRecordCnt: true,
