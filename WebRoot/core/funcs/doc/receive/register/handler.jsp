...
function handler(){
  ...
  var selectIndex = document.getElementById("flowType").selectedIndex;
  var selectText = document.getElementById("flowType").options[selectIndex].innerHTML; 
  window.returnValue = {attid:attids , flowId:$('flowType').value ,flowName:selectText, sort:sortId};
  window.close();
}
function getAttIds() {
  var attids = "";
