function getDeptFunc(deptDiv) {
  var url = contextPath
      + "/t9/core/funcs/workstat/act/T9WorkStatAct/selectDeptToAttendance.act";
...
function deptSelect(selectId) {
  var url = contextPath
      + "/t9/core/funcs/workstat/act/T9WorkStatAct/getUserDeptPrivAct.act";
  var rtJson = getJsonRs(url);
...
function isStaticPerson(id) {
  var url = contextPath
      + "/t9/core/funcs/workstat/act/T9WorkStatAct/getIsStaticAct.act";
  var rtJson = getJsonRs(url);
...
function loadData() {
  ...
  var url = contextPath
      + "/t9/core/funcs/workstat/act/T9WorkStatAct/getDataAct.act";
...
function loadExcelData(){
     ...
     var param="deptId="+deptId+"&startDate="+startDate+"&endDate="+endDate+"&deptMore="+deptMore+"&minNum="+minNum+"&maxNum=-1";
       var url = contextPath + "/t9/core/funcs/workstat/act/T9WorkStatAct/getDataToExeclAct.act?"+param;
       window.location=url;
    }
