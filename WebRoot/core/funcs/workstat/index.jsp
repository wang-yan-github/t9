...
jQuery(document).ready(function(){         
   menuYloc = jQuery("#test").offset().top;       
  jQuery(window).scroll(function (){           
    var offsetTop = menuYloc + jQuery(window).scrollTop() +"px";      
    jQuery("#test").animate({top : offsetTop },{ duration:500 , queue:false }
    );         
  });    
});  
</script>
...
<div id="test" style="position :absolute;background-color:rgb(247, 248, 189);">
...
<img  src="/t9/core/styles/style1/img/loading.gif" width="35" height="35" />
</div>
 </body>
</html>
