...
//	  $('pgSearchInfo').innerHTML = "加载数据中,请稍后.....";
	  var url = "<%=contextPath%>/t9/core/funcs/notify/act/T9NotifyShowAct/queryNotify2.act?ascDesc="+ascDesc+"&field="+field;
...
function delete_news(seqId)
{
 ...
 {
  url="/t9/t9/core/funcs/news/act/T9NewsHandleAct/deleteNewById.act?seqId="+seqId;
  window.location.href=url;
 }
}
function re_news(seqId)
{
 URL="/t9/core/funcs/news/show/reNews.jsp?seqId="+seqId+"&manage=1";
...
{
 URL="/t9/core/funcs/notify/show/readNotify.jsp?isManage=0&flag=1&seqId="+seqId;
...
function back() {
	window.location.href = "/t9/core/funcs/notify/show/notifyQuery.jsp";
}
</script>
</head>
<body onload="doInit();">
