...
//	  $('pgSearchInfo').innerHTML = "加载数据中,请稍后.....";
	  ...
	  var url =contextPath+'/t9/core/funcs/notify/act/T9NotifyShowAct/getnotifyNoReadList.act';
...
{
  url=contextPath + "/t9/core/funcs/notify/act/T9NotifyShowAct/changeNoReadAll.act";
  location=url;
}
}
