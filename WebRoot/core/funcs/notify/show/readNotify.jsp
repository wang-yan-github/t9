...
function doInit(){
   ...
   var url =contextPath+'/t9/core/funcs/notify/act/T9NotifyShowAct/showObject.act?seqId='+seqId+'&isManage='+isManage + "&flag=<%=flag%>" ;
 ...
 <table class="TableBlock" width="100%">
    ...
    <tr align="center" class="TableControl">
      <td>
        ...
        <input type="button" value="返回" class="BigButton" onClick="window.location.href='/t9/core/funcs/notify/show/index.jsp'">
        </span>
      </td>
    </tr>
  </table>
