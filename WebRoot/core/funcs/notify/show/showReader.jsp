...
function loadData(){
	  var url =contextPath+'/t9/core/funcs/notify/act/T9NotifyShowAct/showReader.act?seqId='+seqId;
...
function delete_reader()
{
 ...
 {
  URL= contextPath+"/t9/core/funcs/notify/act/T9NotifyShowAct/deleteReader.act?seqId=" + seqId;
  window.location=URL;
 }
}
</script>
