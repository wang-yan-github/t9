...
function loadData(pageIndex , showLength , typeId , ascDesc , field){
  ...
  var url =contextPath+'/t9/core/funcs/notify/act/T9NotifyShowAct/getnotifyShowList.act';
...
function read_all() {
  ...
  if (window.confirm(msg)) {
    url="/t9/t9/core/funcs/notify/act/T9NotifyShowAct/changeNoReadAll.act?forward=all";
    window.location = url;
  }
}
...
function open_notify(seqId,format) {
  URL="/t9/core/funcs/notify/show/readNotify.jsp?isManage=0&seqId="+seqId;
