...
<form enctype="multipart/form-data" action="<%=contextPath %>/t9/core/funcs/notify/act/T9NotifyHandleAct/addNotify.act"  method="post" name="notifyForm" id="notifyForm">
...
<form id="formFile"
	action="<%=contextPath %>/t9/core/funcs/notify/act/T9NotifyHandleAct/uploadFile.act"
