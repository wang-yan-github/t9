...
function doInit(){
  ...
  var url =contextPath+'/t9/core/funcs/notify/act/T9NotifyHandleAct/beforeAddNotify.act';
  ...
  if(seqId) { //是修改    //document.getElementById("editBack").style.display = "";
    ...
    var url = contextPath + "/t9/core/funcs/notify/act/T9NotifyHandleAct/editNotify.act?seqId="+seqId;
    var json = getJsonRs(url);
    if (json.rtState == "0") {
...
//  var textStr = FORM_HTML;
  var url = contextPath + "/t9/core/funcs/notify/act/T9NotifyHandleAct/saveNotifyByUp.act";
...
function _edit(publish,content,format){ 
  var contents = "<form enctype='multipart/form-data' action='"+ contextPath +"/t9/core/funcs/notify/act/T9NotifyHandleAct/addNotify.act'" 
...
function saveNotify(){
  var url = contextPath + "/t9/core/funcs/notify/act/T9NotifyHandleAct/addNotify.act";
  $("notifyForm").action = url;
  $("notifyForm").submit();
}

function goBack() {
  window.location.href = "/t9/core/funcs/notify/manage/notifyList.jsp";
}
...
function deleteAttachBackHand(attachName,attachId,attrchIndex) {
  var url= contextPath + "/t9/core/funcs/notify/act/T9NotifyHandleAct/delFloatFile.act?attachId=" + attachId +"&attachName=" + attachName ; 
  if (seqId) {
    url += "&seqId=" + seqId;
  }
...
function getManageTopDay(){
	var requestUrl =  contextPath + "/t9/core/funcs/notify/act/T9NotifyHandleAct/getManageTopDays.act"; 
  var rtJson = getJsonRs(requestUrl); 
  if(rtJson.rtState == "1"){ 
    alert(rtJson.rtMsrg); 
    return 0; 
