...
function InitList(){
	  var url = contextPath + "/t9/core/funcs/allreport/act/T9AllReportAct/editReportAct.act";
...
function delReport(){
	if(window.confirm("确认要删除该报表吗？"))  var url = contextPath + "/t9/core/funcs/allreport/act/T9AllReportAct/delReportByIdAct.act";
	    var json = getJsonRs(url,"rId="+rId);
	    if(json.rtState == '0'){    
...
<form action="<%=contextPath %>/t9/core/funcs/allreport/act/T9AllReportAct/updateReportAct.act?rId=<%=rId %>" enctype="multipart/form-data" method="post" id="form1" name="form1">
