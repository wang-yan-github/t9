...
function getJson(){
	 var url = contextPath + "/t9/core/funcs/allreport/act/T9DataReportAct/getReportByRidAct.act?rId=<%=rId%>";
...
function export_excel()
{
 ...
 function export_excel(){
     $("form1").action=contextPath+"/t9/core/funcs/allreport/act/T9DataReportAct/toExcel.act";
     //alert(rsText);
     $("form1").target="";
     $("form1").submit();
