function loadData () {
	var url = contextPath + "/t9/core/funcs/allreport/act/T9AllReportAct/getMenuList.act";
	//alert(rsText);
...
function jInit(){
  ...
  //  jQuery("form").bind("submit",function(){
   ...
   // });
	...
	function addOption(seqId){
		  var url = contextPath + "/t9/core/funcs/allreport/act/T9AllReportAct/getListItemAct.act?rId="+seqId;
	    var json = getJsonRs(url);
	    if(json.rtState == '0'){
	    ...
	    var url1 = contextPath + "/t9/core/funcs/allreport/act/T9AllReportAct/getCalListItemAct.act?rId="+seqId;
  ...
  function addOption1(seqId){ 
    var url = contextPath + "/t9/core/funcs/allreport/act/T9AllReportAct/getCalListItemAct.act?rId="+seqId;
    var json = getJsonRs(url);
    if(json.rtState == '0'){
       var data=json.rtData.data;
	  ...
	  if(dataType=="STR"){
		 ...
		 return name+": <input type=\"hidden\" id=\""+item+"\" name=\""+item+"\" value=\"\">"
		  ...
		  return  name+":  <input type=\"text\"  name=\""+item+"\" id=\""+item+"\" size=\"11\" maxlength=\"10\"  class=\"BigInput\" value=\"\" readonly=\"true\">"
	             +"<img id=\""+item+"_date\" align=\"middle\" src=\"\\t9\\core\\styles\\style1\\img\\calendar.gif\" align=\"middle\" border=\"0\" style=\"cursor:pointer\" >"
		         +" 至:  <input type=\"text\"  name=\""+item+"1\" id=\""+item+"1\" size=\"11\" maxlength=\"10\"  class=\"BigInput\" value=\"\" readonly=\"true\">"
                 +"<img id=\""+item+"1_date\" align=\"middle\" src=\"\\t9\\core\\styles\\style1\\img\\calendar.gif\" align=\"middle\" border=\"0\" style=\"cursor:pointer\" >";
