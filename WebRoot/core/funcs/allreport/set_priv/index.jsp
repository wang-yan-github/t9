...
<script type="text/javascript">
 function doInit(){
     var url = contextPath + "/t9/core/funcs/allreport/act/T9ReportPrivAct/getReportPrivByRidAct.act?rId=<%=rId%>";
 ...
 function del(seqId){
	 ...
	 var url = contextPath + "/t9/core/funcs/allreport/act/T9ReportPrivAct/delReportPrivByIdAct.act";
