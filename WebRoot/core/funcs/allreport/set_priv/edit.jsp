...
<script Language="JavaScript">
 function doInit(){
    var url = contextPath + "/t9/core/funcs/allreport/act/T9ReportPrivAct/getReportPrivByPidAct.act?seqId=<%=seqId%>";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  ...
  <form action="<%=contextPath %>/t9/core/funcs/allreport/act/T9ReportPrivAct/updateReportPrivAct.act"  method="post" name="form1" onSubmit="return CheckForm();">
