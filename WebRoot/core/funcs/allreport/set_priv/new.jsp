...
<form action="<%=contextPath %>/t9/core/funcs/allreport/act/T9ReportPrivAct/addReportPrivAct.act?rid=<%=rId%>" enctype="multipart/form-data"  method="post" name="form1" onSubmit="return CheckForm();">
