...
<script type="text/javascript">
  ...
  //同时，可以设置初始的菜单状况，打开初始文档等等。
   ...
   var URL = contextPath + "/t9/core/funcs/office/ntko/act/T9NtkoAct/downFileByLocal.act?" + param;
...
<body onload="doInit()">
<form name="form1" id="form1" method="post" action="<%=contextPath %>/t9/core/funcs/office/ntko/act/T9NtkoAct/updateFileByLocal.act" enctype="multipart/form-data">
...
<object  id="TANGER_OCX" classid="clsid:C9BC4DFF-4248-4a3c-8A49-63A7D317F404" codebase="<%=contextPath %>/core/cntrls/OfficeControl.cab#version=5,0,1,1" width="100%" height="600">
<%
if ("4".equals(op)) {
%>
