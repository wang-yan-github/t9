...
<script type="text/javascript">
  ...
  var hd =[
	       [
		   ...
		   ],
		    {
	   	   	 header:"操作",
	   	   	 oprates:[
		    		  new T9Oprate('编辑',true,mendFlag),
	   		          new T9Oprate('删除',true,deleteFlag)
	          	     ], width: 100
	         }
	       ];
  var url = "/t9/t9/rad/grid/act/T9GridNomalAct/jsonTest.act?tabNo=11114";
  ...
  function deleteFlag(record, index) {
    ...
    var url = "<%=contextPath %>/t9/core/funcs/specialflag/act/T9SpecialFlagAct/deleteSpecialFlag.act";
