...
function getMaxNum(flagSort) {
  var url = "<%=contextPath%>/t9/core/funcs/specialflag/act/T9SpecialFlagAct/getMaxFlagCode.act";
...
function doInit() {
  ...
  var url = "<%=contextPath%>/t9/core/funcs/specialflag/act/T9SpecialFlagAct/getSpecialFlag.act"; 
  if(seqId){
...
function commitItem() {
  ...
  if(seqId) {
    url = "<%=contextPath%>/t9/core/funcs/specialflag/act/T9SpecialFlagAct/updateSpecialFlag.act";
    ...
    var url = "<%=contextPath%>/t9/core/funcs/specialflag/act/T9SpecialFlagAct/addSpecialFlag.act";
    var rtJson = getJsonRs(url, mergeQueryString($("flagInfoForm")));
...
<form name="flagInfoForm" id="flagInfoForm" method="post">
  ...
  <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.specialflag.data.T9SpecialFlag"/>
