...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/dept/act/T9DeptPositionAct/getDeptSelect.act?treeId=" + treeId;
...
function commitDept(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/dept/act/T9DeptPositionAct/updatePersonDept.act?personSeqId=" + positionSeqId + "&seqId=" + seqId;
...
<body onload="doInit()">
 ...
 <input type="hidden" name="seqId" id="seqId" value="">
  ...
  <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.dept.data.T9PositionPerson"/>
