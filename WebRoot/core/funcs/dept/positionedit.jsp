...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/dept/act/T9DeptPositionAct/getDept.act?treeId=" + seqId;
...
function commitDept(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/dept/act/T9DeptPositionAct/updateDp.act?treeId=" + treeId;
...
function nextDept(){
  location.href="/t9/core/funcs/dept/deptinput.jsp?deptLocal=" + deptLocal + "&deptParent=" + deptParent;
}

function deletePosition(){
  if(confirm("确认要删除该岗位吗？这将同时删除该岗位的权限和人员！")) {
    var url = "<%=contextPath%>/t9/core/funcs/dept/act/T9DeptPositionAct/deletePosition.act?seqId=" + seqId;
    var rtJson = getJsonRs(url, mergeQueryString($("form1"))); 
	$("form1").reset();
    if(rtJson.rtState == '0') {
	  alert(rtJson.rtMsrg); 
...
<body class="" topmargin="5" onload="doInit()">
 <table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
   <tr>
    ...
    <td align="right">
      <input type="button" value="新建岗位" class="BigButton" onClick="location='/t9/core/funcs/dept/positioninput.jsp?treeId='+treeId;" title=""新建岗位"">&nbsp;&nbsp;
 ...
 <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.dept.data.T9DeptPosition"/>
   <tr>
