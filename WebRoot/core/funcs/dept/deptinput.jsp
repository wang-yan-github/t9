...
//mgr.addSelect({cntrlId: "deptParent", tableName: "DEPARTMENT", codeField: "SEQ_ID", nameField: "DEPT_NAME", value: <%=deptParent%>, isMustFill: "1", filterField: "", filterValue: "", order: "", reloadBy: "", actionUrl: ""});
//mgr.loadData();
//mgr.bindData2Cntrl();
}
...
function doSubmit(event) {
  ...
  var rtJson = getJsonRs(contextPath + "/t9/core/funcs/dept/act/T9DeptAct/insertDept.act?treeId="+treeId+"&deptParentDesc="+deptLocal, mergeQueryString($("form1")));
  if (rtJson.rtState == 0) {
