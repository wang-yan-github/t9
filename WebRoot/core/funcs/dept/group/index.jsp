...
function doInit(){
  var count = 0;
  var url = "<%=contextPath%>/t9/core/funcs/dept/act/T9UserGroupAct/getUserGroup.act";
...
function deleteSingle(seqId){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/dept/act/T9UserGroupAct/deleteUserGroup.act";
