...
function doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/dept/act/T9UserGroupAct/getUserGroupEdit.act";
...
function commit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/dept/act/T9UserGroupAct/updateUserGroup.act?seqId="+seqId;
