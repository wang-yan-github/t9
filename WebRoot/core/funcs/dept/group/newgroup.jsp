...
function commit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/dept/act/T9UserGroupAct/addGroup.act";
...
<form name="form1" id="form1">
 <table class="TableBlock" width="400" align="center">
  <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.dept.data.T9UserGroup"/>
