...
function doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/dept/act/T9UserGroupAct/getEditUserGroup.act?seqId="+seqId;
...
function commit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/dept/act/T9UserGroupAct/updateManageUserGroup.act?seqId="+seqId;
