...
function doInit(){
  var p = {bindToContainerId:'di'
         ,isOnceLoad:true
		 ,requestUrl:contextPath + '/t9/core/funcs/dept/act/T9DeptPositionAct/getNoTreeOnce.act?userId=' + userId
  ...
  var url = "<%=contextPath%>/t9/core/funcs/dept/act/T9DeptPositionAct/getPrivTreeData.act?userId=" + userId;
...
function test(){
  ...
  var dtoClass = "t9.core.funcs.dept.data.T9PositionPriv";
  var positionSeqId = userId;
  var seqId = document.getElementById("seqId").value;
  var id = tree.getCheckedList();
  var url = "<%=contextPath%>/t9/core/funcs/dept/act/T9DeptPositionAct/insertPriv.act?userId=" + userId;
...
function commit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/dept/act/T9DeptPositionAct/insertPriv.act?treeId=" + treeId;
