...
function doInit(){
  ...
  var rtJson = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/setports/act/T9PersonInfoAct/getPersonInfo.act");
  if (rtJson.rtState == "0"){
...
function submitForm(){
  ...
  var url = "<%=contextPath %>/t9/core/funcs/setdescktop/setports/act/T9PersonInfoAct/updatePersonInfo.act";
...
<form action=""  method="post" name="form1" id="form1">
  <input type="hidden" value="t9.core.funcs.setdescktop.setports.data.T9Person" name="dtoClass" id="dtoClass">
