...
var pageMgr;
function doInit(){
  var requestURL = "<%=contextPath%>/t9/core/funcs/setdescktop/group/act/T9UserGroupAct/getPage.act";
  var cfgs = {
...
function deleteRecord(recordIndex){
  ...
  var url = "<%=contextPath %>/t9/core/funcs/setdescktop/group/act/T9UserGroupAct/delete.act";
  var seqId = pageMgr.getCellData(recordIndex,"seqId");
