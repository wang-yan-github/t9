...
function submitForm(){
  ...
  var url = "<%=contextPath %>/t9/core/funcs/setdescktop/group/act/T9UserGroupAct/setUser.act";
...
function doInit(){
  ...
  var json = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/group/act/T9UserGroupAct/queryUser.act?seqId=${param.seqId}");
