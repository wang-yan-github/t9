...
(function() {
  ...
  var scroll = ${param.scroll};
	...
	function doInitNote(){
	  var rtJson = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/notes/act/T9NotesAct/getNotes.act");
	...
	function saveNote(){
	  var url = "<%=contextPath %>/t9/core/funcs/setdescktop/notes/act/T9NotesAct/saveNote.act";
