...
<div id="oaknow" class="" style="overflow:hidden;position:relative;width:100%;">
	...
	window.doInitOAKnowDesk = function (){          
       var rtJson = getJsonRs("<%=contextPath%>/t9/core/oaknow/act/T9OAKnowAct/ajaxOaDesk.act");  
       var temp = "";
       ...
       if(asks.length >0){
         for(var i=0; i< asks.length; i++){
           temp += "<li>";
           temp += "[<a href=javascript:top.dispParts('<%=contextPath%>/t9/core/oaknow/act/T9OAKnowTypeAct/findType.act?typeId=";
           temp += asks[i]["typeId"];
           temp += "&parentId=" + asks[i]["pid"];
           temp += "&showFlag=CONTENT')>";
           temp += asks[i]["categoryName"];
           temp += "</a>]&nbsp;&nbsp;";
           temp +="<a href=javascript:top.dispParts('<%=contextPath%>/t9/core/oaknow/act/T9OAAskReferenceAct/findAskRef.act?askId=";
           temp += asks[i]["seqId"];
           temp += "&showFlag=CONTENT')>";
           temp += asks[i]["ask"];
           temp += "</a>&nbsp;&nbsp;";
         ...
         $("seemore").innerHTML="<a href=javascript:top.dispParts('<%=contextPath%>/t9/core/oaknow/act/T9OAKnowAct/OAKnowIndex.act')>查看更多...</a>";
       }else{
          temp +="暂无数据...";
       }       
