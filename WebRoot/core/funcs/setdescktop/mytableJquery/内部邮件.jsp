...
window.getEmail = function (type){
  ...
  var url = contextPath + "/t9/core/funcs/email/act/T9InnerEMailAct/deskMoudel.act?type=" + type;
...
window.mailStatus = function (mailBodyId,typesy){
  ...
  var url = contextPath + "/t9/core/funcs/email/act/T9InnerEMailAct/getMailStatus.act";
