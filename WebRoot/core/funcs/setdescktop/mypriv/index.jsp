...
function doInit(){
  var rtJson = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/mypriv/act/T9MyprivAct/getInfo.act");
...
<form action="<%=contextPath %>/t9/core/funcs/setdescktop/mypriv/act/T9MyprivAct/setByName.act"  method="post" name="form1" id="form1">
