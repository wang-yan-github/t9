...
function doInit(){
  ...
  var rtSelect = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/theme/act/T9ThemeAct/getMenu.act");
  ...
  var rtJson = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/theme/act/T9ThemeAct/initForm.act");
  if (rtJson.rtState == "0"){
...
var submitForm = function(){
  ...
  var url = "<%=contextPath %>/t9/core/funcs/setdescktop/theme/act/T9ThemeAct/setTheme.act";
...
function changeHome(index) {
  ...
  if(json.rtState == "0"){
    if (value == "1") {
      ...
      top.location.replace(contextPath + "/core/frame/3/index.jsp");
    }
    else {
...
<table border="0" width="90%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath%>/control_theme.gif" align="abstop"/><span class="big3"> 界面主题 - <%= user.getUserName() %></span><br>
    </td>
  </tr>
</table>
</div>
<form action="<%=contextPath %>/t9/core/funcs/setdescktop/theme/act/T9ThemeAct/setTheme.act"  method="post" name="form1" id="form1" enctype="multipart/form-data">
...
<table class="TableBlock no-top-border" width="80%" align="left">
    ...
    <tr>
      ...
      <td class="TableData">
        ...
        <input type="button" value="切换为唯美界面" class="BigButtonC" onclick="changeHome(3)">
      </td>
    </tr>
    <tr>
