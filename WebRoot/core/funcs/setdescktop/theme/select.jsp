...
$(document).ready(function() {
  ...
  $.ajax({
    type: "GET",
    url: contextPath + "/t9/core/frame/act/T9WebosAct/listWallpappers.act",
    dataType: "text",
    async: false,
    success: function(t) {
      var j = top.T9.parseJson(t);
      if (j.rtState == "0") {
...
function save() {
  ...
  parent.T9.getCmp('themeSelect').isSave = true;
  parent.T9.getCmp('themeSelect').hide();
  parent.T9.getCmp('themeSelect').isSave = false;
}
</script>
