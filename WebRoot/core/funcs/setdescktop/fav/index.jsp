...
var pageMgr;
function doInit(){
  var requestURL = "<%=contextPath%>/t9/core/funcs/setdescktop/fav/act/T9FavAct/getPage.act";
  var cfgs = {
...
function deleteRecord(recordIndex){
  ...
  var url = "<%=contextPath %>/t9/core/funcs/setdescktop/fav/act/T9FavAct/deleteUrl.act";
  var seqId = pageMgr.getCellData(recordIndex,"seqId");
...
function submitForm() {
  ...
  var url = "<%=contextPath %>/t9/core/funcs/setdescktop/fav/act/T9FavAct/addUrl.act";
  var json = getJsonRs(url,pars);
  if (json.rtState == "0"){
    pageMgr.refreshAll();
    $('form1').reset();
  ...
  <table class="TableBlock" width="450" align="center">
   ...
   <tr>
    <td nowrap  class="TableControl" colspan="2" align="center">
      <input type="hidden" value="t9.core.funcs.system.url.data.T9Url" name="dtoClass" id="dtoClass">
