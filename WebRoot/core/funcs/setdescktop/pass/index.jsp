...
var safeSc;
function doInit(){
  var rtJson = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/pass/act/T9PassAct/getSysPara.act");
  if (rtJson.rtState == "0") {
...
function initGrid(){
  ...
  var url = "<%=contextPath %>/t9/core/funcs/setdescktop/pass/act/T9PassAct/getSysLog.act?";
  
  var grid = new T9Grid(hd,url,null);
...
function checkPassWord(){
  var rtJson = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/pass/act/T9PassAct/checkPassWord.act?PASSWORD=" + $F('PASS0'));
  if (rtJson.rtState == "0") {
    if(rtJson.rtMsrg != ''){
      alert(rtJson.rtMsrg);
      $('PASS0').select();
...
function submitForm(){
  ...
  var url = "<%=contextPath %>/t9/core/funcs/setdescktop/pass/act/T9PassAct/updatePassWord.act";
