...
function doInit(){
  ...
  var rtJson = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/avatar/act/T9AvatarAct/getAvatarNickName.act");
  if (rtJson.rtState == "0") {
...
function checkNickName(){
  if (!$('nickName').value == nickName) {
	  var url = "<%=contextPath %>/t9/core/funcs/setdescktop/theme/act/T9ThemeAct/checkNickName.act?NICK_NAME=" + $('nickName').value;
...
function deleteAvatar() {
  ...
  var rtJson = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/avatar/act/T9AvatarAct/resetAvatar.act");
  if (rtJson.rtState == "0") {
	  $('avatarImg').src = "";
	  $('avatarShow').hide();
	  $('avatarUpload').show();
...
function deletePhoto() {
  ...
  var rtJson = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/avatar/act/T9AvatarAct/resetPhoto.act");
  if (rtJson.rtState == "0") {
    $('photoImg').src = "";
    $('photoShow').hide();
    $('photoUpload').show();
...
function initUpload() {
  var rtJson = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/theme/act/T9ThemeAct/getAvatarConfig.act");
...
<form enctype="multipart/form-data" action="<%=contextPath %>/t9/core/funcs/setdescktop/avatar/act/T9AvatarAct/setAvatarNickName.act"  method="post" name="form1" id="form1">
