...
function doInit(){
	var rtJson = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/setports/act/T9MytableAct/listFiles.act");
	if (rtJson.rtState == "0"){
		initSelectOption($('MODULE_FILE'),rtJson);
	}
	
	var rtDetail = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/setports/act/T9MytableAct/detail.act?seqId=${param.seqId}");
...
var submitForm = function(){
	...
	var url = "<%=contextPath %>/t9/core/funcs/setdescktop/setports/act/T9MytableAct/setMytable.act";
