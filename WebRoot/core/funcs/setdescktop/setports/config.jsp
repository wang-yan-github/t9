...
function  doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/setdescktop/setports/act/T9DesktopDefineAct/getDesktopConfig.act";
...
function submitForm(){
	...
	var url = "<%=contextPath%>/t9/core/funcs/setdescktop/setports/act/T9DesktopDefineAct/setUserMytable.act";
