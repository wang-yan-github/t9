...
<script type="text/javascript" src="/t9/core/js/orgselect.js"></script>
<style>

div.T9_Grid_data_opratePanel{
  font-size:14px;
}
</style>
<script type="text/javascript">
function doInit(){
  var checkJson = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/setports/act/T9MytableAct/checkModuleList.act");
  ...
  if (checkJson.rtState == "0") {
	...
	//初始化桌面参数设置列表
  var rtJson = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/setports/act/T9DesktopDefineAct/getDesktopProperties.act");
	...
	var hd =[
             ...
             ],
             {
               header:'操作',
               oprates:[
                    new T9Oprate('<span style="font-size:14px;color:blue;">编辑</span>',true,function(record,index){
                    ...
                    new T9Oprate('<span style="font-size:14px;color:blue;">暂停</span>',true,function(record,index){
                    	if(confirm('确实要暂停该模块吗?')){
	                    	var setType = getJsonRs("<%=contextPath %>/t9/core/funcs/setdescktop/setports/act/T9MytableAct/setViewType.act?type=3&seqId=" + record.getField('seqId').value);
    ...
    var urlLeft = "<%=contextPath %>/t9/core/funcs/setdescktop/setports/act/T9MytableAct/getModuleList.act?tabName=tabName&side=l";
    var urlRight = "<%=contextPath %>/t9/core/funcs/setdescktop/setports/act/T9MytableAct/getModuleList.act?tabName=tabName&side=r";
    
    var gridleft = new T9Grid(hd,urlLeft,null);
    gridleft.rendTo('gridleft');
    
    var gridright = new T9Grid(hd,urlRight,null);
...
function submitForm() {
  var url = '<%=contextPath %>/t9/core/funcs/setdescktop/setports/act/T9DesktopDefineAct/setMineToOthers.act';
...
<form action="<%=contextPath %>/t9/core/funcs/setdescktop/setports/act/T9DesktopDefineAct/setDesktopProperties.act"  method="post" name="form1">
