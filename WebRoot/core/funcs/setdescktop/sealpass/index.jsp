...
function loadGrid(){
  var hd =[
           ...
           ],
           {
             header:"操作",
             oprates:[
                  new T9Oprate('<span style="font-size:14px;color:blue;">修改密码<span>',true,function(record,index){
                    if(!data)
  ...
  var url = "<%=contextPath %>/t9/core/funcs/setdescktop/sealpass/act/T9SealPassAct/getSealInfo.act?";
...
function mysubmit(){
  ...
  new Ajax.Request('<%=contextPath %>/t9/core/funcs/setdescktop/sealpass/act/T9SealPassAct/updateSealData.act', {
    method: 'post',
    parameters:{
