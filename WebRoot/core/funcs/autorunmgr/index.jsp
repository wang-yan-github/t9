...
<script type="text/javascript">
  ...
  function getAutoRunCfgList(){
    var url = contextPath + "/t9/core/funcs/autorunmgr/act/T9AutoRunManagerAct/getAutoRunCfgs.act";
  ...
  function execDelete(id){
    ...
    var url = contextPath + "/t9/core/funcs/autorunmgr/act/T9AutoRunManagerAct/deleteAutoRunCfg.act";
 ...
 */
  function exec_task(id){
    var url = contextPath + "/t9/core/funcs/autorunmgr/act/T9AutoRunManagerAct/execSubThread.act?subid=" + id;
    var rtJson = getJsonRs(url);
    if(rtJson.rtState == "0"){
      alert(rtJson.rtMsrg);
    }else{
  ...
  function execMainThread(type){
    ...
    var url = contextPath + "/t9/core/funcs/autorunmgr/act/T9AutoRunManagerAct/execMainThread.act?type=" + type;
    var rtJson = getJsonRs(url);
    if(rtJson.rtState == "0"){
      alert(rtJson.rtMsrg);
      location.reload();
  ...
  function bindMainThreadStatus(){
    var url = contextPath + "/t9/core/funcs/autorunmgr/act/T9AutoRunManagerAct/getMainThreadStatus.act";
    var rtJson = getJsonRs(url);
    if(rtJson.rtState == "0"){
