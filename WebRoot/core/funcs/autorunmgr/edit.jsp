...
<script type="text/javascript">
  var cfgname = "<%=cfgname%>";
  function doInit(){
    var url = contextPath + "/t9/core/funcs/autorunmgr/act/T9AutoRunManagerAct/getAutoRunCfg.act";
  ...
  function doSubmit(){
    ...
    var url = contextPath + "/t9/core/funcs/autorunmgr/act/T9AutoRunManagerAct/updateAutoRunCfg.act";
