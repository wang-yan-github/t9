...
function doInit(){
    var url = contextPath + "/t9/core/funcs/connswitch/act/T9ConnSwitchAct/getSqlConnInfo.act";
...
function testDbConnect(){
    var url = contextPath + "/t9/core/funcs/connswitch/act/T9ConnSwitchAct/testSqlConnect.act";
    var param="";
...
function saveDbConnect(){
    ...
    var url = contextPath + "/t9/core/funcs/connswitch/act/T9ConnSwitchAct/saveSqlConnect.act";
    var param="";
    param="hostName="+$("hostName").value+"&socket="+$("socket").value+"&dbase="+$("dbase").value+"&uid="+$("uid").value+"&pwd="+$("pwd").value;
     var rtJson = getJsonRs(url,param);
      if(rtJson.rtState == "0"){ 
