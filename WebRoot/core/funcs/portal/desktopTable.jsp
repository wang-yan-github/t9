...
$(document).ready(function(){
  renderPortal();
  initCfgOptionEvent();
  window.tableOp = new T9.TableOperation({
    table: '#grid',
    selectable: {
      delay: 100,
      distance: 20,
    ...
    success: function(text){
      ...
      if (json.rtState == '0') {
        ...
        $.each(data.records, function(i, e) {
          ...
          $.post("<%= contextPath%>/t9/core/funcs/portal/act/T9PortalAct/viewPort.act", {file:file}, function(d) {
...
function savePortal() {
  ...
  var url = contextPath + "/t9/core/funcs/portal/act/T9PortalAct/updateUserPorts.act";
  $.ajax({
    type: "POST",
    dataType: "text",
    data: params,
