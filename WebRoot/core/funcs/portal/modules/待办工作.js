{
  ...
  "items":[{
    ...
    loader: {
      url: contextPath + "/t9/core/funcs/workflow/act/T9MyWorkAct/getMyWork.act"
    },
    rowRender: function(i, e) {
      ...
      a.append(title);
      a.click(function() {
        //top.dispParts(contextPath + '/core/funcs/workflow/flowrun/list/index.jsp?flowId=' + e.flowId, 0);
        var URL = contextPath + '/core/funcs/workflow/flowrun/list/index.jsp?flowId=' + e.flowId;
      ...
      ac.click(function() {
        if (prcsFlag != '3') {
          ...
          //top.dispParts(contextPath + '/core/funcs/workflow/flowrun/list/inputform/index.jsp?runId=' + e.runId + '&flowId=' + e.flowId + '&prcsId=' + e.prcsId + '&flowPrcs=' + e.flowPrcs, 0);
          var URL = contextPath + '/core/funcs/workflow/flowrun/list/inputform/index.jsp?runId=' + e.runId + '&flowId=' + e.flowId + '&prcsId=' + e.prcsId + '&flowPrcs=' + e.flowPrcs;
          window.open(URL, "", "height=800,width=800,status=1,toolbar=no,menubar=no,location=no,scrollbars=yes,top=100,left=400 resizable=yes");
        } else {
    ...
    xtype: "grid",
    loader: {
      url: contextPath + "/t9/core/funcs/workflow/act/T9MyWorkAct/getSign.act"
    },
    rowRender: function(i, e) {
      var status = "";
      var prcsFlag = e.prcsFlag;
    ...
    xtype: "grid",
    loader: {
      url: contextPath + "/t9/core/funcs/workflow/act/T9MyWorkAct/getFocusWork.act"
    },
    rowRender: function(i, e) {
      var title = $('<span class="title"></span>');
