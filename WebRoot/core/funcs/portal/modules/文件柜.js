{
  ...
  "items":[{
    ...
    loader: {
      url: contextPath + "/t9/core/funcs/filefolder/act/T9FileContentAct/selectFolderInfoToDisk.act?index=1"
    },
    rowRender: function(i, prc) {
      ...
      a.click(function() {
        ...
        var URL = contextPath + "/core/funcs/filefolder/index.jsp?showFlag=CONTENT&sortId=" + returnSortId + "&contentId=" + returnContentId
    ...
    loader: {
      url: contextPath + "/t9/core/funcs/filefolder/act/T9FileContentAct/selectFolderInfoToDisk.act?index=2"
    },
    rowRender: function(i, prc) {
      var returnContentId = prc.contentId;
      var returnSortId = prc.sortId;
      ...
      a.click(function() {
        ...
        var URL = contextPath + "/core/funcs/filefolder/index.jsp?sortId=" + returnSortId;
        window.open(URL, "", "height=800,width=800,status=1,toolbar=no,menubar=no,location=no,scrollbars=yes,top=100,left=400 resizable=yes");
      });
