{
  ...
  my:{
    ...
    loader: {
      url: contextPath + "/t9/core/funcs/diary/act/T9DiaryAct/desktopMyDiary.act?length=10",
  ...
  other:{
    ...
    loader: {
      url: contextPath + "/t9/core/funcs/diary/act/T9DiaryAct/desktopDiary.act?length=10",
      dataRender: function(data) {
        if(data.rtState == "0" && data.rtData) {
          return data.rtData;
        }
  ...
  getPriv:function(t) {
    var url = contextPath + '/t9/core/funcs/diary/act/T9DiaryAct/desktopDiaryPriv.act';
    t.items = [];
