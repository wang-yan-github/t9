{
  ...
  "items":[{
    ...
    loader: {
      url: contextPath + "/t9/subsys/jtgwjh/docReceive/act/T9JhDocrecvInfoAct/select.act?status=0"
    },
     ...
     // time.append(activeTime.substr(11, 5));
      ...
      function receive(seqId){
        ...
        if(window.confirm(msg)) {
          var requestURL = contextPath + "/t9/subsys/jtgwjh/docReceive/act/T9JhDocrecvInfoAct/updateStatus.act?seqId=" + seqId + "&status=1" ; 
  ...
  /*, {
    ...
    loader: {
      url: contextPath + "/t9/subsys/oa/active/act/T9ActiveAct/selectActive.act?index=2"
    },
    rowRender: function(i, e) {
      var seqId = e.seqId;
      var activeTime = e.activeTime;
