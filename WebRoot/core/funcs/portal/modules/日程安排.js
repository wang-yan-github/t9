  ...
  "items":[{
    ...
    loader: {
      url: (function() {
        ...
        return contextPath + "/t9/core/funcs/calendar/act/T9CalendarAct/selectCalendarToDisk.act?date=" + date + "&index=1";
      })()
    },
    ...
    loader: {
      url: (function() {
        ...
        var date = currYear + "-" + currMonth + "-" + currDay;
        return contextPath + "/t9/core/funcs/calendar/act/T9CalendarAct/selectCalendarToDisk.act?date=" + date + "&index=2";
      })()
    },
    rowRender: function(i, prc) {
      var currDate = new Date();
