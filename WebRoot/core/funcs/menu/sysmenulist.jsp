...
<%@ page import="java.util.*,t9.core.funcs.menu.data.T9SysMenu,t9.core.funcs.menu.data.T9SysFunction" %>
...
//function loadData(){
 // var url = "<%=contextPath %>/t9/core/funcs/menu/act/T9SysMenuAct/listSysMenu.act";
 // location = url;
//}
...
function delSysMenu(seqId, menuId) {
  var url = "<%=contextPath %>/t9/core/funcs/menu/act/T9SysMenuAct/deleteSysMenu.act";
...
<body onload="doInit()" style="margin:0px;padding:0px">
  <table id="list" cellpadding="3" width="100%" class="TableList no-border">
    <%
      ArrayList<T9SysMenu> menuList = (ArrayList<T9SysMenu>)request.getAttribute("menuList");
    ...
    <tr class="<%= (i % 2 == 0) ? "TableLine1" : "TableLine2" %>">
      ...
      <td>
        <a href="<%=contextPath %>/t9/core/funcs/menu/act/T9SysMenuAct/listSysFunction.act?menuId=<%=menu.getMenuId() %>"  target="contentFrame">下一级</a>
      </td>
      <td>
