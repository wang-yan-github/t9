...
<%@ page import="java.util.*, t9.core.funcs.menu.data.*, t9.core.funcs.menu.logic.*" %>
...
function delSysFunction(menuId) {
  ...
  var url = "<%=contextPath %>/t9/core/funcs/menu/act/T9SysMenuAct/deleteSysFunction.act";
...
<table border="0" width="90%" cellspacing="0" cellpadding="3" class="small">
  ...
  <%
    ArrayList<T9SysFunction> functionList = (ArrayList<T9SysFunction>)request.getAttribute("functionList");
    ...
    <tr class="<%= ((i % 2 == 0) ? "TableLine1" : "TableLine2") %>">
      ...
      <td>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <%
          ...
          funcName = menuLogic.getSysfunctionByMenuId(((T9RequestDbConn)request.getAttribute(T9BeanKeys.REQUEST_DB_CONN_MGR)).getSysDbConn(), function.getMenuId());
        %>
      <td>
