...
function doInit(){
  //getMenuPara();
  //getMenuDisplay();
  var urlSin = "<%=contextPath %>/t9/core/funcs/menu/act/T9SysMenuAct/getMenuExpandSingle.act";
...
function getMenuDisplay(){
  var urlDis = "<%=contextPath %>/t9/core/funcs/menu/act/T9SysMenuAct/getMenuDisplay.act";
...
function getMenuPara(){
  var url = "<%=contextPath %>/t9/core/funcs/menu/act/T9SysMenuAct/getMenuPara.act";
...
function updateTopMenuNum(){
  var url = "<%=contextPath %>/t9/core/funcs/menu/act/T9SysMenuAct/updateTopMenuNum.act";
...
function commit(){
  ...
  var urls = "<%=contextPath %>/t9/core/funcs/menu/act/T9SysMenuAct/updateMenuNavigation.act";
