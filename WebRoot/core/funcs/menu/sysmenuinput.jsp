...
<script type="text/javascript">
  ...
  function doInit() {
    if(seqId){
      var url = "<%=contextPath%>/t9/core/funcs/menu/act/T9SysMenuAct/getSysMenu.act";
  ...
  function commitItem(){
    ...
    var rtJson = null;
    if (seqId) {
      url = "<%=contextPath%>/t9/core/funcs/menu/act/T9SysMenuAct/updateSysMenu.act";
      ...
      url = "<%=contextPath%>/t9/core/funcs/menu/act/T9SysMenuAct/addSysMenu.act";
      rtJson = getJsonRs(url, mergeQueryString($("menuInfoForm")));
      if (rtJson.rtState == "0") {
        //parent.navigateFrame.location.reload();
...
<form name="menuInfoForm" id="menuInfoForm" method="post">
  ...
  %>
   ...
   <input type="hidden" name="seqId" id="seqId" value="" />
    ...
    <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.menu.data.T9SysMenu"/>
