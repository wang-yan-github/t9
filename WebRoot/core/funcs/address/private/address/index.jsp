...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/getManageContact.act?seqId="+groupIdStr+"&userId="+userIds;
  var cfgs = {
      dataAction: url,
...
function detail(seqId){
  var URL = "/t9/core/funcs/address/private/address/adddetail.jsp?seqId="+seqId;
...
function checkSelectBox(){
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/getPrivateContactPersonGroup.act";
