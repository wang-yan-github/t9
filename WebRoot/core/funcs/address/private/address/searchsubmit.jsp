...
function doInit(){
  ...
  var toIdName = "";
  var userSum = "";
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/getSearchGroup.act?psnName="+encodeURIComponent(psnNames)+"&sex="+sexy+"&nickName="+nickNames
...
function groupNameFunc(cellData, recordIndex, columIndex){
  ...
  if(groupId != 0){
    var urlss = contextPath + '/t9/core/funcs/address/act/T9AddressAct/getGroupName.act';
