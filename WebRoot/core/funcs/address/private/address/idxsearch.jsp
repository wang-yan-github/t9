...
<%
  ...
  nameStrs = T9Utility.encodeSpecial(nameStrs);
  if (nameStrs == null){
    nameStrs = "";
  }
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/getNameIndex.act?seqId="+seqIdStr;
  var cfgs = {
      dataAction: url,
...
function detail(seqId, psnName){
  var URL = "/t9/core/funcs/address/private/address/adddetail.jsp?seqId="+seqId+"&psnName="+encodeURIComponent(psnName);
