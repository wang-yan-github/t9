...
<%
  ...
  psnName = T9Utility.encodeSpecial(psnName);
  if (psnName == null){
    psnName = "";
  }
  ...
  nickName = T9Utility.encodeSpecial(nickName);
  if (nickName == null){
    nickName = "";
  }
  String deptName = request.getParameter("deptName");
  deptName = T9Utility.encodeSpecial(deptName);
  if (deptName == null){
    deptName = "";
  }
  String telNoDept = request.getParameter("telNoDept");
  telNoDept = T9Utility.encodeSpecial(telNoDept);
  if (telNoDept == null){
    telNoDept = "";
  }
  String addDept = request.getParameter("addDept");
  addDept = T9Utility.encodeSpecial(addDept);
  if (addDept == null){
    addDept = "";
  }
  String telNoHome = request.getParameter("telNoHome");
  telNoHome = T9Utility.encodeSpecial(telNoHome);
  if (telNoHome == null){
    telNoHome = "";
  }
  String addHome = request.getParameter("addHome");
  addHome = T9Utility.encodeSpecial(addHome);
  if (addHome == null){
    addHome = "";
  }
  String notes = request.getParameter("notes");
  notes = T9Utility.encodeSpecial(notes);
  if (notes == null){
    notes = "";
  }
  ...
  mobileNo = T9Utility.encodeSpecial(mobileNo);
  if (mobileNo == null){
    mobileNo = "";
  }
%>
...
function doInit(){
  //isPrivFunc();
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/getPublicSearchGroup.act?psnName="+encodeURIComponent(psnNames)
...
function deleteSingle(seqId){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/deleteContact.act";
...
function detail(seqId, psnName){
  var URL = "/t9/core/funcs/address/public/address/adddetail.jsp?seqId="+seqId+"&psnName="+encodeURIComponent(psnName);
