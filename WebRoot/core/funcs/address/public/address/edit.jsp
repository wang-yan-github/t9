...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/getEditContactPerson.act";
...
function selectGroup(){
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/getSelectGroup.act";
...
function commit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/updatePublicEditContactPerson.act?seqId="+seqId;
...
<br>
 ...
 <table class="TableBlock"  width="450" align="center">
  ...
  <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.address.data.T9Address"/>
