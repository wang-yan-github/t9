...
function doInit(){
  ...
  var count = 0;
  if(groupFlag != "0"){
    var urls = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/getGroupName.act";
  ...
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/getPublicManageContact.act?seqId="+groupIdStr+"&userId="+userIds;
  var cfgs = "";
  if(isPriv == "1"){
     cfgs = {
        dataAction: url,
...
function isPrivFunc(){
  var urls = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/getPublicSupportPriv.act";
...
function detail(seqId){
  var URL = "/t9/core/funcs/address/public/address/adddetail.jsp?seqId="+seqId;
...
function deleteAllUser() {
  ...
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/deletePublicContact.act";
...
function checkSelectCopyBox(){
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/getPublicChangePersonGroup.act";
...
function changeBox(dom){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/changePublicGroup.act?seqIds="+ ids + "&groupId=" + groupId +"&groupIdOld="+ groupIdStr;
  var rtJson = getJsonRs(url);
  if(rtJson.rtState == "0"){
    window.location.reload();
...
function changeCopyBox(dom){
  ...
  var groupId = dom.value;
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/changePublicCopyGroup.act?seqIds="+ ids + "&groupId=" + groupId +"&groupIdOld="+ groupIdStr;
  var rtJson = getJsonRs(url);
  if(rtJson.rtState == "0"){
    window.location.reload();
    parent.menu.location.reload();
