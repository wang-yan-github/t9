...
function doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/getPublicEditGroup.act?seqId="+seqId;
...
function commit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/updatePublicGroup.act?seqId="+seqId+"&groupNameOld="+encodeURIComponent(groupNameOld);
