...
function lastTenEntry(div){
  var url = contextPath + "/t9/core/funcs/diary/act/T9DiaryAct/lastTen.act";
...
function show( data) {
  if(data.data.attachmentId){
    var attrCntrl = "attr_"+ data.data.seqId;
    showAttach(data.data.attachmentId,data.data.attachmentName,attrCntrl,true , data.data.seqId);
  }
}
/**
 *根据时间的日志
