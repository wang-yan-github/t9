...
function checkForm2() {
  if (checkForm()) {
    ...
    var url = contextPath + "/t9/core/funcs/workplan/act/T9WorkDetailAct/updateDetaiId2.act";
    var json = getJsonRs(url,pars);
    if (json.rtState == "1") {
      alert(json.rtMsrg);   
    }else {
      window.location = contextPath + "/t9/core/funcs/workplan/act/T9WorkDetailAct/selectDetaiId.act?seqId=" + document.getElementById("planId").value;
    }
  }
}
function jugeFile(){
...
<%
T9WorkDetail detail = (T9WorkDetail)request.getAttribute("detailId");
%>
