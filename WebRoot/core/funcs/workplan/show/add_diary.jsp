...
function checkForm2(planId) {
  if (checkForm()) {
    ...
    var url = contextPath + "/t9/core/funcs/workplan/act/T9WorkDetailAct/addDetaiId.act";
    var json = getJsonRs(url,pars);
    if (json.rtState == "1") {
      alert(json.rtMsrg);
    }else {
      window.location = contextPath + "/t9/core/funcs/workplan/act/T9WorkDetailAct/selectDetaiId.act?seqId=" + planId;
    }
  }
}
function jugeFile(){
...
function deleteId2(seqId,planId) {
  ...
  window.location = "<%=contextPath %>/t9/core/funcs/workplan/act/T9WorkDetailAct/deleteDetaiId.act?seqId=" + seqId + "&planId=" + planId;
  } 
}
function updateId(seqId,sqlName) {
  window.location = "<%=contextPath %>/t9/core/funcs/workplan/act/T9WorkDetailAct/selectId2.act?seqId=" + seqId + "&sqlName=" + sqlName;
}
function checkBox2() {
...
<%
  ...
  List<T9WorkDetail> list = (List<T9WorkDetail>)request.getAttribute("listId");
