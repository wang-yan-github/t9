...
function checkForm2() {
  if (checkForm()) {
    ...
    var url = contextPath + "/t9/core/funcs/workplan/act/T9WorkPersonAct/updatePerson2.act";
    var json = getJsonRs(url,pars);
    if (json.rtState == "1") {
      alert(json.rtMsrg);
    }else {
      window.location = contextPath + "/t9/core/funcs/workplan/act/T9WorkPersonAct/selectPerson.act?seqId=" + document.getElementById("PLAN_ID").value + "&name=" + document.getElementById("PUSER_ID").value;
    }
  }
}
function jugeFile(){
...
<%
  T9WorkPerson person = (T9WorkPerson)request.getAttribute("person");
%>
