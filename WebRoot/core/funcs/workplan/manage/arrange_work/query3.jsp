...
function myOpen2(seqid) {
  ...
  //window.open("<%=contextPath%>/t9/core/funcs/workplan/act/T9WorkDetailAct/selectDetai3.act?seqId=" + seqid,"myOpen2","status=1,toolbar=no,menubar=no,location=no,scrollbars=yes,left=250,top=0,resizable=yes");
}
function workSelect2(seqid) {
  window.open("<%=contextPath%>/t9/core/funcs/workplan/act/T9PlanWorkTwoAct/workSelect2.act?seqId=" + seqid,"myOpen","height=650,width=700,status=1,toolbar=no,menubar=no,location=no,scrollbars=yes,top=90,left=290,resizable=yes");
}
