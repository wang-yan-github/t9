...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/workplan/act/T9PlanWorkTwoAct/applySelect.act";
   cfgs = {
    dataAction: url,
    container: "giftList",
    paramFunc: getParam,   
...
function toUser(cellData,recordIndex,columIndex){
  ...
  var requestUrl = "<%=contextPath%>/t9/core/funcs/workplan/act/T9PlanWorkTwoAct/userName.act" + seqId;
