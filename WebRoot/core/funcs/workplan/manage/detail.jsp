...
<script type="text/javascript">
  function myOpen(seqid) {
    window.open("<%=contextPath%>/t9/core/funcs/workplan/act/T9WorkDetailAct/selectDetai.act?seqId=" + seqid,"myNewOpen","height=550,width=800,top=90,left=290,toolbar=no,menubar=no,scrollbars=yes,resizable=yes,location=no,status=1");
  }
...
<%
T9WorkPlan plan = (T9WorkPlan) request.getAttribute("planData");
Date date = new Date();
...
<table class="TableBlock" width="100%">
 ...
 <div style="display:none">
  ...
  <tr>
    ...
    <td align="left" class="TableData">
    <%
      if (!T9Utility.isNullorEmpty(plan.getAttachmentcomment())) {
 ...
 %> <font color='#FF0000'><b>已结束</b></font>
  ...
  <tr class="TableControl">
    <td colspan="9" align="center"><input type="button" title="收藏当前页" value="收藏本页"
      class="BigButton"
      onClick="javascript:window.external.AddFavorite('http://localhost<%=contextPath%>/t9/core/funcs/workplan/act/T9PlanWorkAct/workSelect2.act?seqId=<%=plan.getSeqId()%>','工作计划详情');">&nbsp;&nbsp;&nbsp;&nbsp;
