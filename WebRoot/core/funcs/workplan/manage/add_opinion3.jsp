  ...
  function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
    ...
    for(var i = 0 ; i < attachNameArrays.length ; i++) { 
      ...
      if (checkForm()) {
        ...
        var url = contextPath + "/t9/core/funcs/workplan/act/T9WorkDetailAct/updateDetail2.act";
  ...
  function isAdd() {
    if (checkForm()) {
      ...
      if(json.rtState == "1"){
        ...
        window.location.href = contextPath + "/t9/core/funcs/workplan/act/T9WorkDetailAct/selectDetai.act?seqId=" + document.getElementById("planId").value;
      }
    }
