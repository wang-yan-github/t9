...
function workDelete(seqId) {
  ...
  if (window.confirm(msg)) {
    var url = "<%=contextPath%>/t9/core/funcs/workplan/act/T9PlanWorkAct/deleteQuery3.act?seqId=" + seqId;
    window.location.href = url;
  }
  window.location.reload();
}
function updatePlu(seqId,pub) {
  var url = "<%=contextPath%>/t9/core/funcs/workplan/act/T9PlanWorkAct/updateQuery3.act?seqId=" + seqId + "&pub=" + pub;
  window.location = url;
  window.location.reload();
}
function pdf() {
  var param = "<%=para%>";
  var url = "<%=contextPath%>/t9/core/funcs/workplan/act/T9Export/exportCsv.act?" + param;
  window.location = url;
}
...
function updatePlu8(seqId,pub,time) {
  var url = "<%=contextPath%>/t9/core/funcs/workplan/act/T9PlanWorkAct/updatePlu8.act?seqId=" + seqId + "&pub=" + pub + "&time=" + time;
  window.location = url;
  window.location.reload();
}
function doInit() {
...
<%
  ...
  List<T9WorkPlan> list = (List<T9WorkPlan>) request.getAttribute("worklist");
...
<table class="TableList" align="center" width="100%">
 ...
 <%} %>
    ...
    <td>
    <%
      if (T9Utility.isNullorEmpty(plan.getAttachmentname())) {
    %>无<%
      } else {
    %>
