...
<%
  T9PlanType type = (T9PlanType)request.getAttribute("type");
%>
<form  method="post" name="form1" onSubmit="return checkForm();" action="<%=contextPath%>/t9/core/funcs/workplan/act/T9PlanTypeAct/updateType.act">
