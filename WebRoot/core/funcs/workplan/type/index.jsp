...
<%@page import="t9.core.funcs.workplan.data.T9PlanType"%>
<html>
<head>
...
function checkType() {
  ...
  var reqURL = "<%=contextPath%>/t9/core/funcs/workplan/act/T9PlanTypeAct/selectTypeName.act?" + param;
...
function checkForm2() {
  if (checkForm()) {
    ...
    if (prcs.length > 0) {
      ...
      var url = contextPath + "/t9/core/funcs/workplan/act/T9PlanTypeAct/addType.act";
...
function deteleType(seqId) {
  ...
  window.location.href = "<%=contextPath%>/t9/core/funcs/workplan/act/T9PlanTypeAct/deleteType.act?seqId=" + seqId;
  }
}
function deteleTypeAll() {
  var msg = "确认要删除所有计划类型吗?";
  if (window.confirm(msg)) {
  window.location.href = "<%=contextPath%>/t9/core/funcs/workplan/act/T9PlanTypeAct/deleteTypeAll.act";
  }
}
function updateType(seqId) {
  window.location.href = "<%=contextPath%>/t9/core/funcs/workplan/act/T9PlanTypeAct/selectId.act?seqId=" + seqId;
}
</script>
</head>
