...
{
	var requestURL = "<%=contextPath%>/t9/core/funcs/netdisk/act/T9NetDiskAct";
...
function showPathName(){
	...
	//alert(ccss);
	var urlStr = "<%=contextPath%>/t9/core/funcs/netdisk/act/T9NetDiskAct/showPathName.act?seqId=<%=seqId%>" + "&diskPath=" + encodeURIComponent(diskPathStr);
...
<form name="form1" id="form1"
	action="<%=contextPath%>/t9/core/funcs/netdisk/act/T9NetDiskAct/uploadFile.act"
...
<form id="upload" style="display: none;"
	action="<%=contextPath%>/t9/core/funcs/netdisk/act/T9NetDiskAct/uploadFile.act?seqId=<%=seqId%>"
