...
function sendForm(){
	...
	if(checkForm()){
		...
		//var url="<%=contextPath%>/t9/core/funcs/netdisk/act/T9NetDiskAct/addFileFolder.act?seqId=<%=seqId%>&DISK_ID="+ encodeDiskId +"&FILE_NAME="+encodefileName;
		var url="<%=contextPath%>/t9/core/funcs/netdisk/act/T9NetDiskAct/addFileFolder.act";
