...
function doInit(){
	  ...
	  var url =contextPath+'/t9/core/funcs/news/act/T9NewsHandleAct/beforeAddNews.act';
	  ...
	  if(seqId) {//seqId 为空标示新建，不为空标示修改
	    ...
	    var url = contextPath + "/t9/core/funcs/news/act/T9NewsHandleAct/editNews.act?seqId="+seqId;
	    var json = getJsonRs(url);     
	      if(json.rtState == "0"){
	        var rtData = json.rtData;
