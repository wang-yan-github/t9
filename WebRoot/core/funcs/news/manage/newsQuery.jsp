...
//	   var url = '/t9/t9/core/funcs/news/act/T9NewsHandleAct/queryNews.act';
//	   var rtJson = getJsonRs(url, mergeQueryString($("form1")));
   ...
   else if(operation2.checked)
   {
      ...
      if(window.confirm(msg))
         document.form1.action=contextPath + "/t9/core/funcs/news/act/T9NewsHandleAct/deleteNewsBySel.act";      
         $("form1").submit();
   }
...
//	  $('pgSearchInfo').innerHTML = "加载数据中,请稍后.....";
	  var url = contextPath + "/t9/core/funcs/news/act/T9NewsHandleAct/queryNews.act?pageIndex="+ pageIndex +"&showLength="+showLength+"&type="+typeId+"&ascDesc="+ascDesc+"&field="+field;
...
function delete_news(seqId)
{
 ...
 if(window.confirm(msg))
 {
	 var url =contextPath+"/t9/core/funcs/news/act/T9NewsHandleAct/deleteNewById.act?seqId="+seqId;
	  var json = getJsonRs(url);
	  if (json.rtState == "0"){
...
<table class="TableBlock" width="550" align="center">
    ...
    <tr align="center" class="TableControl">
      <td colspan="2" nowrap>
         <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.news.data.T9News"/>
