...
<%@page import="t9.core.funcs.news.data.T9News"%>
<%
  String seqId = request.getParameter("seqId");
  if (seqId == null) {
	  seqId = "";
  }
  T9News news = (T9News)request.getAttribute("news");
%>
...
function savenews(){
	 ...
	 // $("formName").value = formName;
	  ...
	  var url = "/t9/t9/core/funcs/news/act/T9NewsHandleAct/addNews.act";
...
<form enctype="multipart/form-data" action="<%=contextPath %>/t9/core/funcs/news/act/T9NewsHandleAct/addNews.act"  method="post" name="newsForm" id="newsForm">
<table class="TableBlock" width="95%" align="center">
   ...
   <td class="TableData" colspan='2' id="contentTd">
      <div>
         <textarea name="content" id="content">1234<%=news.getContent() %></textarea>
         <!-- 实例化编辑器 -->
    	<script type="text/javascript">
