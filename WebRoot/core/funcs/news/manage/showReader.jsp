...
function loadData(){
	  var url =contextPath+'/t9/core/funcs/news/act/T9NewsHandleAct/showReader.act?seqId='+seqId;
...
function delete_reader()
{
 ...
 {
  URL= contextPath+"/t9/core/funcs/news/act/T9NewsShowAct/deleteReader.act?seqId=" + seqId;
  window.location=URL;
 }
}
</script>
