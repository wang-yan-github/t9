...
<head>
  ...
  <script type="text/javascript" src="<%=contextPath %>/core/js/jquery.js"></script>
    ...
    var imgNewPath = contextPath + "/t9/core/funcs/office/ntko/act/T9NtkoAct/upload.act?";   
		...
		function findNewsAndPic(){
			jQuery.ajax({
					url:contextPath + "/t9/core/funcs/news/act/T9ImgNewsAct/findNewsAndPicturesAjax.act" ,
				  type:"post",	
					async:false,                                 
