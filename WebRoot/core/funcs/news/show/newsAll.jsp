...
function loadData(pageIndex, showLength, typeId, ascDesc, field){
  ...
  var url =contextPath+'/t9/core/funcs/news/act/T9NewsShowAct/getnewsAllList.act';
...
function read_all() {
  ...
  if(window.confirm(msg)) {
    url = contextPath + "/t9/core/funcs/news/act/T9NewsShowAct/changeNoReadAll.act?forward=all";
    location=url;
  }
}
