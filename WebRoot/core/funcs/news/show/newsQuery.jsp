...
//	  $('pgSearchInfo').innerHTML = "加载数据中,请稍后.....";
  ...
  if(!index){
    ...
    pageIndex = 1;
	  ...
	  var url = "<%=contextPath%>/t9/core/funcs/news/act/T9NewsShowAct/queryNews.act?pageIndex="+ pageIndex +"&showLength="+showLength+"&ascDesc="+ascDesc+"&field="+field;
...
{
 URL="/t9/core/funcs/news/show/readNews.jsp?seqId="+seqId;
