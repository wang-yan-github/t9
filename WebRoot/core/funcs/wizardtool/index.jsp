...
var actionUrl = contextPath + "/t9/core/funcs/wizardtool/act/T9WizardToolAct";
var pageMenuData = [
...
<div id="right">
<div id="fck">
<form name="submitForm" id="submitForm" action="<%=contextPath %>/t9/core/funcs/wizardtool/act/T9WizardToolAct/previewPage.act" method="post" target="preview">
<script type="text/javascript">
widgetData = {} ;
