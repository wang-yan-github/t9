...
function isOutPriv(){
  var url = '<%=contextPath%>/t9/core/funcs/mobilesms/act/T9MobileSms2Act/queryOutPriv.act';
...
function selectAddress(){
  var url = "/t9/core/funcs/mobilesms/new/MultiAddressSelect.jsp";
...
<br>
<form action="<%=contextPath%>/t9/core/funcs/mobilesms/act/T9MobileSms2Act/addSms.act" onsubmit="return checkForm();" method="post" name="form1" id="form1">
