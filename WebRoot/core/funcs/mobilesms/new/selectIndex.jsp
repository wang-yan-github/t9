...
var selectGroup = '-1';
var deptList = [];
var requestUrl = contextPath + "/t9/core/funcs/address/act/T9AddressAct";
function doInit(){
...
function loadData(){
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/getContactPersonGroup.act";
...
function clickPriv(id , name){
  var seqId = id;
  var userId = name;
  var url = contextPath + "/t9/core/funcs/mobilesms/act/T9MobileSelectAct/getMobileSelect.act";
...
function clickNameIndex(id, name){
  var seqId = id;
  var url = contextPath + "/t9/core/funcs/mobilesms/act/T9MobileSelectAct/getPublicMobileSelect.act";
...
function loadNameIndex(){
  var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/getPublicContactPersonGroup.act";
  var rtJson = getJsonRs(url, null);
  if (rtJson.rtState == "0") {
