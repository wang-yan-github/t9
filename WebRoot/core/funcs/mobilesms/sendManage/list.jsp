...
function doInit(){
  ...
  var requestURL = "<%=contextPath%>/t9/core/funcs/mobilesms/act/T9MobileSms2Act/listSendSms.act";
...
function deleteRecords(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/mobilesms/act/T9MobileSms2Act/deleteSms.act?seqIdStr=" + seqIdStr;
