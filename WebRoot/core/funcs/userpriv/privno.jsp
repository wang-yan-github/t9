...
function doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/person/act/T9UserPrivAct/getSelectData.act";
...
function Submit(){
   ...
   var url = "<%=contextPath%>/t9/core/funcs/person/act/T9UserPrivAct/updateSelectPriv.act?privSeqId=" + privSeqId + "&privNo=" + privNo;
   var rtJson = getJsonRs(url);
   if(rtJson.rtState == "0"){
     //bindJson2Cntrl(rtJson.rtData);
     //alert(rsText);
