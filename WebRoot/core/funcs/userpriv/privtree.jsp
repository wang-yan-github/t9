...
function doInit(){
  var p = {bindToContainerId:'di'
         ,isOnceLoad:true
		 ,requestUrl:contextPath + '/t9/core/funcs/person/act/T9UserPrivAct/getNoTreeOnce.act?userId=' + seqId
  ...
  tree =  new DTree(p);
  tree.show();
  var url = "<%=contextPath%>/t9/core/funcs/person/act/T9UserPrivAct/getPrivTreeData.act?userId=" + seqId;
...
function doSubmit(){
  ...
  var dtoClass = "t9.core.funcs.dept.data.T9UserPriv";
  var positionSeqId = userId;
  
  //var seqId = document.getElementById("seqId").value;
  var id = tree.getCheckedList();
  var url = "<%=contextPath%>/t9/core/funcs/person/act/T9UserPrivAct/insertPriv.act?privNo=" + privNo;
