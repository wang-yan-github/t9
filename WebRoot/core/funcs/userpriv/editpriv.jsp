...
function doInit(){
  if(num){
    var url = "<%=contextPath%>/t9/core/funcs/person/act/T9UserPrivAct/getUserPriv.act?seqId=" + seqId;
...
function commitDept(){
  ...
  if(num){
    var url = "<%=contextPath%>/t9/core/funcs/person/act/T9UserPrivAct/insertUserPriv.act";
  }
  else if(seqId != null&&seqId != ""){
  //document.getElementById("positionFlag") = document.getElementById("pre4");
    var url = "<%=contextPath%>/t9/core/funcs/person/act/T9UserPrivAct/updateUserPriv.act?seqId=" + seqId;
  }else{
    var url = "<%=contextPath%>/t9/core/funcs/person/act/T9UserPrivAct/insertUserPriv.act";
  }
