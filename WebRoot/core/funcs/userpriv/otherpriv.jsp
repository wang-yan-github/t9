...
function test(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/person/act/T9UserPrivAct/otherPriv.act";
...
function SelectUser(TO_ID, TO_NAME){
  var treId = treeId;
  URL = "/t9/core/funcs/userpriv/userselect.jsp?treeId=" + treId + "&TO_ID=" + TO_ID + "&TO_NAME=" + TO_NAME;
