...
function doInit(){
  var p = {bindToContainerId:'di'
         ,isOnceLoad:true
		 ,requestUrl:contextPath + '/t9/core/funcs/person/act/T9UserPrivAct/getPrivTree.act'
  ...
  var url = "<%=contextPath%>/t9/core/funcs/person/act/T9UserPrivAct/getUserName.act";
...
function doSubmit(){
  ...
  //var id = tree.getCheckedList();
  var url = "<%=contextPath%>/t9/core/funcs/person/act/T9UserPrivAct/usertAddDeleltPriv.act?user_op=" + user_op;
