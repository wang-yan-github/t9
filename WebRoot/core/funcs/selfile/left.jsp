...
function doInit(){
    ...
    //location = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/getMb.act";
}
...
function loadPersonTree(){	
  ...
  peersonTree =  new DTree({bindToContainerId:index3
    ,requestUrl:contextPath + '/t9/core/funcs/personfolder/act/T9PersonFolderAct/getPersonTree.act?id='
    ,isOnceLoad:false
...
function loadFileTree(){
  ...
  tree =  new DTree({bindToContainerId:index4
    ,requestUrl:contextPath + '/t9/core/funcs/system/filefolder/act/T9FileSortAct/getPrivTree.act?id='
    ,isOnceLoad:false
    ,checkboxPara:{isHaveCheckbox:false}
  	,linkPara:{clickFunc:test}
  	,treeStructure:{isNoTree:false}	
