...
function doInit(){
  var url = "<%=contextPath%>/t9/core/funcs/demo/act/T9SealAct/getSealPriv.act";
  var rtJson = getJsonRs(url, "seqId="+seqId);
  if (rtJson.rtState == "0") {
    $('user').value = rtJson.rtData.user;
    $('userDesc').value = rtJson.rtData.userDesc;
  }else {
    alert(rtJson.rtMsrg); 
  }
}
function commit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/demo/act/T9SealAct/updateSealPriv.act";
  var rtJson = getJsonRs(url, "seqId=" + seqId +"&userStr=" + userStr);
  if (rtJson.rtState == "0") {
    alert("设置成功");
  }else {
    alert(rtJson.rtMsrg); 
...
function selectUser1(retArray){
	userRetNameArray=retArray;
	var url=contextPath+"/core/funcs/demo/deviceSelects.jsp?1=1";
  ...
  <form method="post" name="form1" id="form1">
   ...
   <tr>
      ...
      <td class="TableData">
        ...
        <a href="javascript:;" class="orgAdd" onClick="selectUser1(['user','userDesc']);">选择</a>
