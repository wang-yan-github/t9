...
<script type="text/javascript" src="<%=contextPath %>/core/funcs/system/ADsealmanage/js/sealManageUtil.js"></script>
<script type="text/javascript">
function doInit(){
  var param = "sealName=<%=sealName%>&beginTime=<%=beginTime%>&endTime=<%=endTime%>";
  param = encodeURI(param);
  var url =  contextPath + "/t9/core/funcs/system/ADsealmanage/act/T9SealAct/getSealList.act?" + param;
  var cfgs = {
    dataAction: url,
    ...
    colums: [
       ...
       {type:"data",width: "10%", name:"id", text:"印章ID", render:sealIdFunc},   
       {type:"data", width: "20%", name:"sealName", text:"印章名称", render:sealNameFunc},    
       {type:"data", width: "10%", name:"sealName", text:"证书绑定"},  
       {type:"data", width: "20%", name:"sealName", text:"授权范围", render:subjectRender},  
       {type:"data", width: "20%", name:"sealName", text:"创建时间", render:creatTimeFunc},     
...
function subjectRender(cellData, recordIndex, columIndex) {
  var urls = "<%=contextPath%>/t9/core/funcs/system/sealmanage/act/T9SealAct/getUserName.act";
...
function deleteAllUser() {
  ...
  var url = "<%=contextPath%>/t9/core/funcs/system/sealmanage/act/T9SealAct/deleteSeal.act";
