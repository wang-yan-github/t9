...
<%@page import="t9.core.funcs.modulepriv.data.T9ModulePriv"%>
<% 
 ...
 T9ModulePriv modulePriv = (T9ModulePriv)request.getAttribute("modulePriv");
%>
...
//       alert(selectOtherAll);
       ...
       var url = contextPath + "/t9/core/funcs/modulepriv/act/T9ModuleprivAct/getJson.act?id="+id+"&uid="+<%=uid%>;
...
//	  alert(dept_priv+'-----'+role_priv+'------'+apply_to_dept+'------'+apply_to_priv);
	  ...
	  var url = "<%=contextPath%>/t9/core/funcs/modulepriv/act/T9ModuleprivAct/updateModulepriv.act";
  ...
  <table class="TableBlock" width="95%" align="center">
   ...
   <tr>
    <td nowrap  class="TableControl" colspan="3" align="center">
        ...
        <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.modulepriv.data.T9ModulePriv"/>
