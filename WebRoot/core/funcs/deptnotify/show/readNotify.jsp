...
function doInit(){
   ...
   var url =contextPath+'/t9/core/funcs/deptnotify/act/T9NotifyShowAct/showObject.act?seqId='+seqId+'&isManage='+isManage + "&flag=<%=flag%>" ;
...
function fw_notify(seqId)
{
	 if(window.confirm("确认要转发该公告通知吗？")){
	   window.location = contextPath+"/core/funcs/deptnotify/manage/notifyAdd.jsp?isFw=1&seqId="+seqId;
	 }
}
 ...
 <table class="TableBlock" width="100%">
    ...
    <tr align="center" class="TableControl">
      <td>
        ...
        <input type="button" value="返回" class="BigButton" onClick="window.location.href='/t9/core/funcs/deptnotify/show/index.jsp'">
        </span>
      </td>
    </tr>
  </table>
