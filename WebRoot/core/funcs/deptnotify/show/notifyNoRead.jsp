...
var ascDesc = '1';
var pageCount = 0;
var deptName = '<%=portName%>';
var dname = encodeURI(deptName,"UTF-8"); 
function doInit(){
...
//	  $('pgSearchInfo').innerHTML = "加载数据中,请稍后.....";
	  var par = "pageIndex="+pageIndex+"&showLength=" +showLength+"&type="+typeId+"&ascDesc="+ascDesc+"&field="+field+"&portName="+dname;
	  var url =contextPath+'/t9/core/funcs/deptnotify/act/T9NotifyShowAct/getnotifyNoReadList.act';
...
function addRow(data , i){
     ...
     var td =  "<td align='center'><u title='部门：" + data.deptName + "' style='cursor:pointer'>" + data.fromName + "</u></td>"
             ...
             + " <td nowrap><a href=javascript:open_notify('" + data.seqId + "','" + data.format + "'); title='" + data.subjectTitle + "'>" + data.subject + "</a><img src='<%=imgPath%>/email_new.gif' align='absMiddle' border='0'></td>"
...
{
  url=contextPath + "/t9/core/funcs/deptnotify/act/T9NotifyShowAct/changeNoReadAll.act";
  location=url;
}
}
...
{
 URL="/t9/core/funcs/deptnotify/show/readNotify.jsp?isManage=0&seqId="+seqId;
