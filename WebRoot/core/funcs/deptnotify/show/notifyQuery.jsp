...
//	  $('pgSearchInfo').innerHTML = "加载数据中,请稍后.....";
	  var url = "<%=contextPath%>/t9/core/funcs/deptnotify/act/T9NotifyShowAct/queryNotify2.act?ascDesc="+ascDesc+"&field="+field+"&portName="+portName;
...
{
 URL="/t9/core/funcs/deptnotify/show/readNotify.jsp?isManage=0&flag=1&seqId="+seqId;
...
function back() {
	window.location.href = "/t9/core/funcs/deptnotify/show/notifyQuery.jsp";
}
</script>
</head>
<body onload="doInit();">
