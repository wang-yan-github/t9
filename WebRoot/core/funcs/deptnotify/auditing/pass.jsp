...
function doInit(){
	 ...
	 var url =contextPath+'/t9/core/funcs/deptnotify/act/T9NotifyAuditingAct/beforeAuditingPass.act?seqId='+seqId;
...
function sendForm(){
	if(checkForm()){
		  var url = "<%=contextPath %>/t9/core/funcs/deptnotify/act/T9NotifyAuditingAct/operation.act";
		  $("form1").action = url;
		  $("form1").submit();
    }
}
