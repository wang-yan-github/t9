...
//	  $('pgSearchInfo').innerHTML = "加载数据中,请稍后.....";
  ...
  if(!index){
    ...
    pageIndex = 1;
	  ...
	  var url =contextPath+'/t9/core/funcs/deptnotify/act/T9NotifyAuditingAct/getUnAuditedList.act';
...
function addRow(data , i){
     ...
     var str = toNameStr + privNameStr + userNameStr;
	  var td =  "<td nowrap align='center' style='cursor:pointer'  title='部门："+data.deptName+"'>"+data.fromName+"</td>"
	            ...
	            + " <td nowrap align='center'> <a href='/t9/core/funcs/notify/auditing/pass.jsp?seqId="+data.seqId+"'>批准</a>"
	            + "&nbsp;&nbsp;<a href='/t9/core/funcs/notify/auditing/unPass.jsp?seqId="+data.seqId+"'>不批准</a></td>";
...
{
  url= contextPath + "/t9/core/funcs/news/act/T9NewsShowAct/changeNoReadAll.act";
  location=url;
}
}
...
{
  URL= contextPath + "/core/funcs/deptnotify/manage/showObject.jsp?seqId="+seqId;
...
function my_affair(seqId)
{
  ...
  URL= contextPath + "/core/funcs/deptnotify/manage/note.jsp?seqId="+seqId;
...
{
 URL= contextPath + "/core/funcs/deptnotify/show/readNotify.jsp?isManage=1&seqId="+seqId;
...
{
  URL= contextPath + "/core/funcs/deptnotify/show/showReader.jsp?seqId="+seqId;
  myleft=(screen.availWidth-500)/2;
