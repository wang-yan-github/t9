...
<%@ page  import="t9.core.funcs.person.data.*"%>
<%
...
function checkForm()
{
   ...
   }else if(operation2.checked)
   {
      ...
      if(window.confirm(msg)){
         document.form1.action = contextPath + "/t9/core/deptnotify/notify/act/T9NotifyHandleAct/deleteSelNotify.act";  
         $("form1").submit(); 
      }   
   }else if(operation3.checked){     
      document.form1.action= contextPath + "/t9/core/deptnotify/notify/act/T9NotifyHandleAct/toExcel.act";
      $("form1").submit();
   }
   return true;
}
...
//	  $('pgSearchInfo').innerHTML = "加载数据中,请稍后.....";
	  var url = "<%=contextPath%>/t9/core/funcs/deptnotify/act/T9NotifyHandleAct/queryNotify.act";
...
function addRow(data , i){
  ...
  var str = toNameStr + privNameStr + userNameStr;  
    ...
    td = td + "<td><a href='javascript:show_reader(" + data.seqId + ");' title='查阅情况'> 查阅情况</a>&nbsp;<a href='/t9/core/funcs/notify/manage/notifyAdd.jsp?seqId=" + data.seqId + "'> 修改</a>";
    var notifyStatus = data.notifyStatus;
    var publish = data.publish;
    if(notifyStatus=="1"&&publish=="1"){
        td = td + "&nbsp;<a href='/t9/t9/core/funcs/deptnotify/act/T9NotifyHandleAct/changeState.act?seqId="+data.seqId+"&operation=1'> 立即生效</a>"
    }else if(notifyStatus=="2"&&publish=="1"){
  	  td = td + "&nbsp;<a href='/t9/t9/core/funcs/deptnotify/act/T9NotifyHandleAct/changeState.act?seqId="+data.seqId+"&operation=2'>终止</a>"
    }else if(notifyStatus=="3"&&publish=="1"){
  	  td = td + "&nbsp;<a href='/t9/t9/core/funcs/deptnotify/act/T9NotifyHandleAct/changeState.act?seqId="+data.seqId+"&operation=3'>生效</a>"
    }
...
{  
  ...
  {   
      ...
      var url =contextPath+'/t9/core/funcs/deptnotify/act/T9NotifyHandleAct/deleteCheckNotify.act';
...
{  
  ...
  {   
	 // var par = 'pageIndex='+pageIndex+'&showLength=' +showLength+'&delete_str=' +delete_str;
      ...
      var url =contextPath+'/t9/core/funcs/deptnotify/act/T9NotifyHandleAct/cancelTop.act?delete_str='+delete_str;
	  var json = getJsonRs(url);
	  if (json.rtState == "0"){
		  window.location.href = "<%=contextPath%>/core/funcs/deptnotify/manage/notifyQuery.jsp";
		} else{
	      alert(json.rtMsrg);
	    }
  }
...
{  
  ...
  {   
      ...
      var url =contextPath + '/t9/core/funcs/deptnotify/act/T9NotifyHandleAct/changeStateGroup.act';
	  var json = getJsonRs(url,par);
	  if (json.rtState == "0"){
		  window.location.href = "<%=contextPath%>/core/funcs/deptnotify/manage/notifyList.jsp";
		} else{
	      alert(json.rtMsrg);
	    }
  }
...
function back() {
	...
	window.location.href = "/t9/core/funcs/deptnotify/manage/notifyQuery.jsp";
}
...
function delete_all()
{
 ...
 { 
	var url =contextPath+'/t9/core/funcs/deptnotify/act/T9NotifyHandleAct/deleteAllNotify.act';
	var json = getJsonRs(url);
	if (json.rtState == "0"){
...
{
  URL="/t9/core/funcs/deptnotify/manage/showObject.jsp?seqId="+seqId;
...
function my_affair(seqId)
{
  ...
  URL="/t9/core/funcs/deptnotify/manage/note.jsp?seqId="+seqId;
...
{
 URL="/t9/core/funcs/deptnotify/show/readNotify.jsp?isManage=1&seqId="+seqId;
...
{
  URL="/t9/core/funcs/deptnotify/show/showReader.jsp?seqId="+seqId;
  myleft=(screen.availWidth-500)/2;
...
<table class="TableBlock" width="550" align="center">
   ...
   <%}%>   
    ...
    <tr align="center" class="TableControl">
      <td colspan="2" nowrap>
         <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.deptnotify.data.T9DeptNotify"/>
