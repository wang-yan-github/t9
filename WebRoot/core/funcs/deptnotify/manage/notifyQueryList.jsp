...
<%@page import="t9.core.funcs.notify.data.t9.core.funcs.notify.data.T9Notify"%>
  ...
  <tr class="TableHeader">
      ...
      <td nowrap align="center">操作</td>
    	...
    	<%
    	    Collection notifyList = (Collection)request.getAttribute("notifyManagerList");
    	    				...
    	    				{
    	    					T9Notify notify = (T9Notify)it.next();
    	%>
		<tr>
   ...
   <tbody id="dataBody"></tbody>
    ...
    <tr class="TableControl">
      ...
      <a href="javascript:delete_mail($F('pageIndex') , $F('pageLen'));" title="删除所选公告通知"><img src="/core/funcs/deptnotify/images/delete.gif" align="absMiddle">删除所选公告</a>&nbsp;
      <a href="javascript:;" title="批量取消置顶"><img src="/core/funcs/deptnotify/images/user_group.gif" align="absMiddle">取消置顶</a>&nbsp;
      <a href="javascript:delete_all();" title="删除所有自己发布的公告通知"><img src="/core/funcs/deptnotify/images/delete.gif" align="absMiddle">删除全部公告</a>&nbsp;
      </td>
   </tr>
</table>
