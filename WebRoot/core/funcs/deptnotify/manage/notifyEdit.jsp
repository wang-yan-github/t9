...
<%
  ...
  T9Notify notify = (T9Notify)request.getAttribute("notify");
%>

<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">

<%@page import="t9.core.funcs.notify.data.t9.core.funcs.notify.data.T9Notify"%><html>
<head>
...
<script type="text/javascript" src="<%=contextPath%>/core/js/cmp/Calendar1.0.js"></script>
...
function saveNotify(){
	 ...
	 // $("formName").value = formName;
	  ...
	  var url = "/t9/t9/core/funcs/notify/act/T9NotifyHandleAct/addNotify.act";
...
var seqId = "<%=seqId%>";
var content = "<%=notify.getContent()%>";

var oFCKeditor = new FCKeditor('Econtent');
var fckTimer = null; 
function doInit(){
  var FCK = FCKeditorAPI.GetInstance('Econtent'); //获得表单设计器的顶层对象FCK，该方法定义位置fckeditorapi.js第47行 by dq 090521
  alert(FCK.EditingArea);
  if (FCK.EditingArea) {
    if (fckTimer) {
...
function initSwfUpload() {
  ...
  var settings = {
    ...
    upload_url: "<%=contextPath %>/t9/core/funcs/email/act/T9InnerEMailAct/fileLoad.act",
...
<table class="TableBlock" width="95%" align="center">
    <tr>
      <td nowrap class="TableData"><select name="typeId" style="background: white;" title="公告通知类型可在“系统管理”->“系统代码设置”模块设置。">
        <option value="1">选择公告类型</option>
        </select>
       </td>
      <td class="TableData">
         <input type="text" name="subject" size="55" maxlength="200" class="BigInput" value="<%=notify.getSubject() %>">
      </td>
    </tr>    
   <tr>
   ...
   <tr id="rang_user" style="display:none">
      ...
      <td class="TableData">
        ...
        <a href="javascript:;" class="orgAdd" onClick="javascript:selectUser();">添加</a>
   ...
   <tr id="rang_role" style="display:none;">
      ...
      <td class="TableData">
        ...
        <a href="javascript:;" class="orgAdd" onClick="javascript:selectRole();">添加</a>
    ...
    <tr id="url_address" style="display:none">
      ...
      <td class="TableData">
        <input type="text" name="urlAdd" size="55" maxlength="200" class="BigInput" value="<%=notify.getContent()%>">
      </td>
    </tr>
    <tr>
      <td nowrap class="TableData"> 发布时间：</td>
      <td class="TableData">
        <input type="text" name="sendTime" size="20" maxlength="20" class="BigInput" value="<%=notify.getSendTime() %>">
       <img src="/t9/core/styles/style1/img/calendar.gif" align="absMiddle" border="0" style="cursor:pointer" onclick="javascript:;">
   ...
   <td class="TableData" colspan='2'>
    ...
    <script language=JavaScript>    
       oFCKeditor.Config["CustomConfigurationsPath"] = "t9/core/funcs/email/js/fckconfig.js"; 
       ...
       oFCKeditor.Config["PluginsPath"] = "t9/core/funcs/email/editor/plugins/";
   ...
   <td class="TableData" colspan='2' id="contentTd">
      <div>
         <textarea name="content" id="content">1234<%=notify.getContent() %></textarea>
         <!-- 实例化编辑器 -->
    	<script type="text/javascript">
    ...
    <tr align="center" class="TableControl">
      <td colspan="2" nowrap>
        ...
        <input type="hidden" value="<%=notify.getSeqId() %>" class="BigButton" name="<%=notify.getSeqId() %>">
