...
function initSwfUpload() {
    ...
    var settings = {
      ...
      upload_url:  contextPath + "/t9/core/funcs/deptnotify/act/T9NotifyHandleAct/fileLoad.act",
...
<form enctype="multipart/form-data" action="<%=contextPath %>/t9/core/funcs/deptnotify/act/T9NotifyHandleAct/addNotify.act"  method="post" name="notifyForm" id="notifyForm">
<table class="TableBlock" width="95%" align="center">
   ...
   <tr id="attr_tr">
    ...
    <tr id="notifyAuditingSingleTop">
      ...
      &nbsp;&nbsp;<input type="text" name="topDays" id="topDays2" size="3" maxlength="4" class="BigInput" value="0">&nbsp;天后结束置顶，<span id="topdaysremindSpan">0表示一直置顶</span>      </td>
    </tr>
   <tr id="editor">
...
<form id="formFile"
	action="<%=contextPath %>/t9/core/funcs/deptnotify/act/T9NotifyHandleAct/uploadFile.act"
