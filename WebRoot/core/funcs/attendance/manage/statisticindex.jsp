...
function dept(deptId){
  var requestUrl = "<%=contextPath%>/t9/core/funcs/calendar/info/act/T9InfoAct/selectDeptToAttendance.act?deptId="+deptId;
...
function config(userId){
  var URL = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageAttendAct/selectAllConfig.act?userId="+userId;
