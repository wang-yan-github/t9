...
function selectUserIds(userId,deptId){
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageAttendAct/selectUserIds.act?userId="+userId+"&deptId="+deptId;
...
function selectuserIdByDutyType(userIds,dutyType){
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageAttendAct/selectuserIdByDutyType.act?userId="+userIds+"&dutyType="+dutyType;
  var rtJson = getJsonRs(requestURL);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
...
function dutyInfo(userIds,beginTime,endTime,dutyType,days){
  ...
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageAttendAct/allUserDutyInfo.act?userId="+userId+"&dutyType="+dutyType+"&days="+days;
  var rtJson = getJsonRs(requestURL);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
...
function out(userIds,beginTime,endTime){
  var requestUrlOut = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageOutAct/selectOut.act?userId="+userIds+"&beginTime="+beginTime+"&endTime="+endTime;
...
function exprot(expType){
  ...
  window.location.href = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageAttendAct/exportCVS.act?expType="+expType+"&userId="+userIds+"&beginTime="+beginTime+"&endTime="+endTime;;
}
function exprotAttend(){
  ...
  var dutyType = '<%=dutyType%>';
  var days = '<%=days%>';
  window.location.href = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageAttendAct/exprotAttendCVS.act?dutyType="+dutyType+"&userId="+userIds+"&beginTime="+beginTime+"&endTime="+endTime+"&days="+days;
}
</script>
</head>
