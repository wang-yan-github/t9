...
function outOverTime(seqId,userId,allow){
  ...
  if(allow == "2"){
    ...
    //window.location.href = "<%=contextPath%>/t9/custom/attendance/act/T9OvertimeRecordAct/updateStatus.act?seqId=" + seqId + "&allow=" + allow+"&userId="+userId+"&checkOut="+checkOut;
    var url = "<%=contextPath%>/t9/custom/attendance/act/T9OvertimeRecordAct/updateStatus.act?seqId=" + seqId + "&allow=" + allow+"&userId="+userId+"&checkOut="+checkOut;
...
function out_confirm(seqId,userId,allow){
  ...
  if(allow == "2"){
    ...
    window.location.href = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageOutAct/updateStatus.act?seqId=" + seqId + "&allow=" + allow+"&userId="+userId+"&checkOut="+checkOut;
  }
}
...
function dutyConfirm(seqId, userId, allow){
  ...
  if(allow == "2"){
    ...
    var url = "<%=contextPath%>/t9/custom/attendance/act/T9DutyAct/updateDutyStatus.act?seqId=" + seqId + "&allow=" + allow+"&userId="+userId+"&checkDuty="+checkDuty;
    var rtJson = getJsonRs(url);
    if(rtJson.rtState == "0"){
      refash();
    }else{
...
function leave_confirm(seqId,userId,allow){
  ...
  if(allow=="2"){
    ...
    window.location.href = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageLeaveAct/updateStatus.act?seqId=" + seqId + "&allow=" + allow+"&userId="+userId+"&checkLeave="+checkLeave;
  }
}
function leave_destroy_confirm(seqId,userId,status){
  ...
  window.location.href = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageLeaveAct/updateDestroyStatus.act?seqId=" + seqId + "&status=" + status+"&userId="+userId+"&checkLeave="+checkLeave;
}
...
function annual_confirm(seqId,userId,allow){ 
  ...
  window.location.href = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageEvectionAct/updateStatus.act?seqId=" + seqId + "&allow=" + allow+"&userId="+userId+"&checkEvection="+checkEvection; 
  } 
}
...
function evection_confirm(seqId,userId,allow){
  ...
  if(allow=="2"){
    ...
    window.location.href = "<%=contextPath%>/t9/custom/attendance/act/T9AnnualLeaveAct/updateAllow.act?seqId=" + seqId + "&allow=" + allow+"&userId="+userId+"&checkEvection="+checkEvection;
  }
}
...
function doAttendLeader(moblieRemindFlag){
  var requestUrlOut = "<%=contextPath%>/t9/custom/attendance/act/T9AttendManageAct/selectAttendLeader.act";
...
function doOnloadOut(moblieRemindFlag){
  var requestUrlOut = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageOutAct/selectOutManage.act";
  var rtJsonOut = getJsonRs(requestUrlOut);
  if(rtJsonOut.rtState == "1"){
    alert(rtJsonOut.rtMsrg); 
    return ;
...
function doOnloadLeave(moblieRemindFlag){
  var requestUrlLeave = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageLeaveAct/selectLeaveManage.act";
...
function doOnloadEvection(moblieRemindFlag){
  var requestUrlEvection = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageEvectionAct/selectEvectionManage.act";
...
function doFillRegister(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/fillRegister/act/T9AttendApprovalAct/getRegisterApprovalListJson.act?assessingStatus="+assessingStatus;
  var cfgs = {
      dataAction: url,
