...
function configFunc(userId,beginTime,endTime,days){
  var URL = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageAttendAct/selectDutyByUserIdName.act?userId="+userId;
  ...
  if(prcs.length){
    ...
    var URL = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageAttendAct/getUserDutyInfo.act?userId="+userId+"&days="+days;
    var rtJson = getJsonRs(URL);
    if(rtJson.rtState == "1"){
      alert(rtJson.rtMsrg); 
      return ;
...
function attendDuty(userId,date,registerType){
  var URL = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageAttendAct/selectDutyByDay.act?userId="+userId+"&date="+date+"&registerType="+registerType;
  var rtJson = getJsonRs(URL);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
...
function evection(userId,date){
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageAttendAct/isEvection.act?date="+date+"&userId="+userId;
...
function leave(userId,date){
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageAttendAct/isLeave.act?date="+date+"&userId="+userId;
  var rtJson = getJsonRs(requestURL);
  var data = rtJson.rtData;
...
function out(userId,date){
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageAttendAct/isOut.act?date="+date+"&userId="+userId;
  var rtJson = getJsonRs(requestURL);
  var data = rtJson.rtData;
  if(data.out=="1"){//0为请假
...
function selectUserInfo(userId){
  var URL = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageAttendAct/selectUserInfo.act?userId="+userId;
  var rtJson = getJsonRs(URL);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
...
function config(userId){
  var URL = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageAttendAct/selectDutyByUserIdNameTemp.act?userId="+userId+"&days="+days;
  var rtJson = getJsonRs(URL);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
...
//得到外出审批
function out(userId){
  var requestUrlOut = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageOutAct/selectOut.act?userId="+userId+"&beginTime="+beginTime+"&endTime="+endTime;
...
function deleteOut(seqId){
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendOutAct/deleteOutById.act?seqId=" + seqId;
  var rtJson = getJsonRs(requestURL);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
...
function leave(userId){
  var requestUrlLeave = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageLeaveAct/selectLeave.act?userId="+userId+"&beginTime="+beginTime+"&endTime="+endTime;
...
function deleteLeave(seqId){
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendLeaveAct/deleteLeaveById.act?seqId=" + seqId;
  var rtJson = getJsonRs(requestURL);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
...
function evection(userId){
  var requestUrlEvection = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageEvectionAct/selectEvection.act?userId="+userId+"&beginTime="+beginTime+"&endTime="+endTime;
...
function fillRegister(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/fillRegister/act/T9AttendApprovalAct/getRegisterApprovalPassJson.act?assessingStatus="+assessingStatus+"&beginTime="+beginTime+"&endTime="+endTime;;
  var cfgs = {
      dataAction: url,
...
function doSubmit(){
 ...
 return false;
  ...
  var url = contextPath + "/t9/subsys/oa/fillRegister/act/T9AttendApprovalAct/updateStatus.act";
...
function deleteEvection(seqId){
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendEvectionAct/deleteEvectionById.act?seqId=" + seqId;
   var rtJson = getJsonRs(requestURL);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
