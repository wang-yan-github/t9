...
function getDutyType(){       
	   var url = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageQueryAct/getDutyType.act"
...
<td class="TableData">
<input type="text" readOnly name="startDate" id="startDate" size="10" maxlength="10" class="BigInput" value=""/>
...
<td class="TableData">
<input type="text" readOnly name="endDate"  id="endDate" size="10" maxlength="10" class="BigInput" value=""/>
