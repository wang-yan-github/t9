...
function getUserName(userId){
  var url = contextPath + "/t9/subsys/oa/hr/moneyMonth/act/T9HrMoneyMonthAct/getUserName.act";
...
function proposerFunc(cellData, recordIndex, columIndex){
  ...
  var url = contextPath + "/t9/subsys/oa/fillRegister/act/T9AttendApprovalAct/getUserName.act";
...
function deleteSingle(seqId){
  ...
  var url = contextPath + "/t9/subsys/oa/fillRegister/act/T9AttendApprovalAct/deleteSingle.act";
...
function deleteAll() {
  ...
  var url = contextPath + "/t9/subsys/oa/fillRegister/act/T9AttendApprovalAct/deleteAll.act";
