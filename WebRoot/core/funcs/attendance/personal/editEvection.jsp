...
function doOnload(){
  ...
  var requestUrlEvection = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendEvectionAct/selectEvectionById.act?seqId=" + seqId;
...
<form action="<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendEvectionAct/updateEvection.act"  method="post" name="form1" onsubmit="return CheckForm();">
  <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.attendance.personal.data.T9AttendEvection"/>
