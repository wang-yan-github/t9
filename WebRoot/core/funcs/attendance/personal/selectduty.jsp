...
function Init(){
    var requestURLDuty = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/selectdutyByDate.act"; 
    ...
    var requestURLConfig = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/selectConfigById.act"; 
