...
function getAttendDuty(){
  ...
  var url = contextPath + "/t9/core/funcs/attendance/personal/act/T9AttendEvectionAct/showMonth.act";
...
<br>
<form action="<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendEvectionAct/addEvection.act"  method="post" name="form1" onsubmit="return CheckForm();">
