<%@ page language="java" contentType="text/html; charset=UTF-8" import="java.util.*,java.text.SimpleDateFormat,t9.core.funcs.calendar.data.*" pageEncoding="UTF-8"%>
<%@ include file="/core/inc/header.jsp" %>
<%@ page import="java.text.*" %>
<%
  String bindUserOther = T9SysProps.getString("BIND_USERS_OTHERS");
...
function doInit(){
  ...
  //var url = "<%=contextPath%>/t9/core/funcs/address/act/T9AddressAct/getManageGroup.act";
  var flag = 0;
  var str = "";
...
function getMoneyMonthStatus(){
  var url = contextPath + "/t9/subsys/oa/hr/moneyMonth/act/T9HrMoneyMonthAct/getMoneyMonthStatus.act";
...
function leaveConvert(){
  ...
  var url = contextPath + "/t9/subsys/oa/hr/moneyMonth/act/T9HrMoneyMonthAct/addMoneyMonthLeave.act";
...
function overtimeMoney(){
  ...
  var url = contextPath + "/t9/subsys/oa/hr/moneyMonth/act/T9HrMoneyMonthAct/addMoneyMonth.act";
...
function getOverTimeHour(){
  var url = contextPath + "/t9/subsys/oa/hr/moneyMonth/act/T9HrMoneyMonthAct/exitsMoneyMonth.act";
  var rtJson = getJsonRs(url, "year="+year+"&month="+month);
  if(rtJson.rtState == "0"){
    var data = rtJson.rtData;
    return data;
...
function getOverTimeMoney(){
  var url = contextPath + "/t9/core/funcs/attendance/personal/act/T9AttendLeaveAct/getOverTimeHour.act";
  var rtJson = getJsonRs(url, "year="+year+"&month="+month);
  if(rtJson.rtState == "0"){
    var data = rtJson.rtData;
...
function getOverTime(){
  var url = contextPath + "/t9/custom/attendance/act/T9OvertimeRecordAct/getOverTimeHour.act";
  var rtJson = getJsonRs(url, "year="+year+"&month="+month);
  if(rtJson.rtState == "0"){
    var data = rtJson.rtData;
...
function getDuty(){
  var url = contextPath + "/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/getAttendDutyCount.act";
  var rtJson = getJsonRs(url, "year="+year+"&month="+month);
  if(rtJson.rtState == "0"){
    var data = rtJson.rtData;
    return data;
...
function getDutyMoney(){
  var url = contextPath + "/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/getAttendDutyMoney.act";
  var rtJson = getJsonRs(url, "year="+year+"&month="+month);
  if(rtJson.rtState == "0"){
    var data = rtJson.rtData;
    return insertKiloSplit(data, 2);
...
function getAttendOut(){
  var url = contextPath + "/t9/core/funcs/attendance/personal/act/T9AttendOutAct/getAttendOutCount.act";
  var rtJson = getJsonRs(url, "year="+year+"&month="+month);
  if(rtJson.rtState == "0"){
    var data = rtJson.rtData;
    return data;
...
function getAttendLeaveHour(){
  var url = contextPath + "/t9/core/funcs/attendance/personal/act/T9AttendLeaveAct/getAttendLeaveHour.act";
  var rtJson = getJsonRs(url, "year="+year+"&month="+month);
  if(rtJson.rtState == "0"){
    var data = rtJson.rtData;
    return data;
...
function getAttendEvectionHour(){
  var url = contextPath + "/t9/core/funcs/attendance/personal/act/T9AttendEvectionAct/getAttendEvectionHour.act";
  var rtJson = getJsonRs(url, "year="+year+"&month="+month);
  if(rtJson.rtState == "0"){
    var data = rtJson.rtData;
    return data;
...
function getAnnualOverplus(){
  var requestUrl = "<%=contextPath%>/t9/custom/attendance/act/T9AnnualLeaveAct/getAnnualOverplus.act";
...
function support(groupNames, seqId){
  var URL = "/t9/core/funcs/system/address/manage/support.jsp?seqId="+seqId+"&groupName="+encodeURIComponent(groupNames);
