...
function doOnload(){
  ...
  // alert(seqId);
  var requestURLDuty = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/selectDutyById.act?seqId=" + seqId; 
...
function Init(){
  ...
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/updateDutyById.act?seqId=" + seqId; 
...
<br>
 <form action="<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/updateDutyById.act"  method="post" id = "form1" name="form1" onsubmit="">
