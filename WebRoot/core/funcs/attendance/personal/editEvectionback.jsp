...
function Init(){
  if( CheckForm()){
    var requestURL= "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendEvectionAct/updateStatus.act";
...
<form action="<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendEvectionAct/updateEvection.act"  method="post" id="form1" name="form1" onsubmit="return CheckForm();">
