...
function doOnload(){
  var userId = '<%=userId%>';
  var seqId = '<%=seqId%>';
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendOutAct/selectOutById.act?seqId=" + seqId;
  ...
  var requestURLManager = "<%=contextPath%>/t9/core/funcs/system/attendance/act/T9AttendManagerAct/selectManagerPerson.act"; 
...
<br>
<form action="<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendOutAct/updateOut.act"  method="post" name="form1" class="big1" onsubmit="return CheckForm();">
  <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.attendance.personal.data.T9AttendOut"/>
