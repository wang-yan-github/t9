<%@ page language="java" import="t9.core.funcs.person.data.T9Person"
...
<br>
<form
	action="<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendLeaveAct/addLeave.act"
	method="post" id="form1" name="form1" class="big1"
	onsubmit="return CheckForm();"><input type="hidden"
	id="dtoClass" name="dtoClass"
	value="t9.core.funcs.attendance.personal.data.T9AttendLeave" />
