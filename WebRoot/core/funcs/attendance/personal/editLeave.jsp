<%@ page language="java" import=" t9.core.funcs.person.data.T9Person" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
...
function doOnload(){
  ...
  var requestUrlLeave = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendLeaveAct/selectLeaveById.act?seqId=" + seqId;
...
function getAttendDuty(){
  ...
  var url = contextPath + "/t9/core/funcs/attendance/personal/act/T9AttendLeaveAct/showMonth.act";
...
<br>
<form action="<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendLeaveAct/updateLeave.act"  method="post" id="form1" name="form1" class="big1" onsubmit="return CheckForm();">
<input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.attendance.personal.data.T9AttendLeave"/>
