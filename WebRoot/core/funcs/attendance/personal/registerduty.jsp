<%@ page language="java" import="java.util.*, t9.core.funcs.person.data.T9Person,java.text.SimpleDateFormat,t9.core.funcs.attendance.personal.logic.T9AttendDutyLogic" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ include file="/core/inc/header.jsp" %>
<%String flowId = request.getParameter("flowId");
  String dateStr = T9Utility.getCurDateTimeStr();
...
function updateDuty(seqId,registerType){
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/updateRegisterTimeById.act?registerType=" + registerType + "&seqId=" + seqId;
  window.location = requestURL;
}
function doOnload(){
  Time();
  var requestURLName = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/selectDutyByUserIdName.act";
  ...
  if(isNoIp()){
    //判断是否为请假时间段
    var requestURLLeave = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/checkIsLeave.act";
    ...
    //判断是否为 节假日 
      var requestURLHoliday = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/checkHoliday.act";
...
//判断是否受IP访问权限
function visitIp(){
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/getIpRuleByType.act";
...
function isNoIp(){
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/getNoIpUser.act";
  var rtJson = getJsonRs(requestURL);
  var data = rtJson.rtData;
  if(data.isNoIp=="1"){
    return true;
...
function evection(){
  var date = '<%=dateStr%>';
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/manage/act/T9ManageAttendAct/isEvection.act?date="+date;
  var rtJson = getJsonRs(requestURL);
  var data = rtJson.rtData;
...
function showTableInterval(){
  var requestURLInteval = "<%=contextPath%>/t9/core/funcs/system/attendance/act/T9SysParaAct/selectParaInteval.act"; 
...
function showTableDuty(holiday){
  var requestURLConfig = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/selectDutyByUserId.act"; 
  ...
  if(prcsJson.seqId){
    ...
    var requestURLDuty = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/selectDuty.act"; 
...
//  }else{
   ...
   // }
 // }
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/addDuty.act?registerType=" + registerType+"&dutyType=" + dutyType  + "&configId="+seqId ;
  window.location = requestURL;
}
//得到四个时间段

function getDutyInterval(){
  var requestURL = "<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendDutyAct/getDutyInterval.act"; 
  var rtjson = getJsonRs(requestURL); 
  //alert(rsText);
  if(rtjson.rtState == '1'){ 
    alert(rtjson.rtMsrg); 
