...
<br>
<form action="<%=contextPath%>/t9/core/funcs/attendance/personal/act/T9AttendOutAct/addOut.act"  method="post" id = "form1" name="form1" class="big1" onsubmit="return CheckForm();">
