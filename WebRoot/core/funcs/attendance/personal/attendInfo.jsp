...
function loadData(){
  var arrayJso = new Array("个人考勤统计","上下班登记","上下班记录","加班登记","值班登记","外出登记","请假登记","出差登记","年休假登记","个人补登记","手机考勤记录");
...
function clickPriv(field){
  ...
  if(seqId == "10"){
    ...
    parent.location = contextPath + "/core/funcs/attendance/personal/selectAttendMobile.jsp";
  }
...
function delFlowType(){
  if(confirm("确定删除吗？\n这将删除以下数据：\n1,流程描述与步骤设置。\n2,依托于该流程的所有工作。")){
    var url =  contextPath + "/t9/core/funcs/workflow/act/T9FlowTypeAct/delFlowType.act?flowId=<%=flowId%>";
