...
function update1() {
  var url = contextPath + "/t9/core/funcs/person/act/T9PersonAct/add.act";
  getJsonRs(url);
}
</script>
</head>
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  ...
  <b>请指定用于导入的CSV文件：</b>
  <form id="form1" name="form1" method="post" action="<%=contextPath%>/t9/core/funcs/person/act/T9PersonAct/importPersonPwd.act" enctype="multipart/form-data">
