...
<%
  ...
  String userId = request.getParameter("userId") == null ? "" :   T9Utility.encodeSpecial(request.getParameter("userId"));
  String userName = request.getParameter("userName") == null ? "" :   T9Utility.encodeSpecial(request.getParameter("userName"));
  String byname = request.getParameter("byname") == null ? "" :   T9Utility.encodeSpecial(request.getParameter("byname"));
...
function doInit() {
  ...
  var url =  contextPath + "/t9/core/funcs/person/act/T9PersonAct/getSearchPersonList.act?" + param;
...
function subjectRender(userId, seqId, notLogin, password) {
  //alert(cellData);
  //var url = "<%=contextPath%>/t9/core/funcs/person/act/T9PersonAct/getMenuPara.act?deptId="+seqId;
  //var rtJson = getJsonRs(url);
  //if(rtJson.rtState == '0'){
  if(notLogin == "1"){
