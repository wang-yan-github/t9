...
<%
  ...
  String maxSum = String.valueOf(T9RegistProps.getInt(T9AuthKeys.USER_CNT + ".t9"));
  if (maxSum == null) {
    maxSum = "";
  }
%>
...
<div align="center">
   <input type="button" value="继续新建用户" class="BigButtonC" title="继续新建用户" onclick="location='indutypersoninput.jsp?deptId=<%= deptId%>'">&nbsp;&nbsp;
