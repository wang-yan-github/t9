...
function doInit(){
  ...
  if(flag != "1"){
    ...
    showCntrl('listContainer');
    var mrs = "共导入 "+ isCount + " 条数据, 更新" + updateCount + "条数据!" + data;
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  ...
  <b>请指定用于导入的CSV文件：</b>
  <form id="form1" name="form1" method="post" action="<%=contextPath%>/t9/core/funcs/person/act/T9PersonAct/importPerson.act" enctype="multipart/form-data">
...
<table class="MessageBox" align="center" width="500">
  <tr>
    <td class="msg info">
      <div class="content" style="font-size:12pt">导入的用户ID和用户名均不能重复，如果ID为空则系统自动生成，用户名、角色不能为空</div>
    </td>
  </tr>
</table>
</div>
