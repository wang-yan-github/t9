...
function doInit(){
  var urls = "<%=contextPath%>/t9/core/funcs/person/act/T9PersonAct/getPostPriv.act";
  ...
  if(rtJsons.rtState == '0'){
    if(rtJsons.rtData == "1"){
      ...
      var url = "<%=contextPath%>/t9/core/funcs/person/act/T9PersonAct/getPostPrivOther.act";
