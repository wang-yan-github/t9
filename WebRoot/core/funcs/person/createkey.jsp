...
function READ_KEYSN(){
  ...
  try{
   ...
   alert("USB用户KEY初始化失败!");
   location = "<%=contextPath%>/t9/core/funcs/person/act/T9PersonAct/addUsbKeyLog.act";
   location="<%=contextPath%>/core/funcs/person/usernew.jsp?deptId="+deptId;
 }
}
function GET_USERKEY(){
  READ_KEYSN();
  var urls = "<%=contextPath%>/t9/core/funcs/person/act/T9PersonAct/updateUserKey.act";
...
function getUserInfo(){
  var urls = "<%=contextPath%>/t9/core/funcs/person/act/T9PersonAct/getUserInformation.act";
