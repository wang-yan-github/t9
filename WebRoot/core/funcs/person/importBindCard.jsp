...
function downCSVTemplet(){
  var downUrl = "<%=contextPath%>/t9/core/funcs/person/act/T9SecureCardAct";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  ...
  <form id="form1" name="form1" method="post" action="<%=contextPath%>/t9/core/funcs/person/act/T9SecureCardAct/impSecureCardInfoToCsv.act" enctype="multipart/form-data">
