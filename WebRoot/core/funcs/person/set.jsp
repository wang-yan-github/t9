...
function doInit(){
  theme();
  deptFunc();
  var url =  contextPath + "/t9/core/funcs/person/act/T9PersonAct/getSetLogList.act";
  var cfgs = {
    dataAction: url,
  ...
  var paraNameStr = "";
  var paraValueStr = "";
  var url = "<%=contextPath%>/t9/core/funcs/person/act/T9PersonAct/getPasswordLength.act";
...
function getUserName(cellData, recordIndex, columIndex) {
  ...
  var url = "<%=contextPath%>/t9/core/funcs/person/act/T9PersonAct/getUserName.act?userId="+cellData;
  var rtJson = getJsonRs(url);
  if(rtJson.rtState == '0'){
...
function commit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/person/act/T9PersonAct/addSet.act?flag="+flag;
 ...
 */
function noPassUser(){
  var url = "<%=contextPath%>/t9/core/funcs/person/act/T9PersonAct/getNoPassUser.act";
  var rtJson = getJsonRs(url);
  if(rtJson.rtState == '0'){
...
function deptFunc(){
  var url = "<%=contextPath%>/t9/core/funcs/system/sealmanage/act/T9SealAct/selectDeptToAttendance.act";
  var rtJson = getJsonRs(url);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
