...
<%@ page import="java.util.*,t9.core.funcs.sms.data.*, t9.core.funcs.sms.logic.T9SmsLogic" %>
...
function loadDataAction(obj){
  ...
  window.location.href = "<%=contextPath %>/t9/core/funcs/sms/act/T9SmsAct/acceptedSms.act?pageNo=" + pageNo + "&pageSize=" + pageSize ;
}
</script> 
</head>
  ...
  <tr class="TableHeader">
   ...
   <%
     ...
     for(int i = 0; i < contentList.size(); i++) {
       T9Sms sms = contentList.get(i);
       T9SmsBody smsContentWant = sms.getSmsBodyList().get(0);
   %>
