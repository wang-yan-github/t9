...
function toPromptStr(obj){
  ...
  if(obj.remindUrl){
    ...
    remindUrl = contextPath + "/t9/core/funcs/sms/act/T9SmsTestAct/acceptedSms.act?pageNo=0&pageSize=20";
  }
...
function getSmsTypeDesc(smsType){
  var url = contextPath + "/t9/core/funcs/sms/act/T9SmsAct/getSmsTypeDesc.act?";
...
function markRead(seqId){
  var url = contextPath + "/t9/core/funcs/sms/act/T9SmsAct/resetFlag.act";
...
function readAll(){
  ...
  var url = contextPath + "/t9/core/funcs/sms/act/T9SmsAct/resetFlagAll.act";
