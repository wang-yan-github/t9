...
function doSearch(form){
  ...
  if(userType == 1){//1代表收件箱查询，2代表发件箱查询
    url = "<%=contextPath %>/t9/core/funcs/sms/act/T9SmsTestAct/acceptedSms.act?pageNo=0&pageSize=100&queryType=1&";
  }else {
    url = "<%=contextPath %>/t9/core/funcs/sms/act/T9SmsTestAct/sentSmsList.act?pageNo=0&pageSize=100&queryType=1&";
  }
  location = url + param;
}
function doExport(form){
  ...
  var  url = contextPath + "/t9/core/funcs/sms/act/T9SmsTestAct/exportExcel.act?";
  location = url + param;
}
