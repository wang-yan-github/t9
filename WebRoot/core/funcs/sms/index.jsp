...
<frameset onload="" rows="40,*"  cols="*" frameborder="no" border="0" framespacing="0" id="frame1">
  ...
  <frameset rows="*"  cols="210,*" frameborder="0" border="0" framespacing="0"> 
    ...
    <frame name="contentFrame" id="contentFrame" src="<%=contextPath %>/t9/core/funcs/sms/act/T9SmsTestAct/notConfirm.act?pageNo=0&pageSize=20" frameborder="NO" scrolling="auto"> 
  </frameset>
</frameset>
</html>