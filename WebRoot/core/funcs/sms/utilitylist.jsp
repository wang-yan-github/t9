 ...
 <%--  $(index).update("");
  tree = new DTree({bindToContainerId:index
	...
	tree.open("organizationNodeId"); --%>
	 ...
	 person.location =   "<%=contextPath %>/t9/core/funcs/sms/act/T9SmsTestAct/sentSmsList.act?pageNo=0&pageSize=20";
...
function getSend(){
  var person = window.parent.contentFrame;
  person.location = "<%=contextPath %>/t9/core/funcs/sms/act/T9SmsTestAct/acceptedSms.act?pageNo=0&pageSize=20";
}

function getNoConfirm(){
	  var person = window.parent.contentFrame;
	  person.location = "<%=contextPath %>/t9/core/funcs/sms/act/T9SmsTestAct/notConfirm.act?pageNo=0&pageSize=20";
	}
