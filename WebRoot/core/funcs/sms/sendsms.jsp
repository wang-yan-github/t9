    ...
    if (isTouchDevice) {
      $('content').value = $("contentTextarea").value;
	   ...
	   if (checkWords($('content').value)) {
		...
		var url = "<%=contextPath%>/t9/core/funcs/sms/act/T9SmsAct/addSmsBody.act?smsType="+<%=smsType%>;
...
<form id="smsBodyInfoForm" name="smsBodyInfoForm" method="post">
  <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.sms.data.T9SmsBody"/>
