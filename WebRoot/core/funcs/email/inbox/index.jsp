...
function bindBoxName(){
  if(boxId == "0"){
    ...
    var url = contextPath + "/t9/core/funcs/email/act/T9EmailBoxAct/getBoxName.act?boxId="+boxId;
    var rtJson = getJsonRs(url);
    if(rtJson.rtState == "0"){
...
<table id="optBar" cellspacing="0" cellpadding="0" border="0" class="controlbar">
  <tr>
    ...
    <td class="controlbar-center">
      <a href="javascript:void(0)" id="allEmail" class="new_dropdown" onclick="allEmailBtn(event)">全部邮件</a>
      ...
      <a href="javascript:exportEml();" title="单独导出"><img src="<%=imgPath%>/cmp/email/inbox/eml.gif" align="absMiddle">&nbsp;导出eml</a>
		   ...
		   <a href="javascript:void(0)" id="more" class="new_dropdown" onclick="moreBtn(event)">更多</a>
    </td>
