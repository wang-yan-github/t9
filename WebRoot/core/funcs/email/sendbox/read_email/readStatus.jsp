...
function deleteMailByMailId(bodyId){
  ...
  if(window.confirm(msg)) {
    var url = contextPath + "/t9/core/funcs/email/act/T9InnerEMailAct/deleteMailByMailId.act?mailId="+ delete_str + "&bodyId="+ bodyId;
...
<%
  List<T9Email> statusList = (List<T9Email>)request.getAttribute("statusList");
