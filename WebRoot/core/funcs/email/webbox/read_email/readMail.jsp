...
function doInit(){
  ...
  var url = "<%=contextPath %>/t9/core/funcs/email/act/T9InnerEMailAct/webmailDeatil.act?seqId=" + seqId + "&boxId=0";
...
function checkIsDel(mailId){
  var url = contextPath + "/t9/core/funcs/email/act/T9InnerEMailAct/checkIsDel.act?mailId=" + mailId + "&type=1";
  var rtJson = getJsonRs(url);
  if(rtJson.rtState == "0"){
...
function hasLagerAttachment(seqId){
  var url = contextPath + "/t9/core/funcs/email/act/T9WebmailAct/hasLagerAttachment.act?bodyId=" + seqId ;
  var rtJson = getJsonRs(url);
  if(rtJson.rtState == "0"){
    if(rtJson.rtData == "1"){
      return true;
...
function refreshAttachment(seqId){
  var url = contextPath + "/t9/core/funcs/email/act/T9WebmailAct/refreshLagerAttachment.act?bodyId=" + seqId ;
