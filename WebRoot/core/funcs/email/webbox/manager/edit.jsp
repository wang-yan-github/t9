...
function doSubmit(){
  ...
  var url = contextPath + "/t9/core/funcs/email/act/T9WebmailAct/updateWebmailInfo.act";
...
function loadWebMailInfo(seqId){
  var url = contextPath + "/t9/core/funcs/email/act/T9WebmailAct/loadWebmailInfo.act";
