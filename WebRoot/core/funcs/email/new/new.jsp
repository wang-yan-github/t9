...
function doInit() {
  ...
  var url =  contextPath + "/t9/core/funcs/email/act/T9InnerEMailAct/listNewBox.act?" + param;
  var cfgs = {
    dataAction: url,
...
function delete_mail() {
  ...
  if(window.confirm(msg)) {
    var url = "<%=contextPath %>/t9/core/funcs/email/act/T9InnerEMailAct/deletM.act?bodyId="+ delete_str + "&deType=1&PAGE_START=&BOX_ID=&FIELD=&ASC_DESC=";
    var rtJson = getJsonRs(url);
    if(rtJson.rtState == "0"){
      location = "<%=contextPath%>/t9/core/funcs/email/act/T9InnerEMailAct/listInBox.act?boxId=0";
    } else{
      location = "<%=contextPath%>/t9/core/funcs/email/act/T9InnerEMailAct/listInBox.act?boxId=0";
      alert(rtJson.rtMsrg);
    }
