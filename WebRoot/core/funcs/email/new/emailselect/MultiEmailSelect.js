...
var requestUrl2 = contextPath + "/t9/core/funcs/address/act/T9EmailSelectAct";
function getAccord(){
  var data = {
  panel:'left',
...
function clickPriv(id , name , bookName){
  ...
  var seqId = id;
  var userId = name;
  var url = contextPath + "/t9/core/funcs/email/act/T9EmailSelectAct/getMobileSelect.act";
...
function clickNameIndex(id, name ,bookName){
  $('right').update("");
  var seqId = id;
  var url = contextPath + "/t9/core/funcs/email/act/T9EmailSelectAct/getPublicMobileSelect.act";
