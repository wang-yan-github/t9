<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    String IsWebmailOnly = T9SysProps.getProp("IsWebmailOnly");
...
<link rel=stylesheet href="/t9/core/js/cmp/ueditor/ueditor/themes/default/css/ueditor.css" type="text/css"/> 
<script type="text/javascript" src="/t9/core/js/cmp/ueditor/ueditor/ueditor.config.js"></script>
<script type="text/javascript" src="/t9/core/js/cmp/ueditor/ueditor/ueditor.all.js"></script>
...
String maxUploadFileSizeEmail =  T9SysProps.getProp("maxUploadFileSize");
%>
<script>
  isFull();
  ...
  function doInit(){
    ...
    var json = null;
    if (emailId){
        url = "<%=contextPath %>/t9/core/funcs/email/act/T9InnerEMailAct/mailDeatil.act?seqId=" + emailId + "&boxId=" + boxId;
    }else if(seqId){
        url = "<%=contextPath %>/t9/core/funcs/email/act/T9InnerEMailAct/mailDeatil.act?seqId=" + seqId + "&boxId=" + boxId;
    }else {
      if(toId.trim()){
...
var webmailOnly = <%=webmailOnly %>;
  ...
  var isNosave = 1;
   ...
   function FCKeditor_OnComplete( editorInstance ) {
     if (!seqId && !emailId) {
       var url = contextPath + "/t9/core/funcs/email/act/T9EmailNameAct/getName2.act";
