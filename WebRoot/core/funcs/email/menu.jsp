...
function doInit(){
	  //initFolder("folders");
	  var url = contextPath + "/t9/core/funcs/email/act/T9InnerEMailAct/getCount.act";
	  var rtJson = getJsonRs(url);
	  if(rtJson.rtState == "0"){
...
function getIn(){
  var url = contextPath + "/t9/core/funcs/email/act/T9InnerEMailAct/getCountIn.act";
  var rtJson = getJsonRs(url);
  if(rtJson.rtState == "0"){
    var counts = rtJson.rtData;
    bindJson2Cntrl(counts);
...
function getSent(){
	  var url = contextPath + "/t9/core/funcs/email/act/T9InnerEMailAct/getCountSent.act";
	  var rtJson = getJsonRs(url);
	  if(rtJson.rtState == "0"){
	    var counts = rtJson.rtData;
	    bindJson2Cntrl(counts);
...
function getNew(){
    var url = contextPath + "/t9/core/funcs/email/act/T9InnerEMailAct/getCountNew.act";
    var rtJson = getJsonRs(url);
    if(rtJson.rtState == "0"){
      var counts = rtJson.rtData;
      if(counts.inNew){
...
function getDel(){
    var url = contextPath + "/t9/core/funcs/email/act/T9InnerEMailAct/getCountDel.act";
    var rtJson = getJsonRs(url);
    if(rtJson.rtState == "0"){
      var counts = rtJson.rtData;
      bindJson2Cntrl(counts);
...
function getOut(){
    var url = contextPath + "/t9/core/funcs/email/act/T9InnerEMailAct/getCountOut.act";
    var rtJson = getJsonRs(url);
    if(rtJson.rtState == "0"){
      var counts = rtJson.rtData;
      bindJson2Cntrl(counts);
