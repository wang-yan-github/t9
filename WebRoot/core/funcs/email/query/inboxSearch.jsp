<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ page import="t9.core.funcs.email.data.*" %>
...
<%
  ...
  String attachmentName = request.getParameter("attachmentName") == null ? "" : T9Utility.encodeSpecial(request.getParameter("attachmentName")) ;
  String subject = request.getParameter("subject") == null ? "" : T9Utility.encodeSpecial(request.getParameter("subject")) ;
  String key1 = request.getParameter("key1") == null ? "" :    T9Utility.encodeSpecial(request.getParameter("key1")) ;
  String key2 = request.getParameter("key2") == null ? "" :    T9Utility.encodeSpecial(request.getParameter("key2")) ;
  String key3 = request.getParameter("key3") == null ? "" :   T9Utility.encodeSpecial(request.getParameter("key3"));
...
function doInit() {
 ...
 //param = encodeURI(param);
  var url =  contextPath + "/t9/core/funcs/email/act/T9InnerEMailAct/listInBox.act?" + param;
  var cfgs = {
    dataAction: url,
...
function initSelectBox(){
  var url = contextPath + "/t9/core/funcs/email/act/T9EmailBoxAct/getSelfForLi.act";
