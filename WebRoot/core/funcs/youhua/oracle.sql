...
create index TO_ID_INDEX on message (TO_ID);
create index REMIND_FLAG_INDEX on message (REMIND_FLAG);
create index DELETE_FLAG_INDEX on message (DELETE_FLAG);
create index BODY_SEQ_ID_INDEX on message (BODY_SEQ_ID);
create index REMIND_TIME_INDEX on message (REMIND_TIME);

create index SEND_TIME_INDEX on message_body (SEND_TIME);
create index FROM_ID_INDEX on message_body (FROM_ID);
