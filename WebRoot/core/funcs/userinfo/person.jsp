...
//获取用户信息      
function doInit(){    
  var url = "<%=contextPath%>/t9/core/funcs/userinfo/act/T9UserInfoAct/getUserDetailAct.act";
...
function openWindow(id,index){
	  if(index==1){ //sms
	  window.open("/t9/core/funcs/sms/smsback.jsp?fromId="+id,"",'height=400,width=700,status=1,toolbar=no,menubar=no,location=no,scrollbars=yes,left=800,top=270,resizable=yes');
	  }
	  else if(index==2){//email
	  window.open("/t9/core/funcs/email/new/index.jsp?toId="+id,"",'height=500,width=900,status=1,toolbar=no,menubar=no,location=no,scrollbars=yes,left=800,top=270,resizable=yes');
	  }
	}
