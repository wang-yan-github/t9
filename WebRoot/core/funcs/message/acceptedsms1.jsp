...
<%@ page import="t9.core.funcs.sms.data.T9SmsContent" %>
...
<%
  ...
  ArrayList<T9SmsContent> contentList = (ArrayList<T9SmsContent>)request.getAttribute("contentList");
  out.println(contentList);
  T9SmsContent smsContent = new T9SmsContent();
  ...
  ArrayList<T9SmsContent> smsContentList = new ArrayList<T9SmsContent>();
...
<script type="text/javascript">
  ...
  function doInit() {
    var url = "<%=contextPath%>/t9/core/funcs/sms/act/T9SmsAct/getTotalSmsNum.act";
  ...
  function deleteAllCheckBoxs() {
    ...
    var url = "<%=contextPath %>/t9/core/funcs/sms/act/T9SmsAct/deleteAllSms.act";
  ...
  function firstPage(){
    window.location.href = "<%=contextPath %>/t9/core/funcs/sms/act/T9SmsAct/acceptedSms.act?pageNo=" + firstPageNo;
  }
  
  function previousPage(){
    window.location.href = "<%=contextPath %>/t9/core/funcs/sms/act/T9SmsAct/acceptedSms.act?pageNo=" + previousPageNo;
  }

  function nextPage(){
    window.location.href = "<%=contextPath %>/t9/core/funcs/sms/act/T9SmsAct/acceptedSms.act?pageNo=" + nextPageNo;
  }

  function lastPage(){
    window.location.href = "<%=contextPath %>/t9/core/funcs/sms/act/T9SmsAct/acceptedSms.act?pageNo=" + lastPageNo;
  }
</script>
</head>
...
<table cellscpacing="1" cellpadding="3" width="100%">
  <tr>
    <td class="Big">
      <img src="/t9/raw/ljf/imgs/msg_fwd.gif"></img><span class="big3"> 已接收的短信息</span>
    </td>
    <td>共有<span style="color:red" id="code"></span>条短消息</td>
    <td>
      <a href="javascript:firstPage();"><img src="/t9/raw/ljf/imgs/firstpage.gif"></img>首页</a>&nbsp;&nbsp;
      <a href="javascript:previousPage();"><img src="/t9/raw/ljf/imgs/previouspage.gif"></img>上页</a>&nbsp;&nbsp;
      <a href="javascript:nextPage();"><img src="/t9/raw/ljf/imgs/nextpage.gif"></img>下页</a>&nbsp;&nbsp;
      <a href="javascript:lastPage();"><img src="/t9/raw/ljf/imgs/lastpage.gif"></img>尾页</a>
    </td>
  </tr>
</table>
  ...
  <tr class="TableHeader">
   ...
   <%
     for(int i = 0; i < smsContentList.size(); i++) {
       T9SmsContent smsContentWant = smsContentList.get(i);
   %>
