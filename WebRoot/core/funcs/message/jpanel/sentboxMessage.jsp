...
function resendSms(seqId,formId) {
  var seqID = null;
  var url = "<%=contextPath %>/t9/core/funcs/message/act/T9MessageAct/bodySeqIdTest.act";
...
function deleteAllCheckBoxs() {
  ...
  var url = "<%=contextPath %>/t9/core/funcs/message/act/T9MessageAct/delMessages.act";
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/message/act/T9MessageAct/messageSentbox.act?pageNo=" + pageNo  + "&pageSize=" + pageSize;
