...
function getToIdByBodyId(smsBodyId){
  var toId = "";
  var url = contextPath + "/t9/core/funcs/message/act/T9MessageAct/getMessageToId.act";
...
function toPromptStr(obj){
  ...
  if(obj.remindUrl){
    ...
    //remindUrl = contextPath + "/t9/core/funcs/message/act/T9SmsTestAct/acceptedSms.act?pageNo=0&pageSize=20";
  }
...
function toPanelInBoxStr(obj){
  ...
  if(obj.remindUrl){
    ...
    remindUrl = contextPath + "/t9/core/funcs/message/act/T9MessageTestAct/acceptedMessage.act?pageNo=0&pageSize=20";
  }
  if(obj.remindTime){
...
function toPanelSentBoxStr(obj){
  ...
  if(obj.remindUrl){
    ...
    //remindUrl = contextPath + "/t9/core/funcs/message/act/T9MessageAct/acceptedMessage.act?pageNo=0&pageSize=20";
  }
...
function getSmsTypeDesc(smsType){
  var url = contextPath + "/t9/core/funcs/message/act/T9MessageAct/getMessageTypeDesc.act?";
...
function redHistory(cntrlId,contentId,fromId,date,type,seqId){
  ...
  if($(cntrlId).style.display){
    ...
    var url = contextPath + "/t9/core/funcs/sms/act/T9SmsAct/getHistory.act?type="+type;
...
function markRead(seqId){
  var url = contextPath + "/t9/core/funcs/message/act/T9MessageAct/resetFlag.act";
...
function delShortCut(shortCutType,delType,msrg){
  ...
  var url = contextPath + "/t9/core/funcs/sms/act/T9SmsAct/delSmsByShortcut.act";
...
function readAll(){
  ...
  var url = contextPath + "/t9/core/funcs/message/act/T9MessageAct/resetFlagAll.act";
...
function getPersonInfo(userId){
  var url = contextPath + "/t9/core/funcs/sms/act/T9SmsAct/getPersonInfo.act?userId=" + userId;
  var rtJson = getJsonRs(url);
  if(rtJson.rtState == "0"){
    return rtJson.rtData;
  }else{
...
function bindStauts(smsBodyId){
	  var obj;
	  var html = "";
	  var url = contextPath+"/t9/core/funcs/message/act/T9MessageAct/getStauts.act";
	  var rtJson = getJsonRs(url, "bodyId=" + smsBodyId);
	  if (rtJson.rtState == "0") {
	    obj = rtJson.rtData;
	  }
