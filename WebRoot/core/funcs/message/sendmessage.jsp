...
<script type="text/javascript">
  ...
  function doInit() {
    ...
    if (!isTouchDevice) {
	    ...
	    if(seqId) {
	      var url = contextPath + "/t9/core/funcs/message/act/T9MessageAct/getMessageBodyContent.act";
  ...
  function commitSms() {
     ...
     */
	    ...
	    if (censorStr1 == "BANNED") {
	      ...
	      var censorUrl = contextPath + "/t9/core/funcs/sms/act/T9SmsAct/censor.act?smsType=0";
	   ...
	   if (checkWords($('content').value)) {
		...
		var url = "<%=contextPath%>/t9/core/funcs/message/act/T9MessageAct/addMessageBody.act?messageType="+<%=smsType%>;
  ...
  function SelectUser(TO_ID, TO_NAME){
    var URL = "/t9/core/funcs/dept/userselect.jsp?TO_ID=" + TO_ID + "&TO_NAME=" + TO_NAME;
...
<form id="smsBodyInfoForm" name="smsBodyInfoForm" method="post" >
  <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.message.data.T9MessageBody"/>
