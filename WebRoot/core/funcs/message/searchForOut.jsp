...
function deleteSms(seqId) {
  ...
  var url = "<%=contextPath %>/t9/core/funcs/message/act/T9MessageAct/deleteMessage.act";
...
function resetSms(smsBodyId,content,smsType,remindUrl){
  ...
  var url = "<%=contextPath%>/t9/core/funcs/message/act/T9MessageAct/addMessageBody.act";
...
function showMsg(seqId){
  var url = "<%=contextPath%>/t9/core/funcs/sms/act/T9SmsAct/getDialogDetail1.act?seqId="+seqId;
...
function loadDataAction(obj){
  ...
  window.location.href = "<%=contextPath %>/t9/core/funcs/sms/act/T9SmsTestAct/sentSmsList.act?pageNo=" + pageNo + "&pageSize=" + pageSize + "&queryType=1";
}
function showStatus(smsBodyId){
  var url = "<%=contextPath%>/t9/core/funcs/message/act/T9MessageAct/getStatusByBodyId.act?bodyId="+smsBodyId;
