...
function getNoConfirm(){
	  var person = window.parent.contentFrame;
	  person.location = "<%=contextPath%>/t9/core/funcs/message/act/T9MessageTestAct/notConfirm.act?pageNo=0&pageSize=20";
	}
...
function getChildOrEdit(id){
  ...
  if(id.indexOf('r') != -1){
	  ...
	  var url="<%=contextPath%>/t9/core/funcs/message/act/T9MessageAct/queryMessageList1.act?toId="+ id+"&pageNo=0&pageSize=100&queryType=1";
