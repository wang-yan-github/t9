...
function detailAll(detailSum){
  top.dispParts('<%=contextPath %>/t9/core/funcs/sms/act/T9SmsTestAct/acceptedSms.act?pageNo=0&pageSize=20');
  top.hideShortMsrg();
}
/**
 * 回复
...
function doInit(){
 // var d1 = new Date();
  var url = "<%=contextPath%>/t9/core/funcs/sms/act/T9SmsAct/remindFlag.act";
