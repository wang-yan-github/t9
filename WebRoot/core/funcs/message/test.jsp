...
<%@ page import="t9.core.funcs.message.data.T9Message" %>
...
<%
  ...
  ArrayList<T9Message> contentList = (ArrayList<T9Message>)request.getAttribute("contentList");
  ...
  <tr class="TableHeader">
   ...
   <%
     ...
     for(int i = 0; i < contentList.size(); i++) {
       ...
       boolean isDel = false;
       T9Message smsContentWant = contentList.get(i);
