...
function sendNote(){
  if(CheckForm()){
    var requestUrl = "<%=contextPath%>/t9/core/funcs/calendar/act/T9CalendarAct/sendNote.act";
...
function doOnload(){
  MyLoad();
  var seqId = '<%=seqId%>';
  var requestUrl = "<%=contextPath%>/t9/core/funcs/calendar/act/T9CalendarAct/selectCalendarById.act?seqId="+seqId;
