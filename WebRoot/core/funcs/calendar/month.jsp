...
function set_work(){
  ...
  if(status=='1'){
    if(overStatus=='0'){
      overStatus='1';
      var URL = "<%=contextPath%>/t9/core/funcs/calendar/act/T9CalendarAct/updateStatusById.act?seqId="+seqId+"&status="+overStatus+"&ldwm=month";
  ...
  if(status=='3'){
    ...
    if(window.confirm(msg)){
      var URL = "<%=contextPath%>/t9/core/funcs/calendar/act/T9CalendarAct/deleteCalendarById.act?seqId="+seqId+"&ldwm=month";
      var rtJson = getJsonRs(URL);
      if(rtJson.rtState == "1"){
        alert(rtJson.rtMsrg); 
        return ;
...
function doOnload(){
  ...
  var requestUrl = "<%=contextPath%>/t9/core/funcs/calendar/act/T9CalendarAct/selectCalendarByMonth.act?year="+year+"&month="+month+"&status="+status;
...
//周期性事物
  var URl = "<%=contextPath%>/t9/core/funcs/calendar/act/T9AffairAct/selectAffairByMonth.act?year="+year+"&month="+month;
  var rtJson = getJsonRs(URl);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
