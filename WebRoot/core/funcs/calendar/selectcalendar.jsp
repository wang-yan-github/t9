...
<br>
<form action="<%=contextPath%>/t9/core/funcs/calendar/act/T9CalendarAct/selectCalendarByTerm.act"  method="post" name="form1" onsubmit="return checkForm();">
 <table  class="TableBlock" width="450" align="center">
    ...
    <tr>
      <td nowrap class="TableData"> 安排人：</td>
      <td class="TableData">
        <select id="manager" name="manager" class="BigSelect">
          <option value="">所有</option>
          <option value="1">自己给自己安排事务</option>
          <option value="2">别人给我安排的事务</option>
          <option value="3">我给别人安排的事务</option>
        </select>
      </td>
    </tr>
    <tr>
