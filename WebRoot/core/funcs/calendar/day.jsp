...
function set_work(){
  ...
  if(status=='1'){
    if(overStatus=='0'){
      overStatus='1';
      var URL = "<%=contextPath%>/t9/core/funcs/calendar/act/T9CalendarAct/updateStatusById.act?seqId="+seqId+"&status="+overStatus+"&ldwm=day";
...
//function today(){
//  document.location.href = "<%=contextPath%>/t9/core/funcs/calendar";
//}
function doOnload(){
  var status = '<%=status%>';
  var year = '<%=year%>';
  ...
  var requestUrl = "<%=contextPath%>/t9/core/funcs/calendar/act/T9CalendarAct/selectCalendarByDay.act?year="+year+"&month="+month+"&day="+day+"&status="+status;
  ...
  //周期性事物
  var URl = "<%=contextPath%>/t9/core/funcs/calendar/act/T9AffairAct/selectAffairByDay.act?year="+year+"&month="+month+"&day="+day;
