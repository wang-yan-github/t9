...
function doOnload(){
  ...
  var URL = "<%=contextPath%>/t9/core/funcs/calendar/act/T9CalendarAct/selectCalendarById.act?seqId="+seqId+"&ldwm="+ldwm;
...
<form action="<%=contextPath%>/t9/core/funcs/calendar/act/T9CalendarAct/updateCalendar.act"  method="post" id="form1" name="form1" onsubmit="return CheckForm();">
