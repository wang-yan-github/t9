...
function doOnload(){
  var requestURL = "<%=contextPath%>/t9/core/funcs/calendar/act/T9AffairAct/selectAffairByPagin.act";
...
<form action="<%=contextPath%>/t9/core/funcs/calendar/act/T9AffairAct/selectAffairByTerm.act"  method="post" name="form1" onsubmit="return checkForm();">
