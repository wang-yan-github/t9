<%@ page language="java" import="java.util.*,java.sql.Connection,java.text.SimpleDateFormat,t9.core.funcs.calendar.data.*,t9.core.data.T9RequestDbConn,t9.core.global.T9BeanKeys,t9.core.funcs.dept.logic.*" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
...
function calendar(year,month,day,status,userIds,deptId){
  var requestUrl = "<%=contextPath%>/t9/core/funcs/calendar/info/act/T9InfoAct/selectCalendarByDept.act?year="+year+"&month="+month+"&day="+day+"&status="+status+"&userIds="+userIds;
  var rtJson = getJsonRs(requestUrl);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
...
function affair(year,month,day,userIds){
  var URl = "<%=contextPath%>/t9/core/funcs/calendar/info/act/T9InfoAct/selectAffairByDeptDay.act?year="+year+"&month="+month+"&day="+day+"&userIds="+userIds;
...
function task(year,month,day,userIds){
  var URl = "<%=contextPath%>/t9/core/funcs/calendar/info/act/T9InfoAct/selectTaskByDeptDay.act?year="+year+"&month="+month+"&day="+day+"&userIds="+userIds;
  var rtJsons = getJsonRs(URl);
  if(rtJsons.rtState == "1"){
    alert(rtJsons.rtMsrg); 
    return ;
