...
function doOnload(){
  ...
  var URL = "<%=contextPath%>/t9/core/funcs/calendar/act/T9TaskAct/selectTaskById.act?seqId="+seqId;
...
function Init(){
  ...
  if(CheckForm()){
    var URL = "<%=contextPath%>/t9/core/funcs/calendar/act/T9TaskAct/updateTaskByUser.act";
...
<form action="<%=contextPath%>/t9/core/funcs/calendar/act/T9TaskAct/updateTask.act"  method="post" id="form1" name="form1" onsubmit="return CheckForm();">
