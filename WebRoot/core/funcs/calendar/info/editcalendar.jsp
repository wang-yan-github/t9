...
function doOnload(){
  ...
  var URL = "<%=contextPath%>/t9/core/funcs/calendar/act/T9CalendarAct/selectCalendarById.act?seqId="+seqId;
...
function Init(){
  if(CheckForm()){
    var URL = "<%=contextPath%>/t9/core/funcs/calendar/act/T9CalendarAct/updateCalendarByUser.act?ldwm=0";
