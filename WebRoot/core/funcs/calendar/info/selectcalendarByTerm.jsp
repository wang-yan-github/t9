...
function export_excel(){
  if(checkForm()){
    ...
    var URL = "<%=contextPath%>/t9/core/funcs/calendar/info/act/T9InfoAct/selectCalendarByDeptTermOut.act?deptId="+deptId+"&minTime="+minTime+"&maxTime="+maxTime+"&calLevel="+calLevel+"&overStatus="+overStatus+"&content="+ encodeURIComponent(content);
    location.href = URL;
  }
}
function doOnload(){
  //得到部门
  var deptId = '<%=deptId%>';
  var requestUrl = "<%=contextPath%>/t9/core/funcs/calendar/info/act/T9InfoAct/selectDeptByParentId.act?deptId=0";
...
<br>
<form action="<%=contextPath%>/t9/core/funcs/calendar/info/act/T9InfoAct/selectCalendarByDeptTerm.act"  method="post" id="form1"  name="form1" onsubmit="return checkForm();">
