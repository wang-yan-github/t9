...
function Init(){
  if(CheckForm()){
    var requestUrl = "<%=contextPath%>/t9/core/funcs/calendar/info/act/T9InfoAct/addTask.act";
...
<form action="<%=contextPath%>/t9/core/funcs/calendar/act/T9TaskAct/addTask.act" id="form1" method="post" name="form1" onsubmit="return CheckForm();">
  <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.calendar.data.T9Task"/>
