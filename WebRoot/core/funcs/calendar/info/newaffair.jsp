...
var requestUrl = contextPath + "/t9/core/funcs/mobilesms/act/T9MobileSelectAct/isShowSmsRmind.act?type=45"; 
...
function Init(){
  if(CheckForm()){
    var requestUrl = "<%=contextPath%>/t9/core/funcs/calendar/info/act/T9InfoAct/addAffair.act";
...
<br>
<form action="<%=contextPath%>/t9/core/funcs/calendar/act/T9AffairAct/addAffair.act" id="form1" method="post" name="form1" onsubmit="return CheckForm();">
  <input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.calendar.data.T9Affair"/>
