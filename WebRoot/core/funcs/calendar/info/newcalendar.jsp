<%@ page language="java" import="java.util.*,java.text.SimpleDateFormat,t9.core.funcs.calendar.act.*" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
...
function Init(){
  if(CheckForm()){
    var requestUrl = "<%=contextPath%>/t9/core/funcs/calendar/info/act/T9InfoAct/addCalendar.act";
...
function selectUserName(userId){
  var requestURL = "<%=contextPath%>/t9/core/funcs/calendar/info/act/T9InfoAct/selectUserNames.act?userId="+userId; 
...
function selectUserNamesByDept(deptId){
  var requestURL = "<%=contextPath%>/t9/core/funcs/calendar/info/act/T9InfoAct/selectUserNamesByDept.act?deptId="+deptId; 
  var json = getJsonRs(requestURL); 
  if(json.rtState == '1'){ 
    alert(json.rtMsrg); 
    return ; 
...
function getSysRemind(){
  var requestUrl = "<%=contextPath%>/t9/core/funcs/calendar/act/T9CalendarAct/getSysParaRemind.act?type=5";
...
var requestUrl = contextPath + "/t9/core/funcs/mobilesms/act/T9MobileSelectAct/isShowSmsRmind.act?type=5"; 
var rtJson = getJsonRs(requestUrl); 
if(rtJson.rtState == "1"){ 
alert(rtJson.rtMsrg); 
return ; 
...
<form action="<%=contextPath%>/t9/core/funcs/calendar/act/T9CalendarAct/addCalendar.act"  method="post" id="form1" name="form1" onsubmit="return CheckForm();">
<input type="hidden" id="dtoClass" name="dtoClass" value="t9.core.funcs.calendar.data.T9Calendar"/>
