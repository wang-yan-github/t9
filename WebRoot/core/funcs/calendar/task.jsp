...
function deleteTask(){
  ...
  msg='确认要删除所选事务吗？';
  if(window.confirm(msg)){
    window.location = "<%=contextPath%>/t9/core/funcs/calendar/act/T9TaskAct/deleteTask.act?seqIds="+delete_str;
  }
}
function  doOnload(){
  var requestURL = "<%=contextPath%>/t9/core/funcs/calendar/act/T9TaskAct/selectTaskByPage.act";
  var cfgs = {
...
<form action="<%=contextPath%>/t9/core/funcs/calendar/act/T9TaskAct/selectTaskByTerm.act"  method="post" id="form1" name="form1"  >
