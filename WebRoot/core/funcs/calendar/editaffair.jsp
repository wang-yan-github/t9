...
function doOnload(){
  ...
  var URL = "<%=contextPath%>/t9/core/funcs/calendar/act/T9AffairAct/selectAffairById.act?seqId="+seqId;
...
function Init(){
  if(CheckForm()){
    var URL = "<%=contextPath%>/t9/core/funcs/calendar/act/T9AffairAct/updateAffair.act";
...
function Test(){
  var URL = "<%=contextPath%>/t9/core/funcs/calendar/act/T9AffairAct/updateAffairRemindTime.act";
  var rtJson = getJsonRs(URL);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
...
<br>
<form action="<%=contextPath%>/t9/core/funcs/calendar/act/T9AffairAct/updateAffair.act"  method="post" id="form1" name="form1" onsubmit="return CheckForm();">
