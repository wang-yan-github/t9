...
function doInit() {
  ...
  if (sqlId) {
    var url = "<%=contextPath%>/t9/core/codeclass/act/T9CodeClassAct/getCodeItem.act";
...
function goback() {
  window.location.href = "<%=contextPath %>/t9/core/codeclass/act/T9CodeClassAct/listCodeItem.act?classNo=" + document.getElementById("classNo").value ;
}
function returnBack(){
  var codeClassId =  '<%=codeClassId%>';
  window.location.href = "<%=contextPath %>/t9/core/codeclass/act/T9CodeClassAct/listCodeItem.act?seqId="+codeClassId;
}
</script>
</head>
<body onload="doInit()">
