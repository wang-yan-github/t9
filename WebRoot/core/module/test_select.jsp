...
function SelectDept(MODULE_ID, TO_ID, TO_NAME)
{
  ...
  URL="/t9/core/module/dept_select?MODULE_ID=" + MODULE_ID + "&TO_ID=" + TO_ID + "&TO_NAME=" + TO_NAME 
...
{
	MODULE_ID = document.getElementById("test").value;
  URL= "<%=contextPath%>/t9/core/module/priv_select/act/T9PrivSelectAct/getPriv.act?&TO_ID=" + TO_ID 
...
{
  URL = "/t9/core/module/user_select?MODULE_ID=" + MODULE_ID + "&TO_ID=" + TO_ID + "&TO_NAME=" + TO_NAME 
