...
codebase="<%=contextPath%>/core/cntrls/OfficeControl.cab#version=5,0,1,1" width="100%" height="750px">
...
<span id="TANGER_OCX_attachURL" style="display:none"><%=contextPath%>/t9/core/funcs/netdisk/act/T9NetDiskAct/getFileContent.act?name=weblogic安装及配置指南.doc&baseFilePath=core</span>
