...
<%
  ...
  String attachUrl = contextPath + "/t9/core/funcs/office/ntko/act/T9NtkoAct/upload.act?" + param;
%>
...
<script type="text/javascript">
  ...
  var url =    contextPath + "/t9/core/funcs/office/ntko/act/T9NtkoAct/upload.act?" + param1;
  function doInit(){
    if(mediaType == "4"){
...
var url =    contextPath + "/t9/core/funcs/office/ntko/act/T9NtkoAct/upload.act?" + param2;
location =  url;
</script>
<%} %>
</td>
