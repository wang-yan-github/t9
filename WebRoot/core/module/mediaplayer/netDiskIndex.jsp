...
<%
  ...
  String attachUrl = contextPath + "/t9/core/funcs/office/ntko/act/T9NtkoAct/downFileByLocal.act?" + param;
%>
...
var path1 = "<%=path%>";
var video =  "<%=video%>";
var url =  contextPath + "/t9/core/funcs/office/ntko/act/T9NtkoAct/downFileByLocal.act?" + "fileName=" + encodeURIComponent(attachmentName1) + "&path=" + encodeURIComponent(path1) + "&directView=1";
function doInit() {
  if(mediaType == "4"){
...
<script type="text/javascript">
  ...
  var path2 = "<%=path%>";
  var url2 =  contextPath + "/t9/core/funcs/office/ntko/act/T9NtkoAct/downFileByLocal.act?" + "fileName=" + encodeURIComponent(attachmentName2) + "&path=" + encodeURIComponent(path2) + "&directView=1";
  location =  url2;
</script>
<%} %>
</td>
