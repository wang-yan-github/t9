...
function doInit(){
  if(type == "FLOW"){
    ...
    var url = "<%=contextPath%>/t9/core/module/menucode/act/T9MenuCodeAct/getFlowName.act";
    ...
    var url = "<%=contextPath%>/t9/core/module/menucode/act/T9MenuCodeAct/getSortName.act";
    var rtJson = getJsonRs(url, "seqId="+id);
    if (rtJson.rtState == "0") {
    ...
    var url = "<%=contextPath%>/t9/core/module/menucode/act/T9MenuCodeAct/getDiskName.act";
    var rtJson = getJsonRs(url, "seqId="+id);
    if (rtJson.rtState == "0") {
    ...
    var url = "<%=contextPath%>/t9/core/module/menucode/act/T9MenuCodeAct/getPicName.act";
    var rtJson = getJsonRs(url, "seqId="+id);
    if (rtJson.rtState == "0") {
    ...
    var url = "<%=contextPath%>/t9/core/module/menucode/act/T9MenuCodeAct/getConfidentialFile.act";
    var rtJson = getJsonRs(url, "seqId="+id);
    if (rtJson.rtState == "0") {
