...
<%@ page import="java.util.*,t9.core.funcs.dept.data.T9Department" %>
<%
  request.setCharacterEncoding("UTF-8");
  ArrayList<T9Department> deptList = (ArrayList<T9Department>)request.getAttribute("DEPT_LIST");
  if(deptList == null)
  {
  	deptList = new ArrayList<T9Department>();
	}
...
<table class="TableBlock" width="95%" name="userTable" id="userTable">
  ...
  else
  {
	%>
	  ...
	  {
	  	T9Department dept = (T9Department)it.next();
	  %> 
