...
Ext.onReady(function(){
    ...
    items:[{
      ...
      listeners: {
        ...
        'afterrender': function(){
          Ext.Ajax.request({
            url: contextPath + '/t9/core/funcs/setdescktop/setports/act/T9MytableAct/getDesktopPorts.act',
  ...
  function addDesktopPorts(o){
    ...
    if(rtJson.rtState == '0'){
      ...
      var mytablePath = contextPath + '/t9/core/funcs/setdescktop/setports/act/T9MytableAct/viewDesktopPort.act';
  ...
  function savePosition(){
    ...
    var actionPath = contextPath + "/t9/core/funcs/setdescktop/setports/act/T9DesktopDefineAct/setDesktopPortal.act";
