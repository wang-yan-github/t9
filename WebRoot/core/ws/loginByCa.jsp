...
function getUserNameByCa(){
  var url = contextPath + "/t9/subsys/portal/bjca/act/T9BjcaSSOAct/getUserNameByCa.act?userId=<%=userid%>";
...
function loginByCa(){
  ...
  var url = contextPath + "/t9/core/funcs/system/act/T9SystemAct/doLoginIn.act?CA_USER=1&userName=" + encodeURIComponent(userName) ;
  try {
    var json = getJsonRs(url);
    loginComplete(json);
  } catch (e){
