...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/salary/welfare_manager/act/T9HrWelfareManageAct/addWelfareInfo.act"  method="post" name="form1" id="form1" >
