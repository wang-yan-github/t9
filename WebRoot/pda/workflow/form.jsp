...
if("1".equals(opFlag)){
%>
<a class="ButtonA" href="<%=contextPath %>/t9/pda/workflow/act/T9PdaWorkflowAct/turn.act?P=<%=loginPerson.getSeqId() %>&flowId=<%=flowId %>&runId=<%=runId %>&prcsId=<%=prcsId %>&flowPrcs=<%=flowPrcs %>">转交</a>&nbsp;
<%
}
