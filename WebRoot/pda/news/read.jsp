...
<body>
<div id="list_top">
  <div class="list_top_left"><a class="ButtonBack" href="<%=contextPath %>/t9/pda/news/act/T9PdaNewsAct/search.act?P=<%= loginPerson.getSeqId()%>"></a></div>
...
%>
   <a  target="_blank" href="<%=contextPath %>/t9/core/funcs/office/ntko/act/T9NtkoAct/downFile.act?module=news&sessionid=<%=sessionid %>&attachmentId=<%=attachmentIds[i] %>&attachmentName=<%=attachmentNames[i] %>"><%=attachmentNames[i] %></a>&nbsp;&nbsp;&nbsp;&nbsp;
<%
  }
  %></div><%
}
