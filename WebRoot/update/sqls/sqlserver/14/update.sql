alter table flow_process add AUTO_SELECT_ROLE varchar(45);
ALTER TABLE flow_process ADD  DOC_CREATE VARCHAR(45) ;
ALTER TABLE flow_process ADD  DOC_ATTACH_PRIV VARCHAR(45) ;
