...
alter table flow_process add EXTEND1 varchar(45);
alter table PORT add MODULE_NO int;
alter table PORT add MODULE_POS char(1);
alter table PORT add VIEW_TYPE char(1)  default '1';
alter table PORT add MODULE_LINES  int  default 5;
alter table PORT add MODULE_SCROLL  char(1)  default 0;

alter table flow_type add IS_SYSTEM  int  default 0;
alter table hr_staff_info add INSURE_NUM VARCHAR(100);
alter table flow_run_feedback add FLOW_PRCS  int  default 0;
...
INSERT INTO portal_port VALUES ('portal17',0,13,1,'29411F22-ED3B-2AEF-E60A-A89212999647',1);
INSERT INTO portal_port VALUES ('portal18',0,3,1,'EFBCB1F5-60F5-C828-2E7B-F1F62814B1A1',1);
INSERT INTO portal_port VALUES ('portal17',0,10,1,'37BE7CEB-23C2-D87E-8F9D-D16B01FB4B7B',0);
INSERT INTO portal_port VALUES ('portal18',0,4,1,'4E6B3D70-53EB-5A02-7962-5B031672C3F2',0);
