ALTER TABLE flow_process ADD COLUMN EXTEND1 VARCHAR(45) AFTER EXTEND;
alter table PORT add column MODULE_NO int(11);
alter table PORT add column MODULE_POS char(1);
alter table PORT add column VIEW_TYPE char(1) default '1';
alter table PORT add column MODULE_LINES int(10) unsigned default '5';
alter table PORT add column MODULE_SCROLL char(1) default '0';
ALTER TABLE flow_type ADD COLUMN IS_SYSTEM INTEGER UNSIGNED DEFAULT 0 AFTER ALLOW_PRE_SET;
ALTER TABLE hr_staff_info ADD COLUMN INSURE_NUM VARCHAR(100) AFTER RECORD_DATE;

INSERT INTO hr_code (CODE_NO,CODE_NAME,CODE_ORDER,PARENT_NO,CODE_FLAG) VALUES  
 ('HR_WELFARE_ITEM','福利项目','1','','0'),
 ('1','公费旅游','1','HR_WELFARE_ITEM','0'),
 ('2','补充医疗保险','2','HR_WELFARE_ITEM','0');
...
ALTER TABLE flow_run_feedback ADD COLUMN FLOW_PRCS INTEGER UNSIGNED DEFAULT 0 AFTER SIGN_DATA;
...
INSERT INTO `portal_port` VALUES (57,'portal17',0,13,1,'29411F22-ED3B-2AEF-E60A-A89212999647',1),(55,'portal18',0,3,1,'EFBCB1F5-60F5-C828-2E7B-F1F62814B1A1',1),(56,'portal17',0,10,1,'37BE7CEB-23C2-D87E-8F9D-D16B01FB4B7B',0),(59,'portal18',0,4,1,'4E6B3D70-53EB-5A02-7962-5B031672C3F2',0);
