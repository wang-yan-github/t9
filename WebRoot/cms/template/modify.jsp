...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/cms/template/act/T9TemplateAct/getTemplateDetail.act?seqId=<%=seqId%>&stationId=<%=stationId%>";
...
<br>
<form action="<%=contextPath%>/t9/cms/template/act/T9TemplateAct/updateTemplate.act"  method="post" name="form1" id="form1" onsubmit="" enctype="multipart/form-data">
    ...
    <tr align="center" class="TableControl">
      <td colspan=4 nowrap>
        <input type="hidden" name="dtoClass" id="dtoClass" value="t9.cms.template.data.T9CmsTemplate">
