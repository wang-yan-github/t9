...
<%
  String templateName = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("templateName")));
  String templateFileName = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("templateFileName")));
  String templateType = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("templateType")));
%>
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/cms/template/act/T9TemplateAct/queryTemplate.act?" + param;
  var cfgs = {
    dataAction: url,
