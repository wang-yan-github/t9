...
<br>
<form action="<%=contextPath%>/t9/cms/template/act/T9TemplateAct/addTemplate.act" method="post" name="form1" id="form1" enctype="multipart/form-data">
	<table class="TableBlock" width="80%" align="center">
	  <tr>
        ...
        <td class="TableData">
          <input type="text" name="templateFileName" id="templateFileName" class="BigInput" size="15" value="index">
        </td>
	  </tr>
	  <tr>
