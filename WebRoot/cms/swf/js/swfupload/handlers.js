...
function fileQueueError(file, errorCode, message) {
  try {
    ...
    case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
      ...
      break;
    case SWFUpload.QUEUE_ERROR.IMAGE_EXCEEDS_SIZE_LIMIT:
        progress.setStatus("图片文件过大,不能上传");
        this.debug("Error Code: File too big, File name: " + file.name + ", File size: " + file.size + ", Message: " + message);
        break;
    case SWFUpload.QUEUE_ERROR.AUDIO_EXCEEDS_SIZE_LIMIT:
        progress.setStatus("音频文件过大,不能上传");
        this.debug("Error Code: File too big, File name: " + file.name + ", File size: " + file.size + ", Message: " + message);
        break;
    case SWFUpload.QUEUE_ERROR.VIDEO_EXCEEDS_SIZE_LIMIT:
        progress.setStatus("视频文件过大,不能上传");
        this.debug("Error Code: File too big, File name: " + file.name + ", File size: " + file.size + ", Message: " + message);
        break;
    case SWFUpload.QUEUE_ERROR.OTHER_EXCEEDS_SIZE_LIMIT:
        progress.setStatus("其他文件过大,不能上传");
        this.debug("Error Code: File too big, File name: " + file.name + ", File size: " + file.size + ", Message: " + message);
        break;
