...
function doInit(){
 	...
 	//初始化附件
 	 ...
 	 var url = "<%=contextPath%>/t9/cms/area/act/T9AreaAct/getAreaDetail.act?seqId=<%=seqId%>&stationId=<%=stationId%>";
 	  ...
 	  if(rtJson.rtState == "0"){
	    ...
	    myOption.value = data.templateId;
	    myOption.text = data.templateName;
	    $("columnId").value=data.columnIdStr;
	    $("columnDesc").value=data.columnDesc;
	    fckContentStr = data.areaContent;
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td><img src="<%=imgPath %>/notify_new.gif" align="middle"><span class="big3"> 编辑区域</span>&nbsp;&nbsp;
    </td>
  </tr>
</table>
<br>
<form action="<%=contextPath%>/t9/cms/area/act/T9AreaAct/updateArea.act" method="post" name="form1" id="form1" enctype="multipart/form-data">
	...
	<table class="TableBlock" width="80%" align="center">
	  <tr>
        ...
        <td class="TableData">
          <input type="text" name="areaFileName" id="areaFileName" class="BigInput" size="15" ><font color="red">   (需要填写后缀名)</font>
        </td>
	  </tr>
	  	  <tr>
    ...
    <tr align="center" class="TableControl">
      <td colspan=4 nowrap>
       <input type="hidden" name="areaContent" id="areaContent" value="">
        ...
        <input type="button" value="修改" onclick="doSubmit();" class="BigButton">
