...
function doInit(){
  var url = "<%=contextPath%>/t9/cms/column/act/T9ColumnAct/getColumnList.act?seqId="+seqId+"&flag="+flag;
  var cfgs = {
    dataAction: url,
...
function toSort(seqId, recordIndex, flag){
  ...
  var requestURLStr = contextPath + "/t9/cms/column/act/T9ColumnAct/toSort.act?seqId="+seqId+"&toSeqId="+toSeqId+"&flag="+flag;
  var rtJson = getJsonRs(requestURLStr);
  if(rtJson.rtState == "0"){
    location.reload();
  }else{
