...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/cms/column/act/T9ColumnAct/getInfomation.act?stationId="+stationId+"&parentId="+parentId;
...
function doSubmit(){
  if(checkForm()){
    var url = "<%=contextPath%>/t9/cms/column/act/T9ColumnAct/addColumn.act";
...
function checkPath(){
  ...
  var url = "<%=contextPath%>/t9/cms/column/act/T9ColumnAct/checkPath.act?stationId="+$('stationId').value+"&parentId="+$('parentId').value+"&columnPath="+$('columnPath').value;
  var rtJson = getJsonRs(url);
	if(rtJson.rtState == "0"){
	  var prcs = rtJson.rtData;
