...
function doInit(){
  var url = "<%=contextPath%>/t9/cms/station/act/T9StationAct/getTemplate.act?stationId=0";
...
function doSubmit(){
  if(checkForm()){
    var url = "<%=contextPath%>/t9/cms/station/act/T9StationAct/addStation.act";
...
function checkPath(){
  ...
  var url = "<%=contextPath%>/t9/cms/station/act/T9StationAct/checkPath.act?stationPath="+$('stationPath').value;
  var rtJson = getJsonRs(url);
	if(rtJson.rtState == "0"){
	  var prcs = rtJson.rtData;
