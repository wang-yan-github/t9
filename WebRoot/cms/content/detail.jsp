...
function doInit(){
  var url = "<%=contextPath%>/t9/cms/content/act/T9ContentAct/getContentDetail.act?seqId=<%=seqId%>";
  ...
  if(rtJson.rtState == "0"){
    ...
    if(data.attachmentId){
      ...
      attachMenuSelfUtil("attr","cms",$('attachmentName').value ,$('attachmentId').value, '','','<%=seqId%>',selfdefMenu);
    }else{
      $('attr').innerHTML = "无附件";
    }
  }else{
