...
function doInit(){
  tree = new DTree({bindToContainerId:'xtree' 
    ,requestUrl:contextPath + '/t9/cms/permissions/act/T9PermissionsAct/getColumnTree.act?GIFT_PROTYPE=GIFT_PROTYPE&id='
    ,isOnceLoad:false
...
function test(id){
  ...
  setTimeout(function() {
	...
	if(parentId == 0){
		var idArry = id.split(",");
	  	url = contextPath + "/cms/permissions/perContent/setBatchStation.jsp?seqId="+idArry[0];
	}
	else{
	  var idArry = id.split(",");
