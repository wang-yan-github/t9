...
function doSubmit(){
  if(checkForm()){
    var url = "<%=contextPath%>/t9/cms/bbs/board/act/T9BbsBoardAct/addBoard.act";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td><img src="<%=imgPath %>/notify_new.gif" align="middle"><span class="big3"> 新建论坛版块</span>&nbsp;&nbsp;
    </td>
  </tr>
</table>
<br>
  ...
  <table class="TableBlock" width="80%" align="center">
    ...
    <tr>
      ...
      <td class="TableData" style="height:60px;" id="spanImageList">
        <input type="hidden" id="imageUrl" name="imageUrl" value="/t9/cms/bbs/image/common_1_icon.png">
        <span class="spanImage" style="background: url('../image/common_1.png') no-repeat center;border: blue solid 2px;" onclick="spanClick(this,1)"></span>&nbsp;
        <span class="spanImage" style="background: url('../image/common_2.png') no-repeat center;" onclick="spanClick(this,2)"></span>&nbsp;
        <span class="spanImage" style="background: url('../image/common_3.png') no-repeat center;" onclick="spanClick(this,3)"></span>&nbsp;
        <span class="spanImage" style="background: url('../image/common_4.png') no-repeat center;" onclick="spanClick(this,4)"></span>&nbsp;
        <span class="spanImage" style="background: url('../image/common_5.png') no-repeat center;" onclick="spanClick(this,5)"></span>&nbsp;
        <span class="spanImage" style="background: url('../image/common_6.png') no-repeat center;" onclick="spanClick(this,6)"></span>&nbsp;
        <span class="spanImage" style="background: url('../image/common_7.png') no-repeat center;" onclick="spanClick(this,7)"></span>&nbsp;
        <span class="spanImage" style="background: url('../image/common_8.png') no-repeat center;" onclick="spanClick(this,8)"></span>&nbsp;
        <span class="spanImage" style="background: url('../image/common_9.png') no-repeat center;" onclick="spanClick(this,9)"></span>&nbsp;
      </td>
    </tr>
