...
function doInit(){
  var url = "<%=contextPath%>/t9/cms/bbs/board/act/T9BbsBoardAct/getBbsAreaById.act?seqId=<%=seqId%>";
...
function doSubmit(){
	if(checkForm()){
	  ...
	  var url = contextPath + "/t9/cms/bbs/board/act/T9BbsBoardAct/modifyBbsArea.act";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/meeting.gif" width="17" height="17"><span class="big3">修改专区信息</span><br>
    </td>
  </tr>
</table>
<br>
<form id="form1" name="form1" action="<%=contextPath%>/t9/cms/bbs/board/act/T9BbsBoardAct/modifyBbsArea.act" method="post" onsubmit="">
