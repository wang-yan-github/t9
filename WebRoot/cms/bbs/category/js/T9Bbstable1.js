 ...
 $.fn.T9Bbstable1 = function(options) {
		var settings = $.extend({
			speed: 300,
			border: "black"
		}, options || {});
	...
	var shtml = "<tbody id=\"normalthread_"+seqId+"\">"
				...
				+"</td>"
				+"<td class=\"o\">"
				+"<input onclick=\"tmodclick(this)\" type=\"checkbox\" name=\"moderate[]\" value=\""+seqId+"\" />"
				+"</td>"
				+"<th class=\"new\">"
				+titleHtml
				+statHtml
				...
				+"</td>"
				+"<td class=\"num\"><a href=\"javascript:void(0)\" class=\"xi2\">"+docReplayCount+"</a><em>"+docLookCount+"</em></td>"
				+"<td class=\"by\">"
