    ...
    <tr>
      <td width="268px" id="treeTd">
        ...
        <div id="tree_container">
          <iframe id="file_tree" src="left.jsp?seqId=<%=seqId %>&flag=<%=flag %>" name="file_tree" allowTransparency="true" frameborder="0" style="border:none;width:100%;">
          </iframe>
        </div>
      ...
      <td style="height: 100%">
        <iframe src="<%=contextPath%>/project/proj/fileSort/blank.jsp" id="file_main" name="file_main" allowTransparency="true" frameborder="0" style="border:none;width:100%;height:100%">
        </iframe>
      </td>
    </tr>
  </table>
