...
function doInit(){
  ...
  var cfgs = {
    ...
    colums: [
             ...
             {type:"data", name:"projName",  width: '10%', text:"项目名称" ,align: 'center',render:getProjInfo},
             ...
             {type:"data", name:"taskStatus",  width: '10%', text:"状态" ,align: 'center',render:getStatus},
...
function opts(cellData, recordIndex, columInde){
   ...
   var recover="<a href=\"javascript:updateStatus("+seqId+");\" >恢复执行</a>&nbsp&nbsp";
   return recover;
}
function getProjInfo(cellData, recordIndex, columIndex){
	var projId=this.getCellData(recordIndex,"projId");
	var projName=this.getCellData(recordIndex,"projName");
  var str="<a href=\"javascript:selectProjInfo("+projId+");\" >"+projName+"</a>&nbsp&nbsp";
  return str;
}
...
function updateStatus(seqId){
	if(confirm("确认恢复执行任务？")){
	var url = "<%=contextPath%>/t9/project/task/act/T9TaskAct/updateStatus.act?status=0&seqId="+seqId;
...
function getStatus(cellData, recordIndex, columInde){
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="small"><img src="<%=contextPath %>/core/funcs/system/filefolder/images/edit.gif" WIDTH="22" HEIGHT="20" align="absmiddle">
    	...
    	<input type="hidden" id="range" name="range" value="5">
