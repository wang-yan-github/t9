...
function showOriginalForm()
{
  $.ajax({
    type: 'GET',
    url: contextPath + "/t9/mobile/workflow/act/T9PdaFormAct/originalForm.act",
    cache: false,
...
function turnWorkFlow()
{
   ...
   $.ajax({
      ...
      url: url,
      cache: false,
      data: {'sessionid': p, 'RUN_ID': q_run_id,'FLOW_ID': q_flow_id,'FLOW_TYPE':flow_type,'PRCS_ID': q_prcs_id,'FLOW_PRCS': q_flow_prcs,'TOP_FLAG': TOP_FLAG},
      beforeSend: function(){
         $.ProLoading.show();      
      },
      success: function(data)
...
function saveSignWorkFlow(){
   ...
   $.ajax({
      type: 'GET',
      url: contextPath + '/t9/mobile/workflow/act/T9PdaHandlerAct/signSubmit.act',
      cache: false,
      data: {'sessionid': p, 'RUN_ID': q_run_id,'FLOW_ID': q_flow_id,'PRCS_ID': q_prcs_id,'FLOW_PRCS': q_flow_prcs,'CONTENT':CONTENT},
      beforeSend: function(){
         $.ProLoading.show();       
      },
      success: function(data){
...
function newFlow() {
  $.ajax({
    type : 'GET',
    url : contextPath + '/t9/mobile/workflow/act/T9PdaNewFlowAct/newList.act',
    cache : false,
    data : {
      'sessionid': p,
      'RUN_ID' : q_run_id,
...
function searchFlow()
{
  $.ajax({
      type: 'GET',
      url: contextPath + '/mobile/workflow/searchflow.jsp',
      cache: true,
      data: {'sessionid': p},
      beforeSend: function(){
            $.ProLoading.show();
...
function searchFlowList()
{
  ...
  $.ajax({
        type: 'GET',
        url : contextPath + '/t9/mobile/workflow/act/T9PdaSearchAct/searchList.act',
        cache: true,
        data: {'sessionid': p,'SEARCH_NAME':search_name,'SEARCH_RUN_ID':search_run_id},
        beforeSend: function(){
              $.ProLoading.show();
           },
        success: function(data){
...
function getFlowNewlist(SORT_ID,SORT_NAME,PARENT_SORT)
{
   $.ajax({
      ...
      url : contextPath + '/t9/mobile/workflow/act/T9PdaNewFlowAct/newList.act',
      cache: true,
      data: {'sessionid': p,'SORT_ID': SORT_ID,'SORT_NAME_TMP': SORT_NAME,'PARENT_SORT': PARENT_SORT},
      beforeSend: function(){
            $.ProLoading.show();
         },
      success: function(data){
...
function pullUp_search_list()
{
  ...
  var currIterms = oUl.find("li").size();
    ...
    var search_name = $("input[name='SEARCH_NAME']").val();
    $.get(
       contextPath + '/t9/mobile/workflow/act/T9PdaSearchAct/searchList.act',
