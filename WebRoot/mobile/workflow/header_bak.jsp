...
<head>
	...
	<title></title>
	<script type="text/javascript" src="<%=contextPath %>/mobile/workflow/js/jquery-1.6.4.min.js"></script>
	<script type="text/javascript" src="<%=contextPath %>/mobile/workflow/js/iscroll.js"></script>
	<link rel="stylesheet"  href="<%=contextPath %>/mobile/workflow/style/pda.css?v=2012.08.23"/>
