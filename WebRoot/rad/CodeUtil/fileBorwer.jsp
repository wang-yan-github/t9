...
<body>
  ...
  <div id="containt" align="center">
    <div align="left" style="width: 200px;height: 200px">
      ...
      <select name="table_folder" id="table_folder" size="20" multiple ondblclick="get_file()" style="width: 200px"></select><br>
    </div>
...
function onShowPro() {
  ...
  prWindow.document.getElementById("project").value = path;
  window.close();
}
