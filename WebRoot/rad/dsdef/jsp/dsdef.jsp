...
<link rel="stylesheet" href="<%=cssPath%>/style.css"
	type="text/css" />
<script type="text/javascript" src="/t9/rad/dsdef/js/gridtable.js"></script>
...
<script type="text/javascript" src="/t9/raw/cy/grid/grid.js"></script>
...
<script type="text/javascript">
	...
	var hd =[
		      ...
		      ],
		     {
	   	   			...
	   	   			oprates:[
	                		...
	                		new T9Oprate('oprate3',false,function(){alert("oprate3")})
	          	]
	        	}
	      	 ];
	//var url = "/t9/raw/cy/act/T9GridNomalAct/jsonTest.act?tabNo=99999";
	var url = "/t9/t9/rad/dsdef/act/T9DsDefAct/listDsDef.act?tabNo=99999";
 ...
 function doSbumit() {
	 ...
	 var divieeeeee =  document.getElementById("divieeeeee");
	  ...
	  var rtJson = getJsonRs("http://localhost:8081/t9/t9/rad/dsdef/act/T9DsDefAct/updateDsDef.act", mergeQueryString($("dataList")));
	  //alert(rsText);
	  if (rtJson.rtState == 0) {
	    alert(rtJson.rtMsrg);
	    grid.reShow(url);
...
<body onload="loads()">
 ...
 <form action="/t9/t9/rad/dsdef/act/T9DsDefUpdateAct/testMethod.act" method="post" name="dataList" onSubmit='return check()'> 
