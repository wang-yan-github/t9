...
function showMenu1(event){
  var style = {border:"1px solid red" , backgroundColor:"blue",width:'50px'};
  var menuData1 =[{name:'新增',action:add,icon:imgPath + '/cmp/rightmenu/addStep.gif' , extData:"menu1"}
         ,{name:'<span style="background-color:red">更新</span>',action:update,icon:imgPath + '/cmp/rightmenu/addStep.gif', extData:"menu1"}
         ,{name:'删除',action:del,icon:imgPath + '/cmp/rightmenu/addStep.gif', extData:"menu1"}
         ];
  var menu = new Menu({menuData:menuData1
    ,attachCtrl:true
    ,bindTo:"menu1"} , style);
  //显示
  menu.show(event);
