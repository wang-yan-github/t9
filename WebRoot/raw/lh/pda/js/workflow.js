...
function turnWorkFlow()
{
   ...
   $.ajax({
      ...
      url: 'turn.php',
      cache: false,
      data: {'P': p, 'RUN_ID': q_run_id,'FLOW_ID': q_flow_id,'PRCS_ID': q_prcs_id,'FLOW_PRCS': q_flow_prcs,'TOP_FLAG': TOP_FLAG},
      beforeSend: function(){
         $.ProLoading.show();      
      },
      success: function(data)
...
function goOnWorkFlow(){
   ...
   $.ajax({
      ...
      url: action,
      cache: false,
      data: {'P': p, 'RUN_ID': q_run_id,'FLOW_ID': q_flow_id,'PRCS_ID': q_prcs_id,'FLOW_PRCS': q_flow_prcs, 'PRCS_ID_NEXT': prcs_id_next},
      beforeSend: function(){
         $.ProLoading.show();       
      },
      success: function(data)
...
function searchFlowList()
{
	...
	$.ajax({
	      ...
	      url: 'search_list.php',
	      cache: true,
	      data: {'P': p,'SEARCH_NAME':search_name},
	      beforeSend: function(){
	            $.ProLoading.show();
	         },
	      success: function(data){
