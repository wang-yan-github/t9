   ...
   <div id="page_2" class="pages tcontent" style="display:none;">
      <div id="wrapper_2" class="wrapper tform_wrapper">
         <div id="scroller_2" class="scroller">
      		 <div class="container">
               <div class="tform tformshow">
                  <div class="read_detail read_detail_header"><?=_("我的账户")?></div>
      		      <div class="read_detail">
               ...
               <div class="tform tformshow">
                  <div class="read_detail read_detail_header"><?=_("个人资料")?></div>
      		      <div class="read_detail">
   ...
   setTimeout(function(){
      ...
      function(){
         if($(this).attr("_href") != "")
         {
            var oImg = $("<img />");
            oImg.hide();
            $(this).html(oImg.attr("src",$(this).attr("_href")).fadeIn("1000"));
         }   
      });},1000);
});
...
var login_dev_cookie = {
	...
	clear: function(){
		...
		//document.cookie = 'TD_MOBILE_DEVICE=;path=/;expires='+(new Date).getTime()-10000+';';
