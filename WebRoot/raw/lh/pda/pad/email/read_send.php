<?
   ...
   $query = "SELECT * from EMAIL,EMAIL_BODY where EMAIL_BODY.BODY_ID=EMAIL.BODY_ID and EMAIL_ID='$EMAIL_ID' and FROM_ID='$LOGIN_USER_ID' and SEND_FLAG='1' and DELETE_FLAG!='2' and DELETE_FLAG!='4'";
