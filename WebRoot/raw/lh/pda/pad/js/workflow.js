      ...
      data: {'RUN_ID': q_run_id,'FLOW_ID': q_flow_id,'PRCS_ID': q_prcs_id,'FLOW_PRCS': q_flow_prcs},
		...
		onSuccess: function(data){
            ...
            delete_flow();			
				...
				tiScroll_2.getOIScroll().scroller.innerHTML = data;
	...
	tiScroll_9.getMainData({
		...
		onSuccess: function(data){
			...
			if(data == "NOREADFLOWPRIV"){
				...
				tiScroll_9.getOIScroll().scroller.innerHTML = data;
				tiScroll_9.show();
				pageInit(9);
				return false;
			}
      ...
      data: {'RUN_ID': q_run_id,'FLOW_ID': q_flow_id,'PRCS_ID': q_prcs_id,'FLOW_PRCS': q_flow_prcs,'TOP_FLAG': TOP_FLAG},
		onSuccess: function(data){
         ...
         if(data == "NOEDITPRIV"){
			...
			tiScroll_5.getOIScroll().scroller.innerHTML = data;
			$(".read_detail:last", tiScroll_5.getElement()).addClass("endline");
			tiScroll_5.show();
...
function signWorkFlow(){
	tiScroll_4.getMainData({
      ...
      data: {'RUN_ID': q_run_id,'FLOW_ID': q_flow_id,'PRCS_ID': q_prcs_id,'FLOW_PRCS': q_flow_prcs, 'OP_FLAG': q_op_flag},
		onSuccess: function(data){
			tiScroll_4.getOIScroll().scroller.innerHTML = data;
...
function selWorkFlow() {
	...
	tiScroll_10.getMainData({
		...
		onSuccess: function(data){
			tiScroll_10.getOIScroll().scroller.innerHTML = data;
			tiScroll_10.show();
			return false;
		}	
	});
      ...
      data: {'RUN_ID': q_run_id,'FLOW_ID': q_flow_id,'PRCS_ID': q_prcs_id,'FLOW_PRCS': q_flow_prcs, 'PRCS_ID_NEXT': prcs_id_next},
		onSuccess: function(data){
            ...
            return false;   
				...
				tiScroll_6.getOIScroll().scroller.innerHTML = data;
				tiScroll_6.show();
				pageInit(6);
				return false;
         }
...
function showPageMessage(str){
	...
	tiScroll_7.getOIScroll().scroller.innerHTML = reMakeMessage(str);
	tiScroll_7.show();
/* 
   $("div[id^='page_']").hide();
...
function newFlow() {
	tiScroll_11.getMainData({
		...
		onSuccess: function(data){
			...
			tiScroll_11.getOIScroll().scroller.innerHTML = '<ul class="comm-list comm-pic-list sideBarSubList">'+data+'</ul>';
			tiScroll_11.show();
			g_pre_page = 11;
      ...
      data: {'P': p,'SORT_ID': SORT_ID,'SORT_NAME_TMP': SORT_NAME,'PARENT_SORT': PARENT_SORT},
		onSuccess: function(data){
            ...
            return false;
				...
				tiScroll_12.getOIScroll().scroller.innerHTML = '<ul class="comm-list comm-pic-list sideBarSubList">'+data+'</ul>';
				tiScroll_12.show();
				pageInit(12);
				g_pre_page = 12;
				return false;
