...
<form name="attachmentForm" id="attachmentForm" action="<%=contextPath %>/t9/core/funcs/webinfo/act/T9WebInfoAct/doUploadFile.act" target="returnPage" method="post" style="display:none" enctype="multipart/form-data">
