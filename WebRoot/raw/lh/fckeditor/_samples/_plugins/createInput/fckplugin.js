FCKCommands.RegisterCommand( 'createInput', new FCKDialogCommand( 'createInput', '编辑输入框',  

FCKPlugins.Items['createInput'].Path + 'test.html', 340, 200 ) ) ; 

var oInsertLinkItem = new FCKToolbarButton( 'createInput', '编辑输入框' ) ; 

oInsertLinkItem.IconPath = FCKPlugins.Items['createInput'].Path + 'cake.gif' ; 

FCKToolbarItems.RegisterItem( 'createInput', oInsertLinkItem ) ; 


var FCKcreate = new Object() ; 


FCKcreate.Add = function( inputid,inputname,value) 

{ 
alert("<input type='text' id='"+inputid+"' name='"+inputname+"'/>");
FCK.InsertHtml("<input type='text' value='"+value+"' id='"+inputid+"' name='"+inputname+"'/>") ; 
