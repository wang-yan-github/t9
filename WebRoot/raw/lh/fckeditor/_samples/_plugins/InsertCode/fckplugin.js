FCKCommands.RegisterCommand( 'InsertCode', new FCKDialogCommand( 'createInput', '代码输入框',  

FCKPlugins.Items['InsertCode'].Path + 'test.html', 340, 200 ) ) ; 

var oInsertCodeItem = new FCKToolbarButton( 'InsertCode', '插入代码' ) ; 

oInsertCodeItem.IconPath = FCKPlugins.Items['InsertCode'].Path + 'cake.gif' ; 

FCKToolbarItems.RegisterItem( 'InsertCode', oInsertCodeItem ) ; 


var FCKIn = new Object() ; 


FCKIn.Add = function(code) 

{ 
FCK.InsertHtml("<div style='height: 100px;width: 200px;border: 1px solid #CCC;overflow: scroll;'><pre style='color:blue'>"+code+"</pre></div>") ; 
} 
