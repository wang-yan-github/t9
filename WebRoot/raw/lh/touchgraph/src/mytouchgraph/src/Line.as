  ...
  public class Line extends UIComponent
  {
    ...
    public function Line(sourceNode:Node , objectNode:Node){
     ...
     sprite.graphics.lineStyle(10, 0x000000, 0, false, LineScaleMode.VERTICAL,
      ...
      this.addEventListener(MouseEvent.MOUSE_DOWN , showDetail);
    ...
    private function showDetail(event:MouseEvent):void {
      ...
      var p:* = {x:event.stageX,y:event.stageY};
      var r:RelContainer = new RelContainer(p,sourceNode , objectNode);
      var r2:RelContainer = this.parentApplication.getChildByName("relCon");
      if (r2 != null ) {
        this.parentApplication.removeChild(r2);
      }
      this.parentApplication.addChild(r);
    }
