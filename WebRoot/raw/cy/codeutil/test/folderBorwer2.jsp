...
<body>
  ...
  <div id="containt" align="center">
    <div align="left" style="width: 200px;height: 200px">
      ...
      <select name="table_folder" id="table_folder" size="10" multiple ondblclick="get_file()"style="width: 200px"></select><br>
    </div>
...
function onShowPro() {
  ...
  var value = "";
    try{
      ...
      alert("非Eclipse工程文件(.project文件)");
   }
  prWindow.document.getElementById("project").value = value;
  window.close();
}
