...
<script type="text/javascript" src="../uniform/js/uni-form-validation.jquery.js"></script>
<link rel="stylesheet" type="text/css" href="<%=cssPath%>/style.css"/>
<link rel="stylesheet" type="text/css" href="<%=cssPath%>/ui/jqueryUI/base/jquery.ui.all.css"/>
  <link href="../uniform/css/uni-form.css" media="screen" rel="stylesheet"/>
  <link href="../uniform/css/default.uni-form.css" title="Default Style" media="screen" rel="stylesheet"/>
  <!--[if lte ie 7]>
...
<body>
  ...
  <button onclick="$('form.uniForm').dialog('open')">新建科目</button>
  <script>
    $(function(){
