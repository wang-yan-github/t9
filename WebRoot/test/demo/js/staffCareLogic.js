...
function doEdit(seqId){
	location.href = contextPath + "/test/demo/modify.jsp?seqId=" + seqId;
}
/**
 * 详细信息
 * @param seqId
...
function detail(seqId){
  var URL = contextPath + "/test/demo/detail.jsp?seqId=" + seqId;
...
function deleteSingle(seqId){
	...
	var requestURLStr = contextPath + "/t9/test/demo/act/T9DemoAct";
