...
var rmgr ;
function doInit() {
  var url = "<%=contextPath%>/test/cy/code/act/T9FlowRunAct/show.act"; 
  if(seqId){
...
//  }
  var url = "";
  if(seqId) {
    url = "<%=contextPath%>/test/cy/code/act/T9FlowRunAct/updateField.act";
  }else {
    url = "<%=contextPath%>/test/cy/code/act/T9FlowRunAct/addField.act";
  }
...
<form name="form1" id="form1" method="post">
  ...
  <input type="hidden" id="dtoClass" name="dtoClass" value="test.cy.code.T9FlowRun"/>
