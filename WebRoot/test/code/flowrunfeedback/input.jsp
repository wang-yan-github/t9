...
var rmgr ;
function doInit() {
  var url = "<%=contextPath%>/test/cy/code/act/T9FlowRunFeedbackAct/show.act"; 
  if(seqId){
...
//  }
  var url = "";
  if(seqId) {
    url = "<%=contextPath%>/test/cy/code/act/T9FlowRunFeedbackAct/updateField.act";
  }else {
    url = "<%=contextPath%>/test/cy/code/act/T9FlowRunFeedbackAct/addField.act";
  }
...
<form name="form1" id="form1" method="post">
  ...
  <input type="hidden" id="dtoClass" name="dtoClass" value="test.cy.code.T9FlowRunFeedback"/>
