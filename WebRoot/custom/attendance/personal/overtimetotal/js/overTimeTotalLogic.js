...
function getNormalAdd(year, month){
  ...
  var url = contextPath + "/t9/custom/attendance/act/T9OvertimeRecordAct/getTotalAdd.act";
...
function normal(){
  var beginDate = $("beginDate").value;
  var endDate = $("endDate").value;
  var requestURL = contextPath + "/t9/custom/attendance/act/T9OvertimeRecordAct/getPersonalOverTime.act";
