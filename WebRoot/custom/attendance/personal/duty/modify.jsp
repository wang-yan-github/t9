...
function doOnload(){
  ...
  var seqId = '<%=seqId%>';
  $("seqId").value = seqId;
  var requestURL = "<%=contextPath%>/t9/custom/attendance/act/T9DutyAct/getDuty.act?seqId=" + seqId;
...
function doSubmit(){
  ...
  var url = "<%=contextPath %>/t9/custom/attendance/act/T9DutyAct/updateDuty.act";
