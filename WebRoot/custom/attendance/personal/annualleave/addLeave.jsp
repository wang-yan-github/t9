<%@ page language="java" import="t9.core.funcs.person.data.T9Person,java.text.SimpleDateFormat,t9.core.funcs.calendar.data.*,java.util.*"
...
function getAttendDuty(){
  ...
  var url = contextPath + "/t9/custom/attendance/act/T9AnnualLeaveAct/showMonth.act";
...
<br>
<form
	action="<%=contextPath%>/t9/custom/attendance/act/T9AnnualLeaveAct/addAnnualLeave.act"
	method="post" id="form1" name="form1" class="big1"
	onsubmit="return CheckForm();"><input type="hidden"
	id="dtoClass" name="dtoClass"
	value="t9.custom.attendance.data.T9AnnualLeave" />
