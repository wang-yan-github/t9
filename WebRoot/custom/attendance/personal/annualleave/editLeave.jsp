...
function doOnload(){
  var userId = '<%=userId%>';
  var seqId = '<%=seqId%>';
  var requestUrlLeave = "<%=contextPath%>/t9/custom/attendance/act/T9AnnualLeaveAct/selectAnnualLeaveById.act?seqId=" + seqId;
...
<br>
<form action="<%=contextPath%>/t9/custom/attendance/act/T9AnnualLeaveAct/updateAnnualLeave.act"method="post" id="form1" name="form1" class="big1" onsubmit="return CheckForm();">
<input type="hidden" id="dtoClass" name="dtoClass" value="t9.custom.attendance.data.T9AnnualLeave" />
