...
function deleteLeave(seqId){
  ...
  if(window.confirm(msg)){
    var requestURL =  "<%=contextPath%>/t9/custom/attendance/act/T9AnnualLeaveAct/deleteAnnualLeaveById.act?seqId=" + seqId;
...
function doOnload(){
  ...
  var requestURL = "<%=contextPath%>/t9/custom/attendance/act/T9AnnualLeaveAct/selectAnnualLeave.act";
  var rtJson = getJsonRs(requestURL);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
