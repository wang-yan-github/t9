...
function doOnload(){
  var userId = '<%=userId%>';
  var seqId = '<%=seqId%>';
  var requestURL = "<%=contextPath%>/t9/custom/attendance/act/T9OvertimeRecordAct/selectOvertimeById.act?seqId=" + seqId;
...
function getAttendDuty(){
  ...
  var url = contextPath + "/t9/custom/attendance/act/T9OvertimeRecordAct/getOverTimeInfo.act";
...
<br>
<form action="<%=contextPath%>/t9/custom/attendance/act/T9OvertimeRecordAct/updateOvertime.act"  method="post" id = "form1" name="form1" class="big1" onsubmit="return CheckForm();">
