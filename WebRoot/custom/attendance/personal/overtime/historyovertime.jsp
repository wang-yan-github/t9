...
function deleteOvertime(seqId){
  ...
  if(window.confirm(msg)){
    var requestURL = "<%=contextPath%>/t9/custom/attendance/act/T9OvertimeRecordAct/delOvertimeById.act?seqId=" + seqId;
...
function doOnload(){
  var requestURL = "<%=contextPath%>/t9/custom/attendance/act/T9OvertimeRecordAct/selectHistoryOvertime.act";
  var rtJson = getJsonRs(requestURL);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
