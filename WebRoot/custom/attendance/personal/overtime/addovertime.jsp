...
<br>
<form action="<%=contextPath%>/t9/custom/attendance/act/T9OvertimeRecordAct/addOvertime.act"  method="post" id = "form1" name="form1" class="big1" onsubmit="return CheckForm();">
