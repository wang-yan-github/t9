...
function leave_confirm(seqId,userId,allow){
  ...
  if(allow=="2"){
    ...
    window.location.href = "<%=contextPath%>/t9/custom/attendance/act/T9PersonalLeaveAct/updateAllowReasonOn.act?seqId=" + seqId + "&allow=" + allow+"&userId="+userId+"&checkLeave="+checkLeave;
  }
}
function leave_destroy_confirm(seqId,userId,status){
  ...
  window.location.href = "<%=contextPath%>/t9/custom/attendance/act/T9PersonalLeaveAct/updateDestroyStatus.act?seqId=" + seqId + "&status=" + status+"&userId="+userId+"&checkLeave="+checkLeave;
}
