...
function selectAnnualUserInfo(userId){
  var URL = "<%=contextPath%>/t9/custom/attendance/act/T9PersonAnnualParaAct/selectAnnualLeavePara.act?userId="+userId;
  var rtJson = getJsonRs(URL);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
...
function doInit(){
  if(CheckForm()){
    var URL = "<%=contextPath %>/t9/custom/attendance/act/T9PersonAnnualParaAct/addUpdateAnnualLeavePara.act?userId="+userId;
