function loadNotify1Data(cntrlId,notifyType){
  ...
  var url =  contextPath + "/t9/subsys/portal/guoyan/module/act/T9PortalGridModuleNotify/loadGridData.act";
...
function loadLeaderData(cntrlId,notifyType){
  ...
  var url =  contextPath + "/t9/subsys/portal/guoyan/module/act/T9PortalGridModule/loadGridData.act";
  var rtJson = getJsonRs(url,param);
  var data = rtJson;
...
function loadLeaderActive(cntrlId,ruleName,strLen,showDate){
  ...
  var url =  contextPath + "/t9/subsys/portal/guoyan/module/act/T9PortalGridNormal/loadGridData.act";
  var rtJson = getJsonRs(url,param);
  var data = rtJson;
  var href = contextPath + "/subsys/portal/guoyan/por/modules/leaderact/article.jsp";
...
function getUserIdByName(userName){
  ...
  var url =  contextPath + "/t9/subsys/portal/guoyan/module/act/T9PortalGridModule/getUserIdByName.act";
  var rtJson = getJsonRs(url,param);
  if(rtJson.rtState == '0'){
...
function getDeptIdByName(deptName){
  ...
  var url =  contextPath + "/t9/subsys/portal/guoyan/module/act/T9PortalGridModule/getDeptIdByName.act";
  var rtJson = getJsonRs(url,param);
  if(rtJson.rtState == '0'){
    return rtJson.rtData;
  }else{
...
function getUserNameById(userId){
  ...
  var url =  contextPath + "/t9/subsys/portal/guoyan/module/act/T9PortalGridModule/getUserNameById.act";
  var rtJson = getJsonRs(url,param);
  if(rtJson.rtState == '0'){
    return rtJson.rtData;
  }else{
...
function imageHandler(content){
  var url = contextPath + "/t9/subsys/portal/guoyan/module/act/T9PortalGridModule/downloadImage.act";
