...
var pageMgr;
function doInit(){
  var requestURL = "<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9PostulantAct/getPage.act";
...
function search(){
  ...
  pageMgr.dataAction = "<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9PostulantAct/getPage.act" + para;
  pageMgr.search();
}
