...
var flag = ${param.flag};
function doInit(){
  var requestURL = "<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9PostulantAct/getPage.act?flag=" + flag;
...
function deleteRecord(recordIndex){
  ...
  var seqId = this.getCellData(recordIndex,"seqId");
  var delJson = getJsonRs("<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9PostulantAct/delete.act?seqId=" + seqId);
...
function updateFlag(flag, seqId){
  var delJson = getJsonRs("<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9PostulantAct/updateFlag.act?seqId=" + seqId + "&flag=" + flag);
...
function search(){
  ...
  pageMgr.dataAction = "<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9PostulantAct/getPage.act?flag=" + flag + para;
  pageMgr.search();
}
