...
function submitForm(){
  ...
  var url = "<%=contextPath %>/t9/subsys/infomgr/bilingual/act/T9PostulantAct/modify.act";
...
function doInit(){
  var url = "<%=contextPath %>/t9/subsys/infomgr/bilingual/act/T9PostulantAct/detail.act?seqId=${param.seqId}";
...
function detailInfo(){
  var total = 0;
  var str = "";
  var url = "<%=contextPath %>/t9/subsys/infomgr/bilingual/act/T9PostulantAct/detailInfo.act?seqId=${param.seqId}";
...
<body onload="doInit()">
	<div class="table">
		<form name="form1" id="form1" method="post" action="">
			...
			<input type="hidden" id="recordSource" name="recordSource" value="T9"/>
