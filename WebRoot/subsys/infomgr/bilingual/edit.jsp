...
function doInit(){
  var queryJson = getJsonRs("<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9BilingualAct/queryRecord.act?seqId=${param.seqId}");
...
<body onload="doInit()">
<form method="post" name="form1" id="form1" action="<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9BilingualAct/modifyBilingual.act" enctype="multipart/form-data">
