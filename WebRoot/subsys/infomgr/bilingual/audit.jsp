...
function doInit(){
  ...
  var requestURL = "<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9BilingualAct/getPage.act";
  var cfgs = {
...
function enableRecord(recordIndex){
  var seqId = this.getCellData(recordIndex,"seqId");
  var delJson = getJsonRs("<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9BilingualAct/setEnable.act?seqId=" + seqId + "&enable=1");
...
function disableRecord(recordIndex){
  var seqId = this.getCellData(recordIndex,"seqId");
  var delJson = getJsonRs("<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9BilingualAct/setEnable.act?seqId=" + seqId + "&enable=0");
...
function search(){
  ...
  pageMgr.dataAction = "<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9BilingualAct/searchPage.act" + para;
  pageMgr.refreshAll();
}
