...
var pageMgr;
function doInit(){
  var requestURL = "<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9CorrectionAct/getPage.act";
  var cfgs = {
...
function confirmRecord(recordIndex){
  var seqId = this.getCellData(recordIndex,"seqId");
  var delJson = getJsonRs("<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9CorrectionAct/confirmRecord.act?seqId=" + seqId);
...
function deleteRecord(recordIndex){
  ...
  var seqId = this.getCellData(recordIndex,"seqId");
  var delJson = getJsonRs("<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9CorrectionAct/deleteRecord.act?seqId=" + seqId);
...
function search(){
  para = "?content=" + encodeURI(encodeURI($('content').value)) +
    ...
    "&tel=" + $('tel').value +
    "&type=" + $('type').value +
    "&correctDate=" + encodeURIComponent($('correctDate').value) +
    "&location=" + $('location').value;
  pageMgr.dataAction = "<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9CorrectionAct/searchPage.act" + para;
  pageMgr.search();
}
