...
function doInit(){
  var queryJson = getJsonRs("<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9CorrectionAct/queryRecord.act?seqId=${param.seqId}");
...
<body onload="doInit()">
<form method="post" name="form1" id="form1" action="<%=contextPath%>/t9/subsys/infomgr/bilingual/act/T9CorrectionAct/modifyCorrection.act">
