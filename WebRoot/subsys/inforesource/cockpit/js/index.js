...
function getHotArticle(keyIds,currNo2){
  ...
  $.ajax({
    url:contextPath + "/t9/subsys/inforesouce/act/T9OutURLAct/getArticleListByKeyIDs.act?KeyIDs=" + keyIds +"&nStartPage=" + (currNo2-1) +"&nPageSize=10",
    type:"post",
    timeout:TIME_OUT,
...
function getHotPictrues(){
  $.ajax({
    url: contextPath + "/t9/subsys/inforesouce/act/T9ManageImgAct/findTenImages.act",
    type:"post",
    timeout:TIME_OUT,
    success:function(data){     
     var obj = eval("(" + data + ")");
...
function getHotPerson(flag){
  $.ajax({
    url: contextPath + "/t9/subsys/inforesouce/act/T9OutURLAct/getHotPersonOfMonth.act",
    type:"post",
    timeout:TIME_OUT,
    success:function(data){     
     var obj = eval("(" + data + ")");
...
function getHotOrganization(){
  $.ajax({
    url: contextPath + "/t9/subsys/inforesouce/act/T9OutURLAct/getHotOrganizationOfMonth.act",
    type:"post",
    timeout:TIME_OUT,
    success:function(data){     
     var obj = eval("(" + data + ")");
...
function getHotAddress(){
  $.ajax({
    url: contextPath + "/t9/subsys/inforesouce/act/T9OutURLAct/getHotAddressOfMonth.act",
    type:"post",
    timeout:TIME_OUT,
    success:function(data){     
     var obj = eval("(" + data + ")");
...
function getHotKeyword(){
  $.ajax({
    url: contextPath + "/t9/subsys/inforesouce/act/T9OutURLAct/getHotKeywordOfMonth.act",
    type:"post",
    timeout:TIME_OUT,
    success:function(data){     
     var obj = eval("(" + data + ")");
