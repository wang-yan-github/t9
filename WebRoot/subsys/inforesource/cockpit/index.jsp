...
<%
String attach =  T9SysProps.getString("attachFilePath");
...
<script type="text/JavaScript" >
 var attachFilePath = "<%=attach%>";
   ...
   function createLineChart(keyId) {
     ...
     chart.setJSONUrl(contextPath + "/t9/subsys/inforesouce/act/T9CockpitAct/getLineData.act?keyId=" + keyId);		   
     chart.render("row-a-right");
   }
   function createColumnChart(){
     var chart2 = new FusionCharts("Charts/Column2D.swf", "columnChart", "493", "175", "0", "1");
     chart2.setJSONUrl(contextPath + "/t9/subsys/inforesouce/act/T9CockpitAct/getColumnData.act");	
   ...
   function getColumnChart(type  , keyId , searchText ) {
     ...
     typeConst = type;
     chart2.setJSONUrl(contextPath + "/t9/subsys/inforesouce/act/T9CockpitAct/getColumnData.act?type=" + type);	
     getLineData(keyId , searchText );
   }
   function getLineData(keyId, name) {
     var chart = new FusionCharts("lineChart");
     chart.setJSONUrl(contextPath + "/t9/subsys/inforesouce/act/T9CockpitAct/getLineData.act?keyId=" + keyId + "&type=" + typeConst);		   
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
	  ...
	  <div id="foot">Copyright 2010. <%=fullOrgName %></div>  
  </div>
</body>
</html>
