...
//设计 教育》》科技》》文化 的长度
  ...
  */
  ...
  function tomanage(){ 
    var url = contextPath + "/t9/subsys/inforesouce/act/T9MateShowAct/toManage.act?ftype="+getFtype();
   ...
   * 点击左边的树进行的操作   */
    ...
    */
     ...
     // $("#contents").html("正在加载数据，请稍后......");
      ...
      $(".next-page").empty(); 
      $.ajax({
        url:contextPath + "/t9/subsys/inforesouce/act/T9OutURLAct/getArticleListByKeyIDs.act?KeyIDs=" + keyIds +"&nStartPage=" + (currNo2-1) +"&nPageSize=" + defaultPageSize,
        type:"post", 
...
function findAFileMate(fileId){
  var temp ="";
  $.ajax({
    url:contextPath + "/t9/subsys/inforesouce/act/T9AFileMateAct/getAFileMate.act",
    type:"post",
