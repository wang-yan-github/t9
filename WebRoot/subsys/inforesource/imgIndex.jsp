...
chart2.setXMLUrl(contextPath + "/t9/subsys/inforesouce/act/T9CockpitAct/getColumnData.act");	
chart2.render("flash-con");
*/
var chart = new FusionCharts("cockpit/Charts/Line.swf", "lineChart", "524", "138", "0", "0");
chart.setXMLUrl(contextPath + "/t9/subsys/inforesouce/act/T9CockpitAct/getLineData.act");		   
