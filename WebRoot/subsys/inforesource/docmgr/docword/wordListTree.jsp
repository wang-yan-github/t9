...
function doInit(){
  ...
  var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9WordTreeAct/getTree.act?id=";
...
function test(id){
  ...
  if(parentId != '0'){
    window.parent.wordInput.location = "<%=contextPath%>/subsys/inforesource/docmgr/docword/wordEdit.jsp?treeId=" + id;
  	...
  	var rtJson = getJsonRs(contextPath + "/t9/subsys/inforesouce/docmgr/act/T9SubjectTermAct/getSeqId.act");
  	if(rtJson.rtState=="0"){
