function delDocAction() {
  ...
  var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocAct/delDoc.act";
...
function oldSaveFeedback(seqId) {
  ...
  if (docCreate) {
    ...
    var url =  contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocAct/saveDocCreateTime.act";
    getJsonRs(url , param);
  }
}