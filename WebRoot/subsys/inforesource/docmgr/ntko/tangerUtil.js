...
function getMarkSetting(){
  var URL = contextPath + "/t9/core/funcs/office/ntko/act/T9NtkoAct/getOcMarkSet.act";
...
function lockRef(attachmentId,lockOp){
  var url = contextPath + "/t9/core/funcs/office/ntko/act/T9NtkoAct/lockRef.act?attachmentId=" + attachmentId + "lockOp=" + lockOp ;
  var rtJson = getJsonRs(url);
  if(rtJson.rtState == "0"){
...
function isCanEidt(attachmentId){
  var url = contextPath + "/t9/core/funcs/office/ntko/act/T9NtkoAct/isCanEdit.act?attachmentId=" + attachmentId;
  var rtJson = getJsonRs(url);
  if(rtJson.rtState == "0"){
   return rtJson.rtData;
  }else {
...
function getLogPageMgr(cntrlId,attachId){
  var url =  contextPath + "/t9/core/funcs/office/ntko/act/T9NtkoAct/getOcLog.act?attachId=" + attachId;
  var cfgs = {
    dataAction: url,
    container: cntrlId,
    colums: [
