...
var docPriv = "<%=docPriv %>";
  ...
  function doInit(){
   ...
   delFlag = false;
   var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocAct/getBookmark.act";
...
function getRunData(){
  var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocAct/getRunData.act";
  var json = getJsonRs(url , "runId=" + runId);
  if (json.rtState == "0") {
