...
function doInit() {
  createYears();
  var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocAct/getDocNum.act";
...
function getNum(docYear) {
  var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocAct/getNum.act";
...
function sendNum() {
  ...
  var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocAct/sendNum.act";
