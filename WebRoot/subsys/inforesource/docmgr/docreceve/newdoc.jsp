...
<%@ page  import="t9.subsys.inforesouce.docmgr.data.T9DocConst"%>
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/t9/core/styles/style3/img/notify_new.gif"/><span class="big3">新建收文</span>
    </td>
  </tr>
</table>
<form action="<%=contextPath%>/t9/subsys/inforesouce/docmgr/act/T9DocReceiveAct/addT9DocReceive.act" id="form1" method="post" name="form1" >
