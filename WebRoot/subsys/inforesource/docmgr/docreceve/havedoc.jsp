...
<%@ page  import="java.util.List, t9.subsys.inforesouce.docmgr.data.T9DocReceive,java.net.URLEncoder,t9.subsys.inforesouce.docmgr.data.T9DocConst"%>

<%
 List<T9DocReceive>docs = (List)request.getAttribute("docs");
...
var constName = '<%=T9DocConst.constName%>';
var centerName = '<%=T9DocConst.centerName%>';
  ...
  function sendTo(seqId, id){//userId签收人Id
    ...
    window.location.href = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocReceiveAct/updateDocReceive.act?seqId=" + seqId +"&userId="+ userId;
    return true;
  }

  function alarmTo(seqId, toId, docNo){
    var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocReceiveAct/alarmToRead.act";
  ...
  */
  ...
  function checkAlarm(){
    var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocReceiveAct/beanchAlarm.act";
    $("form1").action = url;
    $("form1").submit();
    return false;
  }
  ...
  function checkConfirm(){
    var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocReceiveAct/beanChConfirm.act";
    $("form1").action = url;
    $("form1").submit();
    return false;
  }
  ...
  function edit(seqId){
    var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocReceiveAct/editDoc.act?seqId="+ seqId;
    window.open(url);
  }

  function cancel(seqId){
    var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocReceiveAct/cancel.act?seqId="+ seqId;
  ...
  */
  function doPrint(name){
   ...
   if(f1 > 0){
     ...
     var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocReceiveAct/print.act?printIds="+ printIds;
  ...
  function siglePrint(seqId){
    var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocReceiveAct/print.act?printIds="+ seqId;
    var myleft = (screen.availWidth-780)/2 ;
    window.open(url,"read_vote","height=600,width=900,status=1,toolbar=no,menubar=no,location=no,scrollbars=yes,top=150,left="+myleft+",resizable=yes");
  }
...
<body class="bodycolor" topmargin="5" onload="doInit();">
 <form action="<%=contextPath %>/t9/subsys/inforesouce/docmgr/act/T9DocReceiveAct/faDocReceive.act" id="form1" name="form1" method="post">
...
<tr>
  <td class="Big"><img src="/t9/core/styles/style3/img/book.gif" width="22" height="18"><span class="big3"> 
   <%
