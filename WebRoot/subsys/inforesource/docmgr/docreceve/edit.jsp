...
<%@ page  import="t9.subsys.inforesouce.docmgr.data.T9DocConst,t9.subsys.inforesouce.docmgr.data.T9DocReceive,t9.core.util.T9Utility"%>
    
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html>
<%

  T9DocReceive doc = (T9DocReceive)request.getAttribute("doc");
  String docType ="";
  String docNo = "";
  String fromUnits = "";
  String confLevel ="";
  ...
  if(doc != null ){
     ...
     docNo = T9Utility.encodeSpecial(doc.getDocNo());
     fromUnits = T9Utility.encodeSpecial(doc.getFromUnits());
     confLevel = doc.getConfLevel()+"";
     title = T9Utility.encodeSpecial(doc.getTitle());
     copies = doc.getCopies()+"";
     deptId = doc.getSponsor();
     uName = T9Utility.encodeSpecial(doc.getFromUserName());
     uId = doc.getUserId()+"";
     ...
     if(doc.getAttachNames() == null || doc.getAttachNames() == "" || "null".equalsIgnoreCase(doc.getAttachNames())){
       ...
       attName = T9Utility.encodeSpecial(doc.getAttachNames());
     }
     oppDocNo = T9Utility.encodeSpecial(doc.getOppDocNo());
     id = doc.getSeq_id()+"";
     seqId = doc.getSeq_id()+"";
  }
%>
...
var secrtGrade = "<%=T9DocConst.SECRET_GRADE%>";
var docType = "<%=T9DocConst.DOC_TYPE%>";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/t9/core/styles/style3/img/notify_new.gif"/><span class="big3">修改收文</span>
    </td>
  </tr>
</table>
<form action="<%=contextPath%>/t9/subsys/inforesouce/docmgr/act/T9DocReceiveAct/update.act" id="form1" method="post" name="form1" >
...
<form id="formFile" action="<%=contextPath %>/t9/subsys/inforesouce/docmgr/act/T9DocReceiveAct/uploadFile.act" method="post" enctype="multipart/form-data" target="commintFrame">
