...
<%@ page  import="java.util.List, t9.subsys.inforesouce.docmgr.data.T9DocReceive, t9.subsys.inforesouce.docmgr.data.T9DocConst"%>
...
var centerName = '<%=T9DocConst.centerName%>';
  ...
  function read(seqId){
    window.location.href = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocReceiveAct/updateReadDocReceive.act?seqId=" + seqId;
    return true;
  }

  function cost_balance(seqId){
    var url = contextPath + "/t9/subsys/inforesouce/docmgr/act/T9DocReceiveAct/findDocFileAjax.act?seqId="+seqId;
