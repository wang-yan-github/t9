...
<head>
<%
	List<T9MateType> typeList = (List<T9MateType>)request.getAttribute("types");//获取所有的
  T9MateShow show = (T9MateShow)request.getAttribute("idStr");//获取已定义好的元素
  String subs = "";
  String pIds = "";  
  if(show != null){
...
<form id="save" name="save" action="<%=contextPath%>/t9/subsys/inforesouce/act/T9MateShowAct/saveAjax.act?ftype=<%=ftype%>" method="post">
