 ...
 */
	function ajax(){
	  $.ajax({
			url:contextPath + "/t9/subsys/inforesouce/act/T9OutURLAct/firstLevelTag.act",
		  type:"post",			
  ...
  */
  ...
  function keyword(keyId,keyword){
    ...
    if(leng == 6){
     ...
     $.ajax({
     url:contextPath + "/t9/subsys/inforesouce/act/T9OutURLAct/Keyword.act?keyID=" + keyId,    
     type:"post",
     success:function(data){
       var temp = eval("("+data+")");
       //alert(temp);
  ...
  */
   ...
   */
		function getTagsByTagIds(tagIds){			
		  $.ajax({
				url:contextPath + "/t9/subsys/inforesouce/act/T9OutURLAct/Keyword.act?keyID=" + tagIds ,
			  type:"post",			  
				success:function(data){
		    var temp = eval("("+data+")");		
		     insertData(temp);
	...
	*/
	function findZhaiYao(fileId){
	  $.ajax({
			url:contextPath + "/t9/subsys/inforesouce/act/T9FileMetaSaveAct/findAbstract.act?fileId=" + fileId ,
		  type:"post",			  
			success:function(data){
			$("#txt-b").empty();
	    var temp = eval("("+data+")");
  ...
  <div id="preview-con">
    ...
    <div id="and-c1"><img src="images/p-c01.gif" /></div>   
      ...
      <div id="font14"><a type="button" style="color:#990099;cursor:pointer" onclick="showTouchGrap(url ,'clickFunTest','cClickFunTest','dbClickFunTest','cDbClickFunTest')">友好交往</a></div>
       <div id="font9"><a type="button" style="color:Navy;cursor:pointer" onclick="showTouchGrap(url ,'clickFunTest','cClickFunTest','dbClickFunTest','cDbClickFunTest')">外国专家</a></div>
