...
<script type="text/javascript" src="<%=contextPath %>/core/js/smartclient.js"></script>
 ...
 T9MateType type = (T9MateType)request.getAttribute("type");
...
function findNOs(){
  ...
  if(!isNumber(nos)){
    ...
    if(parseInt(nos) <= 0){
      ...
      //用ajax判断编号是否存在
      var url = contextPath + "/t9/subsys/inforesouce/act/T9MateElementAct/isExitNos.act";
...
<form name="form1" id="form1" method="get" action="<%=contextPath%>/t9/subsys/inforesouce/act/T9MateTypeAct/updateMate.act">
