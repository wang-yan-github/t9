...
var MateId,MateName;
function doInit(){
  var url = contextPath + "/t9/subsys/inforesouce/act/T9MateTreePlugAct/findMates.act?id=";    
...
function getDefMate() {
  url = contextPath + "/t9/subsys/inforesouce/act/T9MateTreePlugAct/findDefMate.act";  
...
function treeNodeClick(id){
  var url = contextPath + "/t9/subsys/inforesouce/act/T9MateTreePlugAct/getMateIndent.act";     
