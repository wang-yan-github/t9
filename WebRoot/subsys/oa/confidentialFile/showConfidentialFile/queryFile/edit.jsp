...
//var requestURL="<%=contextPath%>/t9/core/funcs/filefolder/act/T9FileContentAct";
var requestURL = "<%=contextPath%>/t9/subsys/oa/confidentialFile/act/T9ConfidentialContentAct";
function sendForm(){
...
function getFilePath(seqId){
	var returnFilePath="";
	var requestURLStr = contextPath + "/t9/subsys/oa/confidentialFile/act/T9ShowConfidentialSortAct";
...
function newAttach(){
	...
	if(checkForm()){
		...
		location.href = "<%=contextPath%>/t9/subsys/oa/confidentialFile/act/T9ConfidentialContentAct/newAttrachFile.act?" + pars + "&seqId=<%=seqId%>&contentId=<%=contentId%>";
	}
}
...
function moblieSmsRemind(remidDiv){ 
	var moblieSmsUrl = contextPath + "/t9/core/funcs/mobilesms/act/T9MobileSelectAct/isShowSmsRmind.act?type=31"; 
...
function getSysRemind(remidDiv,remind){ 
  var requestUrl = contextPath + "/t9/core/funcs/calendar/act/T9CalendarAct/getSysParaRemind.act?type=31"; 
...
<div>
 <form id="formFile" action="<%=contextPath%>/t9/subsys/oa/confidentialFile/act/T9ConfidentialContentAct/newFileSingleUpload.act?seqId=<%=seqId%>&contentId=<%=contentId %>" method="post" enctype="multipart/form-data">
