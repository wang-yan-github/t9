...
function newAttach(){
  var oEditor = FCKeditorAPI.GetInstance('fileFolder') ;
	...
	if(checkForm()){
		...
		location.href = "<%=contextPath%>/t9/subsys/oa/confidentialFile/act/T9ConfidentialContentAct/createFile.act?" + pars + "&seqId=<%=seqId%>&contentId=<%=contentId%>";
...
<input type="hidden" value="t9.core.funcs.filefolder.data.T9FileContent"
	name="dtoClass">
...
<div>
<form id="formFile"	action="<%=contextPath%>/t9/subsys/oa/confidentialFile/act/T9ConfidentialContentAct/newFileSingleUpload.act?seqId=<%=seqId%>&contentId=<%=contentId%>"
