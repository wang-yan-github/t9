...
function doInit(){	
  ...
  ,requestUrl:contextPath + '/t9/subsys/oa/confidentialFile/act/T9SetConfidentialSortAct/getTree.act?seqId=<%=seqId%>&id='
  ,isOnceLoad:false
...
function test(id){  
	...
	if(id){
		 var ownerPriv = "0";
		 if(id){
		   //判断此节点有没有所有者权限		   var requestURL="<%=contextPath%>/t9/subsys/oa/confidentialFile/act/T9ShowConfidentialSortAct/getPrivteById.act?seqId="+id;
