...
function doInit(){
	...
	showManage("<%=seqId%>");
  var url = "<%=contextPath%>/t9/subsys/oa/confidentialFile/act/T9ConfidentialContentAct/getContentFileListJson.act?seqId=<%=seqId%>";
  var cfgs = {
      dataAction: url,
...
<br>
<form name="form1" id="form1" action="<%=contextPath%>/t9/subsys/oa/confidentialFile/act/T9ConfidentialContentAct/uploadBatchFile.act?seqId=<%=seqId %>" method="post" enctype="multipart/form-data" >
