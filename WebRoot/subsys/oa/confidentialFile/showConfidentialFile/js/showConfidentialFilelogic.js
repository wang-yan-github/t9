...
function deleteArrang() {
  ...
  var requestURLStr = contextPath + "/t9/subsys/oa/confidentialFile/act/T9ConfidentialContentAct";
...
function deleteSort(seqId){
	...
	if(window.confirm(msg)){
		var requestURLStr = contextPath + "/t9/subsys/oa/confidentialFile/act/T9SetConfidentialSortAct";
