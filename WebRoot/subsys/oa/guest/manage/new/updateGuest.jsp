...
function doInit() {
  if (checkForm()) {
    ...
    var requestURL = "<%=contextPath%>/t9/subsys/oa/guest/act/T9GuestAct/addUpdateGuest.act"; 
...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  ...
  var url= "<%=contextPath%>/t9/subsys/oa/guest/act/T9GuestAct/deleleFile.act?attachId=" + attachId +"&attachName=" + encodeURIComponent(attachName) + "&seqId=" + attrchIndex;
...
function getGuestById(seqId){
  var requestURL = "<%=contextPath%>/t9/subsys/oa/guest/act/T9GuestAct/getGuestById.act?seqId=" + seqId; 
...
function getQuestType(){
  var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/act/T9ProjectAct/getCodeItem.act?classNo=GUEST_TYPE"; 
  var json=getJsonRs(requestURL); 
  if(json.rtState == '1'){ 
    alert(json.rtMsrg); 
    return ; 
...
<form  action="#"  method="post" id="form1" name="form1">
    <input type="hidden" name="dtoClass" value="t9.subsys.oa.guest.data.T9Guest">
...
“系统管理”->“系统代码设置”模块设置
 ...
 <form id="formFile" action="<%=contextPath%>/t9/subsys/oa/guest/act/T9GuestAct/uploadFile.act" method="post" enctype="multipart/form-data" target="commintFrame">
