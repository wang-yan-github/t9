...
function abroadUserIdFunc(cellData, recordIndex, columIndex){
  ...
  var url = contextPath + "/t9/subsys/oa/abroad/act/T9HrAbroadRecordAct/getUserName.act";
...
function getAttendDuty(){
  ...
  var url = contextPath + "/t9/subsys/oa/abroad/act/T9HrAbroadRecordAct/showMonth.act";
