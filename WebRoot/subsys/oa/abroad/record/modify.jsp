...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/abroad/act/T9HrAbroadRecordAct/getRecordInfoDetail.act?seqId=${param.seqId}";
...
function doSubmit(){
  ...
  var url = "<%=contextPath %>/t9/subsys/oa/abroad/act/T9HrAbroadRecordAct/updateRecord.act";
...
<table class="TableBlock" width="55%" align="center">
    ...
    <td class="TableData">
      ...
      <img id="date1" align="middle" src="/t9/core/styles/style1/img/calendar.gif" align="middle" border="0" style="cursor:pointer" >
    </td>
</tr>
 <tr>
    ...
    <td class="TableData">
      ...
      <img id="date2" align="middle" src="/t9/core/styles/style1/img/calendar.gif" align="middle" border="0" style="cursor:pointer" >
    </td>
