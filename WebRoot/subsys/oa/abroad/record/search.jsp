...
<%
  String abroadUserId = request.getParameter("abroadUserId")== null ? "" :   T9Utility.encodeSpecial(request.getParameter("abroadUserId"));
  String abroadName = request.getParameter("abroadName")== null ? "" :   T9Utility.encodeSpecial(request.getParameter("abroadName"));
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/abroad/act/T9HrAbroadRecordAct/queryAbroadRecordListJson.act?" + param;
  var cfgs = {
      dataAction: url,
