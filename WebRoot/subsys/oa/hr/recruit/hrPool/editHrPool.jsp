...
function getHrPoolInfo(){
	...
	if(rtJson.rtState == "0"){
		...
		if(data.photoName){
			...
			var filePathStr = "<%=T9SysProps.getAttachPath().replace('\\','/') + "/" + T9HrRecruitPoolAct.headPicFolder%>" ;
...
function deletePhoto(seqId){
	...
	if(window.confirm(msg)){
		var requestURLStr = contextPath+ "/t9/subsys/oa/hr/recruit/hrPool/act/T9HrRecruitPoolAct";
...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
	var requestURL = "<%=contextPath%>/t9/subsys/oa/hr/recruit/hrPool/act/T9HrRecruitPoolAct";
...
<form enctype="multipart/form-data" action="<%=contextPath %>/t9/subsys/oa/hr/recruit/hrPool/act/T9HrRecruitPoolAct/updateHrPoolInfo.act?seqId=<%=seqId %>" method="post" name="form1" id="form1" >
