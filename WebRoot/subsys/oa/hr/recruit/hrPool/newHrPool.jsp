...
<form enctype="multipart/form-data" action="<%=contextPath %>/t9/subsys/oa/hr/recruit/hrPool/act/T9HrRecruitPoolAct/addHrPoolInfo.act" method="post" name="form1" id="form1" >
