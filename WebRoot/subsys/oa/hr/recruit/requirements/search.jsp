...
<%
  String requNo = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("requNo")));
  String requJob= T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("requJob")));
  String requNum= T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("requNum")));
  String requDeptId= T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("requDeptId")));
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/recruit/requirements/act/T9HrRecruitRequirementsAct/queryRecruitRequirementsListJson.act?" + param;
  var cfgs = {
    dataAction: url,
...
function deptFunc(cellData, recordIndex, columIndex){
  var url = contextPath + "/t9/subsys/oa/hr/recruit/requirements/act/T9HrRecruitRequirementsAct/getDeptName.act";
