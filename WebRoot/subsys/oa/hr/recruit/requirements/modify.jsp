...
function doInit(){
	...
	var url = "<%=contextPath%>/t9/subsys/oa/hr/recruit/requirements/act/T9HrRecruitRequirementsAct/getRecruitRequirementsDetail.act?seqId=<%=seqId%>";
...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  var url = "<%=contextPath%>/t9/subsys/oa/hr/recruit/requirements/act/T9HrRecruitRequirementsAct/delFloatFile.act?delAttachId=" + attachId + "&seqId=<%=seqId%>";
...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/recruit/requirements/act/T9HrRecruitRequirementsAct/updateRecruitRequirementsInfo.act"  method="post" name="form1" id="form1" onsubmit="">
