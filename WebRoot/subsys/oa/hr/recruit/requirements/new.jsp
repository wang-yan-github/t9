...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/recruit/requirements/act/T9HrRecruitRequirementsAct/addRecruitRequirementsInfo.act"  method="post" name="form1" id="form1" onsubmit="">
