...
function getHrFilterInfo(){
	var requestURLStr = "<%=contextPath%>/t9/subsys/oa/hr/recruit/filter/act/T9HrRecruitFilterAct";
...
function doSubmit(){
	if(checkForm()){
		...
		var url = "<%=contextPath%>/t9/subsys/oa/hr/recruit/filter/act/T9HrRecruitFilterAct/updateHrFilterInfo.act?seqId=<%=seqId%>";
