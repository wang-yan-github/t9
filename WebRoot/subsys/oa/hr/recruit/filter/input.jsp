...
var rmgr ;
function doInit() {
  var url = "<%=contextPath%>/t9/subsys/oa/hr/recruit/filter/act/T9HrRecruitFilterAct/show.act"; 
  if(seqId){
...
//  }
  var url = "";
  if(seqId) {
    url = "<%=contextPath%>/t9/subsys/oa/hr/recruit/filter/act/T9HrRecruitFilterAct/updateField.act";
  }else {
    url = "<%=contextPath%>/t9/subsys/oa/hr/recruit/filter/act/T9HrRecruitFilterAct/addField.act";
  }
...
<form name="form1" id="form1" method="post">
  ...
  <input type="hidden" id="dtoClass" name="dtoClass" value="t9.subsys.oa.hr.recruit.filter.data.T9HrRecruitFilter"/>
