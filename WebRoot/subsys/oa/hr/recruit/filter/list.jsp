...
var pageMgr = null;
function doInit() {
  var url =  contextPath + "/t9/subsys/oa/hr/recruit/filter/act/T9HrRecruitFilterAct/list.act";
  var cfgs = {
    dataAction: url,
...
function deleteOpt(id){
  ...
  var url =  contextPath + "/t9/subsys/oa/hr/recruit/filter/act/T9HrRecruitFilterAct/deleteField.act?seqId=" + id;
