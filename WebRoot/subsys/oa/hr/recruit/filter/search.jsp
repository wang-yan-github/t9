...
<%
	...
	String planName = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("PLAN_NAME")));
	...
	String employeePhone = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("EMPLOYEE_PHONE")));
	String transactorStep = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("transactorStep")));
	String nextTransaStep1 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("nextTransaStep1")));
	String nextTransaStep2 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("nextTransaStep2")));
	String nextTransaStep3 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("nextTransaStep3")));
	String nextTransaStep4 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("nextTransaStep4")));
	String status = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("STATUS")));
%>
...
function doInit(){
	...
	var url = "<%=contextPath%>/t9/subsys/oa/hr/recruit/filter/act/T9HrRecruitFilterAct/queryFilterListJson.act?" + param;
	var cfgs = {
	    dataAction: url,
