...
function doInit(){
	...
	setDate();
	var url = "<%=contextPath%>/t9/subsys/oa/hr/recruit/plan/act/T9HrRecruitPlanAct/getRecruitPlanDetail.act?seqId=<%=seqId%>";
...
function staffNameFunc(cellData){
  var url = contextPath + "/t9/subsys/oa/hr/recruit/plan/act/T9HrRecruitPlanAct/getUserName.act";
...
function deptFunc(cellData, recordIndex, columIndex){
  var url = contextPath + "/t9/subsys/oa/hr/recruit/plan/act/T9HrRecruitPlanAct/getDeptName.act";
...
function getPlanItem(seqId){
  var urls = contextPath + "/t9/subsys/oa/hr/setting/act/T9HrCodeAct/selectCodeById.act?seqId="+seqId;
...
function approval(){
	var url = contextPath + "/t9/subsys/oa/hr/recruit/plan/act/T9HrRecruitPlanAct/doApproval.act?seqId=<%=seqId%>&flag="+flag+"&approveDate="+$('approveDate').value+"&approveComment="+encodeURIComponent($('approveComment').value)+"&createUserId="+$('createUserId').value;
