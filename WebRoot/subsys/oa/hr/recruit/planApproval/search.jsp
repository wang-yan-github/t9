...
<%
  String planName = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("planName")));
  String planNo = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("planNo")));
  String planStatus = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("planStatus")));
  String approvePerson = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("approvePerson")));
  String recruitDirection = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("recruitDirection")));
  String recruitRemark = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("recruitRemark")));
  String startDate1 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("startDate1")));
  String startDate2 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("startDate2")));
  String endDate1 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("endDate1")));
  String endDate2 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("endDate2")));
%>
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/recruit/plan/act/T9HrRecruitPlanAct/queryRecruitPlan.act?" + param;
  var cfgs = {
    dataAction: url,
