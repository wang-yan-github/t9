...
function getTrainingAjaxFunc(param, userId){
  ...
  var url = contextPath + "/t9/subsys/oa/hr/recruit/hrPool/act/T9HrRecruitPoolAct/getHrRecruitPlanList.act?condition=" + encodeURIComponent(condition) +"&userId=" +userId;
