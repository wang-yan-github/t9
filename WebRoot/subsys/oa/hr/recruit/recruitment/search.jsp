...
<%
  String PLAN_NO = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("PLAN_NO")));
  String APPLYER_NAME = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("APPLYER_NAME")));
  String OA_NAME = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("OA_NAME")));
  String JOB_STATUS = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("JOB_STATUS")));
  String ASSESSING_OFFICER = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("ASSESSING_OFFICER")));
  String ASS_PASS_TIME_START = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("ASS_PASS_TIME_START")));
  String ASS_PASS_TIME_END = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("ASS_PASS_TIME_END")));
  String department = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("department")));
  String TYPE = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("TYPE")));
  String ADMINISTRATION_LEVEL = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("ADMINISTRATION_LEVEL")));
  
  String JOB_POSITION = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("JOB_POSITION")));
  String PRESENT_POSITION = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("PRESENT_POSITION")));
  String REMARK = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("REMARK")));
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/recruit/recruitment/act/T9HrRecruitRecruitmentAct/queryRecruitmentListJson.act?" + param;
  var cfgs = {
          dataAction: url,
