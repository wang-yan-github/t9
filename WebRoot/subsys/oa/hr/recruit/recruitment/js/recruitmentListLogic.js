...
function optsList(cellData, recordIndex, columIndex) {
	...
	var counter = 0;
	var requestURLStr = contextPath + "/t9/subsys/oa/hr/recruit/recruitment/act/T9HrRecruitRecruitmentAct";
...
function getSelectedCode(parentNo, optionType, extValue) {
	var requestURLStr = contextPath
			+ "/t9/subsys/oa/hr/setting/act/T9HrCodeAct/selectChildCode.act?parentNo="
			+ parentNo;
