...
function checkUser(id){
	...
	var url = contextPath + "/t9/subsys/oa/hr/recruit/recruitment/act/T9HrRecruitRecruitmentAct/checkUser.act";
...
function getHrPoolInfo(){
	var urlStr = "<%=contextPath%>/t9/subsys/oa/hr/recruit/hrPool/act/T9HrRecruitPoolAct";
...
function getHrRecruitment(){
	var urlStr = "<%=contextPath%>/t9/subsys/oa/hr/recruit/recruitment/act/T9HrRecruitRecruitmentAct";
...
<form enctype="multipart/form-data" action="<%=contextPath %>/t9/subsys/oa/hr/recruit/recruitment/act/T9HrRecruitRecruitmentAct/addHrStaffInfo.act" method="post" name="form1" id="form1">
