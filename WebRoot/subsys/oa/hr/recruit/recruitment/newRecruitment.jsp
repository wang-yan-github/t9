...
function deptFunc(deptDiv){
  var url = "<%=contextPath%>/t9/subsys/oa/hr/recruit/recruitment/act/T9HrRecruitRecruitmentAct/selectDeptToAttendance.act";
...
function doSubmit(){
	if(checkForm()){
		...
		var url = "<%=contextPath%>/t9/subsys/oa/hr/recruit/recruitment/act/T9HrRecruitRecruitmentAct/addHrRecruitInfo.act";
