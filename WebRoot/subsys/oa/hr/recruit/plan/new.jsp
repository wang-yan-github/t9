...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/recruit/plan/act/T9HrRecruitPlanAct/addRecruitPlanInfo.act"  method="post" name="form1" id="form1" onsubmit="">
