...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  var url = "<%=contextPath%>/t9/subsys/oa/hr/recruit/plan/act/T9HrRecruitPlanAct/delFloatFile.act?delAttachId=" + attachId + "&seqId=<%=seqId%>";
...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/recruit/plan/act/T9HrRecruitPlanAct/updateRecruitPlanInfo.act"  method="post" name="form1" id="form1" onsubmit="">
