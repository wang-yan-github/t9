...
List<T9HrStaffLearnExperience> learnList = (List<T9HrStaffLearnExperience>)request.getAttribute("learnExsInfoList");
T9HrStaffLearnExperience learnEx = learnList.get(0);

String startdate="";//开始日期
String enddate = "";//结束日期
String startDate = String.valueOf(learnEx.getStartDate());
if(!T9Utility.isNullorEmpty(startDate) && startDate!="null"){
	startdate =	startDate.substring(0,10);
	}
String endDate = String.valueOf(learnEx.getEndDate());
if(!T9Utility.isNullorEmpty(endDate) && endDate!="null"){
...
function CheckForm(){
	...
	document.form1.action = contextPath +"/t9/subsys/oa/hr/manage/staffLearnExperience/act/T9NewLearnExperienceAct/updateLearnExperienceInfo.act?seqid="+seqid;
...
function showAttachment(){
	var attachmentId = "<%=T9Utility.null2Empty(learnEx.getAttachmentId())%>";
	var attachmentName = "<%= T9Utility.encodeSpecial(T9Utility.null2Empty(learnEx.getAttachmentName()))%>";
...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/staffLearnExperience/act/T9NewLearnExperienceAct/delFloatFile.act?delAttachId=" + attachId + "&seqId=<%=learnEx.getSeqId()%>";
