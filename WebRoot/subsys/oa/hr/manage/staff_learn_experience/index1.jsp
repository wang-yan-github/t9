...
<%
  ...
  List<T9HrStaffLearnExperience> learnList = (List<T9HrStaffLearnExperience>)request.getAttribute("findLearnExs");
...
<%}%>
<br>
<form action="<%=contextPath%>/t9/subsys/oa/hr/manage/staffLearnExperience/act/T9NewLearnExperienceAct/findLearnExInfo.act" method="get" name="form1" id="form1">
