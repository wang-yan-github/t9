...
List<T9HrStaffLearnExperience> learnList = (List<T9HrStaffLearnExperience>)request.getAttribute("onefindLearn");
T9HrStaffLearnExperience learn = learnList.get(0);
...
function goto(){ 
		window.location.href= contextPath + "/t9/subsys/oa/hr/manage/staffLearnExperience/act/T9NewLearnExperienceAct/findLearnExInfo.act";
	}


function showAttachment(){
	var attachmentId = "<%=T9Utility.null2Empty(learn.getAttachmentId())%>";
	var attachmentName = "<%= T9Utility.encodeSpecial(T9Utility.null2Empty(learn.getAttachmentName()))%>";
...
<table width="90%" align="center" class="TableBlock">
  ...
  <tr>
    ...
    <%
  	if(!T9Utility.isNullorEmpty(learn.getAttachmentId())){
  %>
