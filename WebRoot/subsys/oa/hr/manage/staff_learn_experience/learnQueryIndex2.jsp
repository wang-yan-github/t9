...
<%@ page  import="t9.subsys.oa.hr.manage.staffLearnExperience.data.*"%> 
<html>
<head>
<%
	T9Page pages = (T9Page)request.getAttribute("page");
  List<T9HrStaffLearnExperience> learnList = (List<T9HrStaffLearnExperience>)request.getAttribute("learnInfoList");
  
  T9HrStaffLearnExperience learnEx = (T9HrStaffLearnExperience)request.getAttribute("learnExs");
%>
<title>学习经历管理 </title>
...
<script Language="JavaScript">
   function learnInfo(learnSeqId){ ///t9/subsys/oa/hr/manage/staff_license/act/T9NewLicenseInfoAct/findLicenseInfo.act
    var url  = contextPath + "/t9/subsys/oa/hr/manage/staffLearnExperience/act/T9NewLearnExperienceAct/findLearnXxInfo.act?learnSeqId="+ learnSeqId;
   ...
   function gotoPage(currNo){
     $("currNo").value = currNo;
    // var url  = contextPath + "/t9/subsys/oa/book/act/T9BookQueryAct/findBooks.act?currNo="+ currNo;   
    // window.location.href= url;
     $("form1").submit();
   }
  ...
  function deleteLearnInfo(deleteSeqId){
   ...
   if(!window.confirm(msg)){
     ...
     if(noHiddenId && noHiddenId!="null"){ 
       window.location.href = contextPath + "/t9/subsys/oa/hr/manage/staffLearnExperience/act/T9NewLearnExperienceAct/delLearnExInfo.act?HiddenId="+deleteSeqId;  
       return true;
      }
    }
  ...
  function deleteCheckBook(){
    ...
    if(window.confirm(msg)){
       ...
       var url = contextPath + '/t9/subsys/oa/hr/manage/staffLearnExperience/act/T9NewLearnExperienceAct/deleteLearnExInfo.act';
 ...
 function updateLearnEx(learnseId){
	 var url  = contextPath + "/t9/subsys/oa/hr/manage/staffLearnExperience/act/T9NewLearnExperienceAct/upLearnExInfo.act?learnseId="+ learnseId;
	  window.location.href=url;
 }
...
<form action="<%=contextPath%>/t9/subsys/oa/hr/manage/staffLearnExperience/act/T9NewLearnExperienceAct/queryLearnInfo.act" method="get" name="form1" id="form1">
<%if(learnEx != null){ %>
