...
<%@ page  import="t9.subsys.oa.hr.manage.staffLaborSkills.data.*"%> 
<html>
<head>
<%
	T9Page pages = (T9Page)request.getAttribute("page");
  List<T9HrStaffLaborSkills> laborSkills = (List<T9HrStaffLaborSkills>)request.getAttribute("findLaborSkills");
  ...
  T9HrStaffLaborSkills laborSkill = (T9HrStaffLaborSkills)request.getAttribute("laborSkill");
...
<script Language="JavaScript">
   function laborSkillsInfo(laborSkillSeqId){
    var url  = contextPath + "/t9/subsys/oa/hr/manage/staffLaborSkills/act/T9NewLaborSkillsAct/findlaborSkillsXxInfo.act?skillId="+ laborSkillSeqId;
  ...
  function deleteLaborSkillInfo(deleteSeqId){
   ...
   if(!window.confirm(msg)){
     ...
     if(noHiddenId && noHiddenId!="null"){ 
       window.location.href = contextPath + "/t9/subsys/oa/hr/manage/staffLaborSkills/act/T9NewLaborSkillsAct/delLaborSkillInfo.act?HiddenId="+deleteSeqId;  
       return true;
      }
    }
  ...
  function deleteCheckLaborSkill(){
    ...
    if(window.confirm(msg)){
       ...
       var url = contextPath + '/t9/subsys/oa/hr/manage/staffLaborSkills/act/T9NewLaborSkillsAct/deleteLaborSkillInfo.act';
 ...
 function updateLaborSkill(laborSkillId){
	 var url  = contextPath + "/t9/subsys/oa/hr/manage/staffLaborSkills/act/T9NewLaborSkillsAct/upLaborSkillInfo.act?laborSkillId="+ laborSkillId;
	  window.location.href=url;
 }
...
<%}%>
<br>
<form action="<%=contextPath%>/t9/subsys/oa/hr/manage/staffLaborSkills/act/T9NewLaborSkillsAct/queryLaborSkillInfo.act" method="get" name="form1" id="form1">
 <%if(laborSkill !=null){ %>
