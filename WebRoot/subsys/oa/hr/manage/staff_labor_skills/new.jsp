...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/manage/staffLaborSkills/act/T9NewLaborSkillsAct/addLaborSkillsInfo.act"  method="post" name="form1" id="form1">
