...
List<T9HrStaffLaborSkills> laborSkills = (List<T9HrStaffLaborSkills>)request.getAttribute("onefindLaborSkill");
...
function goto(){ 
		window.location.href= contextPath + "/t9/subsys/oa/hr/manage/staffLaborSkills/act/T9NewLaborSkillsAct/findLaborSkillsInfo.act";
	}
...
<table width="90%" align="center" class="TableBlock">
  ...
  <tr>
    ...
    <%
  	if(!T9Utility.isNullorEmpty(laborSkill.getAttachmentId())){
  %>
  <tr>
