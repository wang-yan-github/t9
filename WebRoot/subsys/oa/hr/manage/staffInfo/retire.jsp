...
if(T9Utility.isNullorEmpty(queryDate1)){
	queryDate1 = "";
}
if(T9Utility.isNullorEmpty(queryDate2)){
	queryDate2 = "";
}
...
<%@page import="t9.core.util.T9Utility"%><html>
<head>
...
function doInit(){
	...
	var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/staffInfo/act/T9RetireQueryAct/queryRetirListJson.act?" + param;
	var cfgs = {
	    dataAction: url,
