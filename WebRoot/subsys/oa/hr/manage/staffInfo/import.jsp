...
function downCSVTemplet(){
	var downUrl = "<%=contextPath%>/t9/subsys/oa/hr/manage/staffInfo/act/T9ImpHrStaffInfoAct";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  ...
  <br>
  <form name="form1" id="form1" action="<%=contextPath%>/t9/subsys/oa/hr/manage/staffInfo/act/T9ImpHrStaffInfoAct/impStaffInfoToCsv.act" method="post" enctype="multipart/form-data">
