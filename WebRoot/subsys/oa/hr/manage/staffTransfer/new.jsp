...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/manage/transfer/act/T9HrStaffTransferAct/addStaffTransferInfo.act"  method="post" name="form1" id="form1" onsubmit="">
