...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/transfer/act/T9HrStaffTransferAct/getTransferDetail.act?seqId=<%=seqId%>";
...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/transfer/act/T9HrStaffTransferAct/delFloatFile.act?delAttachId=" + attachId + "&seqId=<%=seqId%>";
...
function getDeptId(){
  ...
  var requestUrl = contextPath + "/t9/subsys/oa/hr/manage/transfer/act/T9HrStaffTransferAct/getDeptId.act?transferPerson=" + $('transferPerson').value; 
  var rtJson = getJsonRs(requestUrl); 
  if(rtJson.rtState == "1"){ 
    alert(rtJson.rtMsrg); 
    return ; 
...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/manage/transfer/act/T9HrStaffTransferAct/updateTransferInfo.act"  method="post" name="form1" id="form1" onsubmit="">
