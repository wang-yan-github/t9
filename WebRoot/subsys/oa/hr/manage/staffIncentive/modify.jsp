...
function doInit(){
  ...
  changeIncentiveType();
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/act/T9HrStaffIncentiveAct/getIncentiveDetail.act?seqId=<%=seqId%>";
...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/act/T9HrStaffIncentiveAct/delFloatFile.act?delAttachId=" + attachId + "&seqId=<%=seqId%>";
...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/manage/act/T9HrStaffIncentiveAct/updateIncentiveInfo.act"  method="post" name="form1" id="form1" onsubmit="">
