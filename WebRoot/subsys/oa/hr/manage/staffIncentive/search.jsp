...
<%
  ...
  String incentiveTime1 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("incentiveTime1")));
  String incentiveTime2 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("incentiveTime2")));
  String incentiveItem = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("incentiveItem")));
  String incentiveType = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("incentiveType")));
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/act/T9HrStaffIncentiveAct/queryIncentiveListJson.act?" + param;
  var cfgs = {
      dataAction: url,
