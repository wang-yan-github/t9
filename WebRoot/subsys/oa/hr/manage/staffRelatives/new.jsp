...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/manage/relatives/act/T9HrStaffRelativesAct/addStaffRelativesInfo.act"  method="post" name="form1" id="form1" onsubmit="">
