...
<%
  ...
  String member = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("member")));
  String relationship = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("relationship")));
  String jobOccupation = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("jobOccupation")));
  String workUnit = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("workUnit")));
%>
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/relatives/act/T9HrStaffRelativesAct/queryRelativesListJson.act?" + param;
  var cfgs = {
      dataAction: url,
