...
function doInit(){
  ...
  setDate();
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/relatives/act/T9HrStaffRelativesAct/getRelativesDetail.act?seqId=<%=seqId%>";
...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/relatives/act/T9HrStaffRelativesAct/delFloatFile.act?delAttachId=" + attachId + "&seqId=<%=seqId%>";
...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/manage/relatives/act/T9HrStaffRelativesAct/updateRelativesInfo.act"  method="post" name="form1" id="form1" onsubmit="">
