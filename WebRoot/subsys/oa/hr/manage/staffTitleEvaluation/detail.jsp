...
function doInit(){
	var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/titleEvaluation/act/T9HrStaffTitleEvaluationAct/getTitleEvaluationDetail.act?seqId=<%=seqId%>";
...
function staffNameFunc(cellData){
  var url = contextPath + "/t9/subsys/oa/hr/manage/titleEvaluation/act/T9HrStaffTitleEvaluationAct/getUserName.act";
