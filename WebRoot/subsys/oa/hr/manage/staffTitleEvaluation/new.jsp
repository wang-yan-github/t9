...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/manage/titleEvaluation/act/T9HrStaffTitleEvaluationAct/addStaffTitleEvaluationInfo.act"  method="post" name="form1" id="form1" onsubmit="">
