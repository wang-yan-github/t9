...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/manage/titleEvaluation/act/T9HrStaffTitleEvaluationAct/updateTitleEvaluationInfo.act"  method="post" name="form1" id="form1" onsubmit="">
