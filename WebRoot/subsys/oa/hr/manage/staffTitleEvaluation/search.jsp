...
<%
  String byEvaluStaffs = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("byEvaluStaffs")));
  String approvePerson = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("approvePerson")));
  String postName = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("postName")));
  String getMethod = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("getMethod")));
  String reportTime1 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("reportTime1")));
  String reportTime2 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("reportTime2")));
  String receiveTime1 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("receiveTime1")));
  String receiveTime2 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("receiveTime2")));
  String employPost = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("employPost")));
  String employCompany = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("employCompany")));
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/titleEvaluation/act/T9HrStaffTitleEvaluationAct/queryTitleEvaluationListJson.act?" + param;
  var cfgs = {
    dataAction: url,
