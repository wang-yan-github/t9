...
<%@page import="t9.subsys.oa.hr.manage.staffInfo.act.T9HrStaffInfoAct"%><html>
<head>
...
function doInit(){
	var requestURLStr = contextPath+ "/t9/subsys/oa/hr/manage/staffInfo/act/T9HrStaffInfoQueryAct";
