...
function goto(){
		window.location.href= contextPath + "/t9/subsys/oa/hr/manage/staff_contract/act/T9NewContractInfoAct/findContractInfo.act";
	}
...
<table width="90%" align="center" class="TableBlock">
  ...
  <tr>    
    ...
    <%
  	if(!T9Utility.isNullorEmpty(contract.getAttachmentId())){
  %>
  <tr>
