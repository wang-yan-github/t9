...
<%
  ...
  T9HrStaffContract contract = (T9HrStaffContract)request.getAttribute("contracts");
  ...
  List<T9HrStaffContract> contractList = (List<T9HrStaffContract>)request.getAttribute("contractInfoList");
...
<script Language="JavaScript">
   function ConractInfo(ContractSeqId){
    ...
    // window.open(url);
    var url  = contextPath + "/t9/subsys/oa/hr/manage/staff_contract/act/T9NewContractInfoAct/contractXxInfo.act?ContractSeqId="+ ContractSeqId;
  ...
  function deleteContractInfo(deleteSeqId){
   ...
   if(!window.confirm(msg)){
     ...
     if(noHiddenId && noHiddenId!="null"){
       window.location.href = contextPath + "/t9/subsys/oa/hr/manage/staff_contract/act/T9NewContractInfoAct/delContractInfo.act?HiddenId="+deleteSeqId;  
       return true;
      }
    }
  ...
  function deleteCheckBook(){
    ...
    if(window.confirm(msg)){
       ...
       var url = contextPath + '/t9/subsys/oa/hr/manage/staff_contract/act/T9NewContractInfoAct/deleteContractInfo.act';
 ...
 function updateConract(contractId){
	 var url  = contextPath + "/t9/subsys/oa/hr/manage/staff_contract/act/T9NewContractInfoAct/upContractInfo.act?contractId="+ contractId;
	  window.location.href=url;
 }
...
<%}%>
<br>
<form action="<%=contextPath%>/t9/subsys/oa/hr/manage/staff_contract/act/T9NewContractInfoAct/queryContractInfo.act" method="get" name="form1" id="form1">
<%if(contract!=null){ %>
