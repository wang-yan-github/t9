...
function initSwfUpload() {
  ...
  var settings = {
    ...
    upload_url: "<%=contextPath %>/t9/subsys/oa/hr/manage/staff_contract/act/T9NewContractInfoAct/fileLoad.act",
...
function CheckForm(){
  ...
  if(document.form1.MAKE_CONTRACT.value != "") {
    if(!regex.test(document.form1.MAKE_CONTRACT.value)){
      alert("输入的合同签订日期格式错误");
      return false;
    }
  }
  if(document.form1.TRAIL_EFFECTIVE_TIME.value != "") {
    if(!regex.test(document.form1.TRAIL_EFFECTIVE_TIME.value)){
      alert("输入的试用生效日期格式错误");
      return false;
    }
  }
  if(document.form1.TRAIL_OVER_TIME.value != "") {
    if(!regex.test(document.form1.TRAIL_OVER_TIME.value)){
      alert("输入的试用到期日期格式错误");
      return false;
    }
  }
  if(document.form1.PROBATION_END_DATE.value != "") {
    if(!regex.test(document.form1.PROBATION_END_DATE.value)){
      alert("输入的合同转正日期格式错误");
      return false;
    }
  }
  if(document.form1.PROBATION_EFFECTIVE_DATE.value != "") {
    if(!regex.test(document.form1.PROBATION_EFFECTIVE_DATE.value)){
      alert("输入的合同生效日期格式错误");
      return false;
    }
  }
  if(document.form1.CONTRACT_END_TIME.value != "") {
    if(!regex.test(document.form1.CONTRACT_END_TIME.value)){
      alert("输入的合同到期日期格式错误");
      return false;
    }
  }
  if(document.form1.CONTRACT_REMOVE_TIME.value != "") {
    if(!regex.test(document.form1.CONTRACT_REMOVE_TIME.value)){
      alert("输入的合同解除日期格式错误");
      return false;
    }
  }
	...
	if($('PASS_OR_NOT1').checked && document.form1.PROBATION_END_DATE.value!="" && document.form1.TRAIL_OVER_TIME.value!="" && document.form1.TRAIL_OVER_TIME.value > document.form1.PROBATION_END_DATE.value)
	 ...
	 if($('PASS_OR_NOT1').checked && document.form1.PROBATION_END_DATE.value!="" && document.form1.PROBATION_EFFECTIVE_DATE.value!="" && document.form1.PROBATION_END_DATE.value > document.form1.PROBATION_EFFECTIVE_DATE.value)
	   ...
	   document.form1.action = contextPath +"/t9/subsys/oa/hr/manage/staff_contract/act/T9NewContractInfoAct/addContractInfo.act";
...
-->
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/manage/act/T9HrStaffIncentiveAct/addStaffincentiveInfo.act"  method="post" name="form1" id="form1" onsubmit="">
<table class="TableBlock" width="80%" align="center">
   <tr>
    ...
    <tr >
      ...
      <td class="TableData">
       <input type="text" name="MAKE_CONTRACT" id="MAKE_CONTRACT" size="12" maxlength="10" class="BigInput"  value=""/>
      ...
      <td class="TableData">
        <input type="text" name="TRAIL_EFFECTIVE_TIME" id ="TRAIL_EFFECTIVE_TIME" size="12" maxlength="10" class="BigInput"  value="" />
    ...
    <tr >
      ...
      <td class="TableData">     
        <input type="text" name="TRAIL_OVER_TIME" id="TRAIL_OVER_TIME" size="12" maxlength="10" class="BigInput"  value=""/>
    ...
    <tr >
      ...
      <td class="TableData">
         ...
         <input type="text" name="PROBATION_END_DATE" id="PROBATION_END_DATE" size="12" maxlength="10" class="BigInput"  value=""/>
    ...
    <tr style="display:none" id="menu">    
      ...
      <td class="TableData">
        <input type="text" name="PROBATION_EFFECTIVE_DATE" id="PROBATION_EFFECTIVE_DATE"  size="12" maxlength="10" class="BigInput"  value=""/>
      ...
      <td class="TableData">   
        <input type="text" name="CONTRACT_END_TIME" id="CONTRACT_END_TIME" size="12" maxlength="10" class="BigInput"  value=""/>
    ...
    <tr >
      ...
      <td class="TableData">
	      <span id="id_msg5" style="display:none">
	        <input type="text" name="CONTRACT_REMOVE_TIME" id="CONTRACT_REMOVE_TIME" size="12" maxlength="10" class="BigInput"  value=""/>
     ...
     <tr >
      ...
      <td class="TableData">
        <input type="text" name="REMIND_TIME" id="REMIND_TIME" readonly size="20" maxlength="20" class="BigInput"  value="" onClick=""/>
