...
function doSubmit(){
  ...
  if(checkForm()){
    ...
    if(hrSeqId){
    	document.form1.action="<%=contextPath %>/t9/subsys/oa/hr/manage/leave/act/T9HrStaffLeaveAct/addStaffLeaveInfoById.act";
    }
    $("form1").submit();
  }
}
...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/manage/leave/act/T9HrStaffLeaveAct/addStaffLeaveInfo.act"  method="post" name="form1" id="form1" onsubmit="">
