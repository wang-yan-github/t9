...
List<T9HrStaffLicense> licenseList = (List<T9HrStaffLicense>)request.getAttribute("licenseXxInfoList");
...
function goto(){
		window.location.href= contextPath + "/t9/subsys/oa/hr/manage/staff_license/act/T9NewLicenseInfoAct/findLicenseInfo.act";
	}
...
<tbody><tr>
  ...
  <%
  	if(!T9Utility.isNullorEmpty(license.getAttachmentId())){
  %>
