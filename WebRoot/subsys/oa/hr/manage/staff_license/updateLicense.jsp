...
List<T9HrStaffLicense> licenseList = (List<T9HrStaffLicense>)request.getAttribute("licensesInfoList");
T9HrStaffLicense license = licenseList.get(0);
...
if(!T9Utility.isNullorEmpty(license.getLicenseType())){//证照类型
	licenseType = license.getLicenseType();
}
if(!T9Utility.isNullorEmpty(license.getStatus())){//证照类型
 ...
 */ 
 ...
 function CheckForm(){
	...
	if(licenseType.replaceAll(" ","") == "" || licenseType == "null"){
		...
		document.form1.action = contextPath +"/t9/subsys/oa/hr/manage/staff_license/act/T9NewLicenseInfoAct/updateLicenseInfo.act?seqid="+seqid;
 ...
 function showAttachment(){
		var attachmentId = "<%=T9Utility.null2Empty(license.getAttachmentId())%>";
		var attachmentName = "<%= T9Utility.encodeSpecial(T9Utility.null2Empty(license.getAttachmentName()))%>";
...
//删除附件
 function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
   var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/staff_license/act/T9NewLicenseInfoAct/delFloatFile.act?delAttachId=" + attachId + "&seqId=<%=license.getSeqId()%>";
