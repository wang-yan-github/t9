...
<%@ page  import="t9.subsys.oa.hr.manage.staff_license.data.*"%> 
<html>
<head>
<%
	T9Page pages = (T9Page)request.getAttribute("page");
  List<T9HrStaffLicense> licenseList = (List<T9HrStaffLicense>)request.getAttribute("licenseInfoList");
  String expireDate1 = (String)request.getAttribute("expireDate1");
  String expireDate2 = (String)request.getAttribute("expireDate2");
  T9HrStaffLicense licenses = (T9HrStaffLicense)request.getAttribute("licenses");
...
<script Language="JavaScript">
   function LicenseInfo(LicenseSeqId){ ///t9/subsys/oa/hr/manage/staff_license/act/T9NewLicenseInfoAct/findLicenseInfo.act
    var url  = contextPath + "/t9/subsys/oa/hr/manage/staff_license/act/T9NewLicenseInfoAct/findLicenseXxInfo.act?LicenseSeqId="+ LicenseSeqId;
  ...
  function deleteLicenseInfo(deleteSeqId){
   ...
   if(!window.confirm(msg)){
     ...
     if(noHiddenId && noHiddenId!="null"){
       window.location.href = contextPath + "/t9/subsys/oa/hr/manage/staff_license/act/T9NewLicenseInfoAct/delLicenseInfo.act?HiddenId="+deleteSeqId;  
       return true;
      }
    }
  ...
  function deleteCheckBook(){
    ...
    if(window.confirm(msg)){
       ...
       var url = contextPath + '/t9/subsys/oa/hr/manage/staff_license/act/T9NewLicenseInfoAct/deleteLicenseInfo.act';
 ...
 function updateLicense(licenseId){
	 var url  = contextPath + "/t9/subsys/oa/hr/manage/staff_license/act/T9NewLicenseInfoAct/upLicenseInfo.act?licenseId="+ licenseId;
	  window.location.href=url;
 }
...
<%}%>
<br>
<form action="<%=contextPath%>/t9/subsys/oa/hr/manage/staff_license/act/T9NewLicenseInfoAct/queryLicenseInfo.act" method="get" name="form1" id="form1">
  <%if(licenses!=null){ %>
