...
<%
  String careType = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("careType")));
  String byCareStaffs = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("byCareStaffs")));
  String careDate1 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("careDate1")));
  String careDate2 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("careDate2")));
  String careFees1 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("careFees1")));
  String careFees2 = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("careFees2")));
  String participants = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("participants")));
  String careContent = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("careContent")));
%>
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/care/act/T9HrStaffCareAct/queryCareListJson.act?" + param;
  var cfgs = {
    dataAction: url,
