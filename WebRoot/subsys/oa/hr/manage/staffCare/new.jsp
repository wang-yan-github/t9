...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/manage/care/act/T9HrStaffCareAct/addStaffCareInfo.act"  method="post" name="form1" id="form1" onsubmit="">
