...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/care/act/T9HrStaffCareAct/getCareDetail.act?seqId=<%=seqId%>";
...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/care/act/T9HrStaffCareAct/delFloatFile.act?delAttachId=" + attachId + "&seqId=<%=seqId%>";
...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/manage/care/act/T9HrStaffCareAct/updateCareInfo.act"  method="post" name="form1" id="form1" onsubmit="">
