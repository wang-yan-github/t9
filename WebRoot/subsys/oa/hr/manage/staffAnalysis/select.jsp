...
function doSubmit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/analysis/act/T9HrStaffAnalysisAct/getAnalysis.act?module="+module+"&sumField="+sumField+"&deptId="+deptId;
...
function doSubmit1(){
 ...
 if(doCheck()){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/analysis/act/T9HrStaffAnalysisAct/getAnalysisTwo.act?deptId="+deptId+"&startDate="+startDate+"&endDate="+endDate+"&module="+module;
  var rtJson = getJsonRs(url);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ; 
