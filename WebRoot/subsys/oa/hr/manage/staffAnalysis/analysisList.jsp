...
function doInit(){
	  ...
	  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/analysis/act/T9HrStaffAnalysisAct/getAnalysisList.act?module=<%=module%>&startDate=<%=startDate%>&deptId=<%=deptId%>&endDate=<%=endDate%>";
