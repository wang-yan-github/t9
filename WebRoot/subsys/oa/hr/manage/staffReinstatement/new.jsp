...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/manage/reinstatement/act/T9HrStaffReinstatementAct/addStaffReinstatementInfo.act"  method="post" name="form1" id="form1" onsubmit="">
