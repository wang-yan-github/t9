...
var requestUrl = contextPath + "/t9/subsys/oa/hr/manage/reinstatement/act/T9OrgSelect2Act";
function getAccord(){
  var data = {
  panel:'left',
...
function getRole(){
  $(roleIndex).update("");
  var url = contextPath + "/t9/subsys/oa/hr/manage/reinstatement/act/T9RoleSelectAct/getRoles.act";
  if (moduleId) {
    url += "?moduleId=" + moduleId + "&privNoFlag="+ privNoFlag ;
  }
  var json = getJsonRs(url);
