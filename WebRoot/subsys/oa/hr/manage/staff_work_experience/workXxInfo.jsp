...
List<T9HrStaffWorkExperience> workList = (List<T9HrStaffWorkExperience>)request.getAttribute("onefindWork");
T9HrStaffWorkExperience work = workList.get(0);
...
function goto(){ 
		window.location.href= contextPath + "/t9/subsys/oa/hr/manage/staffWorkExperience/act/T9NewWorkExperienceAct/findWorkExInfo.act";
	}


function showAttachment(){
	var attachmentId = "<%=T9Utility.null2Empty(work.getAttachmentId())%>";
	var attachmentName = "<%= T9Utility.encodeSpecial(T9Utility.null2Empty(work.getAttachmentName()))%>";
...
<table width="90%" align="center" class="TableBlock">
  ...
  <tr>
   ...
   <%
  	if(!T9Utility.isNullorEmpty(work.getAttachmentId())){
  %>
  <tr>
