...
function doSubmit(){
	...
	if(document.form1.START_DATE.value!="" && document.form1.END_DATE.value!="" && document.form1.START_DATE.value > document.form1.END_DATE.value)
	   { 
		...
		// document.form1.action = contextPath +"/t9/subsys/oa/hr/manage/staffLearnExperience/act/T9NewLearnExperienceAct/addLearnExperienceInfo.act";
...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/manage/staffWorkExperience/act/T9NewWorkExperienceAct/addWorkExperienceInfo.act"  method="post" name="form1" id="form1" onsubmit="">
