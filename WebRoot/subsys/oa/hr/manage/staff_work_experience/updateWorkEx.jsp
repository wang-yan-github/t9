...
<head>
<%
List<T9HrStaffWorkExperience> workList = (List<T9HrStaffWorkExperience>)request.getAttribute("workExsInfoList");
T9HrStaffWorkExperience workEx = workList.get(0);
...
function showAttachment(){
	var attachmentId = "<%=T9Utility.null2Empty(workEx.getAttachmentId())%>";
	var attachmentName = "<%= T9Utility.encodeSpecial(T9Utility.null2Empty(workEx.getAttachmentName()))%>";
...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/staffWorkExperience/act/T9NewWorkExperienceAct/delFloatFile.act?delAttachId=" + attachId + "&seqId=<%=workEx.getSeqId()%>";
...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/manage/staffWorkExperience/act/T9NewWorkExperienceAct/updateWorkExperienceInfo.act"  method="post" name="form1" id="form1" onsubmit="">
