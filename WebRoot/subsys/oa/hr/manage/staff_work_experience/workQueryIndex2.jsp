...
<%@ page  import="t9.subsys.oa.hr.manage.staffWorkExperience.data.*"%> 
<html>
<head>
<%
	T9Page pages = (T9Page)request.getAttribute("page");
  //String userName = (String)request.getAttribute("userName");
  List<T9HrStaffWorkExperience> workList = (List<T9HrStaffWorkExperience>)request.getAttribute("workInfoList");
  T9HrStaffWorkExperience workEx = (T9HrStaffWorkExperience)request.getAttribute("workExs");
...
<script Language="JavaScript">
   function workInfo(workSeqId){
    var url  = contextPath + "/t9/subsys/oa/hr/manage/staffWorkExperience/act/T9NewWorkExperienceAct/findWorkXxInfo.act?workSeqId="+ workSeqId;
  ...
  function deleteWorkInfo(deleteSeqId){
   ...
   if(!window.confirm(msg)){
     ...
     if(noHiddenId && noHiddenId!="null"){ 
       window.location.href = contextPath + "/t9/subsys/oa/hr/manage/staffWorkExperience/act/T9NewWorkExperienceAct/delWorkExInfo.act?HiddenId="+deleteSeqId;  
       return true;
      }
    }
  ...
  function deleteCheckWork(){
    ...
    if(window.confirm(msg)){
       ...
       var url = contextPath + '/t9/subsys/oa/hr/manage/staffWorkExperience/act/T9NewWorkExperienceAct/deleteWorkExInfo.act';
 ...
 function updateWorkEx(workSeqId){
	 var url  = contextPath + "/t9/subsys/oa/hr/manage/staffWorkExperience/act/T9NewWorkExperienceAct/upWorkExInfo.act?workSeqId="+ workSeqId;
	  window.location.href=url;
 }
...
<%}%>
<br>
<form action="<%=contextPath%>/t9/subsys/oa/hr/manage/staffWorkExperience/act/T9NewWorkExperienceAct/queryWorkInfo.act" method="get" name="form1" id="form1">
 <%if(workEx != null){ %>
