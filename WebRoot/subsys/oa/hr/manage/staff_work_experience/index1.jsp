...
<%
  ...
  List<T9HrStaffWorkExperience> workList = (List<T9HrStaffWorkExperience>)request.getAttribute("findWorkExs");
...
<%}%>
<br>
<form action="<%=contextPath%>/t9/subsys/oa/hr/manage/staffWorkExperience/act/T9NewWorkExperienceAct/findWorkExInfo.act" method="get" name="form1" id="form1">
