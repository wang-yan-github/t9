...
function doOnload(){	
  ...
  var url= "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreFlowAct/getScoreOnline2.act?flowId=" + flowId + "&userId="+userId+"&currPage="+currPage + "&groupId="+groupId;
...
function addData(){
  ...
  var url= "<%=contextPath%>/t9/subsys/oa/examManage/act/T9ExamDataAct/addData2.act?flowId=" + flowId + "&userId="+userId+"&checkFlag="+checkFlag;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
...
function getData(){
  ...
  var groupId = '<%=groupId%>';
  var userId = '<%=userId%>';
  var url= "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreFlowAct/getDataByFlowId2.act?flowId=" + flowId + "&userId="+userId + "&groupId="+groupId;
...
function doInit(){
  ...
  var userId = '<%=userId%>';
  var groupId = '<%=groupId%>';
  var url= "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreDataAct/scoreData2.act?flowId=" + flowId + "&checkFlag=" +checkFlag+ "&userId="+userId+"&"+queryParam + "&groupId=" +groupId;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
