...
function doInit(checkEnd){
  ...
  var userId = '<%=userId%>';
  var groupId = '<%=groupId%>';
  var url= "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreShowAct/scoreData2.act?checkFlag=" +checkFlag+ "&userId="+userId+"&"+queryParam + "&groupId=" +groupId +"&checkEnd="+checkEnd;
