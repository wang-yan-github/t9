...
function getGroupRefer(){
	...
	var url = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreShowAct/getGroupRefer.act?groupId=${param.groupId}";
	var rtJson = getJsonRs(url);
	if(rtJson.rtState == "0"){
...
function getScoreDataStr(){
  ...
  var score = "";
  var memo = "";
  var url = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreShowAct/getScoreDataStr.act?groupId=${param.groupId}";
...
function add(score,memo){
  ...
  var userId = ${param.userId};
  var requestURL = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreShowAct/addScoreData.act";
...
function update(score,memo){
  ...
  var groupId = ${param.groupId};
  var userId = ${param.userId};
  var requestURL = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreShowAct/updateScoreData.act";
...
function getScoreOperationData(groupId, userId){
  var year = ${param.year};
  var month = ${param.month};
  var url = "<%=contextPath %>/t9/subsys/oa/hr/score/act/T9ScoreShowAct/getOperationFlag.act?seqId=${param.seqId}";
