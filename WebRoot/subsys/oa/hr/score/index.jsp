...
function doInit(){
  var url = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreGroupAct/getScoreGroupList.act";
  var cfgs = {
      dataAction: url,
...
function getHrSetUserLogin(){
  var url = "<%=contextPath%>/t9/subsys/oa/hr/hrManager/act/T9HrSetOtherAct/getHrSetUserLogin.act";
...
function doSubmit(){
  ...
  var url = "<%=contextPath %>/t9/subsys/oa/hr/score/act/T9ScoreGroupAct/addScoreGroup.act";
