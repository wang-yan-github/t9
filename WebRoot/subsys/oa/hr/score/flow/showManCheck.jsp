...
var flowId = "<%=flowId%>";
function doInit() {
  var url = "<%=contextPath %>/t9/subsys/oa/hr/score/act/T9ScoreFlowAct/showMan.act?participant=" + participant;
...
function scoreStatus(userId){
  var url = "<%=contextPath %>/t9/subsys/oa/hr/score/act/T9ScoreFlowAct/getFinishFlag.act?flowId=" + flowId+"&userId="+userId;
