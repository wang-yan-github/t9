...
function doInit() {
  var str = "";
  var url = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreDataAct/getItemName.act?groupId=${param.groupId}";
...
function scoreDataList(table,strTd){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreDataAct/getScoreDataList.act?flowId=${param.flowId}";
