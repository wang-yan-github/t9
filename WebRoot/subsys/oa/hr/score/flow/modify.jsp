...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreFlowAct/getScoreFlowDetail.act?seqId=${param.seqId}";
...
function doSubmit(){
  ...
  if (checkForm()) {
    ...
    var requestURL = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreFlowAct/updateScoreFlow.act";
...
<tr>
    ...
    <tr align="center" class="TableFooter">
      <td colspan="2" nowrap>
      	<input type="hidden" name="dtoClass" value="t9.subsys.oa.hr.score.data.T9ScoreFlow">
