...
function doInit() {
  var url = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreFlowAct/selectFlow2.act";
  cfgs = {
   dataAction: url,
   container: "giftList",
   colums: [
...
function getCheckFlag(flowId){
  var url = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreFlowAct/getCheckFlag.act";
