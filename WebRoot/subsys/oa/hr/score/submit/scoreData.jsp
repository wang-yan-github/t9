...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreFlowAct/getScoreDataInsert.act?groupId=${param.groupId}";
...
function getGroupRefer(){
	...
	var url = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreDataAct/getGroupRefer.act?groupId=${param.groupId}";
	var rtJson = getJsonRs(url);
	if(rtJson.rtState == "0"){
...
function getScoreDataStr(){
  ...
  var score = "";
  var memo = "";
  var url = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreDataAct/getScoreDataStr.act?groupId=${param.groupId}";
...
function add(score,memo){
  ...
  var flowId = ${param.flowId};
  var userId = ${param.userId};
  var requestURL = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreDataAct/addScoreData.act";
...
function update(score,memo){
  ...
  var flowId = ${param.flowId};
  var userId = ${param.userId};
  var requestURL = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreDataAct/updateScoreData.act";
...
function getScoreOperationData(flowId, userId){
  var url = "<%=contextPath %>/t9/subsys/oa/hr/score/act/T9ScoreDataAct/getOperationFlag.act?seqId=${param.seqId}";
  var rtJson = getJsonRs(url, "flowId="+flowId+"&userId="+userId);
  if(rtJson.rtState == "0"){
