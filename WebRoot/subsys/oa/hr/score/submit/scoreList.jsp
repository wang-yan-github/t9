...
function addData(){
  ...
  var url= "<%=contextPath%>/t9/subsys/oa/examManage/act/T9ExamDataAct/addData.act?flowId=" + flowId + "&userId="+userId+"&checkFlag="+checkFlag;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
...
function getData(){
  var flowId = '<%=flowId%>';
  var userId = '<%=userId%>';
  var url= "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreFlowAct/getDataByFlowId.act?flowId=" + flowId + "&userId="+userId;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
...
function doInit(){
  ...
  var flowId = '<%=flowId%>';
  var userId = '<%=userId%>';
  var url= "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreDataAct/scoreData.act?flowId=" + flowId + "&checkFlag=" +checkFlag+ "&userId="+userId+"&"+queryParam;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
