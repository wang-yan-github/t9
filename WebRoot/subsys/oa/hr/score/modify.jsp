...
function doInit(){
  var url = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreGroupAct/getScoreGroupDetail.act?seqId=${param.seqId}";
...
function doSubmit(){
  ...
  var url = "<%=contextPath %>/t9/subsys/oa/hr/score/act/T9ScoreGroupAct/updateScoreGroup.act";
