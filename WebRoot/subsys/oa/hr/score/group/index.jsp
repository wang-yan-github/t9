...
function doInit(){
  var url = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreItemAct/getScoreItem.act?seqId=${param.seqId}";
...
function getScoreFlowFlag(){
  var url = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreFlowAct/getScoreFlowFlag.act?groupId=${param.seqId}";
  var rtJson = getJsonRs(url);
  if(rtJson.rtState == "0"){
...
function doSubmit(){
  ...
  var url = "<%=contextPath %>/t9/subsys/oa/hr/score/act/T9ScoreItemAct/addScoreItem.act?seqId=${param.seqId}";
