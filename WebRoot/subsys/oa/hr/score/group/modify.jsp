...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreAnswerAct/getScoreAnswerDetail.act?seqId=${param.seqId}";
...
function doSubmit(){
  ...
  var url = "<%=contextPath %>/t9/subsys/oa/hr/score/act/T9ScoreAnswerAct/updateScoreAnswer.act";
...
<input type="hidden" name="dtoClass" value="t9.subsys.oa.examManage.data.T9ExamQuiz">
