...
var total = 0;
function doInit(){
  var url = "<%=contextPath%>/t9/subsys/oa/hr/score/act/T9ScoreAnswerAct/getScoreAnswerList.act?seqId=${param.seqId}";
    var cfgs = {
        dataAction: url,
...
<br>
<div align="center">
   <input type="button" class="BigButton" value="返回" onClick="location='/t9/subsys/oa/hr/score/index.jsp';">
</div>
