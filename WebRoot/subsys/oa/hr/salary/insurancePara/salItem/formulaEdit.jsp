  ...
  function doInit(){
	  $("selectList").innerHTML="";
		 ...
		 var options =""; 
		 var url = contextPath + '/t9/subsys/oa/hr/salary/insurancePara/salItem/act/T9SalaryItemAct/getSalItemNameAct.act';
...
<form  method="post" action="<%=contextPath%>/t9/subsys/oa/hr/salary/insurancePara/salItem/act/T9SalaryItemAct/upSaveSalaryItemAct.act" name="formMain" id ="formMain">
<%if(SalItemList!=null){ %>
