...
<head>
<%
T9SalItem SalItemList = (T9SalItem)request.getAttribute("findSlaItemList");
...
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/salary/insurancePara/salItem/act/T9SalaryItemAct/upSalaryItemAct.act" method="post" name="form1" id="form1">
