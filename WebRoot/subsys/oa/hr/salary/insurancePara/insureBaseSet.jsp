...
String yesOther = "";
List<T9HrInsurancePara> insuranceList = (List<T9HrInsurancePara>)request.getAttribute("findInsuranceList");
...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/salary/insurancePara/salItem/act/T9SalaryItemAct/findInsureBaseCountAct.act" method="post" name="form1" id="form1">
