...
function doSubmit(){
	...
	var url = "<%=contextPath%>/t9/subsys/oa/hr/salary/report/act/T9HrReportAct/setReportUserInfo.act"; 
...
function doAttendance(userId){
  var url = contextPath + "/t9/subsys/oa/hr/salary/report/act/T9HrReportAct/getAttendance.act";
