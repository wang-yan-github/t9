<%@ page language="java" import="java.util.*,java.text.SimpleDateFormat,t9.core.funcs.person.data.T9Person,t9.core.funcs.calendar.data.*" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ include file="/core/inc/header.jsp" %>
<%
  String staffName = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("userId")));
