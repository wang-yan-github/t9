...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/salary/salFlow/act/T9HrSalFlowAct/addSalFlowInfo.act"  method="post" name="form1" id="form1" onsubmit="">
