...
function doInit(){
	...
	var url = "<%=contextPath%>/t9/subsys/oa/hr/salary/salFlow/act/T9HrSalFlowAct/getSalFlowDetail.act?seqId=<%=seqId%>";
...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/salary/salFlow/act/T9HrSalFlowAct/updateSalFlowInfo.act"  method="post" name="form1" id="form1" onsubmit="">
