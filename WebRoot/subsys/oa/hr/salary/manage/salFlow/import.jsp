...
function getSalDataCountByFlowId(){
	var requestURLStr = "<%=contextPath%>/t9/subsys/oa/hr/salary/salFlow/act/T9HrSalFlowAct";
...
function downCSVTemplet(){
	var downUrl = "<%=contextPath%>/t9/subsys/oa/hr/salary/salFlow/act/T9HrSalFlowAct";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  ...
  <br>
  <form name="form1" id="form1" action="<%=contextPath%>/t9/subsys/oa/hr/salary/salFlow/act/T9HrSalFlowAct/impSalDataInfoToCsv.act" method="post" enctype="multipart/form-data">
