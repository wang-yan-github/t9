...
function getChildOrEdit(id){
	...
	if(id.indexOf('r') == -1){  
		...
		var url = "<%=contextPath%>/t9/subsys/oa/hr/salary/submit/act/T9HrSubmitAct/getSalItemIdUserAct.act?userId="+id+"&flowId="+window.parent.flowId+"&history=true";
...
function showStaffInfo(personId){
	...
	parent.location = "<%=contextPath%>/t9/subsys/oa/hr/salary/submit/act/T9HrSubmitAct/getSalItemIdUserAct.act?userId="+personId+"&flowId="+window.parent.flowId+"&history=true";
}
</script>
</head>
