	...
	<tbody>
     ...
     <tr align="center" class="TableLine1">
       ...
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getAllBase(),1) %>
       </td>
     </tr>               
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">养老保险</td>
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getPensionBase(),1) %>
       </td>       
     </tr>  
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位养老</td>
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getPensionU(),1) %>
       </td>       
     </tr> 
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">个人养老</td>
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getPensionP(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">医疗保险</td>
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getMedicalBase(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位医疗</td>
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getMedicalU(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">个人医疗</td>
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getMedicalP(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">生育保险</td>
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getFertilityBase(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位生育</td>
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getFertilityU(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">失业保险</td>
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getUnemploymentBase(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位失业</td>
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getUnemploymentU(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">个人失业</td>
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getUnemploymentP(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">工伤保险</td>
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getInjuriesBase(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位工伤</td>
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getInjuriesU(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">住房公积金</td>
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getHousingBase(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位住房</td>
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getHousingU(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">个人住房</td>
       <td nowrap="" width="300px" align="center">
         <%=T9Utility.getFormatedStr(person.getHousingP(),1) %>
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
