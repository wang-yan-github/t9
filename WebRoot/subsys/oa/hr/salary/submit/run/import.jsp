...
function getSalDataCountByFlowId(){
	var requestURLStr = "<%=contextPath%>/t9/subsys/oa/hr/salary/submit/act/T9HrSubmitAct";
...
function downCSVTemplet(){
	var downUrl = "<%=contextPath%>/t9/subsys/oa/hr/salary/submit/act/T9HrSubmitAct";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  ...
  <br>
  <form name="form1" id="form1" action="<%=contextPath%>/t9/subsys/oa/hr/salary/submit/act/T9HrSubmitAct/impSubmitInfoByCsv.act" method="post" enctype="multipart/form-data">
