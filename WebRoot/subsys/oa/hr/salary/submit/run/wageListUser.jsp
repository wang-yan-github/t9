...
<%@ page  import="t9.subsys.oa.hr.salary.insurancePara.salItem.data.*"%> 
<%@ page  import="t9.subsys.oa.hr.salary.submit.data.*"%> 
...
<%
  ...
  yesOther = (Integer)request.getAttribute("yesOtherId");
	...
	List<T9SalItem> listSalItem = (List<T9SalItem>)request.getAttribute("listSalItem");
	T9SalPerson person = (T9SalPerson)request.getAttribute("person");
	String title = "";
...
function staffNameFunc(cellData){
  var url = contextPath + "/t9/subsys/oa/hr/manage/leave/act/T9HrStaffLeaveAct/getUserName.act";
...
function doSubmit(){
	...
	var url = "<%=contextPath%>/t9/subsys/oa/hr/salary/submit/act/T9HrSubmitAct/setSubmitUserInfo.act"; 
...
function onEditSalar(){
	var url = "<%=contextPath%>/t9/subsys/oa/hr/salary/staffInsurance/act/T9WageBaseSetAct/getSalItemIdUserAct.act?personId=<%=userId%>&userName="+encodeURI($('userName').innerHTML);
  ...
  <input type="hidden" id="ITEM_COUNT" name="ITEM_COUNT" value="<%=listSalItem.size() %>">
	<tbody>
     ...
     <% 
         ...
         String valueStr = T9Utility.getFormatedStr(value,1);
     %>
     ...
     <tr align="center" class="TableLine1">
       ...
       <td nowrap="" width="300px" align="left">
         <input type="text" size=16 value="<%=T9Utility.getFormatedStr(person.getAllBase(),1) %>" class="BigStatic" readonly name="allBase" id="allBase" style="text-align: right;"> 
       </td>
     </tr>               
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">养老保险</td>
       <td nowrap="" width="300px" align="left">
         <input type="text" size="16" value="<%=T9Utility.getFormatedStr(person.getPensionBase(),1) %>" class="BigStatic" readonly name="pensionBase" id="pensionBase" style="text-align: right;">
       </td>       
     </tr>  
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位养老</td>
       <td nowrap="" width="300px" align="left">
         <input type="text" size="16" value="<%=T9Utility.getFormatedStr(person.getPensionU(),1) %>" class="BigStatic" readonly name="pensionU" id="pensionU" style="text-align: right;">
       </td>       
     </tr> 
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">个人养老</td>
       <td nowrap="" width="300px" align="left">
         <input type="text" size="16" value="<%=T9Utility.getFormatedStr(person.getPensionP(),1) %>" class="BigStatic" readonly name="pensionP" id="pensionP" style="text-align: right;">
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">医疗保险</td>
       <td nowrap="" width="300px" align="left">
         <input type="text" size="16" value="<%=T9Utility.getFormatedStr(person.getMedicalBase(),1) %>" class="BigStatic" readonly name="medicalBase" id="medicalBase" style="text-align: right;">
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位医疗</td>
       <td nowrap="" width="300px" align="left">
         <input type="text" size="16" value="<%=T9Utility.getFormatedStr(person.getMedicalU(),1) %>" class="BigStatic" readonly name="medicalU" id="medicalU" style="text-align: right;">
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">个人医疗</td>
       <td nowrap="" width="300px" align="left">
         <input type="text" size="16" value="<%=T9Utility.getFormatedStr(person.getMedicalP(),1) %>" class="BigStatic" readonly name="medicalP" id="medicalP" style="text-align: right;">
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">生育保险</td>
       <td nowrap="" width="300px" align="left">
         <input type="text" size="16" value="<%=T9Utility.getFormatedStr(person.getFertilityBase(),1) %>" class="BigStatic" readonly name="fertilityBase" id="fertilityBase" style="text-align: right;">
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位生育</td>
       <td nowrap="" width="300px" align="left">
         <input type="text" size="16" value="<%=T9Utility.getFormatedStr(person.getFertilityU(),1) %>" class="BigStatic" readonly name="fertilityU" id="fertilityU" style="text-align: right;">
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">失业保险</td>
       <td nowrap="" width="300px" align="left">
         <input type="text" size="16" value="<%=T9Utility.getFormatedStr(person.getUnemploymentBase(),1) %>" class="BigStatic" readonly name="unemploymentBase" id="unemploymentBase" style="text-align: right;">
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位失业</td>
       <td nowrap="" width="300px" align="left">
         <input type="text" size="16" value="<%=T9Utility.getFormatedStr(person.getUnemploymentU(),1) %>" class="BigStatic" readonly name="unemploymentU" id="unemploymentU" style="text-align: right;">
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">个人失业</td>
       <td nowrap="" width="300px" align="left">
         <input type="text" size="16" value="<%=T9Utility.getFormatedStr(person.getUnemploymentP(),1) %>" class="BigStatic" readonly name="unemploymentP" id="unemploymentP" style="text-align: right;">
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">工伤保险</td>
       <td nowrap="" width="300px" align="left">
         <input type="text" size="16" value="<%=T9Utility.getFormatedStr(person.getInjuriesBase(),1) %>" class="BigStatic" readonly name="injuriesBase" id="injuriesBase" style="text-align: right;">
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位工伤</td>
       <td nowrap="" width="300px" align="left">
         <input type="text" size="16" value="<%=T9Utility.getFormatedStr(person.getInjuriesU(),1) %>" class="BigStatic" readonly name="injuriesU" id="injuriesU" style="text-align: right;">
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">住房公积金</td>
       <td nowrap="" width="300px" align="left">
         <input type="text" size="16" value="<%=T9Utility.getFormatedStr(person.getHousingBase(),1) %>" class="BigStatic" readonly name="housingBase" id="housingBase" style="text-align: right;">
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">单位住房</td>
       <td nowrap="" width="300px" align="left">
         <input type="text" size="16" value="<%=T9Utility.getFormatedStr(person.getHousingU(),1) %>" class="BigStatic" readonly name="housingU" id="housingU" style="text-align: right;">
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
       <td nowrap="" width="120px">个人住房</td>
       <td nowrap="" width="300px" align="left">
         <input type="text" size="16" value="<%=T9Utility.getFormatedStr(person.getHousingP(),1) %>" class="BigStatic" readonly name="housingP" id="housingP" style="text-align: right;">
       </td>       
     </tr>   
     <tr align="center" class="TableLine1">
