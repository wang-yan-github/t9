...
function doSubmit(){
  ...
  var url = contextPath + "/t9/subsys/oa/hr/salary/welfare_manager/act/T9SalaryAnalysisAct/doAnalysis.act";
...
function imageReader2(data) {
  ...
  var chart1 = new FusionCharts("/t9/subsys/oa/examManage/examOnline/FusionCharts/Column3D.swf", "chart1Id", "600","300", "0", "0");
...
function imageReader(data) {
  var chart = new FusionCharts("/t9/subsys/oa/examManage/examOnline/FusionCharts/Pie2D.swf", "ChartId", "600", "300", "0", "0");
  var chartData = {"chart":{ "caption" : "薪酬统计分析" ,  "xAxisName" : "",   "yAxisName" : "部门总计" }, "data" : []};
