...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/manage/care/act/T9HrStaffCareAct/getStaffInfoeListJson.act";
  var cfgs = {
    dataAction: url,
...
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/manage/care/act/T9HrStaffCareAct/staffCareReminder.act" method="post" name="form1" id="form1" >
