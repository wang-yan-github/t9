...
<%
  String staffId = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("staffId")));
  String welfareItem = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("welfareItem")));
  String welfareMonth = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("welfareMonth")));
  String welfarePayment = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("welfarePayment")));
     
  String taxAffares = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("taxAffares")));
  String startDate = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("startDate")));
  String endDate = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("endDate")));
  String freeGift = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("freeGift")));
%>
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/hr/salary/welfare_manager/act/T9HrWelfareManageAct/queryWelfareListJson.act?"+param;
  var cfgs = {
    dataAction: url,
