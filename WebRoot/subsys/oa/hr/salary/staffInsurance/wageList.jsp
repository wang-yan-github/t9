...
<%
 ...
 List<T9SalPerson> listPerson = (List<T9SalPerson>)request.getAttribute("listPerson");
...
function goto(){
		window.location.href= contextPath + "/t9/subsys/oa/hr/salary/insurancePara/salItem/act/T9SalaryItemAct/getSalaryItemJson.act";
	}
function doSubmit(){
...
function doInit(){
	...
	var url = "<%=contextPath %>/t9/subsys/oa/hr/salary/staffInsurance/act/T9WageBaseSetAct/wageBaseSetAct.act";
...
function whereDeptId(){
  var temp ="deptId="+<%=deptId%>;	
  var url = "<%=contextPath %>/t9/subsys/oa/hr/salary/staffInsurance/act/T9WageBaseSetAct/whereDeptIdAct.act";
  var rtJson = getJsonRs(url,temp);
...
function doSubmit(){
	...
	var url = "<%=contextPath%>/t9/subsys/oa/hr/salary/staffInsurance/act/T9WageBaseSetAct/setSubmitInfo.act"; 
...
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/hr/salary/staffInsurance/act/T9WageBaseSetAct/addWageBaseAct.act" method="post" name="form1" id="form1">
