...
<%
  ...
  yesOther = (Integer)request.getAttribute("yesOtherId");
	...
	//T9SalPerson person = (T9SalPerson)request.getAttribute("listPerson");
	List<T9SalPerson> listPerson = (List<T9SalPerson>)request.getAttribute("listPerson");
	T9SalPerson  person = listPerson.get(0);
...
function doSubmit(){
	...
	var url = "<%=contextPath%>/t9/subsys/oa/hr/salary/staffInsurance/act/T9WageBaseSetAct/setPLPersonSubmitInfo.act"; 
