...
<%
  ...
  T9HrInsurancePara insurance = null;
  ...
  List<T9HrInsurancePara> insuranceList = (List<T9HrInsurancePara>)request.getAttribute("hrInsurancePara");
...
function doSubmit(){
	...
	var url = "<%=contextPath%>/t9/subsys/oa/hr/salary/staffInsurance/act/T9WageBaseSetAct/setOnePersonSubmitInfo.act"; 
   ...
   if(yesOther==1){ %>   
	     ...
	     <tr align="center" class="TableLine1">
	       ...
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getAllBase(),1) %>" class="SmallInput" name="allBase" id="allBase" style="text-align: right;"> 
	     ...
	     <tr align="center" class="TableLine1">
	       ...
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getPensionBase(),1) %>" class="SmallInput" name="pensionBase" id="pensionBase" style="text-align: right;">
	       </td>       
	     </tr>  
	     <tr align="center" class="TableLine1">
	       <td nowrap="" width="120px">单位养老</td>
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getPensionU(),1) %>" class="SmallInput" name="pensionU" id="pensionU" style="text-align: right;">
	       </td>       
	     </tr> 
	     <tr align="center" class="TableLine1">
	       <td nowrap="" width="120px">个人养老</td>
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getPensionP(),1) %>" class="SmallInput" name="pensionP" id="pensionP" style="text-align: right;">
	       </td>       
	     </tr>   
	     <tr align="center" class="TableLine1">
	       <td nowrap="" width="120px">医疗保险</td>
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getMedicalBase(),1) %>" class="SmallInput" name="medicalBase" id="medicalBase" style="text-align: right;">
	       </td>       
	     </tr>   
	     <tr align="center" class="TableLine1">
	       <td nowrap="" width="120px">单位医疗</td>
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getMedicalU(),1) %>" class="SmallInput" name="medicalU" id="medicalU" style="text-align: right;">
	       </td>       
	     </tr>   
	     <tr align="center" class="TableLine1">
	       <td nowrap="" width="120px">个人医疗</td>
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getMedicalP(),1) %>" class="SmallInput" name="medicalP" id="medicalP" style="text-align: right;">
	       </td>       
	     </tr>   
	     <tr align="center" class="TableLine1">
	       <td nowrap="" width="120px">生育保险</td>
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getFertilityBase(),1) %>" class="SmallInput" name="fertilityBase" id="fertilityBase" style="text-align: right;">
	       </td>       
	     </tr>   
	     <tr align="center" class="TableLine1">
	       <td nowrap="" width="120px">单位生育</td>
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getFertilityU(),1) %>" class="SmallInput" name="fertilityU" id="fertilityU" style="text-align: right;">
	       </td>       
	     </tr>   
	     <tr align="center" class="TableLine1">
	       <td nowrap="" width="120px">失业保险</td>
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getUnemploymentBase(),1) %>" class="SmallInput" name="unemploymentBase" id="unemploymentBase" style="text-align: right;">
	       </td>       
	     </tr>   
	     <tr align="center" class="TableLine1">
	       <td nowrap="" width="120px">单位失业</td>
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getUnemploymentU(),1) %>" class="SmallInput" name="unemploymentU" id="unemploymentU" style="text-align: right;">
	       </td>       
	     </tr>   
	     <tr align="center" class="TableLine1">
	       <td nowrap="" width="120px">个人失业</td>
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getUnemploymentP(),1) %>" class="SmallInput" name="unemploymentP" id="unemploymentP" style="text-align: right;">
	       </td>       
	     </tr>   
	     <tr align="center" class="TableLine1">
	       <td nowrap="" width="120px">工伤保险</td>
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getInjuriesBase(),1) %>" class="SmallInput" name="injuriesBase" id="injuriesBase" style="text-align: right;">
	       </td>       
	     </tr>   
	     <tr align="center" class="TableLine1">
	       <td nowrap="" width="120px">单位工伤</td>
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getInjuriesU(),1) %>" class="SmallInput" name="injuriesU" id="injuriesU" style="text-align: right;">
	       </td>       
	     </tr>   
	     <tr align="center" class="TableLine1">
	       <td nowrap="" width="120px">住房公积金</td>
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getHousingBase(),1) %>" class="SmallInput" name="housingBase" id="housingBase" style="text-align: right;">
	       </td>       
	     </tr>   
	     <tr align="center" class="TableLine1">
	       <td nowrap="" width="120px">单位住房</td>
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getHousingU(),1) %>" class="SmallInput" name="housingU" id="housingU" style="text-align: right;">
	       </td>       
	     </tr>   
	     <tr align="center" class="TableLine1">
	       <td nowrap="" width="120px">个人住房</td>
	       <td nowrap="" width="230px" align="left">
	         <input type="text" size="20" value="<%=T9Utility.getFormatedStr(person.getHousingP(),1) %>" class="SmallInput" name="housingP" id="housingP" style="text-align: right;">
	       </td>       
	     </tr>   
  <%} %>
	</tbody>
