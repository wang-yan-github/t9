<%@ page language="java" import="t9.subsys.oa.vmeet.act.*,java.text.*,t9.core.global.T9SysProps"  contentType="text/html;charset=utf-8"%>
...
try{
	String sql = "INSERT INTO zl_file(name,file_name,fsize,roomid,create_date) values('"
