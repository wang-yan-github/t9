...
function getVMeetPriv(){
    var url = contextPath + "/t9/subsys/oa/vmeet/act/T9VMeetAct/getVMeetPriv.act";
...
function savePriv(){
   ...
   var url = contextPath + "/t9/subsys/oa/vmeet/act/T9VMeetAct/setVMeetPriv.act";
...
function saveVMeet(){
	   ...
	   var url = contextPath + "/t9/subsys/oa/vmeet/act/T9VMeetAct/addVMeetInfo.act";
...
function getBeginVM(){
	  var url = contextPath + "/t9/subsys/oa/vmeet/act/T9VMeetAct/getLastBeginMeetAct.act"; 
...
function delVM(seqId){
	if(window.confirm("确定删除会议?")){
	  var url = contextPath + "/t9/subsys/oa/vmeet/act/T9VMeetAct/deleteVMeetAct.act";
...
function getInvitedVM(){
	  var url = contextPath + "/t9/subsys/oa/vmeet/act/T9VMeetAct/getLastInvitedMeetAct.act"; 
	  var rtJsons = getJsonRs(url);
	     if (rtJsons.rtState == "0") {
	      var data=rtJsons.rtData;
	      for(var i=0;i<data.length;i++){
