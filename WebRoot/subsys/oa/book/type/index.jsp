...
function CheckForm(){
  ...
  if(typeName.replaceAll(" ","")!="" && typeName != "null"){
	  $("form1").action = contextPath + "/t9/subsys/oa/book/act/T9BookTypeAct/addBookType.act";
  ...
  if(!window.confirm(msg)){
   ...
   // var bookTypeId = $("bookTypeId").value;
    if(delBookId!="" && delBookId!="null"){
      $("form1").action = contextPath + "/t9/subsys/oa/book/act/T9BookTypeAct/deleteBookType.act?bookId="+delBookId;  
      document.form1.submit(); 
      return true;
    }
  }
...
function doInit(){
  //$("form1").action = contextPath + "/t9/subsys/oa/book/act/T9BookTypeAct/findBookType.act";
  //document.form1.submit();
  //return true;
 // /t9/subsys/oa/book/act/T9BookTypeAct/findBookType.act
}
--></script>
  <% 
  ...
  <table  width="400"  class="TableList">
   ...
   %>
    <tr class="TableLine1">
	      ...
	      <a href="<%=contextPath%>/t9/subsys/oa/book/act/T9BookTypeAct/editBookType.act?bookId=<%=booktype.get(i).getSeqId()%>"> 编辑</a>
