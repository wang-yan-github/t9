 ...
 String.prototype.replaceAll = function(s1,s2){ 
	...
	// var typeName = $("TYPE_NAME").value;
	 ...
	 if(typeName.replaceAll(" ","") != "" && typeName !="null"){
	   ...
	   $("form1").action = contextPath + "/t9/subsys/oa/book/act/T9BookTypeAct/updateBookType.act?typeName="+typeName+"&&typeId="+typeId;
	...
	function gotoIndex(){
    window.location.href =contextPath + "/t9/subsys/oa/book/act/T9BookTypeAct/findBookType.act";
	}
</script>
  <%
  T9BookType bookType = (T9BookType)request.getAttribute("bookType");
