 ...
 */
function typeAjax(){
  var url = contextPath + "/t9/subsys/oa/book/act/T9BookQueryAct/findBookTypes.act";
...
<br>
  <form action="<%=contextPath%>/t9/subsys/oa/book/act/T9BookQueryAct/findBooks.act"  method="post" name="form1" id="form1">  
