...
<script Language="JavaScript"><!--
   ...
   function gotoPage(currNo){   
     ...
     var url = contextPath + "/t9/subsys/oa/book/act/T9BookQueryAct/findBooks2.act?";
     //$("form1").submit();
   ...
   function detail(bookId){
    var URL=contextPath + "/t9/subsys/oa/book/act/T9BookQueryAct/detail.act?bookId="+ bookId;
