...
<%
  ...
  List<T9BookManage> manages = (List<T9BookManage>)request.getAttribute("manages");
%>
...
function delete_manage(BORROW_ID)
{
 ...
 if(window.confirm(msg)){
  var URL= contextPath + "/t9/subsys/oa/book/act/T9BookQueryAct/deleteManage.act?seqId=" + BORROW_ID + "&status="+status;
  window.location=URL;
 }
}
...
function return_book(BORROW_ID)
{
 ...
 if(window.confirm(msg))
 {
   var URL= contextPath + "/t9/subsys/oa/book/act/T9BookQueryAct/returnBooks.act?seqId=" + BORROW_ID + "&status="+status;
  window.location=URL;
 }
}
...
function delete_flag(BORROW_ID)
{
 ...
 if(window.confirm(msg))
 {
   var URL= contextPath + "/t9/subsys/oa/book/act/T9BookQueryAct/deleteFlag.act?seqId=" + BORROW_ID + "&status=" +status + "&delFlag=1";
   window.location=URL;
 }
}
</script>
