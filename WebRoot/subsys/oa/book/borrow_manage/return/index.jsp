...
function goBack(){
  var url = contextPath + "/t9/subsys/oa/book/act/T9BookRuleAct/index.act";
...
<br>
<br>
<form action="<%=contextPath%>/t9/subsys/oa/book/act/T9BookRuleAct/regBorrowBook.act"  method="post" name="form1" id="form1">
