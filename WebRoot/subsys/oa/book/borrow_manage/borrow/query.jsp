...
function doInit(){  
  ...
  if(flag == 0){
    $("form1").action = contextPath + "/t9/subsys/oa/book/act/T9BookRuleAct/findHistory.act";    
  }
}
...
<div align="center">
 <form action="<%=contextPath%>/t9/subsys/oa/book/act/T9ReturnBookManageAct/returnBookManage.act"  method="post" id="form1" name="form1" >  
