...
function deleteBorrow(seqId){
  var  msg='确认要删除该记录吗？';
  if(window.confirm(msg)){
    var url = contextPath + "/t9/subsys/oa/book/act/T9BookRuleAct/deleteHistory.act?seqId="+seqId;
...
<form action="<%=contextPath %>/t9/subsys/oa/book/act/T9BookRuleAct/findHistory.act" id="form1" name="form1">
