...
<head>
<%
    List<T9BookManage> manages = (List<T9BookManage>)request.getAttribute("manage");
...
<script type="text/javascript">
 ...
 function returnBook(seqId,bookNo1){
  ...
  // alert(userId+"=="+bookNo+"=="+startDate+"=="+status);
   ...
   var url = contextPath+"/t9/subsys/oa/book/act/T9ReturnBookManageAct/updateBookManage.act?"+param;
 ...
 function deleteSave(seqId,bookNo2){
   ...
   if(window.confirm(msg))
   {
     ...
     var url = contextPath+"/t9/subsys/oa/book/act/T9ReturnBookManageAct/deleteSaveBook.act?"+param;
     window.location.href = url;
     return true;
   }
  }
