...
function newbook(){
  window.location.href= contextPath + "/t9/subsys/oa/book/act/T9BookTypeAct/selectBookType.act"
}
/*
...
function export_csv(){
  ...
  var src=contextPath+"/t9/subsys/oa/book/act/T9BookTypeAct/SysExport.act?"+parameter;
...
function findBookInfo(){
  ///t9/subsys/oa/book/act/T9BookTypeAct/findBooks.act
  var typeId = $("typeId").value;
  var lend = $("lend").value; 
  var bookName = $("bookName").value;
  var bookNo = $("bookNo").value; 
  ...
  var orderflag = $("orderflag").value;
  var parameter ="typeId="+typeId+"&lend="+lend+"&bookName="+bookName+"&bookNo="+bookNo+"&author="+author+"&isbn="+isbn+"&pub_house="+pub_house+"&area="+area+"&orderflag"+orderflag;
  var src = contextPath+"/t9/subsys/oa/book/act/T9BookTypeAct/findBooks.act?"+parameter;
  document.form1.action = src;
  document.form1.submit();
  return true;
}
