...
<%
  ...
  List<T9BookInfo> books = (List<T9BookInfo>)request.getAttribute("books");
  T9BookInfo conditon = (T9BookInfo)request.getAttribute("conditon");
...
<script Language="JavaScript">
   ...
   function borrowBook(bookSeqId){
    ...
    // window.open(url);
    var url  = contextPath + "/t9/subsys/oa/book/act/T9BookTypeAct/selectBookTypeId.act?bookSeqId="+ bookSeqId;
  ...
  function deleteBookInfo(deleteSeqId){
   ...
   if(!window.confirm(msg)){
     ...
     if(noHiddenId && noHiddenId!="null"){
       window.location.href = contextPath + "/t9/subsys/oa/book/act/T9BookTypeAct/deleteBookInfo.act?HiddenId="+deleteSeqId;  
       return true;
      }
    }
  ...
  function deleteCheckBook(){
    ...
    if(window.confirm(msg)){
       ...
       var url = contextPath + '/t9/subsys/oa/book/act/T9BookTypeAct/deleteSelectBook.act';
...
<form action="<%=contextPath%>/t9/subsys/oa/book/act/T9BookTypeAct/findBooks.act" method="get" name="form1" id="form1">
