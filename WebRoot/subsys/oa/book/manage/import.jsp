...
*/
  function checkForm() {
    ...
    document.form1.action = contextPath + "/t9/subsys/oa/book/act/T9BookTypeAct/importBookTypeinfo.act";
  ...
  */
  function templetImport(){
    document.form1.action = contextPath + "/t9/subsys/oa/book/act/T9BookTypeAct/templetImport.act";
    document.form1.submit();
    return true;
  }
