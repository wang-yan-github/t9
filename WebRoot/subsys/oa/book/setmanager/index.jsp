...
<%
	List<T9BookManager> managers = (List<T9BookManager>)request.getAttribute("managers");
%>
<html>
<head>
<title>设置管理员 </title>
   ...
   window.location = contextPath + "/subsys/oa/book/setmanager/addManager.jsp"
	...
	function deleteManager(seqId){
	  ...
	  if(window.confirm(msg)){	   
	    var url = contextPath + "/t9/subsys/oa/book/act/T9SetBookManagerAct/delManager.act?seqId="+seqId;
      ...
      for(int i=0; i<managers.size(); i++){%>
       <tr class="TableLine1">
          ...
          <td align="left" width="50%" nowrap>
    	       <a href="<%=contextPath %>/t9/subsys/oa/book/act/T9SetBookManagerAct/editManager.act?seqId=<%=managers.get(i).getSeqId()%>">编辑</a>&nbsp;&nbsp;
