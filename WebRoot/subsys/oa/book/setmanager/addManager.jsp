...
<%
  T9BookManager manager = (T9BookManager)request.getAttribute("manager");
  boolean flag = false;
  String names = "";
  String manageIds = "";
  String deptNames = "";
...
<script Language="JavaScript"> 
    ...
    if(flag == true){
      ...
      $("seqId").value= seqId;
      $("form1").action = contextPath + "/t9/subsys/oa/book/act/T9SetBookManagerAct/updateManager.act";
    }  
	}
	...
	function goBack(){
   window.location.href= contextPath + "/t9/subsys/oa/book/act/T9SetBookManagerAct/index.act";
	}
...
<body class="bodycolor" topmargin="5" onload="doInit();">
	...
	<form action="<%=contextPath%>/t9/subsys/oa/book/act/T9SetBookManagerAct/addManager.act"  method="post" name="form1" id="form1">
