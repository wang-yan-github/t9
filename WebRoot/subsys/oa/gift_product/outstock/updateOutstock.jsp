...
function getOutstockBack(seqId){
  var requestURL = "<%=contextPath%>/t9/subsys/oa/giftProduct/outstock/act/T9GiftOutstockAct/getOutstockById.act?seqId="+seqId;
...
function Init(){
  if(CheckForm()){
    var requestURL = "<%=contextPath%>/t9/subsys/oa/giftProduct/outstock/act/T9GiftOutstockAct/updateGiftstockInfo.act";
