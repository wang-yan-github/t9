...
function doInit(){	
  ...
  ,requestUrl:contextPath + '/t9/subsys/oa/giftProduct/instock/act/T9GiftInstockAct/getGiftTypeTree.act?GIFT_PROTYPE=GIFT_PROTYPE&id='
  ,isOnceLoad:false
...
function CheckFrom(){
  ...
  if(giftName==''){
    ...
    var requestUrl = "<%=contextPath%>/t9/subsys/oa/giftProduct/instock/act/T9GiftInstockAct/selectGiftInstockByName.act?giftName="+encodeURI(giftName);
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small" >
  <tr>
    <td class="Big"><img src="/t9/core/funcs/system/filefolder/images/notify_open.gif" align="absmiddle"><span class="big3"> 模糊查询礼品</span>
    </td>
  </tr>
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/t9/core/funcs/system/filefolder/images/notify_open.gif" align="absmiddle"><span class="big3"> 请选择礼品</span>
    </td>
  </tr>
</table>
<dir id="xtree"></dir>
