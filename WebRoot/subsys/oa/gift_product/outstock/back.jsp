...
function getOutstockBack(seqId){
  var requestURL = "<%=contextPath%>/t9/subsys/oa/giftProduct/outstock/act/T9GiftOutstockAct/getOutstockByIdBack.act?seqId="+seqId;
    var json = getJsonRs(requestURL); 
      //alert(rsText);
    if(json.rtState == '1'){ 
      alert(json.rtMsrg); 
...
function Init(){
  if(CheckForm()){
    var requestURL = "<%=contextPath%>/t9/subsys/oa/giftProduct/outstock/act/T9GiftOutstockAct/updateGiftstock.act";
