...
function doOnload(){
  ...
  var toDate = '<%=toDate%>';
  var url = "<%=contextPath%>/t9/subsys/oa/giftProduct/outstock/act/T9GiftOutstockAct/queryGiftByTemp.act?giftType="+giftType+"&giftId="+giftId+"&giftName="+encodeURI(giftName)+"&fromDate="+fromDate+"&toDate="+toDate;
  cfgs = {
   dataAction: url,
   container: "bodyDiv",
   colums: [
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/t9/core/funcs/system/filefolder/images/notify_open.gif" WIDTH="22" HEIGHT="22" align="absmiddle"><span class="big3">礼品管理明细</span>
    </td>
</tr>
</table>
 <div id="bodyDiv">
