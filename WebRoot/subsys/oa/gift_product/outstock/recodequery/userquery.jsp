...
function doOnload(){
  var userId = '<%=userId%>';
  var requestURL = "<%=contextPath%>/t9/subsys/oa/giftProduct/outstock/act/T9GiftOutstockAct/getOutstockByUserId.act?userId="+userId;
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/t9/core/funcs/system/filefolder/images/notify_open.gif" WIDTH="22" HEIGHT="22" align="absmiddle"><span class="big3">&nbsp;礼品领用登记明细</span>
    </td>
  </tr>
</table>
