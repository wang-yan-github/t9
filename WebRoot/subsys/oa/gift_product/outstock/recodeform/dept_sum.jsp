...
function doOnload(){
  ...
  var requestUrl = "<%=contextPath%>/t9/core/funcs/calendar/info/act/T9InfoAct/selectDeptToAttendance.act?deptId="
...
function getGiftOutByDeptId(deptId){
  var requestURL = "<%=contextPath%>/t9/subsys/oa/giftProduct/outstock/act/T9GiftOutstockAct/getGiftOutByDeptId.act?fromDate="+fromDate+"&toDate="+toDate+"&giftId="+giftId+"&giftType="+giftType+"&deptId="+deptId;
