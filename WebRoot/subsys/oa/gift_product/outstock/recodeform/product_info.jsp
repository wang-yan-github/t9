...
var toDate = '<%=toDate%>';
function doOnload(){
  var requestURL = "<%=contextPath%>/t9/subsys/oa/giftProduct/outstock/act/T9GiftOutstockAct/selectProductInfo.act?fromDate="+fromDate+"&toDate="+toDate+"&giftId="+giftId+"&giftType="+giftType;
