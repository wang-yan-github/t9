...
var toDate = '<%=toDate%>';
function doOnload(){
  var requestURL = "<%=contextPath%>/t9/subsys/oa/giftProduct/outstock/act/T9GiftOutstockAct/selectReport.act?fromDate="+fromDate+"&toDate="+toDate+"&giftId="+giftId+"&giftType="+giftType;
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/t9/core/funcs/system/filefolder/images/notify_open.gif" WIDTH="22" HEIGHT="22" align="absmiddle">
