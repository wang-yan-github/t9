...
function doOnload(){
  var seqId = '<%=seqId%>';
  var requestURL = "<%=contextPath%>/t9/subsys/oa/giftProduct/instock/act/T9GiftInstockAct/getInstockById.act?seqId="+seqId; 
...
function Init(){
  ...
  if(CheckForm()){
    var requestUrl = "<%=contextPath%>/t9/subsys/oa/giftProduct/instock/act/T9GiftInstockAct/upateGiftInstock.act";
...
function delInstock(){
  ...
  if(window.confirm(msg)){
    var requestUrl = "<%=contextPath%>/t9/subsys/oa/giftProduct/instock/act/T9GiftInstockAct/delGiftInstockById.act?seqId="+seqId;
    var rtJson = getJsonRs(requestUrl);
    if(rtJson.rtState == "1"){
      alert(rtJson.rtMsrg); 
      return ;
...
<body class="" topmargin="5" onload="doOnload();">
  ...
  <input type="hidden" id="dtoClass" name="dtoClass" value="t9.subsys.oa.giftProduct.instock.data.T9GiftInstock"/>
