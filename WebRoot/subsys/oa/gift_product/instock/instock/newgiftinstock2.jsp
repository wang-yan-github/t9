...
function getCodeItem(seqId){
  var requestURL = "<%=contextPath%>/t9/subsys/oa/giftProduct/instock/act/T9GiftInstockAct/getCodeItemById.act?seqId="+seqId; 
...
function Init(){
  if(CheckForm()){
    var requestUrl = "<%=contextPath%>/t9/subsys/oa/giftProduct/instock/act/T9GiftInstockAct/addGiftInstock.act?";
...
function codeInit(){
  if(CheckFormType()){
    var requestUrl = "<%=contextPath%>/t9/subsys/oa/giftProduct/instock/act/T9GiftInstockAct/updateCodeItemById.act";
