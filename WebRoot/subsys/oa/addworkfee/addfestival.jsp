...
<html>
<%
  List<T9Festival> fets = (List<T9Festival>)request.getAttribute("fets");
  int year = (Integer)request.getAttribute("year");
  T9Festival fest = (T9Festival)request.getAttribute("fest");
  String pYear = "";
  String pName = "";
  String begin = "";
  String end = "";
...
<script type="text/javascript"> 
  ...
  function parseList(yearList){
	...
	function updateOpt(){
	  if(pYear){
     $("year").value=pYear;
     $("form1").action = contextPath + "/t9/subsys/oa/addworkfee/act/T9FestivalAct/updateFestival.act";
		}
	  if(pName){
	...
	function delOpt(seqId, year){
	  if(confirm("确实要删除此项么?")){
		  window.location.href = contextPath + "/t9/subsys/oa/addworkfee/act/T9FestivalAct/delFestvial.act?seqId="+seqId+"&year="+year;
	  }
    return false;
	}
	...
	function editOpt(seqId){
		  ...
		  window.location.href = contextPath + "/t9/subsys/oa/addworkfee/act/T9FestivalAct/editFestival.act?seqId="+seqId;
    ...
    window.location.href = contextPath + "/t9/subsys/oa/addworkfee/act/T9FestivalAct/findFestvialList.act?year="+year;
    return false;
  }
</script>
</head>
...
<br>
<form action="<%=contextPath%>/t9/subsys/oa/addworkfee/act/T9FestivalAct/addFestival.act" id="form1" name="form1">
