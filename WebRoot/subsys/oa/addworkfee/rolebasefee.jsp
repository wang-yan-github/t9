	...
	<%@ page import="java.util.List, t9.subsys.oa.addworkfee.data.*" %>
<html>
<%
  List<T9RoleBaseFee> fees = ( List<T9RoleBaseFee>)request.getAttribute("fees");
  T9RoleBaseFee fee = (T9RoleBaseFee)request.getAttribute("fee");
  String seqId = "";
  String base = "";
  String noradd = "";
  String festadd = "";
...
var name = "<%=name%>";
   function doInit(){
     if(seqId){
       $("seqId").value = seqId;
       $("form1").action = contextPath + "/t9/subsys/oa/addworkfee/act/T9RoleBaseFeeAct/updatRoleBaseFee.act";
     }
     if(base){
       $("baseAdd").value = base;
     }
   ...
   function editOPt(seqId){
 		  ...
 		  window.location.href = contextPath + "/t9/subsys/oa/addworkfee/act/T9RoleBaseFeeAct/editRoleBaseFee.act?seqId="+seqId;
   ...
   function delOPt(seqId){
     if(confirm("确实要删除此项么?")){
 		   window.location.href = contextPath + "/t9/subsys/oa/addworkfee/act/T9RoleBaseFeeAct/delRoleBaseFee.act?seqId="+seqId;
 		   return false;
 		 }
  }
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/t9/core/styles/style3/img/infofind.gif" align="absmiddle"><span class="big3">加班费基数设置</span>
    </td>
  </tr>
</table>
<br>
<form action="<%=contextPath%>/t9/subsys/oa/addworkfee/act/T9RoleBaseFeeAct/delRoleBaseFee.act" id="form2" name="form2">
  <input type="hidden" name="seqIdDel" id="seqIdDel" value=""></input>
</form>
<form action="<%=contextPath%>/t9/subsys/oa/addworkfee/act/T9RoleBaseFeeAct/addRoleBaseFee.act" id="form1" name="form1">
 ...
 <table width="50%" border="0" class="TableList pgTable" id="dataTable" align="center">
  ...
  <%
    for(int i=0; i< fees.size(); i++){
      T9RoleBaseFee currFee = fees.get(i);
  %>
    <tr class="TableLine2">
