...
<html>
 <%
   List<T9ChangeRest> rests  = (List<T9ChangeRest>)request.getAttribute("rests");
   T9ChangeRest  fest = (T9ChangeRest)request.getAttribute("fest");
...
function updateOpt(){
  if(pYear){
   $("year").value=pYear;
   $("form1").action = contextPath + "/t9/subsys/oa/addworkfee/act/T9ChangeRestAct/updateFestival.act";
	}
  if(type){
     if(type == 1){
        $("type1").checked = true;
...
function editOpt(seqId){
  window.location.href = contextPath + "/t9/subsys/oa/addworkfee/act/T9ChangeRestAct/editFestival.act?seqId="+seqId;
  return false;
}

function delOpt(seqId, year){
  if(confirm("确实要删除此项么?")){
    window.location.href = contextPath + "/t9/subsys/oa/addworkfee/act/T9ChangeRestAct/delFestvial.act?seqId="+seqId+"&year="+year;
  }
  return false;
}
...
function onSelChange(){
  ...
  window.location.href = contextPath + "/t9/subsys/oa/addworkfee/act/T9ChangeRestAct/findFestvialList.act?year="+year;
  return false;
}
</script>
...
<br>
<form action="<%=contextPath %>/t9/subsys/oa/addworkfee/act/T9ChangeRestAct/addChangeRest.act" id="form1" name="form1">
