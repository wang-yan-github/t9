...
function doInit(){
	getNetmeetingState();
  var url = "<%=contextPath%>/t9/subsys/oa/netmeeting/text/act/T9NetmeetingAct/getNetmeetingInfoListJson.act";
  var cfgs = {
    dataAction: url,
...
function deleteSingle(seqId){
	if(confirm("确定要删除该项文本会议吗？会议记录将被删除！")){
	  var url = contextPath + "/t9/subsys/oa/netmeeting/text/act/T9NetmeetingAct/deleteNetmeeting.act";
...
function doStop(seqId,type){
  var url = contextPath + "/t9/subsys/oa/netmeeting/text/act/T9NetmeetingAct/doStop.act";
