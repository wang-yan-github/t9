...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/netmeeting/text/act/T9NetmeetingAct/addNetmeetingInfo.act"  method="post" name="form1" id="form1" onsubmit="">
