...
String toIdStr = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("toIdStr")));
%>
...
function staffNameFunc(toIdStr){
  var url = contextPath + "/t9/subsys/oa/netmeeting/text/act/T9NetmeetingAct/getUserName.act";
...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/netmeeting/text/act/T9NetmeetingAct/updateNetmeetingInfo.act"  method="post" name="form1" id="form1" onsubmit="">
