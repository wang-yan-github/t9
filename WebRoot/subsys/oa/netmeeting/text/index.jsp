...
function doInit(){
	getNetmeetingState();
  var url = "<%=contextPath%>/t9/subsys/oa/netmeeting/text/act/T9NetmeetingAct/getNetmeetingInfoList.act";
  var cfgs = {
    dataAction: url,
...
function opts(cellData, recordIndex, columIndex){
  ...
  var url = contextPath + "/t9/subsys/oa/netmeeting/text/act/T9NetmeetingAct/joinNeetingCount.act?seqId=" + seqId;
...
function joinMeeting(recordIndex){
  ...
  var url = contextPath + "/t9/subsys/oa/netmeeting/text/act/T9NetmeetingAct/joinNeeting.act?seqId=" + seqId;
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
