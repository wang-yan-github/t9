...
var pageMgr = null;
function doInit(){
  var url = "<%=contextPath%>/t9/subsys/oa/netmeeting/video/act/T9VideoMeetingAct/checkUser.act";
...
function getMeeting(){
  var url = "<%=contextPath%>/t9/subsys/oa/netmeeting/video/act/T9VideoMeetingAct/getVideoMeetingListInfo.act";
  var cfgs = {
    dataAction: url,
