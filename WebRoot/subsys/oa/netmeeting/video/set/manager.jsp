...
var pageMgr;
function doInit(){
  var requestURL = "<%=contextPath%>/t9/subsys/oa/netmeeting/video/act/T9VideoMeetingAct/getPage.act";
  var cfgs = {
...
function deleteRecord(recordIndex){
  ...
  var url = "<%=contextPath %>/t9/subsys/oa/netmeeting/video/act/T9VideoMeetingAct/deleteManager.act";
...
function submitForm() {
  ...
  var url = "<%=contextPath %>/t9/subsys/oa/netmeeting/video/act/T9VideoMeetingAct/editManager.act";
  var json = getJsonRs(url,pars);
  if (json.rtState == "0"){
    alert("操作成功");
    pageMgr.refreshAll();
  ...
  <table class="TableBlock" width="450" align="center">
   ...
   <tr>
    <td nowrap  class="TableControl" colspan="2" align="center">
      ...
      <input type="hidden" value="t9.subsys.oa.netmeeting.video.data.T9VideoMeetingManager" name="dtoClass" id="dtoClass">
