...
<script> 
function doInit(){
  var url = "<%=contextPath %>/t9/subsys/oa/netmeeting/video/act/T9VideoMeetingAct/getParameters.act";
...
function submitForm() {
  ...
  var url = "<%=contextPath %>/t9/subsys/oa/netmeeting/video/act/T9VideoMeetingAct/setParameters.act";
