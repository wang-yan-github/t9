...
<link rel="stylesheet" href="<%=cssPath%>/cmp/Calendimport="java.util.*,java.text.SimpleDateFormat,t9.core.funcs.person.data.T9Person,t9.core.funcs.calendar.data.*"ar.css" type="text/css" />
...
<br>
<form action="<%=contextPath%>/t9/subsys/oa/netmeeting/video/act/T9VideoMeetingAct/addVideoMeeting.act"  method="post" name="form1" id="form1" onsubmit="">
