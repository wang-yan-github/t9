...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/netmeeting/video/act/T9VideoMeetingAct/queryVideoMeetingList.act?" + param;
  var cfgs = {
    dataAction: url,
...
function deleteSingle(recordIndex){
  ...
  var confKey = pageMgr.getCellData(recordIndex,"confKey");
  var requestUrl = contextPath + "/t9/subsys/oa/netmeeting/video/act/T9VideoMeetingAct/deleteMeeting.act?confKey="+confKey; 
...
function formSubmit(){
  var url = "<%=contextPath%>/t9/subsys/oa/netmeeting/video/act/T9VideoMeetingAct/doJoinVideoMeeting.act?confKey=" + $('confKey').value + "&password=" + $('password').value;
