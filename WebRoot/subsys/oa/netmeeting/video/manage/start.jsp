...
<%
	String confKey = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("confKey")));
	String confType = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("confType")));
	String duringTime = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("duringTime")));
	String hostName = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("hostName")));
	String startTime = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("startTime")));
	String endTime = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("endTime")));
	String status = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("status")));
	String subject = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("subject")));
%>
...
function doSubmit(){
  if(checkForm()){
	  ...
	  var url = "<%=contextPath%>/t9/subsys/oa/netmeeting/video/act/T9VideoMeetingAct/doStartVideoMeeting.act";
