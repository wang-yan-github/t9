...
function doInit(){
  setDate();
  var url = "<%=contextPath%>/t9/subsys/oa/netmeeting/video/act/T9VideoMeetingAct/getVideoMeeting.act?confKey=<%=confKey%>";
...
<br>
<form action="<%=contextPath%>/t9/subsys/oa/netmeeting/video/act/T9VideoMeetingAct/updateVideoMeetingInfo.act"  method="post" name="form1" id="form1" onsubmit="">
