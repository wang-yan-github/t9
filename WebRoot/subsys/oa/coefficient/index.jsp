...
function doSubmit(){
	if(checkForm()){
		...
		var requestURL = "<%=contextPath %>/t9/subsys/oa/coefficient/act/T9CoefficientAct/addCoefficient.act";
...
function doInit(){
	var requestURL = "<%=contextPath %>/t9/subsys/oa/coefficient/act/T9CoefficientAct/getCoefficient.act";
