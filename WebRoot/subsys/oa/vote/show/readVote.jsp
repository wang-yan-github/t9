...
function updateTitleReaders(seqId){
  var url= "<%=contextPath%>/t9/subsys/oa/vote/act/T9VoteTitleAct/updateReaders.act?seqId="+seqId;
...
function updateItemUserId(anonymity,itemIds){
  var url= "<%=contextPath%>/t9/subsys/oa/vote/act/T9VoteItemAct/updateUserId.act?seqIds="+itemIds + "&anonymity="+anonymity;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
...
function addData(voteId,fieldName){
  ...
  var url= "<%=contextPath%>/t9/subsys/oa/vote/act/T9VoteDataAct/addData.act?itemId="+voteId + "&fieldData="+encodeURIComponent(fieldData) + "&fieldName=0";
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
...
function addDataToItem(itemId,count,fieldName){
  ...
  var url= "<%=contextPath%>/t9/subsys/oa/vote/act/T9VoteDataAct/addData.act?itemId="+itemId + "&fieldData="+encodeURIComponent(fieldData) + "&fieldName="+count;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
...
function getVoteById(seqId){
  var url= "<%=contextPath%>/t9/subsys/oa/vote/act/T9VoteTitleAct/selectVoteById.act?seqId="+seqId;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
...
function getVoteItem(voteId){
  var url= "<%=contextPath%>/t9/subsys/oa/vote/act/T9VoteItemAct/selectItemByVoteId.act?voteId="+voteId;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
...
function getChiidVoteByParent(parentId){
  var url= "<%=contextPath%>/t9/subsys/oa/vote/act/T9VoteItemAct/getChiidVoteByParent.act?parentId="+parentId;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
