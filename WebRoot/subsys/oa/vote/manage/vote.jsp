...
var seqId = "<%=seqId%>";
function doInit () {
  var url = "<%=contextPath%>/t9/subsys/oa/vote/act/T9VoteTitleAct/showVote.act?seqId=" + seqId;
  cfgs = {
   dataAction: url,
   container: "giftList",
   colums: [ 
...
function deleteVote (seqId) {
  ...
  if (window.confirm(msg)) {
    var url = "<%=contextPath%>/t9/subsys/oa/vote/act/T9VoteTitleAct/deleteVote.act?seqIds=" + seqId + ",";
