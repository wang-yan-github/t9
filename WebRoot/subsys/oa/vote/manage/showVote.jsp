...
function getVoteById(seqId){
  var url= "<%=contextPath%>/t9/subsys/oa/vote/act/T9VoteTitleAct/selectVoteById2.act?seqId="+seqId;
...
function getData(itemId,fieldName){
  var url= "<%=contextPath%>/t9/subsys/oa/vote/act/T9VoteDataAct/getDataByItemId.act?itemId="+itemId + "&fieldName="+fieldName;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "0"){
    var prc = rtJson.rtData;
...
function getItemBySeqId(seqId){
  var url= "<%=contextPath%>/t9/subsys/oa/vote/act/T9VoteItemAct/getItemBySeqId.act?seqId="+seqId;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
...
function outVote() {
  var seqId = "<%=seqId%>";
  window.location.href = "<%=contextPath%>/t9/subsys/oa/vote/act/T9VoteTitleAct/outVote.act?seqId=" + seqId;
}
//显示投票人员信息
function selectReadersInfo(seqId){
  var url= "<%=contextPath%>/t9/subsys/oa/vote/act/T9VoteDataAct/selectReadersInfo.act?seqId="+seqId;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
