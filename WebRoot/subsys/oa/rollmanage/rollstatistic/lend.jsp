...
function doInit(){
  var count = 0;
  var url = "<%=contextPath%>/t9/subsys/oa/rollmanage/act/T9RmsStatisticAct/getRmsStatisticJosn.act";
  var cfgs = {
      dataAction: url,
...
function lendFunc(cellData, recordIndex, columIndex){
  ...
  var url = contextPath + "/t9/subsys/oa/rollmanage/act/T9RmsStatisticAct/getRmsLendCount.act";
