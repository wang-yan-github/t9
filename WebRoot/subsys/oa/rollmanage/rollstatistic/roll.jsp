...
function doInit(){
  checkSelectBox();
  var url = "<%=contextPath%>/t9/subsys/oa/rollmanage/act/T9RmsStatisticAct/getRmsStatisticRollJosn.act?seqId=${param.rollId}";
  var cfgs = {
      dataAction: url,
...
function rollFunc(cellData, recordIndex, columIndex){
  ...
  var url = contextPath + "/t9/subsys/oa/rollmanage/act/T9RmsStatisticAct/getRmsRollCount.act";
