...
function deleteSingle(seqId){
  ...
  var url = contextPath + "/t9/subsys/oa/rollmanage/act/T9RmsRollRoomAct/deleteSingle.act";
...
function deleteAll(){
  if(!confirmDelAll()) {
   ...
   var url = contextPath + "/t9/subsys/oa/rollmanage/act/T9RmsRollRoomAct/deleteAll.act";
