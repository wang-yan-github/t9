...
function destroySingleFile(seqId){
  ...
  if(window.confirm(msg)){
    var requestURLStr = contextPath + "/t9/subsys/oa/rollmanage/act/T9RmsFileAct";
...
function deleteSingle(seqId){
  ...
  var url = contextPath + "/t9/subsys/oa/rollmanage/act/T9RmsRollAct/deleteSingle.act";
  var rtJson = getJsonRs(url, "seqId=" + seqId);
  if (rtJson.rtState == "0") {
    window.location.reload();
  } else {
...
function statusFunc(seqId,statusFlag){
  var urls = contextPath + "/t9/subsys/oa/rollmanage/act/T9RmsRollAct/updateStatusFlag.act";
...
function getRmsRollRoomNameFunc(cellData, recordIndex, columIndex){
  var seqId = this.getCellData(recordIndex,"seqId");
  var urls = contextPath + "/t9/subsys/oa/rollmanage/act/T9RmsRollAct/getRmsRollRoomName.act";
...
function getCodeNameKindFunc(cellData, recordIndex, columIndex){
  ...
  var urls = contextPath + "/t9/subsys/oa/rollmanage/act/T9RmsRollAct/getCodeName.act";
...
function deleteAll() {
  ...
  var url = contextPath + "/t9/subsys/oa/rollmanage/act/T9RmsRollAct/deleteContact.act";
...
function exportRmsFile(){
  ...
  location = contextPath + "/t9/subsys/oa/rollmanage/act/T9RmsRollAct/exportToExcel.act?seqIdStr="+seqIdStr;
}
