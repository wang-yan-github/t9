...
var pageMgr = null;
var seqIdStr = "";
var rollIdStr = "${param.seqId}";
function doInit(){
  var count = 0;
  var url = "<%=contextPath%>/t9/subsys/oa/rollmanage/act/T9RmsRollAct/getRmsFileJosn.act?seqId=${param.seqId}";
  var cfgs = {
      dataAction: url,
    ...
    var url = contextPath + "/t9/subsys/oa/rollmanage/act/T9RmsRollAct/needApprove.act";
    var rtJson = getJsonRs(url, "rollId=${param.seqId}");
    if (rtJson.rtState == "0") {
      if (rtJson.rtData) {
        $('tip').update("此案卷下的文件借阅无需审批!");
      }
    } 
}
...
function selectManage(rollId, seqId){
  ...
  var url = contextPath + "/t9/subsys/oa/rollmanage/act/T9RmsLendAct/rmsLendRoll.act";
