...
<%
  String roomName = request.getParameter("roomName")== null ? "" : T9Utility.encodeSpecial(request.getParameter("roomName"));
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/rollmanage/act/T9RmsLendAct/queryLendFileJosn.act?" + param;
  var cfgs = {
      dataAction: url,
