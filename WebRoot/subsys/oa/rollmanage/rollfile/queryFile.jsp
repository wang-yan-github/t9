...
function checkForm(){
	...
	var filePage1 = $('filePage1').value;
	if (filePage1 && !isInteger(filePage1)) {
	  alert("文件页数只能为整数！");
	  return false;
	}
	var filePage2 = $('filePage2').value;
	if (filePage2 && !isInteger(filePage2)) {
	  alert("文件页数只能为整数！");
	  return false;
	}
	
	var printPage1 = $('printPage1').value;
	if (printPage1 && !isInteger(printPage1)) {
	  alert("打印页数只能为整数！");
	  return false;
	}
	var printPage2 = $('printPage2').value;
	if (printPage2 && !isInteger(printPage2)) {
	  alert("打印页数只能为整数！");
	  return false;
	}
