...
function doInit(){
  ...
  if(json.rtState == "0"){
    ...
    if (data.privUser || data.privDept || data.privRole) {
      $('privUser').value = data.privUser;
      $('privDept').value = data.privDept;
      $('role').value = data.privRole;
      
      $('privUserName').value = json.privUserName;
      $('privDeptName').value = json.privDeptName;
      $('roleDesc').value = json.privRoleName;
      $('nopriv').show();
    }
...
<form  action="<%=contextPath%>/t9/subsys/oa/rollmanage/act/T9RmsFileAct/updateRmsFileById.act"  method="post" name="form1" id="form1"  enctype="multipart/form-data">
