...
<%
  String fileCode = request.getParameter("fileCode")== null ? "" : T9Utility.encodeSpecial(request.getParameter("fileCode"));
  String fileSubject = request.getParameter("fileSubject")== null ? "" : T9Utility.encodeSpecial(request.getParameter("fileSubject"));
  String fileTitle = request.getParameter("fileTitle") == null ? "" : T9Utility.encodeSpecial(request.getParameter("fileTitle"));
  String fileTitleo = request.getParameter("fileTitleo") == null ? "" : T9Utility.encodeSpecial(request.getParameter("fileTitleo")) ;
  String sendUnit = request.getParameter("sendUnit") == null ? "" : T9Utility.encodeSpecial(request.getParameter("sendUnit"));
  
  String sendTimeMin = request.getParameter("sendTime_Min") == null ? "" : T9Utility.encodeSpecial(request.getParameter("sendTime_Min"));
  String sendTimeMax = request.getParameter("sendTime_Max") == null ? "" : T9Utility.encodeSpecial(request.getParameter("sendTime_Max"));
  String secret = request.getParameter("secret") == null ? "" :  T9Utility.encodeSpecial(request.getParameter("secret"));
  String urgency = request.getParameter("urgency") == null ? "" :  T9Utility.encodeSpecial(request.getParameter("urgency"));
  
  String fileType = request.getParameter("fileType") == null ? "" : T9Utility.encodeSpecial(request.getParameter("fileType")) ;
  String fileKind = request.getParameter("fileKind") == null ? "" : T9Utility.encodeSpecial(request.getParameter("fileKind")) ;
  String filePage1 = request.getParameter("filePage1") == null ? "" : T9Utility.encodeSpecial(request.getParameter("filePage2")) ;
  String filePage2 = request.getParameter("filePage2") == null ? "" : T9Utility.encodeSpecial(request.getParameter("catalogNo")) ;
  String printPage1 = request.getParameter("printPage1") == null ? "" : T9Utility.encodeSpecial(request.getParameter("printPage1"));  
  String printPage2 = request.getParameter("printPage2") == null ? "" : T9Utility.encodeSpecial(request.getParameter("printPage2"));  
  String remark = request.getParameter("remark") == null ? "" : T9Utility.encodeSpecial(request.getParameter("remark"));
  String handlerTime = request.getParameter("handlerTime") == null ? "" : T9Utility.encodeSpecial(request.getParameter("handlerTime"));
  String issueNum = request.getParameter("issueNum") == null ? "" : T9Utility.encodeSpecial(request.getParameter("issueNum"));  
  String fileYear = request.getParameter("fileYear") == null ? "" : T9Utility.encodeSpecial(request.getParameter("fileYear"));
  String fileWord = request.getParameter("fileWord") == null ? "" : T9Utility.encodeSpecial(request.getParameter("fileWord"));
%>
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/rollmanage/act/T9RmsFileAct/queryRmsFileJosn.act?" + param;
  var cfgs = {
      dataAction: url,
