...
function doInit(){
  var url = "<%=contextPath%>/t9/subsys/oa/rollmanage/act/T9RmsRollRoomAct/getRmsRollRoomDetail.act?seqId=${param.seqId}";
...
function doSubmit(){
  ...
  var url = "<%=contextPath %>/t9/subsys/oa/rollmanage/act/T9RmsRollRoomAct/update.act";
