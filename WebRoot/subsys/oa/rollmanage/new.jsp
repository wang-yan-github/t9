...
function doSubmit(){
  ...
  var url = "<%=contextPath %>/t9/subsys/oa/rollmanage/act/T9RmsRollAct/addRoll.act";
...
<table border="0" width="90%" cellspacing="0" cellpadding="3" class="small">
  ...
  <TR>
      ...
      <TD class="TableData">
        <input type="text" name="beginDate" id="beginDate" size="10" maxlength="10" class="BigStatic" value="" readonly>
        <img id="beginDateImg" src="<%=imgPath%>/calendar.gif" align="absMiddle" border="0" style="cursor:pointer">
      </TD>
      <TD class="TableData">终止日期：</TD>
      <TD class="TableData">
        <input type="text" name="endDate" id="endDate" size="10" maxlength="10" class="BigStatic" value="" readonly>
