...
function doInit() {
  if (checkForm()) {
    ...
    var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/source/org/act/T9SourceOrgAct/addUpdateOrg.act"; 
...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  ...
  $('attachmentName').value = attaName;
   var url= "<%=contextPath%>/t9/subsys/oa/profsys/source/org/act/T9SourceOrgAct/deleleFile.act?attachId=" + attachId +"&attachName=" + encodeURIComponent(attachName) + "&seqId=" + attrchIndex;
...
function getOrg(seqId){
  var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/source/org/act/T9SourceOrgAct/selectOrgById.act?seqId="+seqId; 
...
<form id="form1" method="post" name="form1">
    <input type="hidden" name="dtoClass" value="t9.subsys.oa.profsys.source.org.data.T9SourceOrg">
   ...
   <tr>
    ...
    <tr>
      ...
      <div><script language=JavaScript>    
         ...
         oFCContact.BasePath = "/t9/core/js/cmp/fck/fckeditor/";  
    ...
    <tr>
      ...
      <div><script language=JavaScript>    
         ...
         oFCNote.BasePath = "/t9/core/js/cmp/fck/fckeditor/";  
