...
function selectSourceOrg(){
  pYxTotal = 0;
  pAllTotal = 0;
  var url = "<%=contextPath%>/t9/subsys/oa/profsys/source/org/act/T9SourceOrgAct/queryOrg.act";
   cfgs = {
    dataAction: url,
    container: "orgDiv",
    paramFunc: getParam,
...
function delOrg(seqId){
 if(window.confirm("确认要删除该记录吗？")){
   var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/source/org/act/T9SourceOrgAct/delOrg.act?seqId="+seqId; 
