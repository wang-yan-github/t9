...
function deleteInfo(seqId) {
  var url = "<%=contextPath%>/t9/subsys/oa/profsys/source/person/act/T9SourcePersonAct/deleteInfo.act?seqId=" + seqId;
...
function doInit(){
  doTime();
  var url = "<%=contextPath%>/t9/subsys/oa/profsys/source/person/act/T9SourcePersonAct/selectPerson.act";
   cfgs = {
    dataAction: url,
    container: "giftList",
    paramFunc: getParam,
