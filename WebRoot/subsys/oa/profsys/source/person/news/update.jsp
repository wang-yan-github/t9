...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  ...
  if (checkForm()) {
    ...
    var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/source/person/act/T9SourcePersonAct/updatePerson.act";
...
function selectPerson() {
  var url = "<%=contextPath%>/t9/subsys/oa/profsys/source/person/act/T9SourcePersonAct/showDetail.act?seqId=" + seqId;
...
<input type="hidden" name="dtoClass" value="t9.subsys.oa.profsys.source.person.data.T9SourcePerson">
