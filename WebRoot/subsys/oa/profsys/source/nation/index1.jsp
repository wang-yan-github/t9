...
function deleteInfo(seqId) {
  var url = "<%=contextPath%>/t9/subsys/oa/profsys/source/nation/act/T9SourceNationAct/deleteInfo.act?seqId=" + seqId;
...
function doInit(){
  var url = "<%=contextPath%>/t9/subsys/oa/profsys/source/nation/act/T9SourceNationAct/selectNation.act";
   cfgs = {
    dataAction: url,
    container: "giftList",
    paramFunc: getParam,
