...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  ...
  if (checkForm()) {
    ...
    var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/source/nation/act/T9SourceNationAct/updateNation.act";
...
var seqId = "<%=seqId%>";
function doInit() {
  var url = "<%=contextPath%>/t9/subsys/oa/profsys/source/nation/act/T9SourceNationAct/showDetail.act?seqId=" + seqId;
...
<input type="hidden" name="dtoClass" value="t9.subsys.oa.profsys.source.nation.data.T9SourceNation">
    ...
    <tr>
     <td nowrap class="TableContent" width="90">国家情况：</td>
      <td class="TableData" colspan="3">
         ...
         oFCStatus.BasePath = "/t9/core/js/cmp/fck/fckeditor/";  
