...
function doInit(){
  ...
  if (checkForm()) {
    ...
    var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/act/T9ProjectCommAct/addUpdateProjectComm.act";
...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
 ...
 // alert(attrchIndex);
  var url= "<%=contextPath%>/t9/subsys/oa/profsys/act/T9ProjectCommAct/deleleFile.act?attachId=" + attachId +"&attachName=" + encodeURIComponent(attachName) + "&seqId=" + attrchIndex;
...
function selectInMem(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/profsys/act/T9ProjectCommAct/queryOutCommByProjId.act?projId=" + projId + "&projCommType=0";
   cfgs = {
    dataAction: url,
    container: "giftList",
    moduleName:"profsys",  
