...
function selectInProject(){
  pYxTotal = 0;
  pAllTotal = 0;
  var url = "<%=contextPath%>/t9/subsys/oa/profsys/act/in/T9InProjectAct/queryInProject.act?projType=0&projStatus=0";
   cfgs = {
    dataAction: url,
...
function openPrint(){
  ...
  if(window.confirm(msg)) {
    URL = "<%=contextPath%>/t9/subsys/oa/profsys/act/in/T9InProjectAct/printIn.act?printStr=" + printStr
    window.open(URL);
  }
}
function getTotal2(){
