...
function checkForm2() {
  ...
  if (checkForm()) {
    ...
    var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9OutProjectCommAct/addProjectComm.act";
...
function checkForm3() {
  ...
  if (checkForm()) {
    ...
    var pars = $('form1').serialize() ;
    var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9OutProjectCommAct/updateProjectComm.act";
    var json = getJsonRs(requestURL,pars);
    if (json.rtState == '1') { 
      alert(json.rtMsrg); 
      return ; 
...
function selectInMem(){
  var url = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9OutProjectCommAct/queryOutCommByProjId.act?projId=" + projSeqId;
   cfgs = {
    dataAction: url,
    container: "giftList",
    moduleName:"profsys",  
...
function deleteCommById(seqId){
  ...
  if(window.confirm(msg)){
    var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9OutProjectCommAct/deleteCommById.act?seqId=" + seqId; 
...
function getCommById(seqId) {
  ...
  if (seqId != "") {
    var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9OutProjectCommAct/getCommById.act?seqId=" + seqId; 
    var json = getJsonRs(requestURL);
    if (json.rtState == '1'){ 
      alert(json.rtMsrg); 
      return ;
...
<div id="seqIdDiv"></div>
<input type="hidden" name="dtoClass" value="t9.subsys.oa.profsys.data.T9ProjectComm">
...
<table class="TableBlock" border="0" width="70%" align="center">
    ...
    <div><script language=JavaScript>    
         ...
         FCKContent.BasePath = "/t9/core/js/cmp/fck/fckeditor/";  
