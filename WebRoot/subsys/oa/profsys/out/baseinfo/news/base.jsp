...
function doForm() {
  if (seqId > 0) {
    var url = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9ProjectAct/showDetail.act?seqId=" + seqId;
...
function checkForm2() {
  ...
  if (checkForm()) {
    ...
    var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9ProjectAct/addProject.act";
...
function getVisitType(){
  var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/act/T9ProjectAct/getCodeItem.act?classNo=PROJ_VISIT_TYPE1"; 
...
function getActiveType() {
  var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/act/T9ProjectAct/getCodeItem.act?classNo=PROJ_ACTIVE_TYPE1"; 
  var json=getJsonRs(requestURL); 
  if(json.rtState == '1'){ 
    alert(json.rtMsrg); 
    return ; 
...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  ...
  if (checkForm()) {
    var pars = $('form1').serialize() ;
    var url = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9ProjectAct/updateProject.act";
...
function checkForm3() {
  ...
  if (checkForm()) {
    ...
    var pars = $('form1').serialize() ;
    var requestURL="<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9ProjectAct/updateProject.act";
    var json=getJsonRs(requestURL,pars);
    if (json.rtState == '1') { 
      alert(json.rtMsrg); 
      return ; 
