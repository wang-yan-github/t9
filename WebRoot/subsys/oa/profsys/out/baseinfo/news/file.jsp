...
function checkForm2() {
  ...
  if (checkForm()) {
    ...
    var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9OutProjectFileAct/addProjectFile.act";
...
function checkForm3() {
  ...
  if (checkForm()) {
    ...
    var pars = $('form1').serialize() ;
    var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9OutProjectFileAct/updateProjectFile.act";
    var json = getJsonRs(requestURL,pars);
    if (json.rtState == '1') { 
      alert(json.rtMsrg); 
      return ; 
...
function selectInMem(){
  var url = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9OutProjectFileAct/queryOutFileByProjId.act?projId=" + projSeqId;
   cfgs = {
    dataAction: url,
    container: "giftList",
    moduleName:"profsys",  
...
function deleteFileById(seqId){
  ...
  if(window.confirm(msg)){
    var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9OutProjectFileAct/deleteFileById.act?seqId=" + seqId; 
...
function getFileById(seqId) {
  ...
  if (seqId != "") {
    var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9OutProjectFileAct/getFileById.act?seqId=" + seqId; 
    var json = getJsonRs(requestURL);
    if (json.rtState == '1'){ 
      alert(json.rtMsrg); 
      return ;
...
<div id="seqIdDiv"></div>
<input type="hidden" name="dtoClass" value="t9.subsys.oa.profsys.data.T9ProjectFile">
...
<table class="TableBlock" border="0" width="70%" align="center">
    ...
    <tr>
     ...
     oFCKContent.BasePath = "/t9/core/js/cmp/fck/fckeditor/";  
  ...
  oFCKNote.BasePath = "/t9/core/js/cmp/fck/fckeditor/";  
 ...
 <div id="but">
  ...
  <form id="formFile" action="<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9ProjectAct/uploadFile.act" method="post" enctype="multipart/form-data" target="commintFrame">
