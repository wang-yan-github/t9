...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9ProjectAct/profsysHistory.act";
   cfgs = {
    dataAction: url,
    container: "giftList",
    paramFunc: getParam,
...
function delProj(seqId) {
  URL = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9ProjectAct/delProj.act?seqId=" + seqId;
...
function updateStatus(seqId) {
  URL = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9ProjectAct/updateStatus.act?seqId=" + seqId + "&status=0";
...
function printMail() {
  ...
  if(window.confirm(msg)) {
    URL = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9ProjectAct/printOut.act?printStr=" + printStr
    window.open(URL);
  }
}
