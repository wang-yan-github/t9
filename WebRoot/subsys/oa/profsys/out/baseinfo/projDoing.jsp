...
function doInit(){
  pYxTotal = 0;
  pAllTotal = 0;
  var url = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9ProjectAct/profsysSelect.act";
   cfgs = {
    dataAction: url,
    container: "giftList",
    paramFunc: getParam,
...
function updateStatus(seqId) {
  URL = "<%=contextPath%>/t9/subsys/oa/profsys/act/out/T9ProjectAct/updateStatus.act?seqId=" + seqId + "&status=1";
