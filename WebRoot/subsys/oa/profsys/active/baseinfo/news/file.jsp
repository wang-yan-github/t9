...
function doInit(){
  if (checkForm()) {
    ...
    var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/act/T9ProjectFileAct/addUpdateProjectFile.act";
...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  ...
  var url= "<%=contextPath%>/t9/subsys/oa/profsys/act/T9ProjectFileAct/deleleFile.act?attachId=" + attachId +"&attachName=" + encodeURIComponent(attachName) + "&seqId=" + attrchIndex;
...
function selectInMem(){
  var projId = parent.projId;
  var url = "<%=contextPath%>/t9/subsys/oa/profsys/act/T9ProjectFileAct/queryOutFileByProjId.act?projId=" + projId + "&projFileType=2";
   cfgs = {
    dataAction: url,
    container: "giftList",
    moduleName:"profsys",  
...
function getFileById(seqId) {
    var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/act/T9ProjectFileAct/getFileById.act?seqId=" + seqId; 
    var json = getJsonRs(requestURL);
    if (json.rtState == '1'){ 
      alert(json.rtMsrg); 
      return ;
