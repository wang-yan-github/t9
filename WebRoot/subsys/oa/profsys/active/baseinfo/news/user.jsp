...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  ...
  var url= "<%=contextPath%>/t9/subsys/oa/profsys/act/T9ProjectMemAct/deleleFile.act?attachId=" + attachId +"&attachName=" + encodeURIComponent(attachName) + "&seqId=" + attrchIndex;
...
function doInit(){
  if (checkForm()) {
    ...
    var requestURL = "<%=contextPath%>/t9/subsys/oa/profsys/act/in/T9InProjectMemAct/addUpdateMem.act";
...
function selectInMem(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/profsys/act/active/T9ActiveProjectMemAct/queryActiveMemByProjId.act?projId="+projId;
   cfgs = {
    dataAction: url,
    container: "memDiv",
    moduleName:"profsys",  
