...
function getActiveType(selectObj,projActiveType){
  var requestURL = contextPath + "/t9/subsys/oa/profsys/act/T9ProjectAct/getCodeItem.act?classNo="+projActiveType; 
...
function selectInProject(){
  pYxTotal = 0;
  pAllTotal = 0;
  var url = "<%=contextPath%>/t9/subsys/oa/profsys/act/active/T9ActiveProjectAct/queryActiveProject.act?projType=2&projStatus=0";
   cfgs = {
    dataAction: url,
