...
<%
List<T9ChargeExpense> list = (List<T9ChargeExpense> )request.getAttribute("list");
...
<span style="writing-mode: tb-rl; text-align: center"><b>
 ...
 if(expense.getChargeItem()!=null&&!expense.getChargeItem().equals("")) {
           ...
           <tr height=47>
            ...
            <td nowrap width="23%" align=center style="border-top:1px #000 solid;   border-right:1px #000 solid;"><SPAN style="FONT-SIZE: 17px">￥<%=T9Utility.getFormatedStr(price,2)%></SPAN></td>
         </tr>
         <%}
         } %>
    <tr height=47>
...
<span style="FONT-SIZE: 18px">&nbsp;人民币&nbsp;<br>（大写）&nbsp;&nbsp;</span>
  <span style="FONT-SIZE: 18px"><%if(!T9Utility.isNullorEmpty(money)){%><%=money%><%}else{%>零<%}%></span></td>
  ...
  <span style="FONT-SIZE: 18px">￥<%=T9Utility.getFormatedStr(sunMoney,2)%> </span>
  </td>
  </tr>
</table>
<table width="73%">
