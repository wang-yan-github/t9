...
<%@page import="t9.subsys.oa.finance.data.T9ChargeExpense"%>
<%@page import="java.text.SimpleDateFormat"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%
T9ChargeExpense charge = (T9ChargeExpense)request.getAttribute("expense");
...
function checkForm2() {
  if (checkForm()) {
    ...
    var url = contextPath + "/t9/subsys/oa/finance/act/T9ChargeExpenseAct/editExpense.act";
...
<input type="hidden" name="dtoClass" value="t9.subsys.oa.finance.data.T9ChargeExpense">
...
<table width="90%" align="center" class="TableBlock">
  ...
  <table id="MYTABLE" width="100%"  class="small">
    ...
    <tr>
      ...
      <td class="TableData">
      &nbsp;<input type="text" name="chargeMoney2" id="chargeMoney2" value="<%=T9Utility.getFormatedStr(charge.getChargeMoney(),2)%>" size="15" maxlength="15" class="BigInput" style="text-align:right;"/>&nbsp;只能为数字            <input value="<%=charge.getChargeMoney()%>" name="chargeMoney" id="chargeMoney" type="hidden">
      </td>
    </tr>
    <tr>
