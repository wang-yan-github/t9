...
function deptTotal(curYear){
  var requestUrl = "<%=contextPath%>/t9/subsys/oa/finance/act/T9BudgetApplyAct/selectBudget.act?year="+curYear;
  var rtJson = getJsonRs(requestUrl);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
...
function selectBudgetApply(){
  var url = "<%=contextPath%>/t9/subsys/oa/finance/act/T9BudgetApplyAct/queryDeptBudget.act";
   cfgs = {
    dataAction: url,
