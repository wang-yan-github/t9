 ...
 <%if(ba!=null){
   ...
   <tr>
    ...
    <tr>
      ...
      <td class="TableData" >
			<%=T9Utility.getFormatedStr(ba.getBudgetMoney(),0) %>     </td>
    </tr>
    <tr>
      <td nowrap class="TableContent">预收入金额：</td>
      <td class="TableData" >
			<%=T9Utility.getFormatedStr(ba.getBudgetInMoney(),0) %>     </td>
    </tr>
    <tr>
    ...
    <table  id="MYTABLE" width="100%"  class="small">
        <tr  class="TableHeader"  align="center">
           ...
           <%for(int i = 0; i<dcs.length;i++){
            ...
            <td><%=person %></td>
            <td><%=days %></td>
            <td><%=T9Utility.getFormatedStr(price,0)%></td>
            <td><%=T9Utility.getFormatedStr(money,0) %></td>
            <td><%=memo %></td>
         </tr>
         <%} %>
