...
function deptTotal(nextYear){
  var requestUrl = "<%=contextPath%>/t9/subsys/oa/finance/act/T9BudgetApplyAct/selectBudget.act?year="+nextYear;
  var rtJson = getJsonRs(requestUrl);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
...
function selectBudgetApply(){
  var url = "<%=contextPath%>/t9/subsys/oa/finance/act/T9BudgetApplyAct/queryDeptBudget.act?year="+nextYear;
   cfgs = {
    dataAction: url,
