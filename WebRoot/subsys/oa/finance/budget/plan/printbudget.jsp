<%@ page language="java" import="java.util.*,java.sql.*,t9.core.funcs.attendance.manage.logic.*,t9.subsys.oa.finance.*,t9.core.data.T9RequestDbConn,t9.core.global.T9BeanKeys" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%
...
<%@page import="t9.subsys.oa.finance.data.T9BudgetApply"%>
<%@page import="t9.core.funcs.person.logic.T9PersonLogic"%>
<%@page import="t9.core.funcs.dept.data.T9Department"%>
<%@page import="t9.core.funcs.dept.logic.T9DeptLogic"%><html>
<head>
<title>查看预算信息</title>
...
<H3 style="TEXT-ALIGN: center; COLOR: black"><SPAN style="FONT-SIZE: 32px">北京外办预算情况明细表(试行)</SPAN></H3>
 ...
 <%if(ba!=null){
   ...
   if(budgetDate!=null&&!budgetDate.equals("")){
     budgetDateStr =T9Utility.getDateTimeStr(budgetDate).substring(0,10);
   }
...
<td nowrap width="32%">预收金额：<%=T9Utility.getFormatedStr(ba.getBudgetInMoney(),0) %></td>
</tr>
<tr height="34">
  ...
  <tr align="center">
     ...
     %>
	      <tr align="center">
            ...
            <td>&nbsp;</td>
            <td>合计：</td>
            <td colspan=2><%=T9Utility.getFormatedStr(ba.getBudgetMoney(),0) %></td>
         </tr>
     <%
