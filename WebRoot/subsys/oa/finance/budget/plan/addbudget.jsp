...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
   ...
   <form action="<%=contextPath%>/t9/subsys/oa/finance/act/T9BudgetApplyAct/addBudgetApply.act" method="post" name="form1" id="form1" enctype="multipart/form-data" onSubmit="return checkForm();">
