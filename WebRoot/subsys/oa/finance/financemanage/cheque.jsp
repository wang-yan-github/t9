...
var cfgs = null;
function doInit(){
  var url = "<%=contextPath%>/t9/subsys/oa/finance/act/T9FinanceApplyRecordAct/applySelectByBudgetId.act?budgetId="+budgetId;
   cfgs = {
    dataAction: url,
    container: "giftList",
    colums: [
...
function editCheque(seqId) {
  myleft = (screen.availWidth-800)/2;
  window.open("<%=contextPath%>/t9/subsys/oa/finance/act/T9FinanceApplyRecordAct/editCheque.act?seqId=" + seqId,"","status=0,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=yes,width=800,height=700,left="+myleft+",top=50");
}
//查看详情
function chequeDetail(seqId) {
  var myleft = (screen.availWidth-800)/2;
  window.open("<%=contextPath%>/t9/subsys/oa/finance/act/T9FinanceApplyRecordAct/chequeDetail.act?seqId=" + seqId,"","status=0,toolbar=no,menubar=no,location=no,scrollbars=yes,resizable=yes,width=800,height=700,left="+myleft+",top=50");
}
//删除记录
function delCheque(seqId) {
  URL = "<%=contextPath%>/t9/subsys/oa/finance/act/T9FinanceApplyRecordAct/delCheque.act?seqId=" + seqId;
...
function printMail() {
  ...
  if(window.confirm(msg)) {
    URL = "<%=contextPath%>/t9/subsys/oa/finance/act/T9FinanceApplyRecordAct/printOut.act?printStr=" + printStr
    window.open(URL);
  }
}
