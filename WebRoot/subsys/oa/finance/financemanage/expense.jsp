...
function doExpense(){
  var url = "<%=contextPath%>/t9/subsys/oa/finance/act/T9BudgetDeptTotalAct/expenseSelectByBudgetId.act?budgetId="+budgetId;
...
function print_mail(){
  ...
  if(window.confirm(msg)) {
    URL = "<%=contextPath%>/t9/subsys/oa/finance/act/T9ChargeExpenseAct/updatePrint.act?printStr=" + print_str
    window.open(URL);
  }
}
