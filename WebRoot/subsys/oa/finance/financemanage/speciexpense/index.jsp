<%@ page language="java" import="java.util.*,t9.core.funcs.person.data.T9Person"
...
function cost_charge(seqId){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/finance/act/T9BudgetDeptTotalAct/expenseSelectByBudgetId.act?budgetId="+seqId;
...
function budget_detail(seqId,type){
  var requestURL = "<%=contextPath%>/t9/subsys/oa/finance/act/T9BudgetApplyAct/selectBudgetById.act?seqId="+seqId+"&type="+type;
	myleft=(screen.availWidth-800)/2;
...
function del_budget(seqId){
  ...
  if(window.confirm(msg)){
    var requestUrl = "<%=contextPath%>/t9/subsys/oa/finance/act/T9BudgetApplyAct/deleteBudgetById.act?seqId="+seqId;
...
function selectBudgetApply(){
  var url = "<%=contextPath%>/t9/subsys/oa/finance/act/T9BudgetApplyAct/queryBudget.act?notAffair=1";
   cfgs = {
    dataAction: url,
...
function chequeTotalByBudgetId(budgetId,type){
  var requestUrl = "<%=contextPath%>/t9/subsys/oa/finance/act/T9BudgetApplyAct/chequeTotalByBudgetId.act?budgetId="+budgetId+"&type="+type;
  var rtJson = getJsonRs(requestUrl);
  if(rtJson.rtState == "1"){
    alert(rtJson.rtMsrg); 
    return ;
