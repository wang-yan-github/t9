...
<%@page import="t9.subsys.oa.finance.data.T9FinanceApplyRecord"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%
T9FinanceApplyRecord applyRecord = (T9FinanceApplyRecord)request.getAttribute("record");
...
function checkForm2() {
  if (checkForm()) {
      ...
      var url = contextPath + "/t9/subsys/oa/finance/act/T9FinanceApplyRecordAct/editRecord.act";
...
<input type="hidden" name="dtoClass" value="t9.subsys.oa.finance.data.T9FinanceApplyRecord">
...
<table width="90%" align="center" class="TableBlock">
   ...
   <tr>
    ...
    <tr>
      ...
      <td class="TableData">
      &nbsp;<input type="text" name="applyMoney" id="applyMoney" value="<%=T9Utility.getFormatedStr(applyRecord.getApplyMoney(),2)%>" size="15" maxlength="15" class="BigInput" style="text-align:right;"/>&nbsp;只能为数字
      </td>
    </tr>
    <tr>
