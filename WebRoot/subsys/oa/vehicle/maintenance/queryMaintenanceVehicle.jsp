...
function doInit(orderType){
    var requestURL = "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleMaintenanceAct/selectVehicleMaintenanceByVId.act?vId="+seqId+"&orderType="+orderType; 
...
function exportCSV(vId){
  var requestURL = "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleMaintenanceAct/exportCSVByVId.act?vId="+vId;
