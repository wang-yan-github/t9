...
function doInit(){
  if(CheckForm()){
    var url="<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleMaintenanceAct/updateVehicleMaimtenById.act";
...
function doOnload(){
  ...
  getVehicle();//得到所有的车辆
  var requestURL="<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleMaintenanceAct/selectVehicleMaintenanceById.act?seqId="+seqId; 
  var json=getJsonRs(requestURL); 
  if(json.rtState == '1'){ 
    alert(json.rtMsrg); 
    return ; 
