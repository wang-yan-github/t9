...
var seqId = "<%=seqId%>"
function doInit() {
  var requestURL="<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleUsageAct/operatorReason.act?seqId=" + seqId;
...
function peratorReasonFrom() {
  var requestURL = "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleUsageAct/updateStatusId.act?seqId=" + seqId + "&status=3";
...
function updatePeratorReason() {
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleUsageAct/updateoPeratorReason.act?seqId=" + seqId + "&operatorReason=" + operatorReason;
