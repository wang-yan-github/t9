...
function doInit() {
  ...
  var requestURL = "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleUsageAct/selectNotes.act?seqId=" + seqId;
...
function checkForm2() {
  if (checkForm()) {
    var pars = $('form1').serialize() ;
    var requestURL="<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleUsageAct/updateNotes.act";
