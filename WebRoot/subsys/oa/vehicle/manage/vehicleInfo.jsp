...
function deleteVehicle(){
  ...
  if(window.confirm(msg)){
    window.location = "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleAct/deleteVehicle.act?seqIds="+delete_str;
    window.location.reload();
  }
}
var pageMgr = null;
function doOnload(){
  var requestURL = "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleAct/selectVehiclePage.act?seqId="+ParSeqId; 
  var cfgs = {
...
function stopInsurance(seqId){
  var url= "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleAct/stopInsurance.act";  
...
function delete_Vehicle(seqId){  
  msg='确认要删除该车辆吗？'; 
  if(window.confirm(msg)) { 
    var url= "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleAct/deleteVehicleById.act";  
    var json=getJsonRs(url, 'seqId=' + seqId); 
    if(json.rtState == '0'){ 
      window.location.reload();
    }else{ 
...
function test(){
  var url= "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleAct/Test.act";  
