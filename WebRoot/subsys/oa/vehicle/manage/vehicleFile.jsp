...
function doOnload(){
  var url= "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleAct/selectVehicleById.act?seqId="+seqId;
...
function deleteAttachBackHand(attachName,attachId,attrchIndex){
	var url= "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleAct/deleleFile.act?attachId=" + attachId +"&attachName=" + encodeURIComponent(attachName) + "&seqId=" + attrchIndex;
	 var rtJson = getJsonRs(url); 
	  if(rtJson.rtState == "1"){
	    alert(rtJson.rtMsrg); 
	    return ;
...
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleAct/updateFile.act" method="post" name="form1" id="form1">
