...
<br><center><input type="button" class="BigButton" value="返回" onclick="returnBack();"></center>
 ...
 <form action="<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleAct/addVehicle.act" enctype="multipart/form-data" method="post" name="form1" id = "form1" onsubmit="return CheckForm()">
