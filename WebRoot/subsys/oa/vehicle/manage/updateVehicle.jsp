...
function doInit(){
  ...
  var requestURL="<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleAct/selectVehicleById.act?seqId="+seqId; 
...
function getVehicleType(){
  var requestURL = "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleAct/getCodeItem.act"; 
  var json=getJsonRs(requestURL); 
  if(json.rtState == '1'){ 
    alert(json.rtMsrg); 
    return ; 
...
<form action="<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleAct/updateVehicle.act" enctype="multipart/form-data" method="post" name="form1" id = "form1" onsubmit="return CheckForm();">
