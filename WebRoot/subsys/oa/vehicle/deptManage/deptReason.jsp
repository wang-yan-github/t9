...
var seqId = "<%=seqId%>"
function doInit() {
  var requestURL="<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleUsageAct/selectDeptReason.act?seqId=" + seqId;
...
function deptReasonFrom() {
  var requestURL = "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleUsageAct/updateDmerStatus.act?seqId=" + seqId + "&dmerStatus=3";
...
function updateDeptReason() {
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleUsageAct/updateDeptReason.act?seqId=" + seqId + "&deptReason=" + deptReason;
