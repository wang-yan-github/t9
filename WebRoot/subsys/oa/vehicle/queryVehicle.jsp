...
function doInit(seqId){
  var requestURL="<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleAct/queryVehicleById.act?seqId="+seqId; 
...
function shwoDetailSize(seqId) {
  var requestURL = "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleUsageAct/showDetail.act?seqId=" + seqId; 
  var json = getJsonRs(requestURL); 
  if(json.rtState == '1'){ 
    alert(json.rtMsrg); 
    return ; 
