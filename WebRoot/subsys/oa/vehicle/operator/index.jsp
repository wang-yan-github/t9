...
function Init(){
  var url="<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleOperatorAct/addUpdateOperator.act";
...
function doInit(){
  var requestURL ="<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleOperatorAct/selectOperator.act"; 
