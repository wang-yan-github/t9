...
function checkForm2() {
  if (checkForm()) {
    ...
    var requestURL="<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleUsageAct/editVehicle2.act";
...
<table class="TableBlock" align="center" width="620">
    ...
    <tr>
      ...
      <td class="TableData">
      <%if(!T9Utility.isNullorEmpty(usage.getVuDestination())) {%>
    ...
    <tr>
      ...
      <td class="TableData" colspan="3"> <%if(!T9Utility.isNullorEmpty(usage.getVuReason())) {%><%=usage.getVuReason() %><%} %></td>
    </tr>
    <tr>
      <td nowrap class="TableContent" width="80"> 备　　注：</td>
      <td class="TableData" colspan="3">
        <textarea name="vuRemark" id="vuRemark" class="BigInput" cols="74" rows="5"><%if(!T9Utility.isNullorEmpty(usage.getVuRemark())) {%><%=usage.getVuRemark() %><%} %></textarea>
      </td>
    </tr>
