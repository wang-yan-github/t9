...
function doInit(){
  var url = "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleUsageAct/vehicleAll.act?" + param;
   cfgs = {
    dataAction: url,
    container: "giftList",
    colums: [
...
function updateVehicle(vuId) {
  var url = "<%=contextPath%>/t9/subsys/oa/vehicle/act/T9VehicleUsageAct/selectId2.act?seqId=" + vuId
