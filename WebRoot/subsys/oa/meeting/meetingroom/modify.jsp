...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/meeting/act/T9MeetingRoomAct/getMeetingRoomDetail.act?seqId=${param.seqId}";
...
function doSubmit(){
	if(checkForm()){
		...
		var url = "<%=contextPath %>/t9/subsys/oa/meeting/act/T9MeetingRoomAct/update.act";
