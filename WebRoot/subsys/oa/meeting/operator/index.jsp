...
var roomRule = "";
function doInit(){
   var url = "<%=contextPath%>/t9/subsys/oa/meeting/act/T9MeetingOperatorAct/getMeetingOperator.act";
...
function getMeetingRoomRule(){
  var url = "<%=contextPath%>/t9/subsys/oa/meeting/act/T9MeetingOperatorAct/getMeetingRoomRule.act";
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
...
function doSubmit(){
  ...
  url = "<%=contextPath%>/t9/subsys/oa/meeting/act/T9MeetingOperatorAct/";
  ...
  urls = "<%=contextPath%>/t9/subsys/oa/meeting/act/T9MeetingOperatorAct/";
...
<input type="hidden" id="dtoClass" name="dtoClass" value="t9.subsys.oa.meeting.act.T9MeetingOperatorAct.java"/>
