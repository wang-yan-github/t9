...
function getMeetingSummaryDetail(){
	var url = "<%=contextPath%>/t9/subsys/oa/meeting/act/T9MeetingAct/getMeetingSummaryDetail.act?seqId=<%=seqId %>";
...
function getNewCommentInfo(){
	var url = "<%=contextPath%>/t9/subsys/oa/meeting/act/T9MeetingCommentAct/getNewCommentInfo.act?seqId=<%=seqId %>";
  var json = getJsonRs(url);
  if(json.rtState == '1'){
		alert(json.rtMsrg);
		return ;				
...
function delCommentInfo(commentId){
	var url = "<%=contextPath%>/t9/subsys/oa/meeting/act/T9MeetingCommentAct/delCommentInfo.act";
...
<form name="form1" id="form1" enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/meeting/act/T9MeetingCommentAct/addMeetingCommentInfo.act"  method="post" name="form1" onsubmit="return CheckForm();">
