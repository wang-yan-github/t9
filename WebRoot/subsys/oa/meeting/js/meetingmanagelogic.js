...
function mProposerFunc(cellData, recordIndex, columIndex){
  ...
  var url = contextPath + "/t9/subsys/oa/meeting/act/T9MeetingAct/getUserName.act";
...
function mRoomFunc(cellData, recordIndex, columIndex){
  ...
  var url = contextPath + "/t9/subsys/oa/meeting/act/T9MeetingAct/getMeetingRoomName.act";
...
function deleteSingle(seqId){
  ...
  var url = contextPath + "/t9/subsys/oa/meeting/act/T9MeetingAct/deleteSingle.act";
...
function checkupFunc(seqId, mStatus){
  ...
  if (window.confirm(msg)) {
    var url = contextPath + "/t9/subsys/oa/meeting/act/T9MeetingAct/updateStatus.act?seqId=" + seqId + "&mStatus=" + mStatus;
...
function mStatusFunc(cellData, recordIndex, columIndex){
  ...
  var url = contextPath + "/t9/subsys/oa/meeting/act/T9MeetingAct/checkRoom.act?seqId=" + seqId;
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
...
function checkUpAll() {
  ...
  var url = contextPath + "/t9/subsys/oa/meeting/act/T9MeetingAct/checkUpAllCycle.act";
...
function autoBeginEnd(){
  var url = contextPath + "/t9/subsys/oa/meeting/act/T9MeetingAct/getAutoBeginEnd.act";
