...
function deleteSingle(seqId){
  ...
  var url = contextPath + "/t9/subsys/oa/meeting/act/T9MeetingRoomAct/deleteSingle.act";
...
function deleteAll(){
  if(!confirmDelAll()) {
   ...
   var url = contextPath + "/t9/subsys/oa/meeting/act/T9MeetingRoomAct/deleteAll.act";
