...
function getSecretFlag(classNo,optionType,extValue){
	var requestURLStr = contextPath + "/t9/subsys/oa/meeting/act/T9MeetingEquipmentAct";
...
function mAttendeeFunc(cellData, recordIndex, columIndex){
	...
	var url =contextPath + "/t9/subsys/oa/meeting/act/T9MeetingAct/getAttendeeName.act";
...
function deleteMeeting(seqId,mStatus){
	if(window.confirm("确认要删除该会议么？")){
		var url = contextPath + "/t9/subsys/oa/meeting/act/T9MeetingAct/delMeetingInfo.act";
