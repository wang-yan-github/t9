...
<%
  String equipmentNo = request.getParameter("equipmentNo")== null ? "" :   T9Utility.encodeSpecial(request.getParameter("equipmentNo"));
  String equipmentName = request.getParameter("equipmentName")== null ? "" :   T9Utility.encodeSpecial(request.getParameter("equipmentName"));
  String equipmentStatus = request.getParameter("equipmentStatus") == null ? "" :   T9Utility.encodeSpecial(request.getParameter("equipmentStatus"));
  String mrId = request.getParameter("mrId") == null ? "" :   T9Utility.encodeSpecial(request.getParameter("mrId"));
...
function doInit(){
  ...
  var url =  contextPath + "/t9/subsys/oa/meeting/act/T9MeetingEquipmentAct/getSearchMeetingEquipment.act?" + param;
  var cfgs = {
      dataAction: url,
