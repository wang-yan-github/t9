...
<%
  String mName = request.getParameter("mName")== null ? "" :   T9Utility.encodeSpecial(request.getParameter("mName"));
  String mProposer = request.getParameter("mProposer")== null ? "" :   T9Utility.encodeSpecial(request.getParameter("mProposer"));
  String beginDate = request.getParameter("beginDate") == null ? "" :   T9Utility.encodeSpecial(request.getParameter("beginDate"));
  String endDate = request.getParameter("endDate") == null ? "" :   T9Utility.encodeSpecial(request.getParameter("endDate"));
  String keyWord1 = request.getParameter("keyWord1") == null ? "" :  T9Utility.encodeSpecial(request.getParameter("keyWord1"));
  String keyWord2 = request.getParameter("keyWord2") == null ? "" :  T9Utility.encodeSpecial(request.getParameter("keyWord2"));
  String keyWord3 = request.getParameter("keyWord3") == null ? "" :  T9Utility.encodeSpecial(request.getParameter("keyWord3"));
  String mRoom = request.getParameter("mRoom") == null ? "" :  T9Utility.encodeSpecial(request.getParameter("mRoom"));
...
function doInit(){
  ...
  var url =  contextPath + "/t9/subsys/oa/meeting/act/T9MeetingAct/queryMeetingSummary.act?" + param;
  var cfgs = {
      dataAction: url,
