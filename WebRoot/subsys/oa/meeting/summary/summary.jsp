...
function getMeetingSummaryDetail(){
  var url = "<%=contextPath%>/t9/subsys/oa/meeting/act/T9MeetingAct/getMeetingSummaryDetail.act?seqId=${param.seqId}";
...
function upload_attach(){
  ...
  var fckContentStr = oEditor.GetXHTML();
	...
	document.form1.action="<%=contextPath%>/t9/subsys/oa/meeting/act/T9MeetingAct/updateMeetingSummary.act";
	$("form1").submit();
}
