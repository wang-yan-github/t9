...
<%
  ...
  String mStatus = request.getParameter("mStatus") == null ? "" :  T9Utility.encodeSpecial(request.getParameter("mStatus"));
...
function doInit(){
  ...
  var url =  contextPath + "/t9/subsys/oa/meeting/act/T9MeetingAct/getSearchMeeting.act?" + param;
  var cfgs = {
      dataAction: url,
