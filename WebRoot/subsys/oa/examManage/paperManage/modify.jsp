...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/examManage/act/T9ExamPaperAct/getExamPaperDetail.act?seqId=${param.seqId}";
...
function doCommit(){
  ...
  var url = "<%=contextPath %>/t9/subsys/oa/examManage/act/T9ExamPaperAct/updateExamPaper.act";
