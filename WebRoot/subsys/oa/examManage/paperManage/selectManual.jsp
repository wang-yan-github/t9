...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/examManage/act/T9ExamPaperAct/getSelectManualJson.act?roomId=${param.roomId}";
...
function doSubmit(){
  ...
  var url = "<%=contextPath %>/t9/subsys/oa/examManage/act/T9ExamPaperAct/updateSelectManual.act";
