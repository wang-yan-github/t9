...
function doInit() {
  doType();
  var url = "<%=contextPath%>/t9/subsys/oa/examManage/act/T9ExamQuizAct/showQuiz.act?seqId=" + seqId;
...
function doSubmit(){
  ...
  var requestURL = contextPath + "/t9/subsys/oa/examManage/act/T9ExamQuizAct/updateQuiz.act";
