...
<script type="text/javascript" src="/t9/subsys/oa/examManage/js/infoPub.js"></script>
<script type="text/javascript">
function doInit(){
  selectCount();
  var url = "<%=contextPath%>/t9/subsys/oa/examManage/act/T9ExamFlowAct/selectFlowToOnLine.act";
  cfgs = {
   dataAction: url,
   container: "giftList",
   colums: [
...
function getData(flowId){
  var url= "<%=contextPath%>/t9/subsys/oa/examManage/act/T9ExamDataAct/getDataByFlowId.act?flowId=" + flowId;
...
function selectCount(){
  var url= "<%=contextPath%>/t9/subsys/oa/examManage/act/T9ExamDataAct/selectCount.act";
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
