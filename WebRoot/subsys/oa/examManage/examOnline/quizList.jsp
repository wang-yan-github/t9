...
function doOnload(){	
  ...
  var url= "<%=contextPath%>/t9/subsys/oa/examManage/act/T9ExamDataAct/getExmaQuiz.act?flowId=" + flowId + "&paperTimes="+paperTimes+"&currPage="+currPage;
...
function addData(){
  var flowId = '<%=flowId%>';
  var paperTimes = '<%=paperTimes%>';
  var url= "<%=contextPath%>/t9/subsys/oa/examManage/act/T9ExamDataAct/addData.act?flowId=" + flowId + "&paperTimes="+paperTimes;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
...
function getData(){
  var flowId = '<%=flowId%>';
  var paperTimes = '<%=paperTimes%>';
  var url= "<%=contextPath%>/t9/subsys/oa/examManage/act/T9ExamDataAct/getDataByFlowId.act?flowId=" + flowId + "&paperTimes="+paperTimes;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
...
function doInit(){
  ...
  var flowId = '<%=flowId%>';
  var paperTimes = '<%=paperTimes%>';
  var url= "<%=contextPath%>/t9/subsys/oa/examManage/act/T9ExamDataAct/ExmaData.act?flowId=" + flowId + "&paperTimes="+paperTimes+"&"+queryParam;
  var rtJson = getJsonRs(url); 
  if(rtJson.rtState == "1"){
	alert(rtJson.rtMsrg); 
	return ; 
