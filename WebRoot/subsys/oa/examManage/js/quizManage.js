function doInit(){
  var url = contextPath + "/t9/subsys/oa/examManage/act/T9ExamQuizAct/selectQuiz.act";
   cfgs = {
    dataAction: url,
    container: "giftList",
    paramFunc: getParam,
...
function deleteQuiz(seqId) {
  ...
  if (window.confirm(msg)) {
    var requestUrl = contextPath + "/t9/subsys/oa/examManage/act/T9ExamQuizAct/deleteQuiz.act?seqId=" + seqId;
