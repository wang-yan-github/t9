...
function getRoomName(paperSeqId){
  var url = contextPath + "/t9/subsys/oa/examManage/act/T9ExamPaperAct/getRoomName.act";
...
function getRoomId(paperSeqId){
  var url = contextPath + "/t9/subsys/oa/examManage/act/T9ExamPaperAct/getRoomId.act";
  var rtJson = getJsonRs(url, "paperSeqId=" + paperSeqId);
  if (rtJson.rtState == "0") {
    return  rtJson.rtData ;
  } else {
...
function roomNameFunc(cellData, recordIndex, columIndex){
  ...
  var url = contextPath + "/t9/subsys/oa/examManage/act/T9ExamPaperAct/getRoomNameSingle.act";
...
function getPaperSeqId(){
  var url = contextPath + "/t9/subsys/oa/examManage/act/T9ExamPaperAct/getPaperSeqId.act";
...
function getQuestionsCount(paperSeqId){
  var url = contextPath + "/t9/subsys/oa/examManage/act/T9ExamPaperAct/getQuestionsCount.act";
  var rtJson = getJsonRs(url, "paperSeqId="+paperSeqId);
  if (rtJson.rtState == "0") {
    return rtJson.rtData;
  } else {
...
function getQuestionsList(paperSeqId){
  var url = contextPath + "/t9/subsys/oa/examManage/act/T9ExamPaperAct/getQuestionsList.act";
  var rtJson = getJsonRs(url, "paperSeqId="+paperSeqId);
  if (rtJson.rtState == "0") {
    return rtJson.rtData;
  } else {
...
function autoTopics(){
  ...
  var url = contextPath + "/t9/subsys/oa/examManage/act/T9ExamPaperAct/getAutoTopics.act";
...
function doEdit(seqId){
  var url = contextPath + "/t9/subsys/oa/examManage/act/T9ExamPaperAct/useredByPaper.act";
...
function isCount(roomId, questionsCount){
  var url = contextPath + "/t9/subsys/oa/examManage/act/T9ExamPaperAct/isCount.act";
...
function deleteSingle(seqId){
  ...
  var url = contextPath + "/t9/subsys/oa/examManage/act/T9ExamPaperAct/deleteSingle.act";
  var rtJson = getJsonRs(url, "seqId=" + seqId);
  if (rtJson.rtState == "0") {
    window.location.reload();
  } else {
