...
function doInit(){
  var url = "<%=contextPath%>/t9/subsys/oa/examManage/act/T9ExamQuizSetAct/getExamQuizSetDetail.act?seqId=${param.seqId}";
...
function doSubmit(){
  ...
  var url = "<%=contextPath %>/t9/subsys/oa/examManage/act/T9ExamQuizSetAct/updateExamQuizSet.act";
