...
function doInitShow() {
  doTitle();
  var url = "<%=contextPath%>/t9/subsys/oa/examManage/act/T9ExamFlowAct/showFlow.act?seqId=" + seqId;
...
<input type="hidden" name="dtoClass" value="t9.subsys.oa.examManage.data.T9ExamFlow">
