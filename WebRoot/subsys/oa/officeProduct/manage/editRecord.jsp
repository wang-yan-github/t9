...
<link rel="stylesheet" href="/t9/core/styles/style3/css/cmp/Calendar.css" type="text/css" />
...
function check_pro_name(name){
	if(name){
		...
		var urlStr = contextPath + "/t9/subsys/oa/officeProduct/manage/act/T9OfficeTranshistoryAct";
...
function doSubmit(){
	if(checkForm()){
		...
		var requestURI = "<%=contextPath%>/t9/subsys/oa/officeProduct/manage/act/T9OfficeTranshistoryAct";
...
function todayOutstock(){
	var requestURL = "<%=contextPath%>/t9/subsys/oa/officeProduct/manage/act/T9OfficeTranshistoryAct";
   ...
   <tr id="PCOUNT" style=>
    ...
    <tr id="REPAIR" style=display:none>
      ...
      <td class="TableData">
    	...
    	<img id="date1" align="middle" src="/t9/core/styles/style3/img/calendar.gif" align="middle" border="0" style="cursor:pointer" >
      </td>
   </tr>
   <tr id="RE_REMEND" style=display:none>
     ...
     <tr id="REM_TIME1" style=display:none>
      ...
      <td class="TableData">
    	...
    	<img id="date2" align="middle" src="/t9/core/styles/style3/img/calendar.gif" align="middle" border="0" style="cursor:pointer" >
