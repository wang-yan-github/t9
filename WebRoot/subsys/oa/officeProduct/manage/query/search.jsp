...
<%
	String transFlag = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("TRANS_FLAG")));
	String dept = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("dept")));
	String user = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("user")));
	String officeDepository = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("OFFICE_DEPOSITORY")));
	String officeProtype = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("officeProtype")));
	String officePro = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("officePro")));
	String proName = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("PRO_NAME")));
	String beginDate = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("beginDate")));
	String endDate = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("endDate")));
...
function deleteAll(){
	  ...
	  if(!window.confirm("确认要删除已选中的办公用品登记信息？")) {
		...
		var requestURLStr = contextPath + "/t9/subsys/oa/officeProduct/manage/act/T9OfficeTranshistoryAct";
...
function doInit(){
	...
	var url = "<%=contextPath%>/t9/subsys/oa/officeProduct/manage/act/T9OfficeTranshistoryAct/getTransDetailListJson.act?" + param;
	var cfgs = {
	    dataAction: url,
