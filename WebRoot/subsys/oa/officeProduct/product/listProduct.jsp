...
function proCreateNameFunc(cellData, recordIndex, columIndex){
  var url = contextPath + "/t9/subsys/oa/officeProduct/query/act/T9OfficeQueryAct/getUserName.act";
...
function deleteAll(){
	  ...
	  if(!window.confirm("确认要删除已选中的办公用品信息？")) {
		...
		var requestURLStr = contextPath + "/t9/subsys/oa/officeProduct/query/act/T9OfficeQueryAct";
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/officeProduct/query/act/T9OfficeQueryAct/queryOfficeProductsListJson.act?"+param;
 //alert(url);
    var cfgs = {
      dataAction: url,
