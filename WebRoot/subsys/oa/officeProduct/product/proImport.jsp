...
function downCSVTemplet(){
	var downUrl = "<%=contextPath%>/t9/subsys/oa/officeProduct/product/act/T9OfficeProductsAct";
...
<br>
 <div align="center"  class="Big1">
  <b>请指定用于导入的CSV文件：</b>
  <form name="form1" id="form1" method="post" action="<%=contextPath%>/t9/subsys/oa/officeProduct/product/act/T9OfficeProductsAct/impOfficeProToCsv.act" enctype="multipart/form-data"  >
