...
if(T9Utility.isNullorEmpty(storeId)){
	storeId = "0";
}
...
function doInit(){
	 ...
	 var url = contextPath+'/t9/subsys/oa/officeProduct/query/act/T9OfficeQueryAct/getOneOfficeProductInfo.act';
...
<table width="500" class="TableBlock" align="center" >
   ...
   <tfoot align="center" class="TableFooter">
    <td colspan="2" align="center">
    	  <input type="button" value="申请" class="BigButton" onClick="window.location.href='<%=contextPath %>/t9/subsys/oa/officeProduct/person/act/T9PersonalOfficeRecordAct/OfficeDepositoryInfo.act?PRO_ID=<%=proSeqId%>&DEPOSITORY=<%=storeId %>&TYPE_ID=<%=typeId %>'"> 
