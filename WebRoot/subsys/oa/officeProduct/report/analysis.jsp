...
function doInit(){
  var url = "<%=contextPath%>/t9/subsys/oa/officeProduct/report/act/T9ReportAnalysisAct/getAnalysis.act?"+param;
...
function getGiftOutByDeptId(deptId){
  var requestURL = "<%=contextPath%>/t9/subsys/oa/officeProduct/report/act/T9ReportAnalysisAct/getAnalysis.act?"+param+"&deptId="+deptId;
...
function printExcel(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/officeProduct/report/act/T9ReportAnalysisAct/printExcel.act?"+param;
  var param2 = "";
  if(module == "OFFICE_WPZB") {
