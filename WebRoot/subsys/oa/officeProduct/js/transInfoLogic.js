...
function borrowerFunc(cellData, recordIndex, columIndex) {
	...
	if (cellData) {
		var url = contextPath
				+ "/t9/subsys/oa/officeProduct/manage/act/T9OfficeTranshistoryAct/getUserName.act";
...
function depositoryOfType(typeId,extData){
	...
	if(typeId){
		selects.length =1;
		var urlStr = contextPath + "/t9/subsys/oa/officeProduct/product/act/T9OfficeProductsAct";
