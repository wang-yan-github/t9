...
int transQty = 0;
String remark = "";
List<T9OfficeTranshistory> officeList = (List<T9OfficeTranshistory>)request.getAttribute("onefindOffices");
T9OfficeTranshistory office = officeList.get(0);
if(office!=null){
...
function goto(){ 
		window.location.href= contextPath + "/t9/subsys/oa/officeProduct/person/act/T9PersonalOfficeRecordAct/findofficeRecordInfo.act";
}
</script>
</head>
