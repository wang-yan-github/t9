...
<head>
<%
  List<T9OfficeDepository> officeDep = (List<T9OfficeDepository>)request.getAttribute("findOfficeDeps");
  // List<T9OfficeType> officeTypes = (List<T9OfficeType>)request.getAttribute("officeTypes");
  // List<T9OfficeProducts> officeProducts = (List<T9OfficeProducts>)request.getAttribute("officeProducts");
...
function CheckForm(){
     ...
     var cc = 0;
	  ...
	  document.form1.action = contextPath +"/t9/subsys/oa/officeProduct/person/act/T9PersonalOfficeRecordAct/addOfficeProducts.act";
 ...
 <% int count = 0 ;
    ...
    if(officeDep!=null){
    	for(int i =0; i<officeDep.size()&& officeDep.size()>0; i++){
    		...
    		List<T9OfficeType> officeTypes = officeDep.get(i).getOfficeTypes();
    		count ++;
	  ...
	  <%
	    if(officeTypes!=null){
	    	 for(int j=0; j<officeTypes.size() && officeTypes.size()>0; j++){
	    		 List<T9OfficeProducts> products = officeTypes.get(j).getProducts();
