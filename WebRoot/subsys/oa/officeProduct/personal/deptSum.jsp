...
function doOnload(){
  ...
  ///t9/subsys/oa/officeProduct/person/act/T9PersonalOfficeRecordAct/getOfficeType.act
  //var requestUrl = "/t9/core/funcs/calendar/info/act/T9InfoAct/selectDeptToAttendance.act?deptId="
	var requestUrl ="<%=contextPath%>/t9/subsys/oa/officeProduct/person/act/T9PersonalOfficeRecordAct/selectDeptToAttendance.act";
...
function getGiftOutByDeptId(deptId){
 var requestURL = "<%=contextPath%>/t9/subsys/oa/officeProduct/person/act/T9PersonalOfficeRecordAct/getGiftOutByDeptId.act?deptId="+deptId;
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/t9/core/funcs/system/filefolder/images/notify_open.gif" align="absmiddle"><span class="big5">&nbsp;&nbsp;部门领用汇总</span><br>
    </td>
    <td align="right">
