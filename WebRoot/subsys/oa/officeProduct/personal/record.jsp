...
function depositoryOfType(id){
	...
	var options = "";
	 var par = "officeId="+id;
	 var url = contextPath+'/t9/subsys/oa/officeProduct/person/act/T9PersonalOfficeRecordAct/getOfficeType.act';
...
function depositoryOfProducts(id){
	 ...
	 var options ="";
	 var par = "officeId="+id;
	 var url = contextPath + '/t9/subsys/oa/officeProduct/person/act/T9PersonalOfficeRecordAct/getOfficeProducts.act';
	 var rtJson = getJsonRs(url,par);
	 if(rtJson.rtState =="0"){
	   var rtData = rtJson.rtData;
	   var listData = rtData.listData;
...
function CheckForm(){
	...
	document.form1.action = contextPath +"/t9/subsys/oa/officeProduct/person/act/T9PersonalOfficeRecordAct/addPersonOfficeRecord.act";
...
function checkProName(proName){
   //alert(proName);
	 ...
	 var url = contextPath + '/t9/subsys/oa/officeProduct/person/act/T9PersonalOfficeRecordAct/getOfficeProductName.act';//模糊查询
	 var rtJson = getJsonRs(url,par);
