...
<%@ page  import="t9.subsys.oa.officeProduct.person.data.*"%> 
<html>
<head>
<%
  ...
  Map map = (Map)request.getAttribute("transhistoryList");
   ...
   List<T9OfficeTranshistory> officeTs = (List<T9OfficeTranshistory>)map.get("list");
...
<script Language="JavaScript">
   function findOfficeXxInfo(officeSeqId){
    var url  = contextPath + "/t9/subsys/oa/officeProduct/person/act/T9PersonalOfficeRecordAct/findOfficeXxInfo.act?officeId="+ officeSeqId;
  ...
  function deleteOfficeInfo(deleteSeqId){
   ...
   if(!window.confirm(msg)){
     ...
     if(noHiddenId && noHiddenId!="null"){
       window.location.href = contextPath + "/t9/subsys/oa/officeProduct/person/act/T9PersonalOfficeRecordAct/deleteofficeRecordInfo.act?HiddenId="+deleteSeqId;  
       return true;
      }
    }
...
<table class="TableList"  width="95%" align="center">
 ...
 if(officeTs!=null){
   ...
   -->
   <%if(T9Utility.isNullorEmpty(officeTs.get(i).getOfficeProductName())){%>
  ...
  <% if (runId == 0) { %>
   <%if(!T9Utility.isNullorEmpty(officeTs.get(i).getTransState())){ %>
...
<%}%>
<br>
<form action="<%=contextPath%>/t9/subsys/oa/officeProduct/person/act/T9PersonalOfficeRecordAct/findofficeRecordInfo.act" method="get" name="form1" id="form1">
