...
<form enctype="multipart/form-data" action="<%=contextPath%>/t9/subsys/oa/officeProduct/officeType/act/T9OfficeDepositoryAct/addOfficeDepository.act"  method="post" name="form1" id="form1" onsubmit="">
