...
function deleteDepository(seqId){
		   ...
		   if(!window.confirm(msg)){
		     ...
		     if(seqId && seqId!="null"){
		       window.location.href = contextPath + "/t9/subsys/oa/officeProduct/officeType/act/T9OfficeDepositoryAct/delOfficeDepositoryInfo.act?HiddenId="+seqId;  
		       return true;
		      }
		   }  
}
...
function updateDepository(seqId){
	 var url  = contextPath + "/t9/subsys/oa/officeProduct/officeType/act/T9OfficeDepositoryAct/upOfficeDepositoryInfo.act?officeSeId="+ seqId;
