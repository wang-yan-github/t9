...
function doInit(){
  if(CheckForm()){
    var requestUrl = "<%=contextPath%>/t9/subsys/oa/active/act/T9ActiveAct/addActive.act";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
 ...
 <table class="TableBlock" width="450" align="center">
    ...
    <tr>
      ...
      <td class="TableData">
    	  <input id="calendar" name="calendar" type="checkbox" checked><label for="calendar">是</label>
      </td>
    </tr>
