...
function deleteSingle(seqId){
  ...
  var url = contextPath + "/t9/subsys/oa/abroad/act/T9HrAbroadRecordAct/deleteSingle.act";
...
function deleteAll() {
  ...
  //  return ;
  //}  
  //var url = contextPath + "/t9/subsys/oa/abroad/act/T9HrAbroadRecordAct/deleteAll.act";
...
function getNormalAdd(userId){
  ...
  var url = contextPath + "/t9/custom/attendance/act/T9OvertimeRecordAct/getTotalAddStat.act";
...
function normal(userId){
  var beginDate = $("beginDate").value;
  var endDate = $("endDate").value;
  var requestURL = contextPath + "/t9/custom/attendance/act/T9OvertimeRecordAct/getOverTimeStat.act";
...
function getUserName(userId){
  var url = contextPath + "/t9/custom/attendance/act/T9OvertimeRecordAct/getUserName.act";
