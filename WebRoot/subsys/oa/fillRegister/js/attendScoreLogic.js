...
function moblieSmsRemind(remidDiv,remind) {
  var requestUrl = contextPath + "/t9/core/funcs/mobilesms/act/T9MobileSelectAct/isShowSmsRmind.act?type=62";
...
function getSysRemind(){ 
  var requestUrl = contextPath + "/t9/core/funcs/calendar/act/T9CalendarAct/getSysParaRemind.act?type=62"; 
  var rtJson = getJsonRs(requestUrl); 
  if (rtJson.rtState == "1") { 
    alert(rtJson.rtMsrg); 
    return ; 
...
function getAttendDuty(){
  var url = contextPath + "/t9/subsys/oa/fillRegister/act/T9AttendScoreAct/getAttendDutyJson.act";
