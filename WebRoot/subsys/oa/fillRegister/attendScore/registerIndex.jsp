...
function addRegister(){
  window.location.href = "/t9/subsys/oa/fillRegister/attendScore/newRegister.jsp";
}

function historyRegister(){
  window.location.href = "/t9/subsys/oa/fillRegister/attendScore/historyRegister.jsp";
}
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/t9/core/styles/style3/img/views/attendance.gif" WIDTH="22" HEIGHT="20" align="absmiddle"><span class="big3">&nbsp;个人补登记</span><br>
    </td>
  </tr>
</table>
<br>
