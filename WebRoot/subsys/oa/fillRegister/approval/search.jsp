...
<%
  String assessingOfficer = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("assessingOfficer")));
  String assessingStatus = T9Utility.encodeSpecial(T9Utility.null2Empty(request.getParameter("assessingStatus")));
...
function doInit(){
  ...
  var url =  contextPath + "/t9/subsys/oa/fillRegister/act/T9AttendApprovalAct/queryApprovalListJson.act?" + param;
  var cfgs = {
      dataAction: url,
