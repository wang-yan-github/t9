<%@ page language="java" contentType="text/html; charset=UTF-8" import="java.util.*,java.text.SimpleDateFormat,t9.core.funcs.calendar.data.*" pageEncoding="UTF-8" isELIgnored="false"%>
...
function getMonthScore(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/assessmentScore/act/T9AssessmentScoreAct/getMonthScore.act";
...
function getYearScore(){
  var url = "<%=contextPath%>/t9/subsys/oa/assessmentScore/act/T9AssessmentScoreAct/getYearScore.act";
