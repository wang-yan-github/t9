...
<%
  String userId = request.getParameter("perSeqId")== null ? "" : T9Utility.encodeSpecial(request.getParameter("perSeqId"));
  String tPlanNo = request.getParameter("tPlanNo")== null ? "" : T9Utility.encodeSpecial(request.getParameter("tPlanNo"));
  ...
  String trainningCost = request.getParameter("trainningCost") == null ? "" : T9Utility.encodeSpecial(request.getParameter("trainningCost"));
...
function doInit(){
  ...
  var url =  contextPath + "/t9/subsys/oa/training/act/T9TrainingRecordAct/getTrainingRecordSearchList.act?" + param;
  var cfgs = {
      dataAction: url,
