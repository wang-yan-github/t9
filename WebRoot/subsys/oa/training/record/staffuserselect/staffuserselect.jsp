...
function getTrainingAjaxFunc(param, userId){
  ...
  var url = contextPath + "/t9/subsys/oa/training/act/T9TrainingApprovalAct/getTrainingUserSelectJson.act?condition=" + encodeURIComponent(condition) +"&userId=" +userId;
