...
<%
  String userIdStr = request.getParameter("userIdStr")== null ? "" : T9Utility.encodeSpecial(request.getParameter("userIdStr"));
%>
...
function doInit(){
  var url = "<%=contextPath%>/t9/subsys/oa/training/act/T9TrainingRecordAct/getRecordInfoDetail.act?seqId=${param.seqId}";
