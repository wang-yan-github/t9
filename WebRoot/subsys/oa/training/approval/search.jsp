...
<%
  ...
  String assessingOfficer = request.getParameter("assessingOfficer") == null ? "" : T9Utility.encodeSpecial(request.getParameter("assessingOfficer"));
  String assessingStatus = request.getParameter("assessingStatus") == null ? "" : T9Utility.encodeSpecial(request.getParameter("assessingStatus"));
...
function doInit(){
  ...
  var url =  contextPath + "/t9/subsys/oa/training/act/T9TrainingApprovalAct/getTrainingApprovalSearchList.act?" + param;
  var cfgs = {
      dataAction: url,
...
function doSubmit(){
  ...
  var url = contextPath + "/t9/subsys/oa/training/act/T9TrainingApprovalAct/updateStatus.act";
