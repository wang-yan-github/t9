...
<%
  String tPlanName = request.getParameter("tPlanName")== null ? "" :   T9Utility.encodeSpecial(request.getParameter("tPlanName"));
  String tChannel = request.getParameter("tChannel")== null ? "" :   T9Utility.encodeSpecial(request.getParameter("tChannel"));
  String tCourseTypes = request.getParameter("tCourseTypes") == null ? "" : T9Utility.encodeSpecial(request.getParameter("tCourseTypes"));
  String tAddress = request.getParameter("tAddress") == null ? "" :   T9Utility.encodeSpecial(request.getParameter("tAddress"));
  String tInstitutionName = request.getParameter("tInstitutionName") == null ? "" : T9Utility.encodeSpecial(request.getParameter("tInstitutionName"));
  String courseStartDate1 = request.getParameter("courseStartDate1") == null ? "" : T9Utility.encodeSpecial(request.getParameter("courseStartDate1"));
  String courseStartDate2 = request.getParameter("courseStartDate2") == null ? "" : T9Utility.encodeSpecial(request.getParameter("courseStartDate2"));
...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/training/act/T9HrTrainingPlanAct/queryTrainingPlanListJson.act?" + param;
  var cfgs = {
      dataAction: url,
