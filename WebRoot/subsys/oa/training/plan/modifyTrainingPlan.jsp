...
var requestURL = "<%=contextPath%>/t9/subsys/oa/training/act/T9HrTrainingPlanAct";
var fckContentStr = "";
//附件上传
...
function getOrgDescFunc(){
  ...
  if($("assessingOfficer") && $("assessingOfficer").value.trim()){
	    bindDesc([{cntrlId:"assessingOfficer", dsDef:"PERSON,SEQ_ID,USER_NAME"}]);
	  }
...
<table class="TableBlock" width="60%" align="center">
  ...
  <tr>
    ...
    <td class="TableData" >
      <INPUT style="display:none" type="text" name="assessingOfficer" id="assessingOfficer" class=BigInput size="12" maxlength="12">
      <INPUT readonly type="text" name="assessingOfficerDesc" id="assessingOfficerDesc" class=BigStatic size="12" maxlength="12">
