...
function staffUserIdFunc(cellData, recordIndex, columIndex){
  ...
  var url = contextPath + "/t9/subsys/oa/training/act/T9TrainingRecordAct/getUserName.act";
...
function deleteSingle(seqId){
  ...
  var url = contextPath + "/t9/subsys/oa/training/act/T9TrainingRecordAct/deleteSingle.act";
...
function deleteAll() {
  ...
  var url = contextPath + "/t9/subsys/oa/training/act/T9TrainingRecordAct/deleteAll.act";
