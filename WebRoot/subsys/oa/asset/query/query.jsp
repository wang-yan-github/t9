...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCptlInfoAct/querySelect.act?" + param;
    cfgs = {
    dataAction: url,
    container: "giftList",
    colums: [
...
function getParam(seqId) {
  var url = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCptlInfoAct/selectID.act?seqId=" + seqId;
