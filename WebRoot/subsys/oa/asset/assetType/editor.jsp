...
<%@page import="t9.subsys.oa.asset.data.T9CpAssetType"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%
T9CpAssetType type = (T9CpAssetType)request.getAttribute("cp");
%>
...
function checkForm2() {
  if (checkForm()) {
      ...
      var url = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpAssetTypeAct/updateType.act";
