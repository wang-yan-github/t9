...
function checkForm2() {
  if (checkForm()) {
    ...
    var reqURL = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpAssetTypeAct/selectTypeName.act?" + param;
    ...
    if (prcs.length > 0) {
      ...
      var url = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpAssetTypeAct/addType.act";
...
function deteleType(seqId) {
  ...
  if (window.confirm(msg)) {
    window.location.href = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpAssetTypeAct/deleteType.act?seqId=" + seqId;
    location.reload();
  }
}
function deteleTypeAll() {
  ...
  if (window.confirm(msg)) {
    window.location.href = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpAssetTypeAct/deleteTypeAll.act";
    window.location.reload();
  }
}
function updateType(seqId) {
  window.location.href = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpAssetTypeAct/selectId.act?seqId=" + seqId;
}
</script>
</head>
...
<input type="hidden" name="dtoClass" value="t9.subsys.oa.asset.data.T9CpAssetType">
