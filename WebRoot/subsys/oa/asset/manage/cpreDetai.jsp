...
<%@page import="t9.subsys.oa.asset.data.T9Cpcptl"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<%
List<T9Cpcptl> list = (List<T9Cpcptl>) request.getAttribute("list");
List<T9Cpcptl> list2 = (List<T9Cpcptl>) request.getAttribute("list2");
  ...
  <tr class="TableLine1">
    ...
    <td nowrap align="center" id="cptlSpecDesc">
     ...
     <td nowrap align="center">
      <%if(!T9Utility.isNullorEmpty(cp.getUseDept())){%>
     <%=cp.getUseDept() %>
     <%} %>
     </td>
