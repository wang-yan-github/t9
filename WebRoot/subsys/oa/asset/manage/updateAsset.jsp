...
T9CpCptlInfo cpcp = (T9CpCptlInfo) request.getAttribute("cpcp");
%>
<html>
<head>
...
function checkForm2(){
  if (checkForm()) {
    ...
    var url = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCptlInfoAct/editAsset.act";
...
function cptlSpec(){
  var url = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpAssetTypeAct/assetTypeId.act";
...
<table width="95%" border="0" cellspacing="0" cellpadding="0" height="3">
 ...
 <input type="hidden" name="dtoClass" value="t9.subsys.oa.asset.data.T9CpCptlInfo">
 ...
 <%if(!T9Utility.isNullorEmpty(cpcp.getUseUser())){%>
 ...
 <%}%>
  <%if(!T9Utility.isNullorEmpty(cpcp.getUseState())){%>
...
<table class="TableBlock" width="500" align="center">
    ...
    <tr>
      ...
      <td class="TableData"> 
       <input type="hidden" name="cptlVal" id="cptlVal" size="20" maxlength="13" class="BigInput" value="<%=cpcp.getCptlVal()%>"> 
         <input type="text" name="cptlVal2" id="cptlVal2" onblur="checkMoney('cptlVal2')" size="20" maxlength="13" class="BigInput" value="<%=T9Utility.getFormatedStr(cpcp.getCptlVal(),2)%>"> &nbsp;</td>
    </tr>
     <tr>
      <td nowrap class="TableData" width="100"> 资产数量：</td>
      <td class="TableData"> 
         <input type="text" name="cptlQty" id="cptlQty" size="10" maxlength="23" class="BigInput" value="1"  style="text-align:right;" readonly> &nbsp;</td>
    </tr>
    <tr>
  ...
  <tr>
    ...
    <tr>
      ...
      <td class="TableData"> 
        <textarea cols="35" name="remark" id="remark" rows="2" class="BigInput" wrap="yes"><%if(!T9Utility.isNullorEmpty(cpcp.getRemark())){ %><%=cpcp.getRemark()%><%} %></textarea>
      </td>
    </tr>  
