...
function sendForm() {
  if (checkForm()) {
    ...
    var url = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCptlRecordAct/add.act";
...
function doInit() {
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCptlRecordAct/nameList.act?useFlag=" + useFlag;
...
<a href="javascript:selectData('<%=request.getParameter("single")%>');" style="cursor: hand">选择数据</a>
    ...
    <tr>
      ...
      <td class="TableData"> 
       <input type="text" name="cpreQty" id="cpreQty" size="12" maxlength="15" class="BigInput" value="1" style="text-align:right;" readonly> 数字
      </td>
    </tr>
  <tr>
