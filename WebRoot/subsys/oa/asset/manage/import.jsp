...
function downCSVTemplet(){
	var downUrl = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCpImportAct";
 ...
 <body class="bodycolor" topmargin="5">
  ...
  <div align="center" class="Big1">
    <form name="form1" id="form1" action="<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCpImportAct/importAsset.act" method="post" enctype="multipart/form-data">
