...
function exportExcel() {
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCpImportAct/outAsset.act?" + param;
  window.location.href = url;
}
function doInit() {
  var url = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCptlRecordAct/cpTypeId.act";
...
function doUseState() {
  var url = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCptlRecordAct/useStateList.act";
  var json = getJsonRs(url);
  var rtData = json.rtData;
  for(var i = 0; i < rtData.length; i++) {
    var opt = document.createElement("option");
