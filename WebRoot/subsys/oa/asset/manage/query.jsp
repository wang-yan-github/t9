...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCptlInfoAct/listSelect.act?" + param;
    cfgs = {
    dataAction: url,
    container: "giftList",
    colums: [
...
function cptlDetail(seqId) {
  var URL = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCptlInfoAct/getSelect.act?seqId=" + seqId;
...
function updateCptl(seqId) {
  var URL = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCptlInfoAct/getSelect2.act?seqId=" + seqId;
  myleft=(screen.availWidth-500)/2;
 ...
 function cpreDetail(seqId) {
  var URL = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCptlRecordAct/getSelectID.act?seqId=" + seqId;
  myleft=(screen.availWidth-500)/2;
 ...
 function delDetail(seqId) {
  if(window.confirm("确认要删除该资产吗？")) {
    var url = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCptlInfoAct/getDelete.act?seqId=" + seqId;
