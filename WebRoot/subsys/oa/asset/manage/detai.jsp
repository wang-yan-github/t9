...
<table class="TableBlock" width="100%">
  ...
  <tr>
      ...
      <%if(!T9Utility.isNullorEmpty(cpcp.getNoDeal())){%>
  ...
  <tr>
      ...
      <td align="left" class="TableData">
      <%if(!T9Utility.isNullorEmpty(cpcp.getInFinance())){%>
  ...
  <tr>
      ...
      <td nowrap align="left" class="TableData"><%=T9Utility.getFormatedStr(cpcp.getCptlVal(),2)  %></td>
  </tr>
  <tr>
