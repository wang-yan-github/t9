...
function doInit(){
  ...
  var url = "<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCptlInfoAct/cpcpSelect.act";
   cfgs = {
    dataAction: url,
    container: "giftList",
    colums: [
...
function cptlDetail(seqId) {
  ...
  window.open("<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCptlInfoAct/getSelect.act?seqId=" + seqId,"read","height=570,width=500,status=0,toolbar=no,menubar=no,location=no,scrollbars=yes,top=150,left="+myleft+",resizable=yes");
}
function cpreDetail(seqId) {
  myleft = (screen.availWidth-500)/2;
  window.open("<%=contextPath%>/t9/subsys/oa/asset/act/T9CpCptlRecordAct/getSelectID.act?seqId=" + seqId,"read","height=370,width=750,status=0,toolbar=no,menubar=no,location=no,scrollbars=yes,top=150,left=150,resizable=yes");
}
</script>
</head>
