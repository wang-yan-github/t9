...
function doInit(){
	  var requestURL = "<%=contextPath%>/t9/subsys/oa/bbs/act/T9BbsAct/getLoginInfo.act";
...
function saveBbsUrl(){
	  ...
	  var requestURL = "<%=contextPath%>/t9/subsys/oa/bbs/act/T9BbsAct/saveBbsUrlAct.act";
...
<div align="center" style="display:none" id="show">
  ...
  <tr>
  <td class="msg info"><div class='content' style='font-size:12pt'>系统还没有集成Discuz，请安装Discuz后，以管理员身份设置Discuz的URL。详情请咨询T9技术支持！</div></td>
  </tr>
  </table>
