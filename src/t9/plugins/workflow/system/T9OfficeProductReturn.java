...
public class T9OfficeProductReturn implements T9IWFHookPlugin {
  ...
  public String execute(Connection conn, int runId, Map arrayHandler,
      Map formData, boolean agree) throws Exception {
        ...
        if(agree)
        {
              String update="update OFFICE_TRANSHISTORY set TRANS_QTY='"+TRANS_QTY + "',OPERATOR='"+BORROWER_ID+"',TRANS_STATE='1',PRICE='"+PRO_PRICE+"' where SEQ_ID='"+TRANS_ID+"'";
