...
public String getSaveInfo() {
  ...
  public String toJson(){
    ...
    sb.append("{");
      ...
      sb.append("bookName:").append("\"").append(T9Utility.encodeSpecial(bookName.trim())).append("\"").append(",");
      sb.append("bookNo:").append("\"").append(T9Utility.encodeSpecial(bookNo.trim())).append("\"");
    sb.append("}");
    return sb.toString();
  }
