...
import t9.subsys.oa.fillRegister.data.T9AttendNoCheck;

public class T9AttendFillLogic {
  private static Logger log = Logger.getLogger("t9.subsys.oa.fillRigister.attendScore.logic.T9AttendFillLogic.java");
  
  public void addAttendFill(Connection dbConn, T9AttendFill scoreFlow) throws Exception {
    try {
      T9ORM orm = new T9ORM();
   ...
   * @throws Exception
   */
  public void addAttendScore(Connection dbConn, T9Person person, String startDateStr, String endDateStr, String proposer) throws Exception{
    ...
    if(list.size() > 2){
      ...
      for(int i = 0; i < list.size(); i++){
        String lenStr = String.valueOf(list.get(i));
        if(lenStr.length() == 7){
          T9AttendNoCheck anc = new T9AttendNoCheck();
          anc.setNoCheckDate(T9Utility.parseDate(lenStr+"-01"));
  ...
  public void getAddRegisterFunc(Connection dbConn, T9AttendFill attendFill, T9Person person,  String lenStr,  String dateStr,  String registerType) throws Exception{
    attendFill.setAssessingStatus("1");
    attendFill.setFillTime(T9Utility.parseDate(lenStr + "-" + dateStr));
    attendFill.setRegisterType(registerType);
    attendFill.setAssessingTime(new Date());
    addAttendFillScore(dbConn, attendFill);
  } 
  
  public void getAddRegisterFunc2(Connection dbConn, T9AttendFill attendFill, T9Person person,  String dateStr,  String registerType, String proposer) throws Exception{
    attendFill.setAssessingStatus("1");
    attendFill.setFillTime(T9Utility.parseDate(dateStr));
    attendFill.setRegisterType(registerType);
    attendFill.setAssessingTime(new Date());
  ...
  public void addAttendFillScore(Connection dbConn, T9AttendFill attendFill) throws Exception {
    try {
      T9ORM orm = new T9ORM();
   ...
   * @throws Exception
   */
  public void addAttendNoCheck(Connection dbConn, T9AttendNoCheck anc) throws Exception {
    try {
      T9ORM orm = new T9ORM();
   ...
   * @throws Exception
   */
  public void addAttendScoreYear(Connection dbConn, T9Person person, String startDateStr, String endDateStr, String proposer, String assessingOfficer) throws Exception{
    T9AttendConfig attend = selectConfigById(dbConn, String.valueOf(person.getDutyType()));
    T9AttendFill attendFill = new T9AttendFill();
    String firstDate = "";
    String lastDate = "";
   ...
   * @throws Exception
   */
  public void addAttendScoreAbord(Connection dbConn, T9Person person, String startDateStr, String endDateStr, String proposer, String assessingOfficer) throws Exception{
    T9AttendConfig attend = selectConfigById(dbConn, String.valueOf(person.getDutyType()));
    T9AttendFill attendFill = new T9AttendFill();
    String firstDate = "";
    String lastDate = "";
   ...
   * @throws Exception
   */
  public void autoAttendFill(Connection dbConn, T9Person person, String startDateStr, String endDateStr, String proposer, String assessingOfficer) throws Exception{
    String dutyType = getDutyType(dbConn, Integer.parseInt(proposer));
    T9AttendConfig attend = selectConfigById(dbConn, dutyType);
    T9AttendFill attendFill = new T9AttendFill();
    String firstDate = "";
    String lastDate = "";
    String daysStr = getDayList(dbConn, startDateStr, endDateStr);
    ...
    for(int x = 0; x < dayStr.length; x++){
      ...
      if(attend != null && !T9Utility.isNullorEmpty(attend.getDutyTime1())){
        getAutoAddRegisterFunc(dbConn, attendFill, dayStr[x], "1", proposer, assessingOfficer);
      }
      if(attend != null &&!T9Utility.isNullorEmpty(attend.getDutyTime2())){
        getAutoAddRegisterFunc(dbConn, attendFill, dayStr[x], "2", proposer, assessingOfficer);
      }
      if(attend != null &&!T9Utility.isNullorEmpty(attend.getDutyTime3())){
        getAutoAddRegisterFunc(dbConn, attendFill, dayStr[x], "3", proposer, assessingOfficer);
      }
      if(attend != null &&!T9Utility.isNullorEmpty(attend.getDutyTime4())){
        getAutoAddRegisterFunc(dbConn, attendFill, dayStr[x], "4", proposer, assessingOfficer);
      }
      if(attend != null &&!T9Utility.isNullorEmpty(attend.getDutyTime5())){
        getAutoAddRegisterFunc(dbConn, attendFill, dayStr[x], "5", proposer, assessingOfficer);
      }
      if(attend != null &&!T9Utility.isNullorEmpty(attend.getDutyTime6())){
        getAutoAddRegisterFunc(dbConn, attendFill, dayStr[x], "6", proposer, assessingOfficer);
      }
    }
  }
   ...
   * @throws Exception
   */
  public void getAutoAddRegisterFunc(Connection dbConn, T9AttendFill attendFill,  String dateStr,  String registerType, String proposer, String assessingOfficer) throws Exception{
    attendFill.setAssessingStatus("1");
    attendFill.setFillTime(T9Utility.parseDate(dateStr));
    attendFill.setRegisterType(registerType);
    attendFill.setAssessingTime(new Date());
   ...
   * @throws Exception
   */
  public void addAttendScoreLeave(Connection dbConn, T9Person person, String startDateStr, String endDateStr, String proposer, String assessingOfficer) throws Exception{
    String dutyType = getDutyType(dbConn, Integer.parseInt(proposer));
    T9AttendConfig attend = selectConfigById(dbConn, dutyType);
    T9AttendFill attendFill = new T9AttendFill();
