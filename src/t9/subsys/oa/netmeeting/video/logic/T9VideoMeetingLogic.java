package t9.subsys.oa.netmeeting.video.logic;
...
public class T9VideoMeetingLogic {
  private static Logger log = Logger.getLogger("t9.subsys.oa.netmeeting.video.logic.T9VideoMeetingLogic.java");

  public String checkUser(Connection dbConn, T9Person person, String contexPathAll) throws Exception  {
    
    String userName = "";
    String password = "";
    String sql = " select RED_USERNAME,RED_PASSWORD "
               + " from VIDEO_MEETING_MANAGER "
    ...
    try {
      ...
      if(rs.next()) {
        ...
        String reXML = T9VideoLogic.send(url,strXML);
      ...
      if(T9Utility.isNullorEmpty(userName) || T9Utility.isNullorEmpty(password)){
        return "{state:\"0\"}";
      }
    } catch (Exception e) {
      throw e;
  ...
  public String getMeetingList(Connection dbConn, Map request, T9Person person, String contexPathAll) throws Exception  {
  ...
  public String getVideoMeetingListInfo(Map request, Connection dbConn, T9Person person, String contexPathAll) throws Exception  {
        ...
        if(body == null){
          ...
          while(iterator.hasNext()){
            ...
            if(meeting.getName().equals("meeting")){ 
              ...
              reXML = T9VideoLogic.send(url,strXML);
              ...
              if(temp.indexOf("," + person.getSeqId() + ",") == -1 && (T9Utility.isNullorEmpty(userName) || !userName.equals(meeting.element("hostName").getText()))){
                continue;
              }
  ...
  public String doStartVideoMeeting(String confKey, String meetingPwd, Connection dbConn, T9Person person, String contexPathAll) throws Exception  {
    Map map = getUsernameAndPassword(dbConn, person);
    String userName = (String)map.get("userName");
      ...
      if(result.getText().equals("SUCCESS")){
        ...
        strXML = "<?xml version='1.0' encoding='UTF-8'?>"
         ...
         while(iterator.hasNext()){
           ...
           if(attendee.element("name").getName().equals("name") && !T9Utility.isNullorEmpty(attendee.element("name").getText())){ 
             attendeesSeqId = attendeesSeqId + attendee.element("name").getText() + ",";
           }
         }
   ...
   * @throws Exception
   */
  public String setNewVideoMeetingValueLogic(Connection dbConn, Map map, T9Person person, String contexPathAll) throws Exception {
   ...
   * @throws Exception
   */
  public String deleteMeetingLogic(String confKey, Connection dbConn, T9Person person, String contexPathAll) throws Exception {
    Map map1 = getUsernameAndPassword(dbConn, person);
    String userName = (String)map1.get("userName");
    String password = (String)map1.get("password");
  ...
  public String getVideoMeetingInfo(String confKey, Connection dbConn, T9Person person, String contexPathAll) throws Exception{
    Map map1 = getUsernameAndPassword(dbConn, person);
    String userName = (String)map1.get("userName");
    String password = (String)map1.get("password");
  ...
  public String updateTransferInfoLogic(Connection dbConn, Map map, T9Person person, String contexPathAll) throws Exception {
  ...
  public String doJoinVideoMeeting(String confKey, String password, T9Person person, String contexPathAll) throws Exception  {
    StringBuffer sb = new StringBuffer();
    try{
      Map ipAndPort = getIpAndPort(contexPathAll);
      String ip = (String)ipAndPort.get("ip");
  ...
  public Map getUsernameAndPassword(Connection dbConn, T9Person person) throws Exception  {
    String userName = "";
    String password = "";
    Map map = new HashMap();
    String sql = " select RED_USERNAME,RED_PASSWORD "
  ...
  public String queryMeetingList(Connection dbConn, Map request, T9Person person, String contexPathAll) throws Exception  {
  ...
  public void addManager(Connection dbConn,T9VideoMeetingManager manager) throws Exception{
    T9ORM orm = new T9ORM();
    orm.saveSingle(dbConn, manager);
  }
  
  public void updateManager(Connection dbConn,T9VideoMeetingManager manager) throws Exception{
    T9ORM orm = new T9ORM();
  ...
  public void deleteManager(Connection dbConn,String seqId) throws Exception{
    T9ORM orm = new T9ORM();
    orm.deleteSingle(dbConn, T9VideoMeetingManager.class, Integer.parseInt(seqId));
  }
