...
public class T9VehicleLogic {
  ...
  public void updateVehicle(Connection dbConn, T9Vehicle vehicle) throws Exception {
    T9ORM orm = new T9ORM();
  ...
  public ArrayList<T9Vehicle> selectVehicle(Connection dbConn, String[] str) throws Exception{
    T9ORM orm = new T9ORM();
    ArrayList<T9Vehicle> vehicleList = (ArrayList<T9Vehicle>)orm.loadListSingle(dbConn, T9Vehicle.class, str);
    return vehicleList;
  }
  public String toSearchData(Connection conn,Map request,String seqId) throws Exception{
    String sql = "select v.SEQ_ID,v.V_MODEL,v.V_NUM,p.USER_NAME,ci.CLASS_DESC,v.V_DATE,v.V_STATUS,v.insurance_flag"
      +" from VEHICLE v left outer join CODE_ITEM ci on v.V_TYPE = ci.SEQ_ID left outer join CODE_CLASS cc on "
  ...
  public T9Vehicle selectVehicleById(Connection dbConn, String seqId) throws Exception{
    T9ORM orm = new T9ORM();
  ...
  public ArrayList<Map<String,String>> selectVehicle(Connection dbConn,String useingFlag) throws Exception{
    ...
    try{
      ...
      if(!T9Utility.isNullorEmpty(useingFlag)){
