...
public class T9OfficeDepository {
	...
	private List<T9OfficeType> officeTypes;
	
	public List<T9OfficeType> getOfficeTypes() {
		return officeTypes;
	}

	public void setOfficeTypes(List<T9OfficeType> officeTypes) {
