...
import t9.subsys.portal.guoyan.module.logic.T9PortalGridModuleNotifyLogic;

public class T9PortalGridModuleNotify {
  /**
   * 加载列表数据,不分页的情况
   * @param request
   * @param response
  ...
  public String loadGridData(HttpServletRequest request,
    ...
    try {
      ...
      T9PortalGridModuleNotifyLogic lal = new T9PortalGridModuleNotifyLogic();
