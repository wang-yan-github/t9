...
public class T9MetaUpdate {
  ...
  public List searchFileList(Connection dbConn,
    ...
    try {
      ...
      preStmt2 = createPreStmtMeta(dbConn, "FILE_ATTRS02", 100);
    ...
    try {
      ...
      if (rs.next()) {
        for (int i = 0; i < 100; i++) {
          ...
          rtMap.put("ATTR_" + T9Utility.getFixLengthStringFront(String.valueOf(i + 100), 3), value);
        }
      }
    }catch(Exception ex) {
      throw ex;
