...
public class T9SignFile {
  ...
  public String toJson() throws Exception {
    ...
    rtBuf.append(",");
    rtBuf.append("title:");
    rtBuf.append("\"" + (this.title == null ? "" : T9Utility.encodeSpecial(this.title)) + "\"");
    rtBuf.append(",");
    ...
    rtBuf.append("\"" + (this.createTime == null ? "" : T9Utility.getDateTimeStr(this.createTime)) + "\"");
    rtBuf.append(",");
    rtBuf.append("updateTime:");
    rtBuf.append("\"" + (this.updateTime == null ? "" : T9Utility.getDateTimeStr(this.updateTime)) + "\"");
    rtBuf.append(",");
    rtBuf.append("signFlag:");
    rtBuf.append("\"" + (this.signFlag == null ? "" : this.signFlag) + "\"");
    rtBuf.append(",");
    rtBuf.append("lastSignTime:");
    rtBuf.append("\"" + (this.lastSignTime == null ? "" : T9Utility.getDateTimeStr(this.lastSignTime)) + "\"");
    rtBuf.append(",");
    ...
    rtBuf.append("\"" + (this.fullTextTime == null ? "" : T9Utility.getDateTimeStr(this.fullTextTime)) + "\"");
    rtBuf.append(",");
    rtBuf.append("fileName:");
    rtBuf.append("\"" + (this.fileName == null ? "" : T9Utility.encodeSpecial(this.fileName)) + "\"");
    rtBuf.append(",");
    rtBuf.append("abstract:");
    rtBuf.append("\"" + (this.abstracts == null ? "" : T9Utility.encodeSpecial(this.abstracts)) + "\"");
    rtBuf.append(",");
  ...
  private StringBuffer toJsonAtts() {
    ...
    while (iKeys.hasNext()) {
      ...
      rtBuf.append(typeNo + ":");
      rtBuf.append("\"" + T9Utility.encodeSpecial(value) + "\",");      
    }
    if (rtBuf.length() > 1) {
  ...
  public void putAttr(Map metas) {
    ...
    T9Utility.copyMap(metas, metaMap);
  }
  /**
   * 设置属性
   * @param attrName
