...
import t9.rad.velocity.createtable.T9TableInfo;

public class T9velocityUtil{
  ...
  public static void velocity(T9TableInfo[] obj, String outpath,
      String templateName, String templateUrl){
    // 获取模板引擎
    for (T9TableInfo t9TableInfo : obj){
      velocity(t9TableInfo, outpath, templateName, templateUrl);
    }
  }
