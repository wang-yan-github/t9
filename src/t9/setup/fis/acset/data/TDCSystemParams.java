...
import t9.setup.fis.acset.global.TDAcsetParamFlagConst;
import t9.setup.fis.acset.global.TDAuthConst;
...
public class TDCSystemParams {
  ...
  public void setCloseInit(String closeInitFlag) {
    ...
    if (!T9Utility.isNullorEmpty(closeInitFlag)) {
  ...
  public void setUsedCasherSign(String usedCasherAsign) {
    ...
    if (!T9Utility.isNullorEmpty(usedCasherAsign)) {
  ...
  public void setPermitCheckSelf(String permitCheckSelf) {
    ...
    if (!T9Utility.isNullorEmpty(permitCheckSelf)) {
