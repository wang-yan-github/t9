...
import t9.core.util.T9I18n;
import t9.core.util.T9Utility;
import t9.core.util.db.T9DBUtility;
import t9.core.util.file.T9FileUtility;
import t9.setup.fis.acset.data.TDAcset;
import t9.setup.fis.acset.data.TDMaintainConst;
...
public class TDDbFileUpdater {
  ...
  public static void exectSqlInfileAsWhole(String inputFile,String dbName,String dbmsName) throws Exception {
    ...
    T9FileUtility.loadLine2Array(inputFile, 0, 1, descList);
    if (descList.size() < 2) {
      throw new T9InvalidParamException(T9I18n.ln(TDDbFileUpdater.class, "1"));
    }
    ...
    try {
      ...
      T9FileUtility.loadLine2Array(inputFile, 2, sqlList);
    ...
    try {
      ...
      for (int i = 0; i < dbNameArray.length; i++) {
        ...
        for (int j = 0; j < sqlList.size(); j++) {          
          ...
          stmt.execute(T9Utility.transferCode(sqlStr,"UTF-8","ISO8859_1"));        
        }
...
//      log.debug("exSql>>" + exSql);
  ...
  public static void executeSqlInPath(String path,String dbmsName) throws Exception {
    ...
    String[] fileNameArray = T9FileUtility.sortFileList(pathFile);
