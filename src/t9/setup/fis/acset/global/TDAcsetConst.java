package t9.setup.fis.acset.global;
...
public class TDAcsetConst {
  ...
  public static final String TDFIS_CLOSE_USER = T9SysProps.getString("shortOrgName") + "财务自动记账";
  public static final String TDFIS_CLOSE_INIT = "acset.init.close";
  /**
   * 取得帐套数据库名前缀
   */
  public static String getAcsetDbPrefix() {
    String acsetDbPrefix = T9SysProps.getString("acsetDbPrefix");
