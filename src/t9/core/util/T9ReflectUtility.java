...
public class T9ReflectUtility {
  ...
  public static boolean setValue(Object obj, String fieldName, Class fieldType, String fieldValue) throws Exception {
    ...
    if (fieldType.equals(int.class)) {
      ...
      exeMethod(obj, methodName, new Class[]{Date.class}, new Object[]{T9Utility.parseDate(fieldValue)});
      return true;
    }else if (fieldType.equals(java.sql.Date.class)) {
      exeMethod(obj, methodName, new Class[]{java.sql.Date.class}, new Object[]{T9Utility.parseSqlDate(fieldValue)});
      return true;
