...
public class T9LinuxUtility {
  ...
  private String getMachineCodeInner() throws Exception {
    ...
    if (diskInfoMap.size() > 0) {
      ...
      if (partList.size() > 0) {
        ...
        rtBuf.append("{");
          String name = T9Utility.null2Empty((String)partMap.get("name"));
          String boot = T9Utility.null2Empty((String)partMap.get("boot"));
          String start = T9Utility.null2Empty((String)partMap.get("start"));
          String end = T9Utility.null2Empty((String)partMap.get("end"));
          String block = T9Utility.null2Empty((String)partMap.get("block"));
          String id = T9Utility.null2Empty((String)partMap.get("id"));
          String system = T9Utility.null2Empty((String)partMap.get("system"));
    ...
    if (!T9Utility.isNullorEmpty(rtStr)) {
      String tmpStr = T9DigestUtility.md5Hex(rtStr.getBytes(T9Const.DEFAULT_CODE));
      rtStr = tmpStr.substring(1, 3)
         + tmpStr.substring(7, 9)
         + tmpStr.substring(20, 22)
         + tmpStr.substring(29, 31);
    }else {
      throw new T9InvalidParamException("");
    }
  ...
  private String appendDisInfo(Map<String, Object> diskInfoMap) {
    StringBuffer rtBuf = new StringBuffer("");
    String diskType = T9Utility.null2Empty((String)diskInfoMap.get("diskType"));
    String size = T9Utility.null2Empty((String)diskInfoMap.get("size"));
    String headers = T9Utility.null2Empty((String)diskInfoMap.get("headers"));
    String sectors = T9Utility.null2Empty((String)diskInfoMap.get("sectors"));
    String cylinders = T9Utility.null2Empty((String)diskInfoMap.get("cylinders"));
    String DiskIdentyfier = T9Utility.null2Empty((String)diskInfoMap.get("DiskIdentyfier"));
