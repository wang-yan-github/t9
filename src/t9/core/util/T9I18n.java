...
public class T9I18n {
  ...
  public boolean isChineseContext() {
    return lm(T9MessageKeys.COMMON_INSERT_OK).indexOf("successfully") < 0;
  }
  /**
   * 缺省构造方法
   *
   ...
   */
  public T9I18n(String resrcName) {    
   ...
   * @param resrcName        资源邦定名称
   */
  public T9I18n(Locale currentLocale) {
   ...
   * @param country          国家
   */
  public T9I18n(String resrcName, String language, String country) {
   ...
   */
  public T9I18n(String resrcName, Locale currentLocale) {
    this.resources = 
   ...
   * @param request
   */
  public T9I18n(ServletContext servletContext,
...
//  }
  ...
  public String ls(String rscId, String msrg, String[] valueArray) {
    ...
    if (this.resources == null) {
      rtStr = T9ServletUtility.getLocaleMsrg(
    ...
    return T9RegexpUtility.assignVar(rtStr, valueArray);
  }
  ...
  public String lm(String rscId, String msrg) {
    ...
    String[] msrgArray = msrg.split("\\" +
        String.valueOf(T9TokenSplit.TOKEN_SPLIT_DOLLAR));
  ...
  public String lmj(String rscId,
    ...
    rtBuff.append(T9ServletUtility.getLocaleMsrg(
