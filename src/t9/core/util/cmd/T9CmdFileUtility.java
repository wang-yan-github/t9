...
//    transCode(new File("D:\\MYOA\\webroot\\mt"), ".php", "UTF-8", "GBK");
    //compactSrc("D:\\project\\t9\\webroot\\t9\\core\\js\\sys.js", ".js");
    //checkSemicolon("D:\\tmp\\js", "D:\\tmp\\semicolon.txt", ".js");
    //D:\\T9\\webroot\\t9\\core\\js\\cmp\\fck\\fckeditor\\editor\\dialog\\fck_spellerpages\\spellerpages\\controlWindow.js
    //checkSemicolon("D:\\T9\\webroot\\t9\\core\\js\\cmp\\fck\\fckeditor\\editor\\dialog\\fck_spellerpages\\spellerpages\\controlWindow.js", "D:\\tmp\\semicolon.txt", ".js");
//    System.out.println("java>>" + getLineCnt(new File("D:\\project\\t9\\src"), ".java"));
//    System.out.println("jsp>>" + getLineCnt(new File("D:\\project\\t9\\webroot"), ".jsp"));
//    System.out.println("js>>" + getLineCnt(new File("D:\\project\\t9\\webroot"), ".js"));
//    System.out.println("css>>" + getLineCnt(new File("D:\\project\\t9\\webroot"), ".css"));
//    
...
//    transCode(new File("D:\\project\\t9erp\\src"), ".properties", "GBK", "UTF-8");
//    transCode(new File("D:\\project\\t9erp\\webroot\\t9erp\\sqlfiles"), ".txt", "GBK", "UTF-8");
    transCode(new File("D:\\project\\t9\\webroot\\t9website"), ".txt", "UTF-8", "GBK");
  }
  ...
  public static void txt2Word(String workPath) throws Exception {
    ...
    try {
      ...
      //T9FileUtility.deleteAll(wordPath);
      ...
      for (int i = 0; i < fileArray.length; i++) {
        ...
        StringBuffer txtBuf = T9FileUtility.loadLine2Buff(txtPath + "\\" + fileName, "GBK");
        String title = null;
        String body = null;
  ...
  public static void transCode(File file, String exName, String fromCode, String toCode) throws Exception {
    ...
    if (file.isFile()) {
      ...
      T9FileUtility.loadLine2Array(file.getAbsolutePath(), lineList, fromCode);
      T9FileUtility.storeArray2Line(file.getAbsolutePath(), lineList, toCode);
  ...
  public static void checkSemicolon(String srcFilePath, String outFilePath, String extName) throws Exception {
    ...
    T9FileUtility.storeArray2Line(outFilePath, outList);
  }
  ...
  public static void clearFile(File file, String exName) throws Exception {
    ...
    if (file.isFile()) {
      ...
      T9FileUtility.storeString2File(file.getAbsolutePath(), "");
    }else if (file.isDirectory()) {
      File[] fileArray = file.listFiles();
      for (int i = 0; i < fileArray.length; i++) {
  ...
  public static long getLineCnt(File file, String exName) throws Exception {
    ...
    if (file.isFile()) {
      ...
      T9FileUtility.loadLine2Array(file.getAbsolutePath(), lineList);
  ...
  public static void compactJsInpath(String srcPath, String destPath) throws Exception {
    ...
    if (srcPathFile.isFile()) {
      if (srcPath.endsWith(".js")) {
        ...
        T9FileUtility.storeString2File(destPath, "");
