...
public class T9ORM2Obj {
  ...
  public static void save(Connection dbConn, Object obj, boolean isCascade) throws Exception {
    ...
    //T9Out.println("fieldInfo >> " + fieldInfo);
  ...
  public static Object loadObj(Connection dbConn, Class cls,  Map filters,boolean isCascade)
    ...
    Object pojo = T9ORMSelect.doSelect(cls, dbConn, fieldInfo, filterMap);
    return pojo;
  }
  /**
   * 加载数据
...
/*    if(!(filters == null)){
    ...
    return T9ORMSelect.doSelectList(cls, dbConn, fieldInfo, filters);
  }
