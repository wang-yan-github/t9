...
public class T9HttpFileUtility {
  public static void main(String[] args) throws Exception {
//    T9HttpFileUtility util = new T9HttpFileUtility();
//    util.downloadFile("localhost",
//        80,
//        "/t9/test/core/act/T9TestFileUploadAct/downloadFile.act",
//        "D:\\tmp\\1.pdf",
//        new HashMap<String, String>());
    ...
    util.uploadFile("localhost", 80,
        "/t9/t9/core/act/T9FileUploadAct/doFileUpload.act",
        "D:\\tmp\\1.pdf", paramMap);
  }
  /**
   * 上传文件
  ...
  public String uploadFile(String host,
    ...
    if (paramMap != null && !paramMap.isEmpty()) {
      ...
      while (iKeys.hasNext()) {
        ...
        String value = T9Utility.null2Empty(paramMap.get(key));
