...
public class T9FileUploadForm {
    ...
    public void parseUploadRequest(HttpServletRequest request) throws Exception {
        ...
        parseUploadRequest(request, T9SysProps.getInt(T9SysPropKeys.MAX_UPLOAD_FILE_SIZE), 10 * T9Const.K,
                T9SysProps.getString("fileUploadTempDir"), T9Const.DEFAULT_CODE);
    }
     ...
     * @throws Exception
     */
    public void parseUploadRequest(HttpServletRequest request, int maxSize, int buffSize, String tempPath,
