...
public class T9FileUtility {
  ...
  public static String appendFileName(String path, String name) {
    ...
    if (lastChar.equals(T9TokenConst.FILE_SEPERATOR)) {
      return path + name;
    }
    return path + T9TokenConst.FILE_SEPERATOR + name;
  }
  ...
  public static void loadLine2Array(String fileName,
    ...
    loadLine2Array(fileName,
        startLine, endLine, rtList, T9Const.DEFAULT_CODE);
  }
  ...
  public static void loadLine2Array(String fileName,
    ...
    loadLine2Array(fileName, startLine, Integer.MAX_VALUE, rtList, T9Const.DEFAULT_CODE);
  }
  ...
  public static void loadLine2Array(String fileName, List rtList) throws Exception {
    loadLine2Array(fileName, 0, Integer.MAX_VALUE, rtList, T9Const.DEFAULT_CODE);
  }
  ...
  public static void storeString2File(String fileName, String content) throws Exception {
    ...
    try {
      ...
      storeString2File(outs, content, T9Const.DEFAULT_CODE);
    }catch(Exception ex) {
      throw ex;
    }finally {
      try {
  ...
  public static void storeArray2Line(String fileName, List rtList) throws Exception {
    storeArray2Line(fileName, rtList, T9Const.DEFAULT_CODE);
  }
  ...
  private static void copyFile0(
    ...
    try {
      ...
      if (passWord != null) {
        ...
        if (cipher != null) {
          ins = T9SecurityUtility.buildPassWordInputStream(cipher, ins);
        }else {
          ins = T9SecurityUtility.buildPassWordInputStream(
  ...
  public static void extractUpdateFile(
    ...
    Date cpDate = T9Utility.parseDate(cpDateStr);
    copyDir(srcDirName, destDirName, msrgList,
        new T9TimeFileFilter(cpDate, true),
        false, true);
  }
  ...
  private static void copyDirImp0(String srcDirName,
    ...
    if (!srcDir.exists() || !srcDir.isDirectory()) {
      throw new T9InvalidParamException("源文件目录输入不正确！");
    }
  ...
  public static StringBuffer loadLine2Buff(String fileName,
    ...
    return loadLine2Buff(fileName, startLine, Integer.MAX_VALUE, T9Const.DEFAULT_CODE);
  }
  ...
  public static StringBuffer loadLine2Buff(String fileName) throws Exception {
    ...
    return loadLine2Buff(fileName, 0, Integer.MAX_VALUE, T9Const.DEFAULT_CODE);
  }
  ...
  public static String getFileNameNoExt(String filePath) {
    ...
    int pointIndex = rtName.lastIndexOf(T9FileConst.PATH_POINT);
    if (pointIndex < 0) {
      return rtName;
    }
    if (pointIndex == 0) {
  ...
  public static String getFileName(String filePath) {
    ...
    int startIndex = 0;
    if (filePath.lastIndexOf(T9FileConst.PATH_SPLIT_FILE_WIN) >= 0) {
      startIndex = filePath.lastIndexOf(T9FileConst.PATH_SPLIT_FILE_WIN) + 1;
    }else if (filePath.lastIndexOf(T9FileConst.PATH_SPLIT_URL) >= 0) {
      startIndex = filePath.lastIndexOf(T9FileConst.PATH_SPLIT_URL) + 1;
    }
  ...
  public static String getFilePath(String fileName) {
    ...
    int tmpIndex = -1;
    if (fileName.lastIndexOf(T9FileConst.PATH_SPLIT_FILE_WIN) >= 0) {
      tmpIndex = fileName.lastIndexOf(T9FileConst.PATH_SPLIT_FILE_WIN);
    }else if (fileName.lastIndexOf(T9FileConst.PATH_SPLIT_URL) >= 0) {
      tmpIndex = fileName.lastIndexOf(T9FileConst.PATH_SPLIT_URL);
    }
    if (tmpIndex < 0) {
      return "";
    }
  ...
  public static byte[] loadByteArrayFromFile(
    ...
    try {
      ...
      if (salt != null) {
        in = T9SecurityUtility.buildPassWordInputStream(
            passWord, salt, itCnt, mode, in);
      }
      
      byte[] buff = new byte[T9Const.DEFAULT_IO_BUFF_SIZE];
      int readLen = 0;
  ...
  public static void deleteFile(List fileList, String rootDir) throws Exception {
    ...
    for (int i = 0; i < fileList.size(); i++) {
      ...
      T9FileUtility.deleteAll(currPath);
    }
  }
  ...
  public static boolean isFileEqual(File f1, File f2) throws Exception {
    ...
    try {
      ...
      byte[] buf1 = new byte[T9Const.K];
      byte[] buf2 = new byte[T9Const.K];
      for (int i = 0; i < T9Const.K; i++) {
        buf1[i] = 0;
        buf2[i] = 0;
      }
      while (true) {
  ...
  public static void copyNotExists(String srcDir, String destDir, String outDir, List msrgList) throws Exception {
    if (T9Utility.isNullorEmpty(srcDir) || T9Utility.isNullorEmpty(destDir)) {
      return;
    }
  ...
  public static void copyDirDiff(String newDir, 
    ...
    T9FileDifFilter filter = new T9FileDifFilter(newDir, oldDir);
