...
public class T9PropUtility {
  //log
  private static Logger log = Logger.getLogger("yzq.t9.core.util.file.T9PropUtility");
  ...
  public static void deletePropFile(String toFile, String deleted) {
    try {
      ...
      T9FileUtility.load2Map(deleted, deletedMap);
  ...
  public static void updatePropFile(String toFile, String fromFile) {
    try {
      ...
      T9FileUtility.load2Map(fromFile, fromMap);
      ArrayList fromList = new ArrayList();
      Iterator iKeys = fromMap.keySet().iterator();
      while (iKeys.hasNext()) {
        String key = (String)iKeys.next();
  ...
  private static void updatePropFile(String propFile, Map updateProps, Map deleteProps) {
    try {
      ...
      T9FileUtility.loadLine2Array(propFile, propLineList);
      ...
      T9FileUtility.storeArray2Line(propFile, propLineList);
    }catch(Exception ex) {      
    }
  }
  /**
  ...
  public static void storeArray2Line(
    ...
    T9FileUtility.loadLine2Array(fileName, lineList);
  ...
  private static void updatePropArray(List lineList, List fieldList) {
    ...
    for (int i = 0; i < fieldList.size(); i++) {
      T9PropField field = (T9PropField)fieldList.get(i);
  ...
  public static void storeArray2Line(
    ...
    T9FileUtility.storeArray2Line(fileName, lineList);
  }
  ...
  public static void updateProp(String fileName,
    ...
    ArrayList<T9PropField> fieldList = new ArrayList<T9PropField>();
    T9PropField field = new T9PropField();
    field.setFieldName(key);
    field.setFieldValue(value);
    fieldList.add(field);
