...
public class T9ZipFileUtility {
  ...
  public static void doCiphZip(String srcFile,
    ...
    String fileName = T9FileUtility.getFileNameNoExt(destFile);
  ...
  public static void doCiphZip(String srcFile,
    ...
    if (passWord == null || passWord.length < 1) {
      throw new T9InvalidParamException("没有传递密码！");
    }
  ...
  private static void putFile2Zip(
    ...
    base = T9Utility.null2Empty(base);
  ...
  public static void unZipFile(String srcFile,
    ...
    FileFilter filter = new T9NameFileFilter(acceptFileList, true);
  ...
  public static void unZipCiphFile(String srcFile,
    ...
    String fileName = T9FileUtility.getFileNameNoExt(srcFile);
    T9ZipFileUtility.unZipCiphFile(
  ...
  public static void unZipCiphFile(
    ...
    try {
      ...
      while(e.hasMoreElements()) {
        ...
        int count;
        byte data[] = new byte[T9Const.DEFAULT_IO_BUFF_SIZE];
        
        String fileOutName = destDir + T9FileConst.PATH_SPLIT_FILE_WIN
          + T9FileUtility.unix2Windows(zipFileName);
        String filePath = T9FileUtility.getFilePath(fileOutName)
          + T9FileConst.PATH_SPLIT_FILE_WIN;
        File fileDir = new File(filePath);
        if (!fileDir.exists()) {
          fileDir.mkdirs();
        }
        String extName = T9FileUtility.getFileExtName(fileOutName);
...
//          System.out.println(extName);
        ...
        dest = new BufferedOutputStream(fos, T9Const.DEFAULT_IO_BUFF_SIZE);
        while ((count = in.read(data, 0, T9Const.DEFAULT_IO_BUFF_SIZE)) > 0) {
  ...
  private static List loadZipFile2List(
    ...
    ZipFile zipFile = null;
    try {
      if (T9Utility.isNullorEmpty(fileNameEncode)) {
