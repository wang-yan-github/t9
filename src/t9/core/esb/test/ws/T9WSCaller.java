...
public class T9WSCaller {
  private static final String WS_PATH = "http://192.168.0.102:88/t9/services/T9EsbService";
  private static Logger log = Logger.getLogger("t9.core.esb.test.ws");

  public String config(String host, int port, String username, String password, String webserviceUri, String cacheDir) {
    try {
      String serviceUrl = T9WSCaller.WS_PATH;
...
//    String md5 = T9DigestUtility.md5File("E:\\TDDOWNLOAD\\database中文.rar");
//    long e = System.currentTimeMillis();
//    System.out.println((e - s) / 1000);
    
    T9WSCaller caller = new T9WSCaller();
