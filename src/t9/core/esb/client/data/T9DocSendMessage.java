...
public class T9DocSendMessage extends T9EsbMessage {
   ...
   * @throws Exception
   */
  public T9DocSendMessage(int runId, String fromDept, String fromDeptName,
    ...
    this.setData(T9ObjectUtility.writeObject(this));
  }
