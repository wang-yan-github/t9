...
public class PropertiesUtil {
  ...
  private static void getClientProperties(){
    try{
      FileInputStream fis = new FileInputStream(new File(T9SysProps.getWebPath() + "\\WEB-INF\\config\\esbconfig.properties"));
  ...
  public static void store(){
    try{
      FileOutputStream fos = new FileOutputStream(new File(T9SysProps.getWebPath() + "\\WEB-INF\\config\\esbconfig.properties"));
  ...
  public static long getUploadPartSize() {
    ...
    if (T9Utility.isNullorEmpty(size) || !T9Utility.isNumber(size)) {
      return 1024 * 10;
    }
  ...
  public static String getUploadPath() {
    ...
    if (T9Utility.isNullorEmpty(dir)) {
      dir = "d:\\httpclient\\uploads";
    }
    return dir;
  }
  public static boolean getDebug() {
    String s = getProp("DEBUG");
  ...
  public static long getMaxUploadTime() {
    ...
    if (!T9Utility.isNullorEmpty(uploadTime)) {
