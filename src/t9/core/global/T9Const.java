...
public class T9Const {
   ...
   * 缺省编码
   */
  public static final String DEFAULT_CODE = T9Utility.isNullorEmpty(T9SysProps.getProp(T9SysPropKeys.DEFAULT_CODE)) ? "UTF-8" : T9SysProps.getProp(T9SysPropKeys.DEFAULT_CODE);
  /**
   * csv文件导入导出编码
   */
  public static final String CSV_FILE_CODE = T9Utility.isNullorEmpty(T9SysProps.getProp("csvFileCode")) ? "GBK" : T9SysProps.getProp("csvFileCode");
