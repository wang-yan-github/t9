...
import t9.core.global.T9DsFieldConst;

public class T9DsField {
  /**  **/
 private int seqId = 0;
  /** 表外键参照,编码5位长 **/
  ...
  /** 数据类型,值请参考t9.core.data.TDCDbType.getTypeName **/
  ...
  public String genFormatMode() {
    if (dataType == Types.BIGINT) {
      return T9DsFieldConst.FORMAT_MODE_NUMBER;
      ...
      return T9DsFieldConst.FORMAT_MODE_DATE;
    } else if (dataType == Types.TIME) {
      return T9DsFieldConst.FORMAT_MODE_TIME;
    }
    return T9DsFieldConst.FORMAT_MODE_TEXT;
  }
  ...
  public boolean equals(Object other) {
    if (other == null || !(other instanceof T9DsField)) {
      return false;
    }
    T9DsField otherField = (T9DsField) other;
  ...
  public String getDataTypeName() {
    return T9DsType.getTypeName(dataType);
  }
  ...
  public boolean isMustFill() {
    ...
    if (isMustFill.equalsIgnoreCase(T9DsFieldConst.IS_MUST_FILL_YES)) {
      return true;
    }
    return false;
  }
  ...
  public boolean isPrimaryKey() {
    ...
    if (isPrimaryKey.equalsIgnoreCase(T9DsFieldConst.PRIM_KEY_YES)) {
      return true;
    }
    return false;
  }
  ...
  public String toString() {
    return "T9DsField [codeClass=" + codeClass + ", dataType=" + dataType
