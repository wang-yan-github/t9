...
public class T9MapComparator implements Comparator<Map> {
   ...
   * @param key
   */
  public T9MapComparator(String key) {
    this(0, key, "ACS");
  }
  /**
   * 构造函数
   ...
   * @param direct
   */
  public T9MapComparator(int type, String key, String direct) {
    this.type = type;
    this.key = key;
    this.direct = direct;
  }
  ...
  public int compare(Map o1, Map o2) {
    ...
    if (this.type == TYPE_INT) {
      int intOp1 = 0;
      int intOp2 = 0;
      if (!T9Utility.isNullorEmpty(op1)) {
        intOp1 = Integer.parseInt(op1);
      }
      if (!T9Utility.isNullorEmpty(op2)) {
