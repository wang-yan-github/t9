...
public class T9DsType {
  ...
  public static int getTypeCatalog(int fieldType) {
    if (fieldType == Types.TINYINT) {
      return T9DsFieldConst.TYPE_CATA_NUMBER;
