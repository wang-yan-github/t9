 ...
 * 
 */
public class T9OAAsk implements Serializable{
  ...
  public String toString(){
    ...
    sb.append("{");
       ...
       sb.append("ask:").append("'").append(T9Utility.encodeSpecial(this.getAsk())).append("'").append(",");
       sb.append("askComment:").append("'").append(T9Utility.encodeSpecial(T9StringUtil.replaceN(getAskComment()))).append("'").append(",");
       //sb.append("askReplyCount:").append("'").append(this.getAskReplyCount()).append("'").append(",");
       sb.append("replyKeyWord:").append("'").append(T9Utility.encodeSpecial(this.getReplyKeyWord())).append("'").append(",");
      ...
      // sb.append("rank:").append("'").append(this.getRank()).append("'").append(",");       
       ...
       sb.append("categoryName:").append("'").append(T9Utility.encodeSpecial(this.getCategoryName())).append("'").append(",");
