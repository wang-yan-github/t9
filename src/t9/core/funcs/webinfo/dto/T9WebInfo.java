package t9.core.funcs.webinfo.dto;
...
public class T9WebInfo {
  private List<T9WebInfoAttachment> attachments = new ArrayList<T9WebInfoAttachment>();
  ...
  public void setAttachments(List<T9WebInfoAttachment> attachments) {
  ...
  public StringBuffer toJSON(boolean isAllContent){
    ...
    if(isAllContent){
     ...
     sb.append("\",\"content\":\"" + escape(T9WebInfo.subStringHTML(this.content, 400, "。。。。")));
    }
    
    sb.append("\",\"attachments\":[");
    for(T9WebInfoAttachment a : this.attachments){
      sb.append(a.toJSON());
      sb.append(",");
    }
  ...
  public void addAttachment(T9WebInfoAttachment a){
    attachments.add(a);
  }
  public void removeAttachment(String filePath){
    for(T9WebInfoAttachment a : attachments){
      if(a.getFilePath().equals(filePath)){
        attachments.remove(a);
      }
    }
  }
  public List<T9WebInfoAttachment> getAttachments(){
