package t9.core.funcs.wizardtool.logic;
...
public class T9HtmlParser {
  private String dataPackageName = "t9.core.funcs.wizardtool.data.T9";
  ...
  public static void main(String[] args){
    T9HtmlParser htmlParser = new T9HtmlParser();
    ...
    String html = "<p>&amp;nbsp;,<img style='width: 20px; height: 17px;' src='/t9/raw/lh/fckeditor/editor/plugins/DtreeWidget/dtree.jpg' id='ff' widgettype='DTree' alt='' /></p>";
    try {
      htmlParser.parseToHtml(html,"/t9", libMap);
    } catch (Exception e) {
