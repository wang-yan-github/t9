...
public class T9CalExpImpLogic {
  private static Logger log = Logger.getLogger("t9.core.act.action.T9SysMenuLog");
  public  ArrayList<T9DbRecord>  getCVS(String sql,ArrayList<T9DbRecord> cvs,Connection dbConn,String type) throws Exception {
    ...
    try {
      ...
      if(type!=null&&type.equals("CALENDAR")){
        while(rs.next()){
          ...
          if(!T9Utility.isNullorEmpty(rs.getString("CAL_TIME"))){
            rd.addField("开始日期", rs.getString("CAL_TIME").substring(0, 19));
          }else{
            rd.addField("开始日期", "");
          }
          if(!T9Utility.isNullorEmpty(rs.getString("END_TIME"))){
      ...
      if(type!=null&&type.equals("AFFAIR")){
        while(rs.next()){
          T9DbRecord rd = new T9DbRecord();
          rd.addField("主题", rs.getString("CONTENT"));
          if(!T9Utility.isNullorEmpty(rs.getString("BEGIN_TIME"))){
      ...
      if(type!=null&&type.equals("TASK")){
        while(rs.next()){
          ...
          if(!T9Utility.isNullorEmpty(rs.getString("BEGIN_DATE"))){
            rd.addField("开始日期", rs.getString("BEGIN_DATE").substring(0, 19));
          }else{
            rd.addField("开始日期", "");
          }
          if(!T9Utility.isNullorEmpty(rs.getString("END_DATE"))){
          ...
          rd.addField("提醒日期", "");
          rd.addField("提醒时间", "");
          if(!T9Utility.isNullorEmpty(rs.getString("FINISH_TIME"))){
  ...
  public void addCalAffarTask(Connection dbConn,Set set,List<Map<String,String>> list)throws Exception {
    ...
    ResultSet rs = null;
    T9CalendarLogic cl = new T9CalendarLogic();
    T9AffairLogic al = new T9AffairLogic();
    T9TaskLogic tl = new T9TaskLogic();
        ...
        for (int i = 0; i < list.size(); i++) {
          ...
          if(map.get("FLAG")!=null&&map.get("FLAG").equals("CALENDAR")){
            ...
            calendar.setUserId(userId);
              if(T9Utility.isDayTime((String)map.get("CAL_TIME"))){
                calendar.setCalTime(dateFormat.parse((String)map.get("CAL_TIME")));
              }else{
                continue;
              }
         
              if(T9Utility.isDayTime((String)map.get("END_TIME"))){
              ...
              if(T9Utility.isInteger((String)map.get("CAL_TYPE"))){
              ...
              if(T9Utility.isInteger((String)map.get("CAL_LEVEL"))){
            ...
            if(map.get("MANAGER_ID")!=null&&!map.get("MANAGER_ID").equals("")){
              if(T9Utility.isInteger((String)map.get("MANAGER_ID"))){
          ...
          if(map.get("FLAG")!=null&&map.get("FLAG").equals("AFFAIR")){
            ...
            affair.setUserId(userId);
              if(T9Utility.isDayTime((String)map.get("BEGIN_TIME"))){
              ...
              if(T9Utility.isInteger((String)map.get("TYPE"))){
            ...
            if(map.get("REMIND_TIME")!=null){
              ...
              if(T9Utility.isDayTime((String)map.get("LAST_REMIND"))){
              ...
              if(map.get("LAST_SMS2_REMIND")!=null&&!((String)map.get("LAST_SMS2_REMIND")).equals("")){
                if(T9Utility.isDayTime((String)map.get("LAST_SMS2_REMIND"))){
                  affair.setLastSms2Remind(dateFormat.parse((String)map.get("LAST_SMS2_REMIND")));
                }else{
                  continue;
                }
              }
              if(!T9Utility.isNullorEmpty((String)map.get("CONTENT"))){
          ...
          if(map.get("FLAG")!=null&&map.get("FLAG").equals("TASK")){
           ...
           task.setUserId(userId);
             if(T9Utility.isDayTime((String)map.get("BEGIN_DATE"))){
               task.setBeginDate(dateFormat.parse((String)map.get("BEGIN_DATE")));
             }else{
               continue;
             }
             if(T9Utility.isDayTime((String)map.get("END_DATE"))){
               task.setEndDate(dateFormat.parse((String)map.get("END_DATE")));
             }
             if(T9Utility.isInteger((String)map.get("TASK_TYPE"))){
               task.setTaskType((String)map.get("TASK_TYPE"));
             }else{
               continue;
             }
             if(T9Utility.isInteger((String)map.get("TASK_STATUS"))){
               task.setTaskStatus((String)map.get("TASK_STATUS"));
             }
             if(T9Utility.isInteger((String)map.get("COLOR"))){
               task.setColor((String)map.get("COLOR"));
             }else{
               continue;
             }
             if(T9Utility.isInteger((String)map.get("IMPORTANT"))){
               task.setImportant((String)map.get("IMPORTANT"));
             }else{
               continue;
             }
           if(map.get("RATE")!=null&&!map.get("RATE").equals("")){
             if(T9Utility.isInteger((String)map.get("RATE"))){
           ...
           if(map.get("TOTAL_TIME")!=null&&!map.get("TOTAL_TIME").equals("")){
             if(T9Utility.isInteger((String)map.get("TOTAL_TIME"))){
           ...
           if(map.get("USE_TIME")!=null&&!map.get("USE_TIME").equals("")){
             if(T9Utility.isInteger((String)map.get("USE_TIME"))){
           ...
           if(map.get("CAL_ID")!=null&&!map.get("CAL_ID").equals("")){
             if(T9Utility.isInteger((String)map.get("CAL_ID"))){
           ...
           if(map.get("FINISH_TIME")!=null&&!((String)map.get("FINISH_TIME")).equals("")){
             if(T9Utility.isDayTime((String)map.get("FINISH_TIME"))){
           ...
           if(map.get("EDIT_TIME")!=null&&!((String)map.get("EDIT_TIME")).equals("")){
             if(T9Utility.isDayTime((String)map.get("EDIT_TIME"))){
  ...
  public void addCalAffarTaskCVS(Connection dbConn,Set set,ArrayList<T9DbRecord> list,String catType)throws Exception {
    PreparedStatement pstmt = null;
    ResultSet rs = null;
    T9CalendarLogic cl = new T9CalendarLogic();
    T9AffairLogic al = new T9AffairLogic();
    ...
    if(set!=null&&!set.isEmpty()){
      ...
      while(it.hasNext()){
        String userId = (String) it.next();
        for (int i = 0; i < list.size(); i++) {
          T9DbRecord rd = list.get(i);
          if(catType!=null&&catType.equals("CALENDAR")){
            T9Calendar calendar = new T9Calendar();
            calendar.setUserId(userId);
              if(T9Utility.isDayTime((String)rd.getValueByName("开始日期"))){
                calendar.setCalTime(dateFormat.parse((String)rd.getValueByName("开始日期")));
              }else{
                continue;
              }
              if(T9Utility.isDayTime((String)rd.getValueByName("结束日期"))){
                calendar.setEndTime(dateFormat.parse((String)rd.getValueByName("开始日期")));
              }else{
                continue;
              }

              if(T9Utility.isInteger((String)rd.getValueByName("类型"))){
                calendar.setCalType((String)rd.getValueByName("类型"));
              }else{
                continue;
              }

              if(T9Utility.isInteger((String)rd.getValueByName("优先级"))){
            ...
            if(rd.getValueByName("安排人")!=null&&!rd.getValueByName("安排人").equals("")){
              if(T9Utility.isInteger((String)rd.getValueByName("安排人"))){
          ...
          if(catType!=null&&catType.equals("TASK")){
           ...
           if(rd.getValueByName("完成百分比")!=null&&!((String)rd.getValueByName("完成百分比")).equals("")){
             if(T9Utility.isInteger((String)rd.getValueByName("完成百分比"))){
           ...
           if(rd.getValueByName("全部工作")!=null&&!((String)rd.getValueByName("全部工作")).equals("")){
             if(T9Utility.isInteger((String)rd.getValueByName("全部工作"))){
           ...
           if(rd.getValueByName("实际工作")!=null&&!((String)rd.getValueByName("实际工作")).equals("")){
             if(T9Utility.isInteger((String)rd.getValueByName("实际工作"))){
