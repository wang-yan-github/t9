...
public class T9FlowExportAct {
  private static Logger log = Logger
    .getLogger("t9.core.funcs.doc.act.T9FlowExportAct");
  public String exportForm(HttpServletRequest request,
    ...
    try{
      ...
      T9ORM orm = new T9ORM();
      T9DocFlowFormType  form = (T9DocFlowFormType) orm.loadObjSingle(dbConn, T9DocFlowFormType.class, Integer.parseInt(formId));
    ...
    return T9WorkFlowConst.MODULE_CONTEXT_PATH + "/flowform/export.jsp";
  }
  ...
  public String exportFlowZip(HttpServletRequest request,
    ...
    try{
      ...
      response.setHeader("Cache-control","private");
      response.setHeader("Accept-Ranges","bytes");
      String fileName = URLEncoder.encode("OA工作流(" + T9Utility.getCurDateTimeStr() + ").zip", "UTF-8");
