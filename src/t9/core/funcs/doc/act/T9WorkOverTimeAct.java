...
import t9.core.funcs.doc.logic.T9FlowOverTimeLogic;
...
public class T9WorkOverTimeAct {
  ...
  public String getOverTimeTotal(HttpServletRequest request,
    ...
    //返回到柱状图页面
    if (flag == 1) {
      return T9WorkFlowConst.MODULE_CONTEXT_PATH + "/flowrun/overtime/columnChart.jsp";
    } else if (flag == 2) {
      return null;
    } else {
      return T9WorkFlowConst.MODULE_CONTEXT_PATH + "/flowrun/overtime/overouttime.jsp";
    }
  }
