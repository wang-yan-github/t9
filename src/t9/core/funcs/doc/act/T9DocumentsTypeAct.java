...
import t9.core.funcs.doc.logic.T9DocumentsTypeLogic;
...
public class T9DocumentsTypeAct {
  ...
  public String addDocumentsTypeInfo(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    response.sendRedirect(contexPath + T9WorkFlowConst.MODULE_CONTEXT_PATH + "/flowrun/documentsType/newRemind.jsp");
    return null;
  }
  ...
  public String updateDocumentsTypeInfo(HttpServletRequest request, HttpServletResponse response) throws Exception{
    ...
    response.sendRedirect(contexPath + T9WorkFlowConst.MODULE_CONTEXT_PATH + "/flowrun/documentsType/manage.jsp");
    return null;
  }
  ...
  public String getDocumentsTypeListSelect2(HttpServletRequest request, HttpServletResponse response) throws Exception{
    ...
    try {
      ...
      dbConn = requestDbConn.getSysDbConn();
      StringBuffer sb = new StringBuffer("[");
      String sql = " SELECT SEQ_ID, DW_NAME FROM doc_word ";
