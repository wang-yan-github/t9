...
import t9.core.funcs.doc.logic.T9FlowReportLogic;
...
public class T9FlowReportAct {
  ...
  public String addReportAct(HttpServletRequest request,
    ...
    return T9WorkFlowConst.MODULE_CONTEXT_PATH + "/flowreport/newRemind.jsp?fId=" + fId;
  }
  public String addReportPrivAct(HttpServletRequest request,
    ...
    return T9WorkFlowConst.MODULE_CONTEXT_PATH + "/flowreport/set_priv/newRemind.jsp";
  }
  ...
  public String updateReportAct(HttpServletRequest request,
    ...
    return T9WorkFlowConst.MODULE_CONTEXT_PATH + "/flowreport/editRemind.jsp?rId="+rId+"&fId="+ fId;
  }
  public String updateReportPrivAct(HttpServletRequest request,
    ...
    return T9WorkFlowConst.MODULE_CONTEXT_PATH + "/flowreport/set_priv/editRemind.jsp?rid="+rId+"&fId="+fId+"&pId=" + pId;
  }
