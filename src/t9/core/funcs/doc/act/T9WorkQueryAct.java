...
import t9.core.funcs.doc.logic.T9FlowWorkSearchLogic;
...
public class T9WorkQueryAct {
  private static Logger log = Logger
      .getLogger("t9.core.funcs.doc.act.T9WorkQueryAct");
  ...
  public String getManagerRole(HttpServletRequest request,
    ...
    public String getFlowType(HttpServletRequest request,
      ...
      try {
        ...
        T9DocFlowType flowType = null;
        T9PrcsRoleUtility prcsRole = new T9PrcsRoleUtility();
        List<T9DocFlowType> typeList = ft.getFlowTypeList(sSortId , dbConn);
        int flowTypeCount = 0;
        T9FlowWorkSearchLogic myWorkLogic = new T9FlowWorkSearchLogic();
        for(int i = 0; i < typeList.size(); i++) {
          flowType = typeList.get(i);
...
//          }
    ...
    public String doQuery(HttpServletRequest request,
        HttpServletResponse response) throws Exception {
      String returnUrl = T9WorkFlowConst.MODULE_CONTEXT_PATH + "/flowrun/query/doQuery.jsp";
      String sSortId =  request.getParameter("sortId");
      if (sSortId == null) {
        sSortId = "";
      }
    ...
    public String flowReport(HttpServletRequest request,
        HttpServletResponse response) throws Exception {
      String returnUrl = T9WorkFlowConst.MODULE_CONTEXT_PATH + "/flowrun/query/flowReport.jsp";
      String sSortId =  request.getParameter("sortId");
      if (sSortId == null) {
        sSortId = "";
      }
