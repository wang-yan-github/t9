...
public class T9DoCReceiveDeskLogic{
   ...
   * @throws Exception 
   */
  public String myDocReceiveJsonDesk(Connection conn, T9Person user,String webroot) throws Exception{
  ...
  public String list2Json(List<T9DocReceive> docs , String webroot) throws Exception{
