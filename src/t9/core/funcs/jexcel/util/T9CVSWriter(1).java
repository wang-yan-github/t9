 ...
 * 
 */
public class T9CVSWriter implements Closeable {
   ...
   */
  public T9CVSWriter(Writer writer) {
   ...
   */
  public T9CVSWriter(Writer writer, char separator) {
   ...
   */
  public T9CVSWriter(Writer writer, char separator, char quotechar) {
  ...
  public void writeAll(ArrayList<T9DbRecord> allLines) {
    String[] headers = null;
    String[][] data = new String[allLines.size() + 1][];
    for (int i = 0; i < allLines.size(); i++) {
      T9DbRecord dbr = allLines.get(i);
      String[] values = null;
      if(i == 0){
