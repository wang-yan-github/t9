 ...
 *
 */
public class T9DiaryUtil{
  private static Logger log = Logger
  .getLogger("t9.core.funcs.diary.logic.T9DiaryUtil");
  /**
   * 去掉所有html标签
   * @param html
   * @return
  ...
  public static String  cutHtml(String html){
    String result = "";
    if (!T9Utility.isNullorEmpty(html)) {
 ...
 */
  ...
  public static T9Diary getDiary(Connection conn,int seqId) throws Exception{
    T9Diary dia = null;
    T9ORM orm = new T9ORM();
    dia = (T9Diary) orm.loadObjSingle(conn, T9Diary.class, seqId);
    return dia;
  }
  /**
   * 取得最大的seqId
