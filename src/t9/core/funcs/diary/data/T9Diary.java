package t9.core.funcs.diary.data;
...
public class T9Diary{
  ...
  public void setDiaDate(Date diaDate){
    try{
      diaDate =T9Utility.parseDate(new SimpleDateFormat("yyyy-MM-dd").format(diaDate));
  ...
  public String toString(){
    return "T9Diary [attachmentId=" + attachmentId + ", attachmentName="
