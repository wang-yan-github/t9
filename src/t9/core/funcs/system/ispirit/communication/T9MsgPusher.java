package t9.core.funcs.system.ispirit.communication;
...
public class T9MsgPusher {
  ...
  public static void mobilePushNotification(String uidSend, String content, String module) throws Exception {
    ...
    //System.out.println("C^m^n^" +uidSend+"^"+module+"^"+content);
  ...
  public static void push(String content) throws IOException {  
    //从配置文件中读取
    String addr = T9SysProps.getString("IM_SERVER_ADDR");
    String portStr = T9SysProps.getString("IM_SERVER_PORT");
//    String addr = "192.168.1.1";
//    String portStr = "";
    int port = 1188;
    if (T9Utility.isNullorEmpty(addr)) {
      addr = "127.0.0.1";
    }
    if (T9Utility.isNumber(portStr)) {
