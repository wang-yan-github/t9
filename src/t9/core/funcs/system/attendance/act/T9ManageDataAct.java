...
import t9.core.funcs.system.attendance.logic.T9ManageDataLogic;
import t9.core.global.T9ActionKeys;
import t9.core.global.T9BeanKeys;
import t9.core.global.T9Const;

public class T9ManageDataAct {
  /***
  ...
  public String deleteData(HttpServletRequest request,
    ...
    try {
      ...
      T9ManageDataLogic dataLogic = new T9ManageDataLogic();
      if(duty!=null){
        if(userIds.equals("")){
      ...
      t9.core.funcs.system.syslog.logic.T9SysLogLogic.addSysLog(dbConn,"13","删除考勤记录",userId,ip);
