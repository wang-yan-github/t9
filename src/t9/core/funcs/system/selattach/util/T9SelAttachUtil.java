package t9.core.funcs.system.selattach.util;
...
public class T9SelAttachUtil {
   ...
   * @throws Exception 
   */
  public T9SelAttachUtil(T9FileUploadForm fuf,String moudel) throws Exception{
    try{
   ...
   * @throws Exception
   */
  public T9SelAttachUtil(Map<String, String> fuf,String moudel) throws Exception{
    init(fuf, moudel);
  }
  /**
   * 构造方法  
   ...
   * @throws Exception
   */
  public T9SelAttachUtil(HttpServletRequest request,String moudel) throws Exception{
  ...
  private void saveFileByDisk(String attachName,String path,String diskId,String moudel) throws Exception{
    ...
    String copyPath = T9SysProps.getAttachPath();
