...
import t9.core.funcs.system.syslog.logic.T9SysYearLogSearchLogic;
import t9.core.global.T9ActionKeys;
import t9.core.global.T9BeanKeys;
import t9.core.global.T9Const;

public class T9SysYearLogSearchAct {
  ...
  public String getMySysLog(HttpServletRequest request,
    ...
    try {
        ...
        T9SysYearLogSearchLogic syslog =new T9SysYearLogSearchLogic();
  ...
  public String getMySysYearLog(HttpServletRequest request,
    ...
    try {
        ...
        request.setAttribute(T9ActionKeys.RET_STATE, T9Const.RETURN_OK);
        request.setAttribute(T9ActionKeys.RET_MSRG,"成功取出日志");
        request.setAttribute(T9ActionKeys.RET_DATA, sb1.toString());
    }catch(Exception ex) {
        request.setAttribute(T9ActionKeys.RET_STATE, T9Const.RETURN_ERROR);
        request.setAttribute(T9ActionKeys.RET_MSRG, ex.getMessage());
        throw ex;
