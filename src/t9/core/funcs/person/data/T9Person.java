package t9.core.funcs.person.data;
...
public class T9Person  implements Serializable{
  private int seqId;
  ...
  public boolean isAdmin() {
    return T9SysProps.getAdminName().equals(userId);
  }
...
//    }
  ...
  public String toString() {
    return "T9Person [addHome=" + addHome + ", auatar=" + auatar
