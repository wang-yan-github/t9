...
public class T9CreateTime {
  public static void main(String[] args) throws  Exception { 
    String startday2 = "2010-03-20";//开始时间 
    String endday2 = "2010-04-16";//结束时间
    Date startday = T9Utility.parseDate(startday2);
    Date endday = T9Utility.parseDate(endday2);
    ...
    //得到相差多少天 
    int spanDays = getIntervalDays(startDate,T9Utility.parseDate(end2)); 
...
//    System.out.println(endday2.substring(8,10));
  ...
  public static List getDays(Date start,Date end,int day){ 
    ...
    for(int i = 0;i<=day;i++){ 
      ...
      String dateTempStr = T9Utility.getDateTimeStr(dateTemp); 
