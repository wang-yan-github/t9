...
public class T9FolderSizeLogic {

	public String getSize(Connection conn, T9Person loginUser) throws Exception {
		String query = "select SEQ_ID, USER_ID from FILE_SORT where SORT_TYPE=4  and SORT_PARENT=0";
		long sortSize = 0;
...
//		long returnSize = 0;
	...
	public int getTreeSizeRoot(Connection conn, int userId) throws Exception {
		String query = "select * from FILE_CONTENT where sort_ID=0 and user_id='" + userId + "'";
		Statement stm1 = null;
		ResultSet rs1 = null;
		int sortSize = 0;
		try {
