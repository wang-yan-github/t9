...
public class T9Department {

  @Override
  public String toString() {
    return "T9Department [deptCode=" + deptCode + ", deptFunc=" + deptFunc
  ...
  private ArrayList<T9DeptPosition> deptList = null;
 
  public Iterator itDept(){
    if(deptList==null){
      deptList=new ArrayList<T9DeptPosition>();
    }
    return deptList.iterator();
  }
  
  public ArrayList<T9DeptPosition> getDeptList() {
    return deptList;
  }
  public void setDeptList(ArrayList<T9DeptPosition> deptList) {
