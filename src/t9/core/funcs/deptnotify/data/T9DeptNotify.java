package t9.core.funcs.deptnotify.data;

import java.util.Date;

import t9.core.util.T9Utility;

public class T9DeptNotify {
  ...
  public String toJSON(){
    ...
    if(this.subject != null){
      sb.append(",subject:'" + T9Utility.encodeSpecial(this.subject) + "'");
    }else{
      sb.append(",subject:''");
    }
    if(this.content != null){
      sb.append(",content:'" + T9Utility.encodeSpecial(this.content) + "'");
    }else{
      sb.append(",content:''");
    }
