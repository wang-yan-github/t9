...
public class T9NewsMetaLogic{
  ...
  public void insertMainData(Connection dbConn, String guid, String filePath, Map<String, String> dataMap, 
    ...
    String className = "t9.subsys.inforesouce.db.T9MetaDbHelper";
    ...
    T9ReflectUtility.exeMethod(className, method, paramTypeNameArray, params);
  }
