...
public class T9FeedbackAct {
  private static Logger log = Logger
    .getLogger("t9.core.funcs.workflow.act.T9FeedbackAct");
  ...
  public String getRecFeedback(HttpServletRequest request,
    ...
    try{
      ...
      int count = 0 ;
      String query  = "SELECT CONTENT from FLOW_RUN_FEEDBACK where USER_ID='"+loginUser.getSeqId()+"' order by EDIT_TIME desc";
      Statement stm5 = null;
      ResultSet rs5 = null;
      String contentAll = "";
      try {
