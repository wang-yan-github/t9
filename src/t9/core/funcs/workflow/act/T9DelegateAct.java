...
import t9.core.funcs.workflow.logic.T9DelegateLogic;
...
public class T9DelegateAct {
  private static Logger log = Logger
    .getLogger("t9.core.funcs.workflow.act.T9DelegateAct");
  public String getDelegateMsg(HttpServletRequest request,
    ...
    try{
      ...
      if ( "5,".equals(roleStr) ) {//没有权限
        ...
        request.setAttribute(T9ActionKeys.RET_MSRG,"没有该流程委托权限，请与OA管理员联系");
      } else {
        T9DelegateLogic logic = new T9DelegateLogic();
        if (!isManage) {
