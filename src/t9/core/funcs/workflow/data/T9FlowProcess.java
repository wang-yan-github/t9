...
public class T9FlowProcess {
  ...
  public StringBuffer toJSON() throws Exception, Exception{
    ...
    if(this.childFlow != 0){
      ...
      if (!T9Utility.isNullorEmpty(this.prcsTo) && this.prcsTo.endsWith(",")) {
        this.prcsTo = this.prcsTo.substring(0 , this.prcsTo.length() - 1);
      }
      if("0".equals(this.prcsTo) || T9Utility.isNullorEmpty(this.prcsTo)){
        sb.append("act0:0,");
        sb.append("prcsTo:'" + this.prcsTo + "',");
      ...
      if(this.autoType.equals("7")){
        ...
        if (this.autoUserOp == null) {
          ...
          ||this.autoType.equals("6")){
        sb.append("autoBaseUser:'" + this.autoBaseUser + "',");
      }else if(this.autoType.equals("22")){
        sb.append("autoDeptOp:'" + this.autoUser + "',");
      }
      ...
      sb.append("viewPriv:'" + this.viewPriv + "',");
      sb.append("extend:'" + extend + "',");
      if (extend1 == null) {
        extend1 = "";
      }
      sb.append("extend1:'" + extend1 + "',");
      sb.append("autoSelectRole:'" + T9Utility.null2Empty(autoSelectRole) + "',");
      sb.append("dispAip:" + this.dispAip + ",");
      if(this.plugin == null){
        this.plugin = "";
      }
