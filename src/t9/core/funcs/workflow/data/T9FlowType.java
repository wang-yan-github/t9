...
public class T9FlowType {
    ...
    public String getNewUser(Connection conn) throws Exception {
        this.newUser = T9OrgSelectLogic.changePriv(conn, this.newUser);
        return this.newUser;
    }
    ...
    private String autoEdit;// 是否允许手动修改文号
    ...
    public String toJson() {
        ...
        sb.append(",flowName:\"" + T9Utility.encodeSpecial((flowName != null ? flowName : "")) + "\"");
        ...
        sb.append(",autoName:\"" + T9Utility.encodeSpecial((autoName != null ? autoName : "")) + "\"");
        ...
        sb.append(",flowDesc:\"" + T9Utility.encodeSpecial((flowDesc != null ? flowDesc : "")) + "\"");
        ...
        sb.append(",attachmentId:'" + (attachmentId != null ? attachmentId : "") + "'");
        sb.append(",attachmentName:'" + (attachmentName != null ? attachmentName : "") + "'");
        ...
        sb.append(",listFldsStr:\"" + T9Utility.encodeSpecial(listFldsStr != null ? listFldsStr : "") + "\"");
        ...
        sb.append(",viewPriv:'" + viewPriv + "'");
        sb.append(",viewUser:'" + T9Utility.null2Empty(viewUser) + "'");
