...
public class T9FlowHookUtility {
  ...
  public String runHook(Connection conn, T9Person user  ,Map dataMap,  String module ) throws Exception {
    String query = "select * from flow_hook where hmodule='"+ module +"' and status >0";
    Statement stm = null; 
    ResultSet rs = null; 
    ...
    try { 
      ...
      if (rs.next()){ 
        ...
        String query1 = "insert into flow_run_hook (run_id,module,field,key_id) values('"+runId+"','"+module+"','"+field+"','"+keyId+"')";
  ...
  public String runHookPlugin(Connection conn , int runId) throws Exception {
    String query = "SELECT * from flow_hook a left outer join flow_run_hook b on a.hmodule = b.module where b.run_id='"+runId+"'";
    Statement stm = null; 
    ResultSet rs = null; 
    Map arrayData = new HashMap();
    try { 
      ...
      if (rs.next()){ 
        ...
        String notPass = "";
        String query2 = "SELECT FORM_SEQ_ID , FLOW_TYPE.SEQ_ID from FLOW_TYPE , FLOW_RUN WHERE RUN_ID=" + runId + " AND FLOW_RUN.FLOW_ID = FLOW_TYPE.SEQ_ID";
        int formId = 0;
        int flowId = 0;
        ...
        ResultSet rs3 = null; 
        String map = "";
        String query3 = "select map from flow_hook where SEQ_ID='"+seqId+"'";
        try { 
  ...
  public int getFlowId(Connection conn , String field ,String keyId) throws Exception{
    String query  = "select run_id from flow_run_hook where field='"+ field + "' and key_id='"+keyId+"'";
    Statement stm = null; 
    ResultSet rs = null; 
    int runId = 0;
    try { 
  ...
  public void deleteHook(Connection dbConn , String field , String keyId) throws Exception {
    ...
    if (runId != 0) {
      String delete = "delete from flow_run_hook where  field='"+field+"' and key_id='"+keyId+"'";
