package t9.core.funcs.connswitch.logic;
...
public class T9ConnSwitchLogic {
  ...
  public void getSwitchDbms(String dbms,String rootPath) throws Exception{
   ...
   String dbconfig=T9SysProps.getWebInfPath()+ File.separator + "config" + File.separator + "dbconfig.properties";
   String selfconfig=T9SysProps.getWebInfPath()+ File.separator + "config" + File.separator + "selfconfig.properties";
   ...
   Map<String,String> map = T9FOM.json2Map(dbInfo);
    ...
    if("oracle".equals(dbms)){
      String dbName=  T9SysProps.getProp("db.jdbc.userName.oracle");
  ...
  public String testOraConnect(Map request)throws Exception{
   ...
   try{
    String driverName=  T9SysProps.getProp("db.jdbc.driver.oracle");
  ...
  public String testSqlConnect(Map request)throws Exception{
    ...
    Connection conn= null;
   try{
    String driverName=  T9SysProps.getProp("db.jdbc.driver.sqlserver");
    Class.forName(driverName).newInstance();
    conn=DriverManager.getConnection(url,user,password);
    data="1";
    conn.close();
  ...
  public void saveSqlConnect(Map request)throws Exception{
    ...
    StringBuffer dbConfigInfo=T9FOM.toJson(map);
