...
public class T9SignReaderLogic {
	private int readCount = 0;
	private int unReadCount = 0;
	private int isHavePriv = 0;
	private Map userIdMap = null;
	public String getSignReader(int sortId, int contentId,T9Person person, Connection conn) throws Exception {
	...
	public Map getFileContent(int contentId, Connection conn) throws Exception {
		Map map = new HashMap();
		String sql = "SELECT SUBJECT,READERS from FILE_CONTENT where SEQ_ID=" + contentId;
		Statement stm1 = null;
		ResultSet rs1 = null;
		String subject = "";
		String readers = "";
	...
	public Map getUserId(int sortId, Connection conn) throws Exception {
		Map map = new HashMap();
		String query = "SELECT USER_ID from FILE_SORT where SEQ_ID =" + sortId;
	...
	public List<T9Department> getDeptByParentId(Connection conn, int deptId) throws Exception {
		List<T9Department> list = new ArrayList();
		String query = "select SEQ_ID , DEPT_NAME from Department where dept_parent=" + deptId;
		Statement stm1 = null;
		ResultSet rs1 = null;
		try {
			stm1 = conn.createStatement();
	...
	public void delSignReader(Connection conn, int contentId, T9Person user) throws Exception {
		boolean accessPriv = false;
		boolean managePriv = false;

		String query = "select SORT_ID from FILE_CONTENT where SEQ_ID=" + contentId;
		Statement stm1 = null;
		ResultSet rs1 = null;
		int sortId = 0;
		try {
		...
		String queryUser = "select USER_ID,MANAGE_USER,OWNER from FILE_SORT where SEQ_ID=" + sortId;
		Statement stm2 = null;
		ResultSet rs2 = null;
		String userId = "";
		String manageUser = "";
		...
		String del = "update FILE_CONTENT set READERS='' where SEQ_ID=" + contentId;
		Statement stm3 = null;
		try {
